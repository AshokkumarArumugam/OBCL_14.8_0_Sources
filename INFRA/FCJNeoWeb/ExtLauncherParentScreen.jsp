<%/*----------------------------------------------------------------------------------------------------
**
** File Name    : ExtLauncherParentScreen.jsp
**
** Module       : FCJWeb
**
...
<html lang="<%=StringEscapeUtils.escapeHTML(langISOMap)%>">
    ...
    <link href="Script/css/fonts/ojuxIconFont.css" type="text/css" rel="stylesheet"/>
        ...
        <script type="text/javascript">
            ...
            var inTime              = '<%=StringEscapeUtils.escapeJavaScript(inTime)%>';
      ...
      <!-- 12.0.4 js segregation changes starts -->
      <!--  <%
        ...
        %> 12.0.4 js segregation changes ends 
        -->
			<script type="text/javascript" src="Script/ExtJS/ExtPrint.js"></script> <noscript><%=StringEscapeUtils.escapeJavaScript(noScriptLabel)%></noscript><!--35125810-->
        ...
        <!--23657573 - HOOK REQUIRED FOR F11 ends-->
         <script type="text/javascript" src="Script/OJET/main_parentscreen.js"></script>
    </head>  
     <!--Security bug SEC-12-Patch-081 fixes starts -->
    <body onkeydown="return shortcut(event)" 
        ...
        <div style="height:100%" id="DIVWNDContainer">
            <DIV id="WNDtitlebar"   >
                ...
                <div class="oj-flex-bar-start">
                    <h1><%=StringEscapeUtils.escapeHTML(description)%>&nbsp;</h1>
                     ...
                     <div class="oj-flex-bar-end">
                       ...
                       <oj-button display="icons" chroming="borderless" type="button" class="WNDcls" accesskey="6" id ="WNDbuttonsMin" title="<%=StringEscapeUtils.escapeHTML((String)itemDescMap.get("LBL_CLOSE"))%>" title="<%=StringEscapeUtils.escapeHTML((String)itemDescMap.get("LBL_CLOSE"))%>" onclick="if(this.disabled) return false; fnExitAll('', event)" onkeydown="return fnHandleScrBtn(event)">
