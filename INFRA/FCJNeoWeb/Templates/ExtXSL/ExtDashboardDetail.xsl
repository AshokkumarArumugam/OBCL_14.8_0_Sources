          ...
          <div id="{./BLOCK}_tableContainer">
                 <oj-bind-if test="{{showTable}}">
                    <oj-table cellspacing="0"   ID="{./BLOCK}" caption="{./LBL}" type="ME"
                              summary="{./LBL}" role="presentation" display="grid" class="oj-sm-width-full oj-sm-margin-4x-vertical" user-assistance-density="compact">
        ...
        <div name="dataContainer" id="dataContainer_{./BLOCK}">
            ...
            <div class="DIVmultiplebox" onkeydown="return addRowShortcut('{./BLOCK}', event);">
                ...
                <div id="{./BLOCK}_tableContainer" style="Height:{$multipleHeight}px;" onscroll="toggleSelectBoxes(this,'{./BLOCK}Header')"><!--Fix for 21619139 -->
                    ...
                    <oj-bind-if test="{{showTable}}">
                     <oj-table cellpadding="0" ID="{./BLOCK}"       caption="{./LBL}"   type="ME" summary="{./LBL}" role="presentation" user-assistance-density="compact">
...
<!--UDF Changes Start -->
    ...
    <xsl:template match="FLDSET">
        ...
        <xsl:choose>
            ...
            <!--<div class="oj-flex">-->
                ...
                <fieldset style="padding-top:0px" block="{./BLOCK}" type="{./@TYPE}" view="{./@VIEW}">
                    <!-- 12.0.3 Enable/Disable Screen Element starts -->
                    <xsl:attribute name="id">
    ...
    <xsl:template match="SECTION">
        ...
        <div>
            ...
            <xsl:choose>
             ...
             <oj-collapsible class="oj-sm-padding-5x-horizontal">
             <h4 slot="header">
                <xsl:value-of select="LBL"/>
             </h4>
                <!--<xsl:attribute name="class">
   ...
   <xsl:if test="(count(../../HREQ) = 0 or (count(../../HREQ) > 0 and ../../HREQ != -1)) and (../../@TYPE != 'ME' or ../../@VIEW = 'SE')">  
    <oj-label slot="label">
      ...
      <oj-input-text slot="value"   related_field="{../RELATED_FIELD}"  class="oj-helper-text-align-end align-right">
            <!--Added for 17388325 -->
      ...
      <xsl:if test="../LBL = ''">
       ...
       <!--Fix for 21499059 end-->
         ...
         <xsl:if test="../../@TYPE != 'ME' or ../../@VIEW = 'SE'">
            ...
            <xsl:attribute name="class">
                <xsl:text>oj-sm-padding-2x-bottom</xsl:text>
            </xsl:attribute>
...
<!--<xsl:text>amountConverter</xsl:text><xsl:value-of select="$amountNode/../BLOCK"/><xsl:text>__</xsl:text> <xsl:value-of select="$amountNode/NAME"/>= getFormattedAmount(this,  '<xsl:value-of select="$amountNode/RELATED_FIELD"/>',true);-->    
    ...
    <!-- added for Amount/Exchange Rate patterns starts -->
        ...
        <oj-input-text slot="value" class="oj-helper-text-align-end align-right" type="text">
            <!-- added for 17388325 start -->
            <xsl:attribute name="TITLE">
            <xsl:value-of select="../LBL"/>
           </xsl:attribute>
   ...
   <OJ-INPUT-TEXT style="display:none;" onpropertychange="displayValue(this)">
    ...
    <xsl:template match="SCREEN">
         ...
         <div name="dataContainer" id="dataContainer" class="oj-sm-padding-2x-vertical oj-sm-margin-2x-vertical oj-sm-padding-1x-end">
            <div id="multipleboxDiv" class="oj-sm-padding-4x-start partitionPanel">
                <div class="oj-flex-bar oj-sm-align-items-center" id="wndtitle">
                    <div class="oj-flex-bar-start">
                        <h4 id="heading"><xsl:value-of select= "$scrTitle"/></h4>
                    </div>
                </div>
		<div class="oj-sm-width-full" id="DIVMainTmp" style="overflow:auto;">
