define(['jquery', 'ojs/ojcore', 'knockout', 'ojs/ojarraydataprovider', 'ojs/ojpagingdataproviderview', "ojs/ojconverter-number","ojs/ojcontext", 'ojs/ojinputtext', 'ojs/ojdialog','ojs/ojnavigationlist', 'ojs/ojradioset', 'ojs/ojtable', 'ojs/ojswitcher', 'ojs/ojselectsingle', 'ojs/ojselectcombobox', 'ojs/ojarraytabledatasource', 'ojs/ojpagingcontrol', 'ojs/ojpagingtabledatasource', 'ojs/ojswitch', "ojs/ojlabelvalue", "ojs/ojbutton", "ojs/ojswitch", 'ojs/ojnavigationlist', 'ojs/ojconveyorbelt', 'ojs/ojcollapsible',"ojs/ojlistitemlayout", "ojs/ojlistview",'ojs/ojdatetimepicker','ojs/ojvalidation-datetime'], function ($, oj, ko, ArrayDataProvider, PagingDataProviderView, ojconverter_number_1,Context) {
            ...
            setTimeout(function () {
                ...
                setTimeout(function () {
                 ...
                 setTimeout(function () {
                    ...
                    if (!fnEventsHandlerSubScreen('fnPostLoad', scrName, functionId, parent.screenArgs)) {
                        disableForm();
                        fnEnableElement(document.getElementById('BTN_EXIT_IMG'));
                        //document.getElementById('BTN_EXIT_IMG').focus();
                        setTimeout(function () {
                ...
                if( document.getElementById("BTN_EXIT_IMG")){
                 ...
                 },100); //REDWOOD_35217621  reduce milliseconds 100 instead of 1000
