require(['ojs/ojbootstrap','knockout','ojs/ojarraydataprovider','JS/UIUtil','JS/GlobalConstants','JS/LOV', 'ojs/ojtable', 'ojs/ojlabelvalue', 'ojs/ojcollapsible'], 
    function (Bootstrap, ko, ArrayDataProvider) {
        Bootstrap.whenDocumentReady().then(
          function () {
            ...
            setTimeout(function (){getLovResults();},0);
