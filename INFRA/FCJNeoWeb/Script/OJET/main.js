...
require.config( {
    ...
    shim :  {
        ...
        kernelJSFile :  {
            deps : ['JS/SYS/' + uiXML + '_SYS', extJs,'ExtJS/ExtDatabinding', 'ExtJS/ExtensibleMEUtil', 'ExtJS/ExtensibleUtil', extBpelJs, summaryUtilJs]
        },                                                                                                                     
        clusterJSFile :  {                                                                                                     
            deps : [ 'JS/SYS/' + uiXML + '_SYS', extJs,'ExtJS/ExtDatabinding', 'ExtJS/ExtensibleMEUtil', 'ExtJS/ExtensibleUtil', extBpelJs, summaryUtilJs,   kernelJSFile]
        },                                                                                                                     
        customJSFile :  {                                                                                                      
            deps : [ 'JS/SYS/' + uiXML + '_SYS', extJs,'ExtJS/ExtDatabinding', 'ExtJS/ExtensibleMEUtil', 'ExtJS/ExtensibleUtil', extBpelJs, summaryUtilJs,   kernelJSFile, clusterJSFile]
        },                                                                                                                     
        extUtilCluster :  {                                                                                                    
            deps : [ 'JS/SYS/' + uiXML + '_SYS', extJs,'ExtJS/ExtDatabinding', 'ExtJS/ExtensibleMEUtil', 'ExtJS/ExtensibleUtil', extBpelJs, summaryUtilJs,   kernelJSFile, clusterJSFile]
        },                                                                                                                     
        extUtilCustom :  {                                                                                                     
            deps : ['JS/Alert', 'ExtJS/ExtFuncs', 'ExtJS/ExtUIUtil', 'ExtJS/ExtUtil', 'ExtJS/ExtBuildXML', 'JS/SYS/' + uiXML + '_SYS', extJs,'ExtJS/ExtDatabinding', 'ExtJS/ExtensibleMEUtil', 'ExtJS/ExtensibleUtil', extBpelJs, summaryUtilJs,   kernelJSFile, customJSFile]
        }
    }
    });

/*    
require(['ojs/ojbootstrap', 'ojs/ojcontext', 'knockout', 'ojs/ojknockout', 'ojs/ojconverterutils-i18n', 'ojs/ojarraydataprovider', 'ojs/ojconveyorbelt', 'ojs/ojinputtext', 'ojs/ojformlayout', 'ojs/ojradioset', 'ojs/ojcheckboxset', 'ojs/ojinputnumber', 'ojs/ojselectcombobox', 'ojs/ojdatetimepicker', 'ojs/ojbutton', 'ojs/ojlabelvalue', 'ojs/ojlabel', 'ojs/ojnavigationlist', 'ojs/ojtable', 'ojs/ojswitch', 'ojs/ojradioset', 'ojs/ojcheckboxset', 'ojs/ojselectcombobox', 'ojs/ojdatetimepicker', 'ojs/ojnavigationlist', 'ojs/ojconveyorbelt', 'JS/SYS/' + uiXML + '_SYS', extJs, 'ExtJS/ExtDatabinding', 'ExtJS/ExtensibleMEUtil', 'ExtJS/ExtensibleUtil', summaryUtilJs], function () {
...
require(['ojs/ojbootstrap', 'ojs/ojcontext', 'knockout', 'ojs/ojknockout', 'ojs/ojconverterutils-i18n', 'ojs/ojarraydataprovider', 'ojs/ojconveyorbelt', 'ojs/ojinputtext', 'ojs/ojformlayout', 'ojs/ojradioset', 'ojs/ojcheckboxset', 'ojs/ojinputnumber', 'ojs/ojselectcombobox', 'ojs/ojdatetimepicker', 'ojs/ojbutton', 'ojs/ojlabelvalue', 'ojs/ojlabel', 'ojs/ojnavigationlist', 'ojs/ojtable', 'ojs/ojswitch', 'ojs/ojradioset', 'ojs/ojcheckboxset', 'ojs/ojselectcombobox', 'ojs/ojdatetimepicker', 'ojs/ojnavigationlist'], function(){
    require(['JS/Alert', 'ExtJS/ExtFuncs', 'ExtJS/ExtUIUtil', 'ExtJS/ExtUtil', 'ExtJS/ExtBuildXML'], function(){
        require(['JS/SYS/' + uiXML + '_SYS', extJs, 'ExtJS/ExtDatabinding', 'ExtJS/ExtensibleMEUtil', 'ExtJS/ExtensibleUtil', extBpelJs, summaryUtilJs], function () {
            require([kernelJSFile],function(){
                require([clusterJSFile], function(){
                    require([customJSFile], function(){
                        require([extUtilCluster], function(){
            ...
            console.log("Ranjan ---- here on failure")
            require([clusterJSFile], function(){
                    require([customJSFile], function(){
                        require([extUtilCluster], function(){
                            require([extUtilCustom], function(){
...
require(['ojs/ojbootstrap', 'ojs/ojcontext', 'knockout', 'ojs/ojknockout', 'ojs/ojconverterutils-i18n', 'ojs/ojarraydataprovider', 'ojs/ojconveyorbelt', 'ojs/ojinputtext', 'ojs/ojformlayout', 'ojs/ojradioset', 'ojs/ojcheckboxset', 'ojs/ojinputnumber', 'ojs/ojselectcombobox', 'ojs/ojdatetimepicker', 'ojs/ojbutton', 'ojs/ojlabelvalue', 'ojs/ojlabel', 'ojs/ojnavigationlist', 'ojs/ojtable', 'ojs/ojswitch', 'ojs/ojradioset', 'ojs/ojcheckboxset', 'ojs/ojselectcombobox', 'ojs/ojdatetimepicker', 'ojs/ojnavigationlist'], function(){
    require(['JS/Alert', 'ExtJS/ExtFuncs', 'ExtJS/ExtUIUtil', 'ExtJS/ExtUtil', 'ExtJS/ExtBuildXML'], function(){
        require(['JS/SYS/' + uiXML + '_SYS', extJs, 'ExtJS/ExtDatabinding', 'ExtJS/ExtensibleMEUtil', 'ExtJS/ExtensibleUtil', extBpelJs, summaryUtilJs, summaryJs], function () {
            require([kernelJSFile], function () {
		require([clusterJSFile], function () {
			require([customJSFile], function () {
				require([extUtilCluster], function () {
		...
		require([clusterJSFile], function () {
			require([customJSFile], function () {
				require([extUtilCluster], function () {
					...
					function (err) {require([defineJs], function () {});
					});
				},
				function (err) {
					require([extUtilCustom], function () {
