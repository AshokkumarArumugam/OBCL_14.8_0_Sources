    var screenId = parentFunc;
if ("Y" == scrChild) {
    screenId = parentFunction;
}

var summaryUtilJs = "ExtJS/ExtGlobalSumUtil";
var summaryJs = 'ExtJS/ExtGlobalSum';
var defineJs = 'OJET/ExtDetailDefine';
var extJs = '';
var extBpelJs = '';
//var extJsSum = 'ExtJS/Extensible';
    //	var thirdChar 	= funcID.substring(2,3);
if (isDetailed) {
    summaryUtilJs = "";
    summaryJs = "";
    extJs = 'ExtJS/Extensible';

    // extJsSum = "";
}
 if("P" == screenType || "T"==screenType){
       extBpelJs= 'ExtJS/ExtensibleBPEL';
    }
...
require.config( {
    ...
    shim :  {
        ...
        'OJET/ExtDetailDefine' :  {
            deps : [summaryJs]
        },
        superParentKernelJSFile:{
            deps : ['JS/SYS/' + screenId + '_SYS', extJs, 'OJET/ExtDetailDefine', 'ExtJS/ExtDatabinding', 'ExtJS/ExtensibleMEUtil', 'ExtJS/ExtensibleUtil', extBpelJs, summaryUtilJs, defineJs]
        
        },parentKernelJSFile:{
             deps : ['JS/SYS/' + screenId + '_SYS', extJs, 'OJET/ExtDetailDefine', 'ExtJS/ExtDatabinding', 'ExtJS/ExtensibleMEUtil', 'ExtJS/ExtensibleUtil', extBpelJs, summaryUtilJs, defineJs,superParentKernelJSFile]
        },kernelJSFile:{
             deps : ['JS/SYS/' + screenId + '_SYS', extJs, 'OJET/ExtDetailDefine', 'ExtJS/ExtDatabinding', 'ExtJS/ExtensibleMEUtil', 'ExtJS/ExtensibleUtil', extBpelJs, summaryUtilJs, defineJs,superParentKernelJSFile,parentKernelJSFile]
        },superParentClusterJSFile:{
            deps : ['JS/SYS/' + screenId + '_SYS', extJs, 'OJET/ExtDetailDefine', 'ExtJS/ExtDatabinding', 'ExtJS/ExtensibleMEUtil', 'ExtJS/ExtensibleUtil', extBpelJs, summaryUtilJs, defineJs,superParentKernelJSFile]
        },parentClusterJSFile :{
            deps : ['JS/SYS/' + screenId + '_SYS', extJs, 'OJET/ExtDetailDefine', 'ExtJS/ExtDatabinding', 'ExtJS/ExtensibleMEUtil', 'ExtJS/ExtensibleUtil', extBpelJs, summaryUtilJs, superParentKernelJSFile,superParentClusterJSFile,parentKernelJSFile]
        },clusterJSFile:{
            deps : ['JS/SYS/' + screenId + '_SYS', extJs, 'OJET/ExtDetailDefine', 'ExtJS/ExtDatabinding', 'ExtJS/ExtensibleMEUtil', 'ExtJS/ExtensibleUtil', extBpelJs, summaryUtilJs, superParentKernelJSFile,superParentClusterJSFile,parentKernelJSFile,parentClusterJSFile,kernelJSFile]
        },superParentCustomJSFile:{
            deps : ['JS/SYS/' + screenId + '_SYS', extJs, 'OJET/ExtDetailDefine', 'ExtJS/ExtDatabinding', 'ExtJS/ExtensibleMEUtil', 'ExtJS/ExtensibleUtil', extBpelJs, summaryUtilJs, superParentKernelJSFile,superParentClusterJSFile]
        },parentCustomJSFile:{
            deps : ['JS/SYS/' + screenId + '_SYS', extJs, 'OJET/ExtDetailDefine', 'ExtJS/ExtDatabinding', 'ExtJS/ExtensibleMEUtil', 'ExtJS/ExtensibleUtil', extBpelJs, summaryUtilJs, superParentKernelJSFile,superParentClusterJSFile,superParentCustomJSFile,parentKernelJSFile,parentClusterJSFile]
        },customJSFile:{
            deps : ['JS/SYS/' + screenId + '_SYS', extJs, 'OJET/ExtDetailDefine', 'ExtJS/ExtDatabinding', 'ExtJS/ExtensibleMEUtil', 'ExtJS/ExtensibleUtil', extBpelJs, summaryUtilJs, superParentKernelJSFile,superParentClusterJSFile,superParentCustomJSFile,parentKernelJSFile,parentClusterJSFile,parentCustomJSFile,kernelJSFile,clusterJSFile]
        },extUtilCustom:{
            deps : ['JS/SYS/' + screenId + '_SYS', extJs, 'OJET/ExtDetailDefine', 'ExtJS/ExtDatabinding', 'ExtJS/ExtensibleMEUtil', 'ExtJS/ExtensibleUtil', extBpelJs, summaryUtilJs, superParentKernelJSFile,superParentClusterJSFile,superParentCustomJSFile,parentKernelJSFile,parentClusterJSFile,parentCustomJSFile,kernelJSFile,clusterJSFile]
        },extUtilCluster:{
            deps : ['JS/SYS/' + screenId + '_SYS', extJs, 'OJET/ExtDetailDefine', 'ExtJS/ExtDatabinding', 'ExtJS/ExtensibleMEUtil', 'ExtJS/ExtensibleUtil', extBpelJs, summaryUtilJs, superParentKernelJSFile,superParentClusterJSFile,parentKernelJSFile,parentClusterJSFile,kernelJSFile]
...
require(['ojs/ojbootstrap', 'ojs/ojcontext', 'knockout', 'ojs/ojknockout', 'ojs/ojconverterutils-i18n', 'ojs/ojarraydataprovider', 'ojs/ojconveyorbelt', 'ojs/ojinputtext', 'ojs/ojformlayout', 'ojs/ojradioset', 'ojs/ojcheckboxset', 'ojs/ojinputnumber', 'ojs/ojselectcombobox', 'ojs/ojdatetimepicker', 'ojs/ojbutton', 'ojs/ojlabelvalue', 'ojs/ojlabel', 'ojs/ojnavigationlist', 'ojs/ojtable','ojs/ojswitch','ojs/ojradioset', 'ojs/ojcheckboxset','ojs/ojselectcombobox', 'ojs/ojdatetimepicker','ojs/ojnavigationlist'], function(){
    require(['JS/Alert', 'ExtJS/ExtFuncs', 'ExtJS/ExtUIUtil', 'ExtJS/ExtUtil', 'ExtJS/ExtBuildXML'], function(){
        require(['JS/SYS/' + screenId + '_SYS', extJs, 'ExtJS/ExtDatabinding', 'ExtJS/ExtensibleMEUtil', 'ExtJS/ExtensibleUtil', extBpelJs, summaryUtilJs], function () {
            require([superParentKernelJSFile], function(){
                require([parentKernelJSFile], function(){
                    require([kernelJSFile], function(){
                        require([superParentClusterJSFile], function(){
                            require([parentClusterJSFile], function(){
                                require([clusterJSFile], function(){
                                    require([superParentCustomJSFile], function(){
                                        require([parentCustomJSFile], function(){
                                            require([customJSFile], function(){
                                                require([extUtilCluster], function(){
                                                    require([extUtilCustom], function(){
                                                        require([defineJs], function(){
                                                        });
                                                    });
                                                });
                                             });
