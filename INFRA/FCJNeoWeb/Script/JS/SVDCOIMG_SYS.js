...
var queryFields = new Array();    //Values should be set inside SVDCOIMG.js, in "BlockName__FieldName" format
var pkFields    = new Array();    //Values should be set inside SVDCOIMG.js, in "BlockName__FieldName" format
...
ArrFuncOrigin["SVDCOIMG"]="KERNEL";
ArrPrntFunc["SVDCOIMG"]="";
ArrPrntOrigin["SVDCOIMG"]="";
ArrRoutingType["SVDCOIMG"]="X";


 // Code for Loading Cluster/Custom js File Starts
ArrClusterModified["SVDCOIMG"]="N";
ArrCustomModified["SVDCOIMG"]="N";
