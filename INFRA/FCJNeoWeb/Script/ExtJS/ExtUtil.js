...
** 	Search String        : Redwood_35313671

**	Modified By          : Girish M
** 	Modified on          : 20-Apr-2023
** 	Modified Reason      : Redwood changes
** 	Search String        : redwood_35349364

**	Modified By          : Manoj S
** 	Modified on          : 08-May-2023
** 	Modified Reason      : Redwood changes applied for handling date separator when date value and format mismatches.
** 	Search String        : Redwood_35332879
**
**
**  Modified By          : Meenakshi K
**  Modified On          : 20-Apr-2023
**  Modified Reason      : Added code as upper case conversion was not happening .
**  Search String        : 35242531_ODT_REDWOOD_CHANGES
**
**  Modified By          : Meenakshi K
**  Modified On          : 14-Aug-2023
**  Modified Reason      : Ctrl+j was not launching joint holder screen as attribute value was not NULL.Corrected the same.
**  Search String        : 35661072_ODT_REDWOOD_CHANGE
**
**  Modified By          : Girish M
**  Modified On          : 18-Oct-2023
**  Modified Reason      : TAB OUT HOTKEY issue.
**  Search String        : REDWOOD_35358181
**
**  Modified By          : Meenakshi K
**  Modified On          : 03-Apr-2024
**  Modified Reason      : Help was not loading for callforms
**  Search String        : 36251737 
...
**  Modified By          : Girish M
**  Modified On          : 04-Feb-2025
**  Change Description   : F2 key function was failing.
**  Search String        : Bug_37510466 
********************************************************************************************
*/
...
var buttonCheck= false; //REDWOOD_35358181
        ...
        if (tab_obj.childNodes.length > 0) {
            if (tab_obj.childNodes[0].nodeType == '3')/*This happens in case of Safari Browser, the first child is text node*/
            {
                for (var i = 0;i < tab_obj.childNodes.length;i++) {
                    if (tab_obj.childNodes[i].nodeType != '3' && !tab_obj.childNodes[i].classList.contains( "oj-navigationlist-divider") )/*checking node is not text becos, setting childNodes[0].id is not possible for text nodes*//* Fix for Bug 16514031 - changed childNodes[0] to childNodes[i] in if condition*/ //REDWOOD_CHANGES
                    { //REDWOOD_CHANGES
            ...
            {
                for (var i = 0;i < tab_obj.childNodes.length;i++) {
                if(!tab_obj.childNodes[i].classList.contains( "oj-navigationlist-divider") ){ //REDWOOD_CHANGES
...
//REDWOOD_35358181 fix
   if ((srcElem.tagName == "OJ-BUTTON" && srcElem.type == "TEXT") ){
       type = srcElem.getAttribute("type");
   } else if (srcElem.parentNode.parentNode.parentNode!=null && srcElem.parentNode.parentNode.parentNode.tagName=="BUTTON"){ //Bug_37510466 
        type = "button";
   }
//REDWOOD_35358181 fix
    Obj = new Object();
    ...
    if (event.keyCode == 13) {
        ...
        }else if ((type.toUpperCase() != "TEXTAREA" && type.toUpperCase() != "BUTTON"  && typeof(srcElem.tagName)!="undefined" && srcElem.tagName.toUpperCase()!="SELECT")
			||(type.toUpperCase() == "TEXT" && typeof(srcElem.tagName)!="undefined" && typeof(srcElem.tagName) =="OJ-BUTTON") //REDWOOD_35358181 changes
		  || srcElem.readOnly )  {
            return false;
        }
    }
    ...
    if (event.ctrlKey == true && event.altKey == false &&  event.keyCode == 78) { //Fix for 22653877
    ...
    else if (event.ctrlKey == true && event.altKey == false && event.keyCode == 83) { //Fix for 22653877
    ...
    else if (event.ctrlKey == true && event.altKey == false && event.shiftKey == true && event.keyCode == 67) { //Fix for 22653877
    ...
    else if (event.ctrlKey == true && event.altKey == false && event.shiftKey == true && event.keyCode == 89) { //Fix for 22653877
    ...
    else if (event.ctrlKey == true && event.altKey == false && event.shiftKey == true && event.keyCode == 90) { //Fix for 22653877
    ...
    else if (event.ctrlKey == true && event.altKey == false && event.keyCode == 68) { //Fix for 22653877
    ...
    else if (event.ctrlKey == true && event.altKey == false && event.keyCode == 85) { //Fix for 22653877
    ...
    else if (event.ctrlKey == true && event.altKey == false && event.keyCode == 82) { //Fix for 22653877
    ...
    else if (event.ctrlKey == true && event.altKey == false && event.keyCode == 80) { //Fix for 22653877
        // If 'P' is pressed with Ctrl Key...for Print
        if(/*mainWin.applicationExt == "JP" && */restrictPrint == 'Y') return false;//jc2 changes//PIPA
        fnDisableBrowserKey(event);
        if (!(document.getElementById("Print").disabled))
            setTimeout("doAction(mainWin.ACTIONPRINT)", 0);//JS Segregation changes
        return false;
    }
    else if (event.ctrlKey == true && event.altKey == false && event.keyCode == 69) { //Fix for 22653877
        // If 'E' is pressed with Ctrl Key...for Reverse
        fnDisableBrowserKey(event);
        if (document.getElementById("Export")) {
            if (document.getElementById("Export").style.display == "flex") { //REDWOOD_CHANGES
    ...
    else if (event.ctrlKey == true && event.altKey == false && event.shiftKey == true && event.keyCode == 86) { //Fix for 22653877
    ...
    else if (event.ctrlKey == true && event.altKey == false && event.keyCode == 77) { //Fix for 22653877
    ...
    else if (event.ctrlKey == true && event.altKey == false && event.altKey == false && event.keyCode == 81) { //Fix for 22653877
    ...
    else if (event.ctrlKey == true && event.altKey == false && event.keyCode == 72) { //Fix for 22653877
        // If 'H' is pressed with Ctrl Key...for Hold
        fnDisableBrowserKey(event);
        if (thirdChar == 'S') {
            if (document.getElementById("Refresh").style.display == 'flex') { //REDWOOD_CHANGES
    ...
    else if (event.ctrlKey == true && event.altKey == false && event.keyCode == 66) { //Fix for 22653877
    ...
    if (event.ctrlKey == true && event.altKey == false && event.keyCode == 80) { //Fix for 22653877
        // If 'P' is pressed with Ctrl Key...for PRINT
        if(/*mainWin.applicationExt == "JP" &&*/ restrictPrint == 'Y') return false;//jc2 changes//PIPA
        if (!(document.getElementById("Print").disabled))
            setTimeout("doAction(mainWin.ACTIONPRINT)", 0);//JS Segregation changes,Fix for 21754906 
    }
    if (event.ctrlKey == true && event.altKey == false && event.keyCode == 84) { //Fix for 22653877
		preventpropagate(e);
        if (typeof (mainWin.screenType) != 'undefined' && mainWin.screenType == "WB") {
    ...
    if (event.keyCode == 118) {
        ...
        if (thirdChar == 'S') {
            //fnResetQry(event);
            if (document.getElementById("SavedQry").style.display == 'flex') {	//REDWOOD_CHANGES
        ...
        if (thirdChar == 'S') {
            /* fix for bug 16911237 for query in summary screen start */
            if (!fnValidateOnF8(event))
                return;
            /* fix for bug 16911237 for query in summary screen end */
...
function fnshowHelpFile(){
    //if (mainWin.applicationName == "FCIS") {
        ...
        winObj.style.zIndex = "9000";  //REDWOOD_CHANGES
...
function loadHelpFileDIV(divId, src) {
    ...
    if (mainWin.applicationName == "FCIS" && helpPath == "") {//helpfile changes
        ...
        winObj.style.visibility = "visible";
        winObj.style.display = "block";
		winObj.style.zIndex = "5990";//36251737
    }
}
...
function fnHandleButtons(e) {
	...
	var ccy; //MCY/VA Hot Key  CHANGES
    /*Fix for 16799210*/
    if (e.keyCode == 116) {
        fnDisableBrowserKey(e);
        preventpropagate(e);
    ...
    if (e.keyCode == 13) {
        if (srcElem.tagName) {
//REDWOOD_35358181 starts
	if (srcElem.tagName == "OJ-BUTTON"){
 		      var event = e;
        	var ojObject = (srcElem.parentElement);
        	var fnEval = new Function("event", getClickFunction(ojObject.getElementsByTagName("OJ-BUTTON")[0])); 
        	fnEval(event);
	}
//REDWOOD_35358181 ends
    ...
    if (!e.ctrlKey && !e.shiftKey && e.keyCode == 115) {
        ...
        //redwood_35349364 Starts
		else{ 
		      var ojObject1 = getNextSibling(srcElem.parentElement.parentNode);
			if (ojObject1 && ojObject1.getElementsByTagName("OJ-BUTTON").length > 0 && ojObject1.getElementsByTagName("OJ-BUTTON").type!="hidden") { 
          if (srcElem.getAttribute("aria-readonly")) {
                if (getIEVersionNumber() > 0)
                    fireHTMLEvent(getNextSibling(srcElem), "onclick");
                else {
                    var fnEval = new Function("event", getClickFunction(ojObject1.getElementsByTagName("OJ-BUTTON")[0])); 
                    fnEval(event);
                }
            }
        }
    ...
    //redwood_35349364  Ends
        ...
        var event = e;
        if (getNextSibling(getNextSibling(srcElem)) && getNextSibling(getNextSibling(srcElem)).tagName == "BUTTON"&&getNextSibling(getNextSibling(srcElem)).className!="hidden") {		 //27295304  added and condition
            if (getIEVersionNumber() > 0) {
	...
	//fix for bug: 19060316 starts 
     ...
     if (e.ctrlKey && !e.shiftKey && !e.altKey && e.keyCode == 74) {
        parentWinParams = new Object();
		//35661072_ODT_REDWOOD_CHANGE
		srcElem1 = getEventSourceElement(e).parentNode.parentElement.parentNode;
        //if(srcElem.getAttribute("HOTKEYREQJA")=='Y') {
			if(srcElem1.getAttribute("HOTKEYREQJA")=='Y') {
		//35661072_ODT_REDWOOD_CHANGE
           // parentWinParams.accNo = srcElem.value;           
            //parentWinParams.brn = getAccBranch(e);
            //mainWin.dispHref1("STDJHMNT",seqNo);
            fncallJointHolderDetails(srcElem.value,getAccBranch(e));
            fnDisableBrowserKey(e);
            try {
                e.keyCode = 0;
            } catch (e) {}
    ...
    else if (e.ctrlKey == true && e.altKey == false && e.keyCode == 87) { //Fix for 22653877
    ...
    else if (e.ctrlKey == true && e.altKey == false && e.keyCode == 33) { //Fix for 22653877
        // If 'Page Up' is pressed with Ctrl Key...for PREVIOUS TAB
        fnNavigateTabs('backward', tab_arr, tab_ids);
        fnDisableBrowserKey(e);
        return false;
    }
    else if (e.ctrlKey == true && e.altKey == false && e.keyCode == 34) { //Fix for 22653877
	...
	//30620131 -- start
	else if (e.altKey == true && e.ctrlKey == false && e.keyCode == 33)
	{
        fnNavigateSubScreens('backward', subScr_arr);
        fnDisableBrowserKey(e);
        return false;
    }
	else if (e.altKey == true && e.ctrlKey == false && e.keyCode == 34)
	{
        fnNavigateSubScreens('forward', subScr_arr);
        fnDisableBrowserKey(e);
        return false;
    }
	//30620131 -- end
    ...
    if (e.keyCode == 123 || e.keyCode == 121) {
 		/*Fix for 20143643,20385269 Starts */
		if (screenType != 'WB') {
        hotKeyPressed = false;
        ...
        /*Fix for 20143643,20385269 Ends */
		var imgType ="";
        if(e.keyCode == 123) {
            imgType="S";
        }else {
		...
		if (srcElem.name == undefined) srcElem =getNextSibling(srcElem.parentNode);//35082486		
        ...
        if (fieldName != undefined) {
            ...
            if ((fieldName.indexOf('AC') != '-1') && srcElem.value != "") {
                ...
                var prevSib = "";
                try {
					//Fix for 24585704 Starts
                    if (getEventSourceElement(e).parentNode.parentNode.tagName && getEventSourceElement(e).parentNode.parentNode.tagName == 'TD') {
                        prevSib = getEventSourceElement(e).parentNode.parentNode.parentNode.getElementsByTagName("INPUT"); //Fix for 24585704 Ends
                    }else {
                        prevSib = getPreviousSibling(getEventSourceElement(e).parentNode).childNodes;
                    }
                    /*Fix for 17434292  Starts*/
                ...
                if (screenType == 'WB') {
                    if (mainWin.functionDef[functionId].txnAcc != "null") {
						...
						//FCUBS_141_MGN_EMPEROR_26878904 starts
                       // if (srcElem.id == mainWin.functionDef[functionId].txnAcc || (srcElem.id == "BLK_TRANSACTION_DETAILS__VIRACCNO" && functionId != '1006')|| srcElem.id == "BLK_TRANSACTION_DETAILS__UI_TXN_ACC") { //9NT1606_12_4_INTERNAL_26820002 //9NT1606_12_4_RETRO_12_2_26939842
						if (srcElem.id == mainWin.functionDef[functionId].txnAcc || (srcElem.id == "BLK_TRANSACTION_DETAILS__VIRACCNO" && functionId != '1006')|| srcElem.id == "BLK_TRANSACTION_DETAILS__UI_TXN_ACC" ||srcElem.id == "BLK_TRANSACTION_DETAILS__UI_AC_NO") {
						//FCUBS_141_MGN_EMPEROR_26878904 ends
                            //12.0.3_18374725 			
				...
				if (srcElem.tagName == "INPUT" && srcElem.type.toUpperCase() == 'TEXT') {
                    if(typeof(parent.seqNo)!= "undefined" && parent.seqNo!= null&& getSeqNo() == parent.seqNo){//21545026 //if Hot key pressed from callforms
                    parent.parentWinParams.accNo = accNo;
                    parent.parentWinParams.brn = brn;
                    parent.parentWinParams.imgType = imgType;
					parent.parentWinParams.ccy= ccy;  //MCY/VA Hot Key  CHNAGES
                    }
                    else{
                    parentWinParams.accNo = accNo;
                    parentWinParams.brn = brn;
                    parentWinParams.imgType = imgType;             
					parentWinParams.ccy= ccy;  //MCY/VA Hot Key  CHNAGES					
                    }
                    
					//  F12 chnages
                    var addlArgs = new Array(); 
                    if (!fnEventsHandlerKey('fnAmountF12',addlArgs,e)){ //21311632
                        fnDisableBrowserKey(e);
			try {
                            e.keyCode = 0;
			} catch (e) {}
			return false;
					...
					//Bug_36924146 Changes Ends	
                     mainWin.dispHref1("SVDIMGVW", getSeqNo());
					//Bug_36924146 Changes Starts
					}else{
						 if(imgType == 'I'){  
 ...
 /*Fix for 20143643,20385269 Starts */
        ...
        if (fieldName != undefined) {
            ...
            if ((fieldName.indexOf('AC') != '-1') && srcElem.value != "") {
                ...
                try {
                    try {
						/*Fix for 22907799 Starts*/
                        if (getEventSourceElement(e).parentNode.parentNode.tagName && getEventSourceElement(e).parentNode.parentNode.tagName == 'TD') {
                            prevSib = getEventSourceElement(e).parentNode.parentNode.parentNode.getElementsByTagName("INPUT");
                        }/*Fix for 22907799 Ends*/
                        else {
                            prevSib = getPreviousSibling(getEventSourceElement(e).parentNode).childNodes;
                        }
                        /*Fix for 17434292  Starts*/
                ...
                g_txnBranch = brn;
                 if (srcElem.tagName == "INPUT" && srcElem.type.toUpperCase() == 'TEXT') { //F11 extensible
                    ...
                    var addlArgs = new Array();
					if (!fnEventsHandlerKey('fnPreCustomViewF11',addlArgs,e)){ //21311632
						fnDisableBrowserKey(e);
						try {
							e.keyCode = 0;
						} catch (e) {}
					...
					if(isRofcFunctionId()){
					//Bug_36924146 Changes Ends	
                     mainWin.dispHref1("STDCUBAL",getSeqNo());
					//Bug_36924146 Changes Starts 
					}else{
        ...
        hotKeyPressed = true;
		if (srcElem.name == undefined) {
		srcElem =getNextSibling(srcElem.parentNode);//Redwood_35313671
		}
		...
		//MCY/VA Hot Key  starts
				if (!fnEventsHandler('fnSetHotKeyBranch',e))
					return false;
				if(hotKeyBrn != ""){
					brnFldValue = hotKeyBrn;
				}
				//MCY/VA Hot Key  changes
				if(hotKeyCcy != ""){
					ccy = hotKeyCcy;
		...
		//MCY/VA Hot Key  ends		
		/*
		if(typeof(brnFldValue)=="undefined" && hotKeyBrn == ""){
		...
		*/
        ...
        //fndispInstr(fieldValue, fieldName, fieldId, brnFldValue,ccy); //Bug_36924146
        fndispInstrCore(fieldValue, fieldName, fieldId, brnFldValue,ccy); //Bug_36924146
		fnDisableBrowserKey(e);
        e.keyCode = 0;
    }
    //Fix for 21362214 Starts
    if (e.ctrlKey == true && e.altKey == false && e.shiftKey == true && e.keyCode == 68) { // Cntrl + Shift + D //Fix for 22653877
		preventpropagate(e);
...
function handleTableTabKey(e){
    ...
    if(!nextCell){
        ...
        //REDWOOD_35358181
    } else if (currentCell.getElementsByTagName('span')[1]!= undefined && currentCell.getElementsByTagName('span')[0].children[0].tagName.startsWith('OJ') && buttonCheck!=true){
	        nextCellElement =currentCell.getElementsByTagName('span')[1].children[0];
	        buttonCheck =true;
	}
  //REDWOOD_35358181
        ...
        nextCellElement = findImmediateOJElement(nextCell);
		 buttonCheck =false; //REDWOOD_35358181
    }
...
function splitDate(dt, dateFormatComp, separator) {
    if (!separator || separator == '' || separator.toUpperCase() == "NULL") {
		...
		try{//Redwood_35332879
        return dt.split(separator);
			}
			catch(e)//Redwood_35332879 starts
			{
			var dsep = getSeparator(dt);
			if (dsep!= separator)
				{ return dt.split(dsep);
				}
			}//Redwood_35332879 Ends
    }
}

function get_dd_mm_yy(dt, dateInputFormat, separator, dmy) {
	dateInputFormat='YYYY-MM-DD'; //REDWOOD_CHANGES
	separator='-'; //REDWOOD_CHANGES
    var dd, mm, yy;
...
function getRowIndex(e) {
    ...
    if (event != null) {
        ...
        try {
            ...
            //rowIndex = rowIndex + 1; //REDWOOD_CHANGES
...
function debugs(msg, value, funcName) {
   ...
   //REDWOOD_CHANGES     
        if (mainWin.gActiveWindow) {
            var xmlFile = mainWin.gActiveWindow.xmlFileName;
            var funcId = xmlFile.substring(xmlFile.lastIndexOf("/") + 1, xmlFile.lastIndexOf(".xml"));
            col2FuncId=funcId;	//REDWOOD_CHANGES
        }
        else {
        ...
        if (funcName == undefined) {
            ...
            if (fname.substr(0, 6) == " debug") {
             col4FuncName=msg;	//REDWOOD_CHANGES
            }
            else {
            col4FuncName=fname;	//REDWOOD_CHANGES
            }
        }
        else {
        col4FuncName=funcName; //REDWOOD_CHANGES
        }
        
        if (fname.substr(0, 6) == " debug") {
            col5Statement=value; //REDWOOD_CHANGES
        }
        else {
        col5Statement=msg; //REDWOOD_CHANGES
        }
        if (fname.substr(0, 6) == " debug") {
        col6Value='';	//REDWOOD_CHANGES
        }
        else {
            if (value != undefined) {
                if (value.length != undefined) {
                    if (value.length < 50 || value == true) {
                        col6Value=value; //REDWOOD_CHANGES
                    }
                    else {
                    col6Value=  mainWin.getItemDesc("LBL_SHOWDATA") ;  //REDWOOD_CHANGES
                    }
                }
                else {
                     col6Value=''; //REDWOOD_CHANGES
...
//REDWOOD_CHANGES
    ...
    var htmlvalue = currentObj.row.fulData;	//REDWOOD_CHANGES
...
function validateInputNumber(dispNumField) {
    ...
    if (gDecimalSymbol != ".") {
        var arrNumComponents = String(dispNumField.value).match(new RegExp(gDecimalSymbol,"g")); //REDWOOD_CHANGES
    }
    else {
       var arrNumComponents = String(dispNumField.value).match(/\./g);//REDWOOD_CHANGES
    }
    if (arrNumComponents != null && (arrNumComponents.length > 1)) {
        focusReqd = false;
        focusField = dispNumField;
        displayMsg("ST-COM041");
        dispNumField.value = null; //REDWOOD_CHANGES
        getPreviousSibling(getPreviousSibling(dispNumField)).value = "";
        gIsValid = false;
        return false;
    }
    var enteredVal = String(dispNumField.value); //REDWOOD_CHANGES
...
function displayFormattedNumber_old(hdnNumField) { //REDWOOD_CHANGES
    isFromDisplay = false;
    if (hdnNumField.value == "") {
        getNextSibling(getNextSibling(hdnNumField)).value =  null;  // ""; OJET Migration //ojet-number field will not accept string value so changing the default value to null //REDWOOD_CHANGES
        return;
    }
    ...
    if (!checkNumberValidation(hdnNumField.value) || hdnNumField.value.indexOf(" ") !=  - 1) {
        alert(mainWin.getItemDesc("LBL_VALUE_INCORRECT"));
        hdnNumField.value = "";
        getNextSibling(getNextSibling(hdnNumField)).value = null ;//""; //REDWOOD_CHANGES
    ...
    if (hdnNumField.value != "") {
        ...
        //9NT1606_12_2_RETRO_12_0_3_23652325 starts
		 dispNumField.value = parseInt(updatedValue);//REDWOOD_CHANGES
...
//REDWOOD_CHANGES
    ...
    if(txtVal!=null)
		//35242531_ODT_REDWOOD_CHANGES
		{
		if (txtObj.rawValue != txtObj.value){
		txtObj.value = null;
		}
		//35242531_ODT_REDWOOD_CHANGES
...
//Changes for formatting number start
function formatNumber_old(dispNumField) { //REDWOOD_CHANGES
...
function getTableObjElement(ele, obj) {
    var tblElement = ele;
    while (tblElement.tagName.toUpperCase() != obj) {
            tblElement = tblElement.parentNode;
        }    
    return tblElement;
}	 
