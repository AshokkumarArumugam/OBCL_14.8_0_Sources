...
<html lang="<%=StringEscapeUtils.escapeHTML(langISOMap)%>">
    <head>
		...
		<!--<link href="Theme/Ext<%= StringEscapeUtils.escapeURL(strTheme).substring(0, StringEscapeUtils.escapeURL(strTheme).indexOf(".css"))+"_Cust.css" %>" rel="stylesheet" type="text/css"/>-->        <link href="Theme/Ext<%=StringEscapeUtils.escapeURL(langISOMap)%>.css" rel="stylesheet" type="text/css"/>
        ...
        <!--
        <script type="text/javascript" src="Script/JS/Alert_Cust.js"></script><noscript><%=StringEscapeUtils.escapeJavaScript(noScriptLabel)%></noscript>
        <script type="text/javascript" src="Script/ExtJS/ExtFuncs_Cust.js"></script><noscript><%=StringEscapeUtils.escapeJavaScript(noScriptLabel)%></noscript>
        <script type="text/javascript" src="Script/ExtJS/ExtUIUtil_Cust.js"></script><noscript><%=StringEscapeUtils.escapeJavaScript(noScriptLabel)%></noscript>
        <script type="text/javascript" src="Script/ExtJS/ExtUtil_Cust.js"></script> <noscript><%=StringEscapeUtils.escapeJavaScript(noScriptLabel)%></noscript>
        <script type="text/javascript" src="Script/ExtJS/ExtBuildXML_Cust.js"></script><noscript><%=StringEscapeUtils.escapeJavaScript(noScriptLabel)%></noscript>
        -->
        <script type="text/javascript">
            var meBlockResponse     = "";
            ...
            var superParentKernelJSFile="";
            var parentKernelJSFile="";
            var kernelJSFile="";
            
            var superParentClusterJSFile="";
            var parentClusterJSFile="";
            var clusterJSFile="";

            var superParentCustomJSFile="";
          ...
          /*   var screenTitleArray   = (mainWin.document.title).split(" - ");
            ...
            mainWin.document.title = BranchEoiLabelDesc;*/
             if(srcType== "null"){
              parent.document.getElementById("testwin_cust").id     = seqNo;
//              parent.document.getElementById(seqNo).style.height = "100vh";
//              parent.document.getElementById(seqNo).getElementsByTagName("iframe")[0].style.height = "100vh";
//              parent.document.getElementById(seqNo).style.width = "100vw";
//              parent.document.getElementById(seqNo).getElementsByTagName("iframe")[0].style.width = "100vw";
//              parent.document.getElementById(seqNo).style.overflow = "auto";
        ...
        %>--%>
        <!--<script type="text/javascript" src="Script/ExtJS/ExtDatabinding_Cust.js"></script> <noscript><%=StringEscapeUtils.escapeJavaScript(noScriptLabel)%></noscript>
        <script type="text/javascript" src="Script/ExtJS/ExtensibleMEUtil_Cust.js"></script> <noscript><%=StringEscapeUtils.escapeJavaScript(noScriptLabel)%></noscript>
        <script type="text/javascript" src="Script/ExtJS/ExtensibleUtil_Cust.js"></script> <noscript><%=StringEscapeUtils.escapeJavaScript(noScriptLabel)%></noscript>
        ...
        <script type="text/javascript" src="Script/ExtJS/Extensible_Cust.js"></script> <noscript><%=StringEscapeUtils.escapeJavaScript(noScriptLabel)%></noscript>-->
        ...
        %>
            ...
            %>
                ...
                %>
                    ...
                    <script language="JavaScript">superParentKernelJSFile = "JS/<%= StringEscapeUtils.escapeURL(superParentFunction) %>_KERNEL";
                </script>
                <%
                }
                %>
            ...
            %>
                ...
                %>
                    ...
                    <script language="JavaScript">parentKernelJSFile = "JS/<%= StringEscapeUtils.escapeURL(parentFunction) %>_KERNEL";
                </script>
                <%
                }
                %>
			...
			if ("KERNEL".equalsIgnoreCase(functionOrigin) && "N".equals(scrChild)) {
            %>
        ...
        %>
                ...
                %>
                    ...
                    %>
                        <!--<script language="JavaScript" src="Script/JS/<%= StringEscapeUtils.escapeURL(superParentFunction) %>_CLUSTER.js"></script>-->
                              <script language="JavaScript">superParentClusterJSFile = "JS/<%= StringEscapeUtils.escapeURL(superParentFunction) %>_CLUSTER";
                </script>
            ...
            %>
                ...
                %>
                    ...
                    %>
                        ...
                        <script language="JavaScript">parentClusterJSFile = "JS/<%= StringEscapeUtils.escapeURL(parentFunction) %>_CLUSTER";
                </script>
                    <%
                    } 
                    %>
            ...
            if ("KERNEL".equalsIgnoreCase(functionOrigin) && "N".equals(scrChild)) {
            %>
			<!--27858337 - Child Screen loading error ends-->
                <!--<script language="JavaScript" src="Script/JS/<%= StringEscapeUtils.escapeURL(FinalJSFile) %>_KERNEL.js"></script>-->
                 <script language="JavaScript">kernelJSFile = "JS/<%= StringEscapeUtils.escapeURL(FinalJSFile) %>_KERNEL";
                </script>
                <%
                ...
                %>
            <%
            } else if ("CLUSTER".equalsIgnoreCase(functionOrigin) && "N".equals(scrChild)) {
            %>
			<!--27858337 - Child Screen loading error ends-->
                <!--<script language="JavaScript" src="Script/JS/<%= StringEscapeUtils.escapeURL(FinalJSFile) %>_CLUSTER.js"></script>-->
                 <script language="JavaScript">clusterJSFile = "JS/<%= StringEscapeUtils.escapeURL(FinalJSFile) %>_CLUSTER";</script>
        ...
        %>
            ...
            %>
                ...
                %>
                    <!--<script language="JavaScript" src="Script/JS/<%= StringEscapeUtils.escapeURL(superParentFunction) %>_KERNEL.js"></script>-->
                     <script language="JavaScript">superParentKernelJSFile = "JS/<%= StringEscapeUtils.escapeURL(superParentFunction) %>_KERNEL";</script>
                    <%
                    if ("Y".equalsIgnoreCase(clusterModified)) {
                    %>
                        <!--<script language="JavaScript" src="Script/JS/<%= StringEscapeUtils.escapeURL(superParentFunction) %>_CLUSTER.js"></script>-->
                        <script language="JavaScript">superParentClusterJSFile = "JS/<%= StringEscapeUtils.escapeURL(superParentFunction) %>_CLUSTER";</script>
                    <%
                    }
                    ...
                    %>
                        <!--<script language="JavaScript" src="Script/JS/<%= StringEscapeUtils.escapeURL(superParentFunction) %>_CUSTOM.js"></script>-->
                         <script language="JavaScript">superParentCustomJSFile = "JS/<%= StringEscapeUtils.escapeURL(superParentFunction) %>_CUSTOM";</script>
                    <%
                    }
                    %>
                <%
            ...
            %>
                ...
                %>
                    <!--<script language="JavaScript" src="Script/JS/<%= StringEscapeUtils.escapeURL(parentFunction) %>_KERNEL.js"></script>-->
                     <script language="JavaScript">parentKernelJSFile = "JS/<%= StringEscapeUtils.escapeURL(parentFunction) %>_KERNEL";</script>
                    <%
                    if ("Y".equalsIgnoreCase(clusterModified)) {
                    %>
                        <!--<script language="JavaScript" src="Script/JS/<%= StringEscapeUtils.escapeURL(parentFunction) %>_CLUSTER.js"></script>-->
                        <script language="JavaScript">parentClusterJSFile = "JS/<%= StringEscapeUtils.escapeURL(parentFunction) %>_CLUSTER";</script>
                    <%
                    }
                    if ("Y".equalsIgnoreCase(customModified)) {
                    %>
                        <!--<script language="JavaScript" src="Script/JS/<%= StringEscapeUtils.escapeURL(parentFunction) %>_CUSTOM.js"></script>-->
                         <script language="JavaScript">parentCustomJSFile = "JS/<%= StringEscapeUtils.escapeURL(parentFunction) %>_CUSTOM";</script>
                    <%
                    }
                    %>
                <%
        ...
        %>
                ...
                %>
                    <!--<script language="JavaScript" src="Script/ExtJS/ExtUtil_CLUSTER.js"></script>-->
                     <script language="JavaScript">extUtilCluster = "ExtJS/ExtUtil_CLUSTER";
                </script>
                <%
                }
                if ("Y".equalsIgnoreCase(customModified)) {
        ...
        %>
         ...
         <script type="text/javascript" src="Script/OJET/main_custLanding.js"></script>
    </head>  
     <%-- Security bug SEC-12-Patch-081 fixes starts  --%>
    <body onkeydown="return shortcut(event)" onmousedown="fnMouseDownEvents(event)" 
          onhelp="return disableDefault();"
          oncontextmenu="return false;">
        <div id="DIVWNDContainer" style="height: 100%;">           
            <div id="DIVScrContainer">
                <div id="toolbar" class="oj-flex-bar oj-sm-margin-2x-top oj-sm-margin-2x-bottom"  style="display:none;">
