...
** Modified By         : Manju Sah
** Modified On         : 13-JUN-2023
  ...
  <head>
   ...
   <!--<link href="Theme/Ext<%=StringEscapeUtils.escapeURL(logintheme)%>" rel="stylesheet" type="text/css"/>--><!--HTML5 Changes-->
    ...
    <script type="text/javascript">
		...
		function fnFileEnvelop(){
			  parent.document.getElementById('BLK_BRN_FILE_UPLD_ENVELOPE__FILE_NAME').value = fileName;
			  fnExitUpload();
			}
...
function fnPostLoadImageScr(){   
            try{
                var fileInputField = document.getElementsByName("FILEENVELOPSELECT")[0];
...
//                                iFrameBody += '<link type="text/css" rel="stylesheet" href="https://static.oracle.com/cdn/fnd/gallery/2110.1.0/images/iconfont/ojuxIconFont.min.css"/>';
                ...
                iFrameBody += "<FORM id='fileEnvelopForm' method='post' action='fileenvelopservlet?actionType=UPLOAD' enctype='multipart/form-data' onsubmit='createXML();'>";
                ...
                iFrameBody += "<INPUT TYPE='File' class='oj-sm-padding-1x' LABEL_VALUE='Select' ID='' DBT='' DBC='' NAME='FILEENVELOPSELECT' DTYPE='' SIZE='' REQUIRED='0'/>";
        ...
        function fnCalcHgt(){
		  ...
		  function createXML(){
            ...
            var fileName = iFrameFormDocument.getElementsByName("FILEENVELOPSELECT")[0].value;
			var filePath = parent.document.getElementById("BLK_BRN_FILE_UPLD_ENVELOPE__FILE_PATH").value;
            if(fileName == ""){
                return false;
            }
            ...
            strFormData += "<SOURCEFILE>" +  iFrameFormDocument.getElementsByName("FILEENVELOPSELECT")[0].value + "</SOURCEFILE>";
            strFormData += "<SEQNO>1</SEQNO>";
            strFormData += "<FILENAME>"+fileName+"</FILENAME>";
			strFormData += "<UPLOADPATH>" + filePath + "</UPLOADPATH>";
           ...
           // strFormData +="<CURRENTBRANCH><%=StringEscapeUtils.escapeJavaScript(currBranch)%></CURRENTBRANCH>";
			...
			iFrameFormDocument.getElementById('fileEnvelopForm').target = 'ResponseFrame';
            iFrameFormDocument.getElementById("fileEnvelopForm").submit();
        }
        ...
        <DIV  slot="body" id="WNDcontent">
                    <div id="ResTree" style="width:100%" >
                        <div class="oj-flex-bar">
                                <div class="oj-flex-bar-start ">
                                <div>
					<INPUT TYPE="File" class="oj-sm-padding-1x" LABEL_VALUE="Select" ID="" DBT="" DBC="" NAME="FILEENVELOPSELECT" ID="FILEENVELOPSELECT" DTYPE="" SIZE="" REQUIRED="0">
                                 </div>      
                ...
                <div id="DIV_AUDIT_BUTTONS" >
                 <div><div class="oj-flex-bar oj-sm-align-items-center oj-sm-padding-5x-horizontal">
                        <div class="footer-btn-container oj-flex-bar-end">
							...
							VALUE="Ok" DEFAULT="Ok" 
                                                        on-oj-action="[[function() {fnFileEnvelop()}.bind(null)]]"
