...
** 	Description   : LOV Title Changes for special charact Hash
...
<%}%><!--HTML5 Changes End -->
     ...
     <%-- Security bug SEC-12-Patch-081 fixes starts  --%>
        ...
        <script type="text/javascript" src="Script/OJET/main_lov.js"></script>
        
        
    </HEAD>
    <BODY oncontextmenu="return false;" onkeydown="return lovAccessKeys(event);" onhelp="return false;" onclick="setParentWinActive(event);">
    ...
    <oj-dialog id="scrollingDialog"  initial-visibility="show"   position.my.horizontal="center" position.my.vertical="center"
                ...
                <div class="oj-flex-bar-start">		  
                    ...
                    <h3><%=StringEscapeUtils.escapeHTML(request.getParameter("title").replaceAll("_HASH_", "#"))%></h3>	<%-- 9NT1606_14_5_33810041 fix to replace title --%>
                    </div>
