...
function fnPostLoad() {
    ...
    gAction = "DEFAULT";
    //appendData(document.getElementById("TBLPage" + strCurrentTabID)); //redwood change
	appendData();//redwood change
	...
	setTimeout( function(){    //redwood change
	...
	//fnSetExitButton(true);  //redwood change
