...
//----------------------------------------------------------------------------------------------------------------------
var fieldNameArray = {"BLK_EOC_MONITOR":"BRNCD~EOCSTATS~MESSAGE~BRNNAME~ERROR_CODE","BLK_EOC_RUNCHART":"BRNCD~BRNDATE~EOCSEQUENCE~EOCSTAGE~EOCSTAGESTATUS~EOCREFNO~SESSION~ERROCDE~ERRPARAM~ERR","BLK_EOC_PROGRAMS":"BRNCD~EOCSEQUENCE~EOCSTAGE~EOCBATCH~BRNDT~EOCBATCHSTATUS~EOCREFNUM~SESSION~ERRCD~ERR~EOCBATCHSEQ"};
...
var msgxml=""; 
msgxml += '    <FLD>'; 
msgxml += '      <FN PARENT="" RELATION_TYPE="1" TYPE="BLK_EOC_MONITOR">BRNCD~EOCSTATS~MESSAGE~BRNNAME~ERROR_CODE</FN>'; 
...
var queryAmendArr = {"BLK_EOC_MONITOR":["BRNCD","EOCSTATS","ERROR_CODE","MESSAGE"],"BLK_EOC_PROGRAMS":["BRNCD","BRNDT","EOCBATCH","EOCBATCHSEQ","EOCBATCHSTATUS","EOCREFNUM","EOCSEQUENCE","EOCSTAGE","ERR","ERRCD","SESSION"],"BLK_EOC_RUNCHART":["BRNCD","BRNDATEI","EOCREFNO","EOCSEQUENCE","EOCSTAGE","EOCSTAGESTATUS","ERR","ERROCDE","ERRPARAM","SESSION"]};
