...
function fnPostNew() {
	debugs("In fnPostNew", "A");
        ...
        document.getElementById("RPTMS_PRINTER__BRANCH").value = lBranch;
}
/*
...
function fnPostEnterQuery() {
 ...
 var lBranch = mainWin.CurrentBranch;
        document.getElementById("RPTMS_PRINTER__BRANCH").value = lBranch;
        document.getElementById("RPTMS_PRINTER__BRANCH").readOnly = true;
