...
//----------------------------------------------------------------------------------------------------------------------
var fieldNameArray = {"BLK_STTMS_FIC_HOL_MASTER":"YEAR~FINANCIAL_CENTER~WEEKLY_HOLIDAYS~UNEXP_HOL~FINANCIAL_CENTER_DESC~MAKER~MAKERSTAMP~CHECKER~CHECKERSTAMP~MODNO~TXNSTAT~AUTHSTAT~ONCEAUTH","BLK_STTMS_FIC_HOLIDAY":"FINANCIAL_CENTER~YEAR~MONTH~HOLIDAY_LIST"};

var multipleEntryPageSize = {"BLK_STTMS_FIC_HOLIDAY" :"15" };

var multipleEntrySVBlocks = "";

var tabMEBlks = {"CVS_MAIN__TAB_MAIN":"BLK_STTMS_FIC_HOLIDAY"};

var msgxml=""; 
msgxml += '    <FLD>'; 
msgxml += '      <FN PARENT="" RELATION_TYPE="1" TYPE="BLK_STTMS_FIC_HOL_MASTER">YEAR~FINANCIAL_CENTER~WEEKLY_HOLIDAYS~UNEXP_HOL~FINANCIAL_CENTER_DESC~MAKER~MAKERSTAMP~CHECKER~CHECKERSTAMP~MODNO~TXNSTAT~AUTHSTAT~ONCEAUTH</FN>'; 
msgxml += '      <FN PARENT="BLK_STTMS_FIC_HOL_MASTER" RELATION_TYPE="N" TYPE="BLK_STTMS_FIC_HOLIDAY">FINANCIAL_CENTER~YEAR~MONTH~HOLIDAY_LIST</FN>'; 
msgxml += '    </FLD>'; 
...
var msgxml_sum=""; 
msgxml_sum += '    <FLD>'; 
msgxml_sum += '      <FN PARENT="" RELATION_TYPE="1" TYPE="BLK_STTMS_FIC_HOL_MASTER">AUTHSTAT~TXNSTAT~YEAR~FINANCIAL_CENTER</FN>'; 
msgxml_sum += '    </FLD>'; 

var detailFuncId = "STDFCHOL";
var defaultWhereClause = "";
var defaultOrderByClause ="";
var multiBrnWhereClause ="";
var g_SummaryType ="S";
var g_SummaryBtnCount =0;
var g_SummaryBlock ="BLK_STTMS_FIC_HOL_MASTER";
//----------------------------------------------------------------------------------------------------------------------
//***** CODE FOR DATABINDING *****
//----------------------------------------------------------------------------------------------------------------------
 var relationArray = {"BLK_STTMS_FIC_HOL_MASTER" : "","BLK_STTMS_FIC_HOLIDAY" : "BLK_STTMS_FIC_HOL_MASTER~N"}; 

 var dataSrcLocationArray = new Array("BLK_STTMS_FIC_HOL_MASTER","BLK_STTMS_FIC_HOLIDAY"); 
...
//***** CODE FOR LOVs *****
//----------------------------------------------------------------------------------------------------------------------
var lovInfoFlds = {"BLK_STTMS_FIC_HOL_MASTER__FINANCIAL_CENTER__LOV_CLG":["BLK_STTMS_FIC_HOL_MASTER__FINANCIAL_CENTER~BLK_STTMS_FIC_HOL_MASTER__FINANCIAL_CENTER_DESC~","","N~N",""]};
...
//----------------------------------------------------------------------------------------------------------------------
var multipleEntryIDs = new Array("BLK_STTMS_FIC_HOLIDAY");
...
ArrFuncOrigin["STDFCHOL"]="KERNEL";
ArrPrntFunc["STDFCHOL"]="";
ArrPrntOrigin["STDFCHOL"]="";
ArrRoutingType["STDFCHOL"]="X";


 // Code for Loading Cluster/Custom js File Starts
ArrClusterModified["STDFCHOL"]="N";
ArrCustomModified["STDFCHOL"]="N";
