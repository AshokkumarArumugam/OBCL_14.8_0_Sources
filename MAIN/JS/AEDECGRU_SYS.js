...
//----------------------------------------------------------------------------------------------------------------------
var fieldNameArray = {"BLK_AEGM":"AEGM_1~AEGM_2~EOPD_GRP~MAKER~MAKERSTAMP~CHECKER~CHECKERSTAMP~MODNO~TXNSTAT~AUTHSTAT~ONCEAUTH","BLK_AEGB":"AEGB_1~AEGB_2~BRANCH_SEQ"};
...
msgxml += '      <FN PARENT="BLK_AEGM" RELATION_TYPE="N" TYPE="BLK_AEGB">AEGB_1~AEGB_2~BRANCH_SEQ</FN>'; 
msgxml += '    </FLD>'; 
