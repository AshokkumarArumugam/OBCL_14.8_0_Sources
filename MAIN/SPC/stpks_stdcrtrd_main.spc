CREATE OR REPLACE PACKAGE  stpks_stdcrtrd_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdcrtrd_main.spc
  **
...
TYPE ty_stdcrtrd IS RECORD (
     v_sttm_core_trade_contract     sttm_core_trade_contract%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END stpks_stdcrtrd_main;
/
CREATE OR REPLACE SYNONYM stpkss_stdcrtrd_main FOR stpks_stdcrtrd_main
/