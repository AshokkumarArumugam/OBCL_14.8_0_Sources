CREATE OR REPLACE PACKAGE  ispks_isdbkdir_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : ispks_isdbkdir_main.spc
  **
...
TYPE ty_isdbkdir IS RECORD (
     v_local_bank_directory     isvw_local_bank_directory%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_isdbkdir          IN OUT  ispks_isdbkdir_Main.Ty_isdbkdir,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_isdbkdir          IN ispks_isdbkdir_Main.Ty_isdbkdir,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_isdbkdir     IN  ispks_isdbkdir_Main.Ty_isdbkdir,
p_Wrk_isdbkdir      IN OUT  ispks_isdbkdir_Main.Ty_isdbkdir,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_isdbkdir     IN  ispks_isdbkdir_Main.Ty_isdbkdir,
p_Prev_isdbkdir IN OUT  ispks_isdbkdir_Main.Ty_isdbkdir,
p_Wrk_isdbkdir      IN OUT  ispks_isdbkdir_Main.Ty_isdbkdir,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_isdbkdir     IN  ispks_isdbkdir_Main.Ty_isdbkdir,
p_Prev_isdbkdir     IN  ispks_isdbkdir_Main.Ty_isdbkdir,
p_Wrk_isdbkdir      IN OUT  ispks_isdbkdir_Main.Ty_isdbkdir,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_isdbkdir IN  ispks_isdbkdir_Main.Ty_isdbkdir,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END ispks_isdbkdir_main;
/
CREATE OR REPLACE SYNONYM ispkss_isdbkdir_main FOR ispks_isdbkdir_main
/