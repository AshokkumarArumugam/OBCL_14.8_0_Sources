CREATE OR REPLACE PACKAGE  stpks_stdfcdmt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdfcdmt_main.spc
  **
...
TYPE ty_stdfcdmt IS RECORD (
     v_sttm_fin_defn     sttm_fin_defn%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END stpks_stdfcdmt_main;
/
CREATE OR REPLACE SYNONYM stpkss_stdfcdmt_main FOR stpks_stdfcdmt_main
/