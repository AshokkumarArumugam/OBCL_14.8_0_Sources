CREATE OR REPLACE PACKAGE  stpks_stdcrcad_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdcrcad_main.spc
  **
...
TYPE ty_stdcrcad IS RECORD (
     v_sttm_core_customer_addr     sttm_core_customer_addr%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END stpks_stdcrcad_main;
/
CREATE OR REPLACE SYNONYM stpkss_stdcrcad_main FOR stpks_stdcrcad_main
/