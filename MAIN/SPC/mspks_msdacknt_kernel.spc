CREATE OR REPLACE PACKAGE  mspks_msdacknt_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : mspks_msdacknt_kernel.spc
  **
  ** Module     : Messaging
  ** 
...
END mspks_msdacknt_kernel;
/
CREATE OR REPLACE SYNONYM mspkss_msdacknt_kernel FOR mspks_msdacknt_Kernel
/