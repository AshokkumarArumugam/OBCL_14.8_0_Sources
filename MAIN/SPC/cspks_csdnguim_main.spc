CREATE OR REPLACE PACKAGE  cspks_csdnguim_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : cspks_csdnguim_main.spc
  **
  ** Module     : Core
  ** 
...
TYPE ty_csdnguim IS RECORD (
     v_cstb_ngui_registry     cstb_ngui_registry%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END cspks_csdnguim_main;
/
CREATE OR REPLACE SYNONYM cspkss_csdnguim_main FOR cspks_csdnguim_main
/