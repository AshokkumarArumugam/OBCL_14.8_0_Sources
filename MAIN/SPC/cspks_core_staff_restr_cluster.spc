create or replace package cspks_core_staff_restr_cluster As
  /*-----------------------------------------------------------------------------------
  **
  ** File Name    :  cspks_core_staff_restr_cluster
  **
  ** Module       :  Core
  **
...
*/ 
 ...
 FUNCTION fn_post_staff_restr(
                          ...
                          p_err_param   IN OUT VARCHAR2,
                          p_err_code    IN OUT VARCHAR2) return boolean;				 
END cspks_core_staff_restr_cluster;
/
CREATE OR REPLACE SYNONYM cspkss_core_staff_restr_cluster for cspks_core_staff_restr_cluster
/
