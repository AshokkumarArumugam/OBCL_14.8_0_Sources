CREATE OR REPLACE PACKAGE  mspks_msdfdlnt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : mspks_msdfdlnt_main.spc
  **
  ** Module     : Messaging
  ** 
...
TYPE ty_msdfdlnt IS RECORD (
     v_dly_msg_failed_dlvry_ntf     msvw_dly_msg_failed_dlvry_ntf%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_msdfdlnt          IN OUT  mspks_msdfdlnt_Main.Ty_msdfdlnt,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_msdfdlnt          IN mspks_msdfdlnt_Main.Ty_msdfdlnt,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_msdfdlnt     IN  mspks_msdfdlnt_Main.Ty_msdfdlnt,
p_Wrk_msdfdlnt      IN OUT  mspks_msdfdlnt_Main.Ty_msdfdlnt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_msdfdlnt     IN  mspks_msdfdlnt_Main.Ty_msdfdlnt,
p_Prev_msdfdlnt IN OUT  mspks_msdfdlnt_Main.Ty_msdfdlnt,
p_Wrk_msdfdlnt      IN OUT  mspks_msdfdlnt_Main.Ty_msdfdlnt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_msdfdlnt     IN  mspks_msdfdlnt_Main.Ty_msdfdlnt,
p_Prev_msdfdlnt     IN  mspks_msdfdlnt_Main.Ty_msdfdlnt,
p_Wrk_msdfdlnt      IN OUT  mspks_msdfdlnt_Main.Ty_msdfdlnt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_msdfdlnt IN  mspks_msdfdlnt_Main.Ty_msdfdlnt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END mspks_msdfdlnt_main;
/
CREATE OR REPLACE SYNONYM mspkss_msdfdlnt_main FOR mspks_msdfdlnt_main
/