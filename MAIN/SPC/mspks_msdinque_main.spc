CREATE OR REPLACE PACKAGE  mspks_msdinque_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : mspks_msdinque_main.spc
  **
  ** Module     : Messaging
  ** 
...
TYPE ty_msdinque IS RECORD (
     v_ems_connectivity_line     mstm_ems_connectivity_line%ROWTYPE,
     v_mstm_ems_con_line_queue     mstm_ems_con_line_queue%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END mspks_msdinque_main;
/
CREATE OR REPLACE SYNONYM mspkss_msdinque_main FOR mspks_msdinque_main
/