CREATE OR REPLACE PACKAGE  mspks_msdsprof_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : mspks_msdsprof_main.spc
  **
  ** Module     : MS
  ** 
...
TYPE ty_msdsprof IS RECORD (
     v_mstm_service_profile     mstm_service_profile%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END mspks_msdsprof_main;
/
CREATE OR REPLACE SYNONYM mspkss_msdsprof_main FOR mspks_msdsprof_main
/