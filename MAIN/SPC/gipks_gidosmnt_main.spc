CREATE OR REPLACE PACKAGE  gipks_gidosmnt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : gipks_gidosmnt_main.spc
  **
...
TYPE ty_gidosmnt IS RECORD (
     v_gitm_obj_storage_param     gitm_obj_storage_param%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END gipks_gidosmnt_main;
/
CREATE OR REPLACE SYNONYM gipkss_gidosmnt_main FOR gipks_gidosmnt_main
/