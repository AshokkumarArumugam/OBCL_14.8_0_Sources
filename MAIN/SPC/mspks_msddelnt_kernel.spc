CREATE OR REPLACE PACKAGE  mspks_msddelnt_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : mspks_msddelnt_kernel.spc
  **
  ** Module     : Messaging
  ** 
...
END mspks_msddelnt_kernel;
/
CREATE OR REPLACE SYNONYM mspkss_msddelnt_kernel FOR mspks_msddelnt_Kernel
/