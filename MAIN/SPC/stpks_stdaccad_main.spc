CREATE OR REPLACE PACKAGE  stpks_stdaccad_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdaccad_main.spc
  **
...
TYPE ty_stdaccad IS RECORD (
     v_sttm_core_account_addr     sttm_core_account_addr%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END stpks_stdaccad_main;
/
CREATE OR REPLACE SYNONYM stpkss_stdaccad_main FOR stpks_stdaccad_main
/