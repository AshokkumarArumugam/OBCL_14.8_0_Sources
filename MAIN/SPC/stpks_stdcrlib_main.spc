...
TYPE ty_tb_v_core_el_liab_allw_cust IS TABLE OF sttm_core_el_liab_allw_cust%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_sttm_core_customer IS TABLE OF sttm_core_customer%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_stdcrlib IS RECORD (
     v_sttm_core_el_liab     sttm_core_el_liab%ROWTYPE,
     v_core_el_liab_allw_cust    ty_tb_v_core_el_liab_allw_cust,
     v_sttm_core_customer    ty_tb_v_sttm_core_customer,
