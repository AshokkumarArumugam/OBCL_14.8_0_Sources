CREATE OR REPLACE PACKAGE  mspks_msdndlnt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : mspks_msdndlnt_main.spc
  **
  ** Module     : Messaging
  ** 
...
TYPE ty_msdndlnt IS RECORD (
     v_dly_msg_non_dlvry_notif     msvw_dly_msg_non_dlvry_notif%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_msdndlnt          IN OUT  mspks_msdndlnt_Main.Ty_msdndlnt,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_msdndlnt          IN mspks_msdndlnt_Main.Ty_msdndlnt,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_msdndlnt     IN  mspks_msdndlnt_Main.Ty_msdndlnt,
p_Wrk_msdndlnt      IN OUT  mspks_msdndlnt_Main.Ty_msdndlnt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_msdndlnt     IN  mspks_msdndlnt_Main.Ty_msdndlnt,
p_Prev_msdndlnt IN OUT  mspks_msdndlnt_Main.Ty_msdndlnt,
p_Wrk_msdndlnt      IN OUT  mspks_msdndlnt_Main.Ty_msdndlnt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_msdndlnt     IN  mspks_msdndlnt_Main.Ty_msdndlnt,
p_Prev_msdndlnt     IN  mspks_msdndlnt_Main.Ty_msdndlnt,
p_Wrk_msdndlnt      IN OUT  mspks_msdndlnt_Main.Ty_msdndlnt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_msdndlnt IN  mspks_msdndlnt_Main.Ty_msdndlnt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END mspks_msdndlnt_main;
/
CREATE OR REPLACE SYNONYM mspkss_msdndlnt_main FOR mspks_msdndlnt_main
/