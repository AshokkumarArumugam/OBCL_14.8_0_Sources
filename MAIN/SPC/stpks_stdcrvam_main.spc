CREATE OR REPLACE PACKAGE  stpks_stdcrvam_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdcrvam_main.spc
  **
...
TYPE ty_stdcrvam IS RECORD (
     v_core_virtual_account     sttm_core_virtual_account%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END stpks_stdcrvam_main;
/
CREATE OR REPLACE SYNONYM stpkss_stdcrvam_main FOR stpks_stdcrvam_main
/