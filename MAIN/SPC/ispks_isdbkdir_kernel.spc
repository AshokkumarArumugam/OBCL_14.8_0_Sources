CREATE OR REPLACE PACKAGE  ispks_isdbkdir_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : ispks_isdbkdir_kernel.spc
  **
...
END ispks_isdbkdir_kernel;
/
CREATE OR REPLACE SYNONYM ispkss_isdbkdir_kernel FOR ispks_isdbkdir_Kernel
/