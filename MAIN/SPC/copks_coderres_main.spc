CREATE OR REPLACE PACKAGE  copks_coderres_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : copks_coderres_main.spc
  **
...
TYPE ty_coderres IS RECORD (
     v_ertm_error_resolution     ertm_error_resolution%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END copks_coderres_main;
/
CREATE OR REPLACE SYNONYM copkss_coderres_main FOR copks_coderres_main
/