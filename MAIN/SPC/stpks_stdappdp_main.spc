CREATE OR REPLACE PACKAGE  stpks_stdappdp_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdappdp_main.spc
  **
...
TYPE ty_stdappdp IS RECORD (
     v_smtb_user_function_trace     smtb_user_function_trace%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END stpks_stdappdp_main;
/
CREATE OR REPLACE SYNONYM stpkss_stdappdp_main FOR stpks_stdappdp_main
/