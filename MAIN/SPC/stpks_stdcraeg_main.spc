CREATE OR REPLACE PACKAGE  stpks_stdcraeg_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdcraeg_main.spc
  **
...
TYPE ty_stdcraeg IS RECORD (
     v_sttm_core_acc_ent_group     sttm_core_acc_ent_group%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END stpks_stdcraeg_main;
/
CREATE OR REPLACE SYNONYM stpkss_stdcraeg_main FOR stpks_stdcraeg_main
/