CREATE OR REPLACE PACKAGE  mspks_msdfdlnt_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : mspks_msdfdlnt_kernel.spc
  **
  ** Module     : Messaging
  ** 
...
END mspks_msdfdlnt_kernel;
/
CREATE OR REPLACE SYNONYM mspkss_msdfdlnt_kernel FOR mspks_msdfdlnt_Kernel
/