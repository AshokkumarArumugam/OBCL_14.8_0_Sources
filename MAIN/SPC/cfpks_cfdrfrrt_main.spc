CREATE OR REPLACE PACKAGE  cfpks_cfdrfrrt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : cfpks_cfdrfrrt_main.spc
  **
  ** Module     : The ICCF
  ** 
...
TYPE ty_tb_v_cftms_rfr_ccy IS TABLE OF cftm_rfr_ccy%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_cftms_rfr_detail IS TABLE OF cftm_rfr_detail%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_cfdrfrrt IS RECORD (
     v_cftms_rfr_master     cftm_rfr_master%ROWTYPE,
     v_cftms_rfr_ccy    ty_tb_v_cftms_rfr_ccy,
     v_cftms_rfr_detail    ty_tb_v_cftms_rfr_detail,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END cfpks_cfdrfrrt_main;
/
CREATE OR REPLACE SYNONYM cfpkss_cfdrfrrt_main FOR cfpks_cfdrfrrt_main
/