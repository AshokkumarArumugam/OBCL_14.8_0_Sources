CREATE OR REPLACE PACKAGE  ifpks_ifdkfprm_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : ifpks_ifdkfprm_main.spc
  **
  ** Module     : IF
  ** 
...
TYPE ty_ifdkfprm IS RECORD (
     v_iftm_kafka_params     iftm_kafka_params%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END ifpks_ifdkfprm_main;
/
CREATE OR REPLACE SYNONYM ifpkss_ifdkfprm_main FOR ifpks_ifdkfprm_main
/