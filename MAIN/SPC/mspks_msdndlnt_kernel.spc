CREATE OR REPLACE PACKAGE  mspks_msdndlnt_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : mspks_msdndlnt_kernel.spc
  **
  ** Module     : Messaging
  ** 
...
END mspks_msdndlnt_kernel;
/
CREATE OR REPLACE SYNONYM mspkss_msdndlnt_kernel FOR mspks_msdndlnt_Kernel
/