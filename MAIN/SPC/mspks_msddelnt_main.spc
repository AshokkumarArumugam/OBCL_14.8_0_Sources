CREATE OR REPLACE PACKAGE  mspks_msddelnt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : mspks_msddelnt_main.spc
  **
  ** Module     : Messaging
  ** 
...
TYPE ty_msddelnt IS RECORD (
     v_msvw_dly_msg_dlvry_notif     msvw_dly_msg_dlvry_notif%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_msddelnt          IN OUT  mspks_msddelnt_Main.Ty_msddelnt,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_msddelnt          IN mspks_msddelnt_Main.Ty_msddelnt,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_msddelnt     IN  mspks_msddelnt_Main.Ty_msddelnt,
p_Wrk_msddelnt      IN OUT  mspks_msddelnt_Main.Ty_msddelnt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_msddelnt     IN  mspks_msddelnt_Main.Ty_msddelnt,
p_Prev_msddelnt IN OUT  mspks_msddelnt_Main.Ty_msddelnt,
p_Wrk_msddelnt      IN OUT  mspks_msddelnt_Main.Ty_msddelnt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_msddelnt     IN  mspks_msddelnt_Main.Ty_msddelnt,
p_Prev_msddelnt     IN  mspks_msddelnt_Main.Ty_msddelnt,
p_Wrk_msddelnt      IN OUT  mspks_msddelnt_Main.Ty_msddelnt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_msddelnt IN  mspks_msddelnt_Main.Ty_msddelnt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END mspks_msddelnt_main;
/
CREATE OR REPLACE SYNONYM mspkss_msddelnt_main FOR mspks_msddelnt_main
/