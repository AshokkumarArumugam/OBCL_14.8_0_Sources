...
(
	if [ -f "ZDTLoginSwitchRun.jar" ]
	then
	##echo $InstallationShipment
	export CLASSPATH=./ZDTLoginSwitchRun.jar:$CLASSPATH
	echo "Running in Silent Mode"
	java com.ofss.genericsoftinstaller.common.ZDTLoginSwitchRun "$InstallationShipment" "$ApplicationType" "$ConfigPath" "$JAVA_HOME" "$APPSERVER_HOME" "$ORACLE_HOME" "$WEBLOGIC_HOME" "$LOAD_ENV_VARIABLES"
	EXITINSTALLER
	else
