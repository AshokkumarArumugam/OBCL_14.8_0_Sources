...
if [ -e GatewayRestReCompileRunChk.flg ]
then
...
> GatewayRestReCompileRunChk.flg
...
(
	...
	export CLASSPATH=./GatewayRestReCompile.jar:$CLASSPATH
	echo "Running in Silent Mode"
	java com.ofss.genericsoftinstaller.Gateway.GatewayRestReCompile "$InstallationShipment" "$ApplicationType" "$ConfigPath" "$JAVA_HOME" "$APPSERVER_HOME" "$ORACLE_HOME" "$WEBLOGIC_HOME" "$LOAD_ENV_VARIABLES"
	EXITINSTALLER
)
...
(
	...
	rm GatewayRestReCompileRunChk.flg
