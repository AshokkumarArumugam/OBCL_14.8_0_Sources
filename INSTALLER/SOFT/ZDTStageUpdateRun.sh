...
(
	if [ -f "ZDTStageUpdateRun.jar" ]
	then
	##echo $InstallationShipment
	export CLASSPATH=./ZDTStageUpdateRun.jar:$CLASSPATH
	echo "Running in Silent Mode"
	java com.ofss.genericsoftinstaller.common.ZDTStageUpdateRun "$InstallationShipment" "$ApplicationType" "$ConfigPath" "$JAVA_HOME" "$APPSERVER_HOME" "$ORACLE_HOME" "$WEBLOGIC_HOME" "$LOAD_ENV_VARIABLES"
	EXITINSTALLER
	else
