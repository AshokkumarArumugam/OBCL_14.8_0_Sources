...
if [ -e GatewayReCompileEarRunChk.flg ]
then
...
(
	...
	export CLASSPATH=./GatewayReCompileEarCreation.jar:$CLASSPATH
	echo "Running in Silent Mode"
	java com.ofss.genericsoftinstaller.Gateway.GatewayReCompile "$InstallationShipment" "$ApplicationType" "$ConfigPath" "$JAVA_HOME" "$APPSERVER_HOME" "$ORACLE_HOME" "$WEBLOGIC_HOME" "$LOAD_ENV_VARIABLES"
	EXITINSTALLER
)
...
(
	...
	rm GatewayReCompileEarRunChk.flg
