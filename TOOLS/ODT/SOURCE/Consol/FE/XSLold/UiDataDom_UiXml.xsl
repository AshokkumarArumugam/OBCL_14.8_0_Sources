...
<!--
    ...
    -->  
      <xsl:if test="//UIGENSCR_BLOCKS[TXT_BLOCK_ID =$blkId]/BLOCKS_ATTRIBUTE[TXT_FIELD_NAME = $fldName][TXT_DEFAULT_VALUE != '']">
      <VALUE>
        <xsl:value-of select="//UIGENSCR_BLOCKS[TXT_BLOCK_ID =$blkId]/BLOCKS_ATTRIBUTE[TXT_FIELD_NAME = $fldName]/TXT_DEFAULT_VALUE"/>
      </VALUE>
      </xsl:if>
     <xsl:if test="//UIGENSCR_BLOCKS[TXT_BLOCK_ID =$blkId]/BLOCKS_ATTRIBUTE[TXT_FIELD_NAME = $fldName][CHK_RO = 'Y']">
      <READ_ONLY>
        <xsl:call-template name="SetCheckVals">
          <xsl:with-param name="v_Node">
      ...
      <xsl:if test="//UIGENSCR_BLOCKS[TXT_BLOCK_ID =$blkId]/BLOCKS_ATTRIBUTE[TXT_FIELD_NAME = $fldName][CHK_REQ = 'Y']">
      <REQUIRED>
        <xsl:call-template name="SetCheckVals">
          <xsl:with-param name="v_Node">
      ...
      <xsl:if test="//UIGENSCR_BLOCKS[TXT_BLOCK_ID =$blkId]/BLOCKS_ATTRIBUTE[TXT_FIELD_NAME = $fldName][CHK_UCASE = 'Y']">
      <UPPERCASE>
        <xsl:call-template name="SetCheckVals">
          <xsl:with-param name="v_Node">
