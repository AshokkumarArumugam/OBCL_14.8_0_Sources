...
<xsl:template name="dispDateField">
    ...
    <INPUT TYPE="TEXT" CLASS="TextDate"  onactivate="acceptInputDate('{$fldNode/NAME}')" onbeforedeactivate="validateInputDate('{$fldNode/NAME}')" >
        ...
        <xsl:if test="count($fldNode/READ_ONLY) = 0 or $fldNode/READ_ONLY != -1">
            <BUTTON CLASS="BUTTONInline" onclick="disp_cal('{$fldNode/NAME}', '{$fldNode/NAME}I')" onMouseOver="this.className='BUTTONInlineHover'" onMouseOut="this.className='BUTTONInline'" onFocus="this.className='BUTTONInlineHover'" onBlur="this.className='BUTTONInline'" title="Calendar">
                <IMG CLASS="IMGInline" SRC="{$imgPath_XSL}/calendar.gif" title="Calendar"/>
            </BUTTON>
        </xsl:if>
...
<xsl:template name="RequiredFieldHandler">
    <xsl:param name="curr_fld" select="." />
    <img src="{$imgPath_XSL}/star_disabled.gif" title="Required Field"/>
</xsl:template>
...
<xsl:template name="LovHandler">
    ...
    <xsl:if test="$Brn_Neo = ''">
        ...
        <xsl:if test="$curr_fld/TYPE='TEXT' or $curr_fld/TYPE='RESTRICTED_TEXT'" >
            <BUTTON CLASS="BUTTONInline" ONCLICK="fnBuildSummaryLOV('{$curr_fld/DBT}.{$curr_fld/DBC}', '{$curr_fld/LABEL}', '{$curr_fld/DTYPE}')" onMouseOver="this.className='BUTTONInlineHover'" onMouseOut="this.className='BUTTONInline'" onFocus="this.className='BUTTONInlineHover'" onBlur="this.className='BUTTONInline'">
                <IMG CLASS="IMGInline" SRC="{$imgPath_XSL}/Lov.gif"/>
            </BUTTON>
        </xsl:if>
       <!-- </xsl:if>-->
    </xsl:if>    
