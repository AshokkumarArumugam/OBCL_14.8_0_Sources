...
<INPUT aria-required="false" type="checkbox" class="CHKstd" name="SCREEN_QUERYREQ" id="SCREEN_QUERYREQ" checked="true" >Query Required</LABEL>
</div>
</div>
...
<b  id="groupidpymt"></b>
<div class="DIVchkrad">
<LABEL class="LBLauto" for="IMGFLD_QUERYREQ">
<INPUT aria-required="false" type="checkbox" class="CHKstd" name="IMGFLD_QUERYREQ" id="IMGFLD_QUERYREQ" checked="true" >Query all Img Required</LABEL>
</div>
</div>
