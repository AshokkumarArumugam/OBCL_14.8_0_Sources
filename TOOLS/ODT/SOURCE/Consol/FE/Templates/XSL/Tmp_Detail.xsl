    ...
    <div class="DIVPagingContainerMESV" id="DIVVerisonBtns">
        <xsl:choose>
            <xsl:when test="$langCode = 'ARB'">
                <button class="BUTTONInline" onclick="fnOnClick_BTN_LAST_VER()" LABEL_VALUE="" ID="" DBT="" DBC="" DTYPE="" name="BTN_LAST_VER" onMouseOver="this.className='BUTTONInlineHover'" onMouseOut="this.className='BUTTONInline'" onFocus="this.className='BUTTONInlineHover'" onBlur="this.className='BUTTONInline'" title="{$last_SummaryAudit}"><img class="IMGInline" src="{$imgPath_XSL}/Icons/BTNLast.gif" alt="{$last_SummaryAudit}"/></button>
                <button class="BUTTONInline" onclick="fnOnClick_BTN_NEXT_VER()" LABEL_VALUE="" ID="" DBT="" DBC="" DTYPE="" name="BTN_NEXT_VER" onMouseOver="this.className='BUTTONInlineHover'" onMouseOut="this.className='BUTTONInline'" onFocus="this.className='BUTTONInlineHover'" onBlur="this.className='BUTTONInline'" title="{$next_SummaryAudit}"><img class="IMGInline" src="{$imgPath_XSL}/Icons/BTNNext.gif" alt="{$next_SummaryAudit}"/></button><img height="1" width="10" src="{$imgPath_XSL}/Icons/spacer.gif" alt=""/>                
            ...
            <xsl:otherwise>
                ...
                <button class="BUTTONInline" onclick="fnOnClick_BTN_NEXT_VER()" LABEL_VALUE="" ID="" DBT="" DBC="" DTYPE="" name="BTN_NEXT_VER" onMouseOver="this.className='BUTTONInlineHover'" onMouseOut="this.className='BUTTONInline'" onFocus="this.className='BUTTONInlineHover'" onBlur="this.className='BUTTONInline'" title="{$next_SummaryAudit}"><img class="IMGInline" src="{$imgPath_XSL}/Icons/BTNNext.gif" alt="{$next_SummaryAudit}"/></button><img height="1" width="10" src="{$imgPath_XSL}/spacer.gif" alt=""/>
                <button class="BUTTONInline" onclick="fnOnClick_BTN_LAST_VER()" LABEL_VALUE="" ID="" DBT="" DBC="" DTYPE="" name="BTN_LAST_VER" onMouseOver="this.className='BUTTONInlineHover'" onMouseOut="this.className='BUTTONInline'" onFocus="this.className='BUTTONInlineHover'" onBlur="this.className='BUTTONInline'" title="{$last_SummaryAudit}"><img class="IMGInline" src="{$imgPath_XSL}/Icons/BTNLast.gif" alt="{$last_SummaryAudit}"/></button>
            </xsl:otherwise>
        </xsl:choose>
...
<xsl:template name="multipleEntrySingleViewBtns" >
    ...
    <xsl:if test="$l_sec1 = $secId and $l_par1 = $partId" >
        ...
        <div class="DIVPagingContainerMESV" id="MESV_{$blockId}">
            <button class="BUTTONInline" onMouseOver="this.className='BUTTONInlineHover'" onMouseOut="this.className='BUTTONInline'" onFocus="this.className='BUTTONInlineHover'" onBlur="this.className='BUTTONInline'" title="{$previous_SummaryAudit}" name="BTN_PREV_{$blockId}" onClick="fnMovePrev_{$blockId}()"><img class="IMGInline" src="{$imgPath_XSL}/Icons/BTNPrevious.gif" alt="{$previous_SummaryAudit}"/></button>
            <button class="BUTTONInline" onMouseOver="this.className='BUTTONInlineHover'" onMouseOut="this.className='BUTTONInline'" onFocus="this.className='BUTTONInlineHover'" onBlur="this.className='BUTTONInline'" title="{$next_SummaryAudit}" name="BTN_NEXT_{$blockId}" onClick="fnMoveNext_{$blockId}()"><img class="IMGInline" src="{$imgPath_XSL}/Icons/BTNNext.gif" alt="{$next_SummaryAudit}"/></button>
            <button class="BUTTONInline" onMouseOver="this.className='BUTTONInlineHover'" onMouseOut="this.className='BUTTONInline'" onFocus="this.className='BUTTONInlineHover'" onBlur="this.className='BUTTONInline'" title="{$add_row}" name="BTN_ADD_{$blockId}" onClick="fnAddRow_{$blockId}()"><img class="IMGInline" src="{$imgPath_XSL}/Icons/BTNAddrow.gif" alt="{$add_row}"/></button>
            <button class="BUTTONInline" onMouseOver="this.className='BUTTONInlineHover'" onMouseOut="this.className='BUTTONInline'" onFocus="this.className='BUTTONInlineHover'" onBlur="this.className='BUTTONInline'" title="{$delete_row}" name="BTN_REMOVE_{$blockId}" onClick="fnDelRow_{$blockId}()"><img class="IMGInline" src="{$imgPath_XSL}/Icons/BTNRemoveRow.gif" alt="{$delete_row}"/></button>
        </div>
    </xsl:if>
