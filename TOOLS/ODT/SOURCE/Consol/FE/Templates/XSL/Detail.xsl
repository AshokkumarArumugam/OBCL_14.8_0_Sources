...
<xsl:template name="version_button_required_tmp">
	...
	<label class="LABELNormal" for="Goto_version"></label>
        ...
        <button class="BUTTONInlineText" onclick="fnOnClick_goToPage()" LABEL_VALUE="GOTO" ID="" DBT="" DBC="" DTYPE="" name ="BTN_GO_VER" onmouseover="this.className='BUTTONInlineTextHover'" onmouseout="this.className='BUTTONInlineText'" onfocus="this.className='BUTTONInlineTextHover'" onblur="this.className='BUTTONInlineText'" title="{$gotoPage_SummaryAudit}" value="{$gotoPage_SummaryAudit}" alt="{$gotoPage_SummaryAudit}"><sup><xsl:value-of select="$gotoPage_SummaryAudit"/></sup></button>
   ...
   <INPUT TYPE="HIDDEN" onpropertychange="displayFormattedNumber(this)"> 
	...
	<xsl:attribute name="viewMode">Y</xsl:attribute>
        ...
        <xsl:if test="count(../POPUPEDIT) &gt; 0 or (number(../MAXLENGTH) &gt; $displaySize)">
            <BUTTON class="BTNhide" tabindex="-1" oldClassName = "BTNimg" title="{$narrative_SummaryAudit}" disabled="true">
                <xsl:call-template name="Popup_Handler_tmp" />
                <span tabindex="-1" class="ICOnarrative"><span class ="LBLinv"><xsl:value-of select = "$narrative_SummaryAudit"/></span></span>   
            </BUTTON>
        </xsl:if>
</xsl:template>
...
<!--    <div class="DIVMultipleSmall">  -->
    ...
    <xsl:choose>
        ...
        <div id="tableContainer" style="height:200px; overflow:scroll" onscroll="toggleSelectBoxes(this,'{ID}Header')">
            ...
            <table border="0" cellspacing="0" cellpadding="0" ID="{ID}" caption="{LABEL}" class="TABLEMultiple" summary="" onkeydown="return addRowShortcut(this, event)">
            <xsl:attribute name="DBT">
...
<xsl:template name="MultipleHandler_tmp">
    ...
    <tr>
        ...
        <th class="TBODYTDMultipleCheckbox" scope="col">
            <label class="LBLinv" for=""></label><input name="" type="checkbox" class="INPUTCheck" id = "Checkbox_Title" OnClick="fnToggleAllOrNoneME('{$curr_blk/ID}',this)" title="{$select_all_rows}"/>
        </th>            
    ...
    <tfoot>
            <tr><td colspan="##" tabindex="0"><span class="LBLinv"></span><xsl:text disable-output-escaping="yes"></xsl:text></td></tr>
    </tfoot>
    <!-- </table> -->
</xsl:template>
...
<xsl:template name="detail_row_tmp">
    ...
    <tr>
        <td class="TBODYTDMultipleFirst">
            <label class="LBLauto" for="chkDeleteRow"><input name="chkDeleteRow" type="checkbox" id="chkDeleteRow" onclick="fnMulipleEntryRow_onClick(event)" title="{$select_row}"/></label>
        </td>
    ...
    -->
        ...
        <!--<caption class="HeaderMultiple" >-->
            ...
            <xsl:if test="$paginationReq = 'Y'">
                <button class="BUTTONInline" title="First" name="nFirst__{$curr_blk/ID}" id="nFirst__{$curr_blk/ID}" tabindex="-1" onclick="fnMoveNextAndPrevPgOfMultipleEntry('{$curr_blk/@TABPAGE}','{$curr_blk/DBT}','{$curr_blk/ID}','FIRST', 'TRUE')" onMouseOver="this.className='BUTTONInlineHover'" onMouseOut="this.className='BUTTONInline'" onFocus="this.className='BUTTONInlineHover'" onBlur="this.className='BUTTONInline'" type="navBtn" >
                    <img class="IMGInline" src="{$imgPath_XSL}/BTNFirst_Disabled.gif" id="imgFirst_{$curr_blk/ID}" alt="imgFirst_{$curr_blk/ID}"/>
                </button>
                <button class="BUTTONInline" title="Previous" name="nPrev__{$curr_blk/ID}" id="nPrev__{$curr_blk/ID}" tabindex="-1" onClick="fnMoveNextAndPrevPgOfMultipleEntry('{$curr_blk/@TABPAGE}','{$curr_blk/DBT}','{$curr_blk/ID}','PREV', 'TRUE')" onMouseOver="this.className='BUTTONInlineHover'" onMouseOut="this.className='BUTTONInline'" onFocus="this.className='BUTTONInlineHover'" onBlur="this.className='BUTTONInline'" type="navBtn">
                        <img class="IMGInline" src="{$imgPath_XSL}/BTNPrevious_Disabled.gif" id="imgPrev_{$curr_blk/ID}" alt="imgPrev_{$curr_blk/ID}"/>
                </button>
                <xsl:text disable-output-escaping="yes"></xsl:text>
                <xsl:text disable-output-escaping="yes"></xsl:text>
                ...
                <xsl:text disable-output-escaping="yes"></xsl:text>
                <button class="BUTTONInline" title="Next" name="nNext__{$curr_blk/ID}" id="nNext__{$curr_blk/ID}" tabindex="-1" onClick="fnMoveNextAndPrevPgOfMultipleEntry('{$curr_blk/@TABPAGE}','{$curr_blk/DBT}','{$curr_blk/ID}','NEXT', 'TRUE')" onMouseOver="this.className='BUTTONInlineHover'" onMouseOut="this.className='BUTTONInline'" onFocus="this.className='BUTTONInlineHover'" onBlur="this.className='BUTTONInline'" type="navBtn">
                        <img class="IMGInline" src="{$imgPath_XSL}/BTNNext_Disabled.gif" id="imgNext_{$curr_blk/ID}" alt="imgNext_{$curr_blk/ID}"/>
                </button>
                <button class="BUTTONInline" title="Last" name="nLast__{$curr_blk/ID}" id="nLast__{$curr_blk/ID}" tabindex="-1" onClick="fnMoveNextAndPrevPgOfMultipleEntry('{$curr_blk/@TABPAGE}','{$curr_blk/DBT}','{$curr_blk/ID}','LAST', 'TRUE')" onMouseOver="this.className='BUTTONInlineHover'" onMouseOut="this.className='BUTTONInline'" onFocus="this.className='BUTTONInlineHover'" onBlur="this.className='BUTTONInline'" type="navBtn">
                        <img class="IMGInline" src="{$imgPath_XSL}/BTNLast_Disabled.gif" id="imgLast_{$curr_blk/ID}" for="imgLast_{$curr_blk/ID}"/>
                </button>
                ...
                type="navBtn" value="{$gotoPage_SummaryAudit}">
                        ...
                        <sup><xsl:value-of select="$gotoPage_SummaryAudit"/></sup>
                </button>
	...
	<xsl:template match="BLOCK" mode="AuditEntry_Neo_tmp">        
		...
		<td width="98%" valign="top">
			<fieldset class="FSTcell">
				...
				<div class="DIVText">
					<label for="MAKER_ID" class="LABELNormal">
						<xsl:value-of select="$makerId" />
					</label>
					<input type="TEXT" class="TEXTAudit1" name="MAKER_ID" id="{DBT}__MAKER_ID" dbt="{DBT}" dbc="MAKER_ID" readonly="readonly" maxlength="12" size="12"/>
				</div>
				<div class="DIVText">
					...
					<input type="TEXT" class="TEXTAudit1" name="MAKER_DT_STAMPI" id="MAKER_DT_STAMPI" readonly="readonly" maxlength="19" size="22"/>
				</div>
			</fieldset>
			<fieldset class="FSTcell">
				<legend>Untitled group</legend>
				<div class="DIVText">
					<label for="CHECKER_ID" class="LABELNormal">
						<xsl:value-of select="$checkerId" />
					</label>
					<input type="TEXT" class="TEXTAudit1" name="CHECKER_ID" id="{DBT}__CHECKER_ID" dbt="{DBT}" dbc="CHECKER_ID" readonly="readonly" maxlength="12" size="12"/>
				</div>
				<div class="DIVText">
					...
					<input type="TEXT" class="TEXTAudit1" name="CHECKER_DT_STAMPI" id="CHECKER_DT_STAMPI" readonly="readonly" maxlength="19" size="22"/>
				</div>
			</fieldset>
			<fieldset class="FSTcell">
				<legend>Untitled group</legend>
				<div class="DIVText">
					...
					<input type="TEXT" class="TEXTAudit1 numeric" name="MOD_NO" id="{DBT}__MOD_NO" dbt="{DBT}" dbc="MOD_NO" readonly="readonly" maxlength="4" size="3"/>
				</div>
			</fieldset>
			<fieldset class="FSTcell">
				<legend>Untitled group</legend>
...
<xsl:template match="BLOCK" mode="AuditEntry_Neo_Online_tmp">        
        ...
        <xsl:variable name="dealStatus" select = "//FORM/BLOCK[@SCREEN=$screen and @TYPE='Audit Entry']/DEAL_STATUS"/>
            <tr><td width="98%" valign="top">
				<fieldset class="FSTcell">
					...
					<div class="DIVText">
						...
						<INPUT TYPE="TEXT" CLASS="TEXTAudit1" name="MAKERID" id="{DBT}__MAKERID" DBT="{DBT}" DBC="MAKERID" READONLY="true" MAXLENGTH="12" SIZE="12"/>
					</div>
					<div class="DIVText">
						<LABEL CLASS="LABELNormal" for="MAKERSTAMPI"><xsl:value-of select="$DtStamp"/></LABEL>
				...
				<fieldset class="FSTcell">
					<legend>Untitled group</legend>
					<div class="DIVText">
						<label class="LABELNormal" for="CHECKERID"><xsl:value-of select="$checkerId"/></label>
						<INPUT TYPE="TEXT" CLASS="TEXTAudit1" name="CHECKERID" id="{DBT}__CHECKERID" DBT="{DBT}" DBC="CHECKERID" READONLY="true" MAXLENGTH="12" SIZE="12"/>
					</div>
					<div class="DIVText">
				...
				<fieldset class="FSTcell">
					...
					<div class="DIVText">
						<xsl:if test = "$contractStatus = -1">
							<LABEL CLASS="LABELAudit1" for="{DBT}__CONTSTAT"></LABEL>
						...
						<xsl:if test = "$contractStatus = 0 and $paymentStatus = 0 and $collectionStatus = 0 and $ProcessStatus = -1">
							<LABEL CLASS="LABELAudit1" for="{DBT}__PROCESSTAT"></LABEL>
						...
						<xsl:if test = "$dealStatus = -1">
							<LABEL CLASS="LABELAudit1" for="{DBT}__DEAL_STATUS"></LABEL>
			...
			<fieldset class="FIELDSETNormal" style="clear:both">
				<legend><xsl:value-of select="$reversal"/></legend>
				<fieldset class="FSTcell">
					<div class="DIVText">
						<LABEL CLASS="LABELNormal" for="{DBT}__MAKERID"><xsl:value-of select="$makerId"/></LABEL>
						<INPUT TYPE="TEXT" CLASS="TEXTAudit1" name="REVR_MAKERID" id="{DBT}__REVR_MAKERID" DBT="{DBT}" DBC="REVR_MAKERID" READONLY="true" MAXLENGTH="12" SIZE="12"/>					
					</div>
					<div class="DIVText">
        ...
        <TABLE CLASS="TABLEAddDelRow" cellspacing="0" cellpadding="0" border="0"
          ...
          <TR CLASS="TRAddDelRow">
            <TD CLASS="TDAddDelRow">
              <BUTTON CLASS="BtnAddRow" name="cmdAddRow_{$curr_blk/ID}" tabindex="-1"
          ...
          <TR CLASS="TRAddDelRow">
            <TD CLASS="TDAddDelRow">
              <BUTTON CLASS="BtnDelRow" name="cmdDelRow_{$curr_blk/ID}" tabindex="-1"
          ...
          <TR CLASS="TRAddDelRow">
            <TD CLASS="TDAddDelRow">
              <BUTTON CLASS="BtnSingleView" tabindex="-1"
...
<!--      </xsl:if> -->
   ...
   <xsl:variable name="refFld" select="../REF_FIELD"/>
    <xsl:variable name="referFld">
      ...
      <xsl:if test="count(../LOV) = 0">      
        <xsl:if test="count(../READ_ONLY) = 0 or ../READ_ONLY != -1">
          <BUTTON CLASS="ButtonLov" tabindex="-1" onclick="disp_cal('{../NAME}', '{../NAME}I')">
            <IMG CLASS="IMGLov" SRC="{$imgPath_XSL}/Calendar.gif" title="Calendar"/>
          </BUTTON>
        </xsl:if>
      </xsl:if>
...
<!-- sundar added for NEO...for a text field, both lov & popup can appear -->
      <xsl:if test="$Brn_Neo != ''">
        <xsl:if test="count(../LOV) = 0 ">
          <xsl:if test="count(../POPUPEDIT) &gt; 0 and (count(../READ_ONLY) = 0 or ../READ_ONLY = 0)">
            <BUTTON CLASS="ButtonLov" tabindex="-1" onmouseover="this.className='ButtonLovOver'" onmouseout="this.className='ButtonLov'">
              <xsl:call-template name="Popup_Handler" />
                      <IMG CLASS="IMGPopupEdit" SRC="{$imgPath_XSL}/narrative.gif" title="{$narrative_SummaryAudit}"/>
            </BUTTON>
          </xsl:if>
        </xsl:if>
      </xsl:if>
...
<!--                       <BUTTON CLASS="ButtonLov" TABINDEX="{$curr_fld/TABINDEX}" ONCLICK="{$curr_fld/LOV/NAME}.show_lov('{$curr_fld/LOV/RET_FLDS}','{$curr_fld/LOV/FORM_NAME}','{$curr_fld/LOV/BIND_VARS}', '{$curr_fld/LOV/TITLE}', '{$curr_fld/LOV/COL_HEADING}', '{$curr_fld/LOV/REDUCTION_FLD_LABELS}')" -->
   <!-- 10.2sp1   Security Chnages      <BUTTON CLASS="ButtonLov" TABINDEX="{$curr_fld/TABINDEX}" ONCLICK="{$curr_fld/LOV/NAME}.show_lov('{normalize-space($curr_fld/LOV/RET_FLDS)}','{normalize-space($curr_fld/LOV/FORM_NAME)}','{normalize-space($curr_fld/LOV/BIND_VARS)}', '{normalize-space($curr_fld/LOV/TITLE)}', '{normalize-space($curr_fld/LOV/COL_HEADING)}', '{normalize-space($curr_fld/LOV/REDUCTION_FLD_LABELS)}')"-->
                           <BUTTON CLASS="ButtonLov" tabindex="-1" ONCLICK="{$curr_fld/LOV/NAME}.show_lov('{normalize-space($curr_fld/LOV/RET_FLDS)}','{normalize-space($curr_fld/LOV/FORM_NAME)}','{normalize-space($curr_fld/LOV/BIND_VARS)}', '{normalize-space($curr_fld/LOV/TITLE)}', '{normalize-space($curr_fld/LOV/COL_HEADING)}', '{normalize-space($curr_fld/LOV/REDUCTION_FLD_LABELS)}','{substring-before($Brn_Neo, '__')}','{$curr_fld/LOV/NAME}')"
...
<!--10.2 sp1 security chnages-->
         <BUTTON CLASS="ButtonLov" tabindex="-1" ONCLICK="{normalize-space($curr_fld/LOV/NAME)}.show_lov('{normalize-space($curr_fld/LOV/RET_FLDS)}','{normalize-space($curr_fld/LOV/FORM_NAME)}','{normalize-space($curr_fld/LOV/BIND_VARS)}', '{normalize-space($curr_fld/LOV/TITLE)}', '{normalize-space($curr_fld/LOV/COL_HEADING)}', '{normalize-space($curr_fld/LOV/REDUCTION_FLD_LABELS)}', '{$containerId}', '{normalize-space($curr_fld/LOV/NAME)}')"
                       onmouseover="this.className='ButtonLovOver'" onmouseout="this.className='ButtonLov'" >
            <xsl:if test="count($curr_fld/READ_ONLY) &gt; 0 and $curr_fld/READ_ONLY = -1 and count($curr_fld/INPUT_LOV) = 0">
                   <xsl:attribute name="DISABLED"/>
            </xsl:if>
		...
		<xsl:if test="count($curr_fld/LOV) = 0 ">
			...
			<xsl:if test="$EntityType = 'ACCOUNT' ">
				<BUTTON CLASS="ButtonLov" tabindex="-1" ONCLICK="Account.show_lov()">
					<IMG CLASS="IMGLov" SRC="{$imgPath_XSL}/Lov.gif"  />
				</BUTTON>
			</xsl:if>
	    
			<xsl:if test="$EntityType = 'BRANCH' ">
				<BUTTON CLASS="ButtonLov" tabindex="-1" ONCLICK="Branch.show_lov()">
					<IMG CLASS="IMGLov" SRC="{$imgPath_XSL}/Lov.gif"  />
				</BUTTON>
			</xsl:if>

			<xsl:if test="$EntityType = 'CURRENCY' ">
				<BUTTON CLASS="ButtonLov" tabindex="-1" ONCLICK="Currency.show_lov()">
					<IMG CLASS="IMGLov" SRC="{$imgPath_XSL}/Lov.gif"  />
				</BUTTON>
			</xsl:if>
	    
			<xsl:if test="$EntityType = 'CUSTOMER' ">
				<BUTTON CLASS="ButtonLov" tabindex="-1" ONCLICK="Customer.show_lov()">
					<IMG CLASS="IMGLov" SRC="{$imgPath_XSL}/Lov.gif"  />
				</BUTTON>
			</xsl:if>
		</xsl:if>
