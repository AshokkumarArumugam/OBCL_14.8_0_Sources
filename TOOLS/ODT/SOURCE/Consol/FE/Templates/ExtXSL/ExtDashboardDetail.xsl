...
<xsl:template name="sprtHandler">
    ...
    <xsl:template name="MultipleHandler_Head_tmp" >
        ...
        <div class="DIVgrid">
            <span class="Fleft">
                ...
                <label class="LBLinv" for="goto"></label><input id="goto__{$curr_blk/BLOCK}" title="{$gotoPage_SummaryAudit}" type="text" size="1" class="DashTXTro" value="" READONLY="true" />
    ...
    <xsl:template match="FIELD" mode="withoutSubPart" >
        ...
        <xsl:if test="./TYPE = 'RADIO'">
            <div class="DIVRadio" role="group" aria-labelledby="groupidpercentage"> <!--Radio changes -->
                <xsl:call-template name="dispFields_tmp" />
            </div>
        </xsl:if>
        <xsl:if test="./TYPE = 'CHECKBOX'">
            <div class="DIVCheck" role="group" aria-labelledby="groupidpymt"> <!--Checkbox changes -->
                <xsl:call-template name="dispFields_tmp" />
            </div>
        </xsl:if>
    </xsl:template>
    ...
    <xsl:template name="dispLinkField_tmp">
        ...
        <a class="Afoot" href="#;return false" tabindex ='-1'>
            <xsl:attribute name="ID">
            ...
            <xsl:attribute name="onclick">
                <xsl:text>fnShowCustomerDetails(this, event)</xsl:text>
            </xsl:attribute>
            View
            <xsl:text disable-output-escaping="yes">&#160;</xsl:text>
    ...
    <xsl:template match="FIELD/TYPE[text()='ROSELECT']" mode="template">
        ...
        <INPUT class="DashTXTro" tabIndex="-1" viewMode="Y" INPUT_LOV="N">                       
...
<xsl:template name="dispAmountField_tmp">
    ...
    <INPUT TYPE="TEXT" class="DashTXTro numeric" title="{../LBL}" readOnly="true">
        <xsl:call-template name="ATTR_InputEntity_Handler_tmp">
            <xsl:with-param name="curr_fld" select=".." />
        </xsl:call-template>
...
<xsl:template name="ATTR_InputEntity_Handler_tmp">
	...
	<xsl:attribute name="READONLY1">true</xsl:attribute>
        ...
        <xsl:attribute name="class">DashTXTro</xsl:attribute>
        <xsl:if test="$curr_fld/TYPE[text() != 'MASK'] and $curr_fld/TYPE[text() != 'DATE']" >
            <xsl:attribute name="class">
                <xsl:text>DashTXTro numeric</xsl:text>
            </xsl:attribute>
        </xsl:if>
    </xsl:if>
...
<xsl:template name="dispNumberField_tmp">
    ...
    <input type="text" class="DashTXTro numeric" title="{../LBL}" onblur="validateInputNumber(this)">
...
<xsl:template name="dispTextField_tmp">
    <xsl:param name="EntityType"/>
    <input type="text" class="DashTXTro">
	<xsl:attribute name="viewMode">Y</xsl:attribute>
        <xsl:attribute name="readOnly">true</xsl:attribute>
...
<xsl:template name="dispDateField_tmp">
    ...
    <INPUT TYPE="TEXT" class="DashTXTro" title="{../LBL}"  onblur="validateInputDate('{../NAME}', event)" readOnly="true" >
...
<xsl:template name="dispFileField_tmp">
    ...
    <label class="LBLstd" for=""></label>
    <INPUT TYPE="File" class="DashTXTro"  size="10" readOnly="true" >
        <xsl:call-template name="ATTR_Handler_tmp">
            <xsl:with-param name="curr_fld" select=".." />
        </xsl:call-template>
...
<xsl:template name="dispMaskField_tmp">
    ...
    <label class="LBLstd" for=""></label><INPUT TYPE="TEXT" class="DashTXTro" mask="{../MASK}" onblur="validateInputValue('{../NAME}');" readOnly="true" >
        <xsl:call-template name="ATTR_InputEntity_Handler_tmp">
            <xsl:with-param name="curr_fld" select=".." />
        </xsl:call-template>
...
<xsl:template name="dispPasswordField_tmp">    
    <Input type="PASSWORD" class="DashTXTro" onpaste="return false;" readOnly="true" >
        <xsl:call-template name="ATTR_Handler_tmp">
            <xsl:with-param name="curr_fld" select=".." />
        </xsl:call-template>
        ...
        <div class="DIVAbutton" id="DIVSubSystem">
            <ul>
                <xsl:for-each select="//*[name() = 'SCREEN' and @NAME =  $screen]/*[name() ='SUBSCREEN']/FORM">
                    ...
                    <li id="{@id}">
                        <a href="#" class="Abutton" onmouseover="this.className='AbuttonH'" onfocus="this.className='AbuttonH'" onmouseout="this.className='Abutton'" onblur="this.className='Abutton'" onkeydown="return fnhandleSubScrBtn(event)">
                            <xsl:attribute name="onclick">
                                <xsl:if test="@TYPE = 'S'">
