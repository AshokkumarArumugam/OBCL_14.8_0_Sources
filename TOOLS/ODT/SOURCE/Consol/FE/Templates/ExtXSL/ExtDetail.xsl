...
<!--Change for header in ME screen-->
                    <table border="0" cellspacing="0" cellpadding="0" ID="{./BLOCK}" caption="{./LBL}" class="TBLgrid" type="ME" summary="{./LBL}" role="presentation">
    ...
    <xsl:template name="MultipleHandler_Head_tmp" >
        ...
        <!--<div class="DIVpage">
            <span class="DIVpageH">-->
        <!-- Changes for Header in ME screen start-->
        <div tabindex="0" onkeydown="return addRowShortcut('{./BLOCK}', event);">
            <xsl:choose>
              <xsl:when test="$partWidth = '100' and $l_scr_type='L'"> 
                  <xsl:attribute name="class">
              ...
              <xsl:when test="$partWidth = '100' and $l_scr_type!='L'"> 
                  <xsl:attribute name="class">
                      <xsl:value-of select="'DIVGridME DIVGridMediumInner'" />
                  </xsl:attribute>
              </xsl:when>
              <xsl:when test="$partWidth = '66'">
                <xsl:attribute name="class">
            ...
            <xsl:if test="count($curr_blk/READ_ONLY) = 0 or  (count($curr_blk/READ_ONLY) &gt; 0 and $curr_blk/READ_ONLY != -1)">
                ...
                <button class="BTNimgD"  name="cmdDelRow_{$curr_blk/BLOCK}" id="cmdDelRow_{$curr_blk/BLOCK}" tabindex="-1" onClick="fnDeleteRow('{$curr_blk/BLOCK}')" title="{$delete_row}" disabled = "true">
                    <span tabindex="-1" class="ICOremove">
                    <span class="LBLinv"><xsl:value-of select = "$delete_row"/></span> 
                    </span>
                </button>
            </xsl:if>
            <button class="BTNimgD" name="BTN_SINGLE_VIEW_{$curr_blk/BLOCK}" id="BTN_SINGLE_VIEW_{$curr_blk/BLOCK}" tabindex="-1" onClick="fnShowSingleViewForME('{$curr_blk/BLOCK}')" title="{$single_rec_view}" disabled = "true">
                <span tabindex="-1" class="ICOsingleview">
                <span class="LBLinv"><xsl:value-of select = "$single_rec_view"/></span>                
                </span>                 
            </button>
        </div>
    </xsl:template>
    ...
    <xsl:template name="MultipleHandler_tmp">
        ...
        <thead id="{$curr_blk/BLOCK}Header">
            ...
            <th class="THgrid1" scope="col">
				<!--Change for ME screen-->
                <input type="checkbox" id = "{./BLOCK}_CHK_ME" OnClick="fnToggleAllOrNoneME('{./BLOCK}',this, event)" title="{$select_all_rows}"/><span class="LBLinv"><xsl:value-of select="$select_all_rows"/></span>
            </th>
            ...
            <xsl:if test="count(./NAV_BTN_REQ) > 0 and ./NAV_BTN_REQ = 'Y'">
                <xsl:if test="$sprtReqd = 'Y'">
                    <xsl:if test="$SPRT_Index = 1">
                        <xsl:if test="count(./NAV_BTN_FULL_WIDTH) = 0"><!--Fix for 25643449 starts-->
    ...
    <xsl:template name="VCHandler">
        <div class="DIVpage" id="DIVVerisonBtns">
            <button class="BTNicon2D" tabindex="-1" onclick="fnChangeVersion('First')" LABEL_VALUE="" ID="" DBT="" DBC="" DTYPE="" name="BTN_FIRST_VER" title="{$first}">
                <span tabindex="-1" class="ICOfirst">
               <span class="LBLinv"><xsl:value-of select = "$first"/></span>
                </span>
            </button>
            <button class="BTNicon2D" tabindex="-1" onclick="fnChangeVersion('Previous')" LABEL_VALUE="" ID="" DBT="" DBC="" DTYPE="" name="BTN_PREV_VER" title="{$previous}">
                <span tabindex="-1" class="ICOprevious">
                 <span class="LBLinv"><xsl:value-of select = "$previous"/></span>
                 </span>
            </button>
            ...
            <button class="BTNicon2D" tabindex="-1" onclick="fnChangeVersion('Next')" LABEL_VALUE="" ID="" DBT="" DBC="" DTYPE="" name="BTN_NEXT_VER" title="{$next}">
                <span class="ICOnext">
                <span class="LBLinv"><xsl:value-of select = "$next"/></span></span>
            </button>
            <button class="BTNicon2D" tabindex="-1" onclick="fnChangeVersion('Last')" LABEL_VALUE="" ID="" DBT="" DBC="" DTYPE="" name="BTN_LAST_VER" title="{$last}">
                <span class="ICOlast">
                <span class="LBLinv"><xsl:value-of select = "$last"/></span>
                </span>
            </button>
    ...
    <xsl:template match="FIELD" mode="withoutSubPart" >
        <xsl:if test="./TYPE != 'CHECKBOX' and ./TYPE != 'RADIO'">
            <div class="DIVText" onclick="mainWin.fnUpdateScreenSaverInterval();"><!-- 12.0.2 ScreenSaver Changes -->
                <xsl:call-template name="dispFields_tmp" />
            </div>
        </xsl:if>
        <xsl:if test="./TYPE = 'RADIO'">
            <div class="DIVRadio" role="group" aria-labelledby="groupidpercentage" onclick="mainWin.fnUpdateScreenSaverInterval();"> <!--Radio changes --> <!-- 12.0.2 ScreenSaver Changes -->
                <xsl:call-template name="dispFields_tmp" />
            </div>
        </xsl:if>
        <xsl:if test="./TYPE = 'CHECKBOX'">
            <div class="DIVCheck" role="group" aria-labelledby="groupidpymt" onclick="mainWin.fnUpdateScreenSaverInterval();"> <!--Checkbox changes --><!-- 12.0.2 ScreenSaver Changes -->
                <xsl:call-template name="dispFields_tmp" />
            </div>
        </xsl:if>
    </xsl:template>
    ...
    <xsl:template match="FIELD" mode="withSubPart">
        ...
        <xsl:if test="./TYPE = 'RADIO'">
            <div class="DIVRadio" role="group" aria-labelledby="groupidpercentage" onclick="mainWin.fnUpdateScreenSaverInterval();"><!-- 12.0.2 ScreenSaver Changes -->
                <xsl:call-template name="dispFields_tmp" />
            </div>
        </xsl:if>
        <xsl:if test="./TYPE = 'CHECKBOX'">
            <div class="DIVCheck" role="group" aria-labelledby="groupidpymt" onclick="mainWin.fnUpdateScreenSaverInterval();"><!-- 12.0.2 ScreenSaver Changes -->
                <xsl:call-template name="dispFields_tmp" />
            </div>
        </xsl:if>
    </xsl:template>
    ...
    <xsl:template match="FIELD/TYPE[text()='CHECKBOX']" mode="template">
        <xsl:if test="../../@TYPE != 'ME' or ../../@VIEW = 'SE'">
             <xsl:if test="../../@ID != 'FLD_AUDIT1'">
                <b class="LBLstd" id="groupidpymt"> <!--Checkbox changes-->
                    <xsl:text disable-output-escaping="yes">&#160;</xsl:text>
    ...
    <xsl:template match="FIELD/TYPE[text()='SELECT']" mode="template">
        ...
        <xsl:if test="../../@TYPE != 'ME' or ../../@VIEW = 'SE'">
            <div class="DIVList" onclick="mainWin.fnUpdateScreenSaverInterval();"><!-- 12.0.2 ScreenSaver Changes -->
                <xsl:call-template name="dispNormalLabel_tmp"/>
                <xsl:call-template name="dispSelectField_tmp"/>
            </div>
        </xsl:if>
    ...
    <xsl:template match="FIELD/TYPE[text()='BUTTON']" mode="template">
        <xsl:choose>
            ...
            <xsl:otherwise>
                <xsl:if test="(../../@TYPE = 'ME' and ../../@VIEW != 'SE') or (../../@TYPE = 'ME' and count(../../@VIEW) = 0)"> 
                    <td class="TDgrid" nowrap="nowrap" onclick="mainWin.fnUpdateScreenSaverInterval();"><!-- 12.0.2 ScreenSaver Changes -->
                        <xsl:call-template name="dispButtonField_tmp"/>
                    </td>
                </xsl:if>
                <xsl:if test="../../@TYPE != 'ME' or ../../@VIEW = 'SE'">              
                    <div class="DIVText" > <label class="LBLstd" onclick="mainWin.fnUpdateScreenSaverInterval();"></label><!-- 12.0.2 ScreenSaver Changes -->
                        <xsl:call-template name="dispButtonField_tmp"/>
                    </div>
                </xsl:if>
            </xsl:otherwise>
...
<!--UDF Changes Start -->
  ...
  <xsl:otherwise>
    ...
    <xsl:template name="dispRadioLabel_tmp" >
        <xsl:if test="count(../REQD) = 0 or ../REQD = '0'">
        <b class="LBLstd" id="groupidpercentage">  <!--Radio changes -->
            <xsl:value-of select="../LBL"/>
        </b>
        </xsl:if>
        <xsl:if test="count(../REQD) &gt; 0 and ../REQD = '-1'">
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
                <fieldset class="FSTcell" block="{./BLOCK}" type="{./@TYPE}" view="{./@VIEW}">
                    ...
                    <xsl:if test="$sprtReqd = 'Y'">
                        <xsl:if test="@TYPE = 'ME' and @VIEW = 'SE'"><!--Fix for 25643449 starts-->
                            <xsl:if test="count(NAV_BTN_REQ) > 0 and NAV_BTN_REQ = 'Y'">
                                <xsl:if test="count(NAV_BTN_FULL_WIDTH) > 0 and NAV_BTN_FULL_WIDTH = 'Y'">
                                    <xsl:variable name="blkId" select="BLOCK"/>
                                    <xsl:variable name="blockId">
                                        <xsl:if test="contains($blkId,'_TMP')">
                                            <xsl:value-of select="substring-before($blkId,'_TMP')"/>
                                    ...
                                    <xsl:if test="count(READ_ONLY) > 0 and READ_ONLY = -1">
                                        <div class="DIVpage" id="MESV_{$blockId}">
                                            ...
                                            <span id="CurrPageSV__{$blockId}" name="CurrPage__{$blockId}" class="SPNtext">
                                                1
                                                <xsl:text disable-output-escaping="yes">&#160;</xsl:text>
                                            </span>
                                            <span class="SPNtext">
                                            ...
                                            <span id="TotPageSV__{$blockId}" name="TotPage__{$blockId}" class="SPNtext">
                                                <xsl:text disable-output-escaping="yes">&#160;</xsl:text>
                                                1
                                            </span>
                                            <button class="BTNicon2D" title="{$next}" name="BTN_NEXT_{$blockId}" onClick="fnMoveNextMESV('{$blockId}')" disabled="disabled">
                                    ...
                                    <xsl:if test="count(./READ_ONLY) = 0 or ./READ_ONLY = 0">
                                        <div class="DIVpage" id="MESV_{$blockId}">
                                            ...
                                            <span id="CurrPageSV__{$blockId}" name="CurrPageSV__{$blockId}" class="SPNtext">
                                                1
                                                <xsl:text disable-output-escaping="yes">&#160;</xsl:text>
                                            </span>
                                            <span class="SPNtext">
        ...
        <fieldset block="{./BLOCK}" type="{@TYPE}" view="{@VIEW}">
			...
			<xsl:attribute name = "class">
				<xsl:if test="count(./FIELD[position()=1]/CALENDARTEXT) &gt; 0">
					<xsl:value-of select="'FSTcell FSTCal'" />
				</xsl:if>
				<xsl:if test="count(./FIELD[position()=1]/CALENDARTEXT) = 0">
					<xsl:value-of select="'FSTcell'" />
				</xsl:if>
			</xsl:attribute> 
            <xsl:if test="LBL != ''">
                <xsl:attribute name = "class">
                    <!--change for holiday maint screen fields alignment -->
                    <xsl:if test="count(./FIELD[position()=1]/CALENDARTEXT) &gt; 0">
                        <xsl:value-of select="'FSTstd FSTCal'" />
                    </xsl:if>
                    <xsl:if test="count(./FIELD[position()=1]/CALENDARTEXT) = 0">
                    <xsl:value-of select = "'FSTstd'"/>
                    </xsl:if>
    ...
    <xsl:template  match="SECTION">
          ...
          <xsl:otherwise>
               <xsl:text>TwoColSectionContainer</xsl:text>
          </xsl:otherwise>
    </xsl:choose>
    </xsl:variable>
        <div>
        ...
        <xsl:value-of select = "$section_class"/>
            ...
            <button class="BTNicon" title="$expand_section" id = "BtnSectionNav" onclick="expandCollapseSection(this, 'EXPAND');"><span class="sectionExpand"></span></button> 
            </span>
            <fieldset class="FSTstd" style="border:none;"><legend><xsl:value-of select="LBL"/></legend></fieldset>
            </div>   
             </xsl:if> 
             <xsl:choose>
            ...
            <div>
				...
				<span class="sectionToggle">
					<button class="BTNicon" title='$collapse_section'  id = "BtnSectionNav" onclick="expandCollapseSection(this, 'COLLAPSE');"><span class="sectionCollapse"></span></button>
				</span>
                <fieldset class="FSTstd" style="border:none;"><legend><xsl:value-of select="LBL"/></legend></fieldset>
            </div>
         ...
         <!-- added for Amount/Exchange Rate patterns starts -->
            <xsl:if test="count(../REFERRED_FIELDS) != 0">
                ...
                <xsl:attribute name="onchange">
                    <xsl:text disable-output-escaping="yes">processAmount('</xsl:text>
                    <xsl:value-of select="../NAME"/>
                    <xsl:text disable-output-escaping="yes">', '</xsl:text>
...
<xsl:template name="ATTR_HiddenEntity_Handler_tmp">
	...
	<!-- Start of PreVal -->
	<xsl:if test="count($curr_fld/PRE_VAL) &gt; 0">
	 <xsl:attribute name="VALUE">
                <xsl:value-of select="$curr_fld/PRE_VAL" />
            </xsl:attribute>
	</xsl:if>
	<!--END of PreVal -->
...
<xsl:template name="dispNumberField_tmp">
    ...
    <!-- added for Amount/Exchange Rate patterns starts -->
        <input type="text" class="TXTro numeric" title="{../LBL}">
            <xsl:if test="count(../REFERRED_FIELDS) != 0">
                <xsl:attribute name="RNAMES">
                    <xsl:variable name="rNamesValue">
                        <xsl:for-each select="../REFERRED_FIELDS/RFIELD">
                ...
                <xsl:attribute name="onchange">
                    <xsl:text disable-output-escaping="yes">processNumber(this,event);</xsl:text>
                </xsl:attribute>
            </xsl:if>
            <xsl:if test="count(../REFERRED_FIELDS) = 0">
                <xsl:attribute name="onblur">                     
...
<xsl:template name="dispProductField_tmp">
    <xsl:param name="EntityType"/>
    <input type="text" class="TXTro" pickup_product="">
	<xsl:attribute name="viewMode">Y</xsl:attribute>
        <xsl:attribute name="readOnly">true</xsl:attribute>
        ...
        <xsl:if test="../LBL = ''">
            <label>
                <xsl:attribute name="class">
                    <xsl:choose>
                        <xsl:when test="../../HREQ = '-1'">
                            <xsl:value-of select="'LBLauto LBLinvHF'" />
                        </xsl:when>
                        <xsl:otherwise>
                            <xsl:value-of select="'LBLauto LBLinv2'" />
                        </xsl:otherwise>
                    </xsl:choose>
                </xsl:attribute>
                <xsl:attribute name="for">
...
<xsl:template name="dispTextareaField_tmp" >
    ...
    <xsl:if test="count(../POPUPEDIT) &gt; 0 and (count(../READ_ONLY) = 0 or ../READ_ONLY = 0)">
         <BUTTON class="BTNhide" oldClassName = "BTNimg"  title="{$narrative}" disabled="true" tabindex="-1">            
            <xsl:call-template name="Popup_Handler_tmp" />
...
<xsl:template match="BODY/TAB" mode="template">
    <li >
        ...
        <a class="Htaball" href="#href{@ID}" tabindex = '0' onkeydown="return handleTabKeys(this,event)" onmouseover= "this.className='Htabover'" onblur="this.className='Htaball'"  onmouseout="this.className='Htaball'" objClicked="false">
...
<!-- End of ExtTabs.xsl -->
    ...
    <xsl:template match="SCREEN">
		...
		<div class="DIVHeaderBodyContainer" id="DIVMainTmp"><!-- Fix for Bug 16700426 and 16785227 - removed attribute style="overflow-x:hidden" from div element -->
    ...
    <xsl:template match="BODY/TAB">
        ...
        <xsl:if test="$tabCount &gt; 1">
            <div class="DIVtabC" id="tabcontentcontainer">
                <xsl:variable name="sc">
                    <xsl:number value="position()" format="1"/>
                </xsl:variable>
                <div class="DIVtabP" id="TBLPage{@ID}">
    ...
    <xsl:template name="SubSysBtns_tmp">
        <div class="subSystemContainer DIVAbutton"> 
        <div class="DIVAbutton" id="DIVSubSystem" style="width:98%">
            <ul>
                <xsl:for-each select="//*[name() = 'SCREEN' and @NAME =  $screen]/*[name() ='SUBSCREEN']/FORM">
                    ...
                    <li id="{@id}">
                        <a href="#" class="Abutton" tabindex="0" onmouseover="this.className='AbuttonH'" onfocus="this.className='AbuttonH'" onmouseout="this.className='Abutton'" onblur="this.className='Abutton'" onkeydown="return fnhandleSubScrBtn(event)">
                            <xsl:attribute name="onclick">
                                <xsl:if test="@TYPE = 'S'">
                        ...
                        <xsl:choose>
                          <xsl:when test="position() != last()">
                            <a tabindex="0" href="#" class="Abutton">|</a>
                          </xsl:when>
                        </xsl:choose>
         ...
         <div  id="DIVSubSystemController" style="width:2%;">
              <button class="BTNicon" title="$expand_section" id="BtnSubSysNav" onclick="fnExpandCollapseSubSys(this);"><span class="subSystemExpand"></span></button> 
        </div>
        </div>
