...
<body class="BODYDetails" style="background-color:#ffffff" onkeydown="return shortcut(event)" onload="fnLoad();getSchemadetails();">
...
<SELECT aria-required="false" class="SELstd" type="text" name="CONNECT_TO" id="CONNECT_TO" onchange="fncontobulk();">
...
<BUTTON class="BTNimg" title="List Of Values" tabindex="-1" style ="visibility:hidden" id="BTN_XELEASE_NAME" onclick="deleteAll('XSDBULKGEN');LOV_XREL_CODE.show_lov('XELEASE_NAME~TYPE_SYSTEM~','frmTCM','', 'Release Code', 'Release Code~Type System', 'Release Code~Type System',event);"><span class="ICOlov"></span></BUTTON>
</div>

<div class="DIVText" >
<LABEL class="LBLstd" for="DEST_XML">Destination Path</LABEL>
<INPUT aria-required="false"  class="TXTstd" type="text"  id="DEST_XML" name="DEST_XML" value=""  size="35">
</div>
...
<div class="DIVMultipleBig" style="position:relative; margin-left:20px; margin-right:20px;width:95%;">
	<div class="DIVmultiplebox">
		<div class="DIVMultipleBigInner" style="height:400px;overflow-x:hidden"  >
			<table id="XSDBULKGEN" name="XSDBULKGEN" summary="Multi Tenor" width="100%" TYPE="MULTIPLE" class="TBLgrid" caption="Multi Tenor" border="0" cellpadding="0" cellspacing="0">
			   <thead>
					<tr>
						<th scope="col" class="THgrid1"><INPUT aria-required="false" title="Select All Rows" id="SEL_ALL_PREF" name="SEL_ALL_PREF" class="CHKstd" type="checkbox" onclick="checkAll('XSDBULKGEN','checkgroup','SEL_ALL_PREF')"><span class="LBLinv">Select All Rows</span></th>
						<th scope="col" class="THgrid" ><span class="SPNtext">Service Name</span></th>
		...
		<div style="float:right;padding-right:20px;padding-top:25px;">
			<BUTTON class="BTNfooter" style="height:25px;width:80px;"  name="OK"  id="ok"  onclick="fnBulkGeneratexsd('XSDBULKGEN')">Generate</BUTTON>
