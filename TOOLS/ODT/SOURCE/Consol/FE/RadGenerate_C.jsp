	...
	<div class="DIVmultiplebox">
		<div class="DIVMultipleBigInner" style="width:100%;overflow-x:hidden"  >
			<table role="presentation" onKeyDown="FnAcessTblkeys(this,event);"  id="RDGENTBL" name="RDGENTBL" width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
					...
					<tr>
						<td>&nbsp;</td>
						<td><INPUT aria-required="false" type="checkbox" id="ELCM_DTO_CLASS" name="ELCM_DTO_CLASS" ><LABEL for="ELCM_DTO_CLASS" id="ELCMDTOCLASS">ELCM DTO Class</LABEL></td>
...
<div style="float:right;padding-right:40px;padding-top:25px;"> 
		<BUTTON class="BTNfooter" name="OK"  id="Gen_ok" onclick="if(isNotDoubleClick('Gen_ok'))createxml();"   style="visibility:visible;height:25px;width :70px;">Ok</BUTTON>&nbsp;
