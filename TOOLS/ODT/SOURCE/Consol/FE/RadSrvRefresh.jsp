...
%>
   ...
   <head>
		...
		<script type="text/javascript" src="Script/JS/RadSrvGenerate.js"></script>
...
<div class="WNDcontainer" id="DIVWNDContainer">
    <div class="WNDtitlebar" id="WNDtitlebar" >
        <div class="WNDtitle" id="wndtitle" onmousedown="startDrag(seqNo, event)"> <h1 class="WNDtitletxt">Service Refresh</h1>
