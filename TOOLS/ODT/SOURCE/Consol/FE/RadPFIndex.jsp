...
<html lang="en" >
    <head>
        ...
        <script type="text/javascript" src="Script/JS/RadPFAccessibility.js"></script>		  
	    ...
	    <script>
             ...
             function fnLoadRad()
               {
			    setInnerText(document.getElementById("fnTtl"),"Purge Generation");
...
<div class="WNDcontainer" id="DIVWNDContainer" border="2">
    <div class="WNDtitlebar" id="WNDtitlebar" >
        <div class="WNDtitle" id="wndtitle" onmousedown="startDrag(seqNo, event)"> <h1 class="WNDtitletxt" id="fnTtl"></h1>
            <div class="WNDbuttons">
				<a class="WNDcls" href="#nogo" onblur="this.className='WNDcls'" onmouseover="this.className='WNDclsH'" onfocus="this.className='WNDclsH'" onmouseout="this.className='WNDcls'" title="Close" id="RADPFINDEXCLOSE" name="RADPFINDEXCLOSE" onclick="fnRADExitAll(seqNo, event)">
					<span class="LBLinv">Close</span>
				</a>
				<a class="WNDmin" href="#nogo" onblur="this.className='WNDmin'" onmouseover="this.className='WNDminH'" onfocus="this.className='WNDminH'" onmouseout="this.className='WNDmin'" title="Minimize" id="RADPFINDEXMIN" name="RADPFINDEXMIN" onclick="fnMinimize(seqNo, event)">
    ...
    <div class="WNDcontent" id="DIVScrContainer">
        <div id="ResTree">      
            <div id="Dtop" >
                <jsp:include page="RadPFMain.jsp" flush="true" /> 
            </div>               
            <div id="Dleft" style="background-color: rgb(85, 113, 118);">						
                <jsp:include page="RadPFTree.jsp" flush="true" />
            </div>
            <div  id="Dright" style="display:block">              
                <jsp:include page="RadPFDetails.jsp" flush="true" />                
            </div>
        </div>
    </div>  
</div>
