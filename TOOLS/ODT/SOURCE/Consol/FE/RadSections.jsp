...
<div class="DIVText"  >
<LABEL class="LBLstd" for="SECTION_LABEL">Section Label</LABEL>
<INPUT aria-required="false" class="TXTstd" type="text" name="SECTION_LBL" id="SECTION_LABEL" value="" onchange="FnCheckSecVal()" size="40">
<BUTTON class="BTNimg"  title="List Of Values" tabindex="-1"  id="BTN_LBL_SEC" onclick="LOV_LABEL_CODE.show_lov('SECTION_LABEL~','frmScrSnm','', 'Label Code', 'Label Code~Label Description', 'Label Code~Label Description',event)">
