...
<html lang="en" >
    <head>
	    ...
	    <script type="text/javascript" src="Script/JS/RadUtil_C.js"></script>
        <script type="text/javascript" src="Script/JS/RadLoadandGen_C.js"></script>
        <script type="text/javascript" src="Script/JS/RadUIUtils_C.js"></script>
        <script type="text/javascript" src="Script/JS/RadValidations_C.js"></script>		
        <script type="text/javascript" src="Script/JS/RadMultipleTables_C.js"></script>
		...
		<script type="text/javascript" src="Script/JS/RadGlobals_C.js"></script>
        <script type="text/javascript" src="Script/JS/RadTree_C.js"></script>
		<script type="text/javascript" src="Script/JS/RadDomCreator_C.js"></script>
        <script type="text/javascript" src="Script/JS/RadHandler_C.js"></script>
        ...
        <script type="text/javascript" src="Script/JS/RadHeader_C.js"></script> 
	  ...
	  function fnLoadRadXMLFORNONIE(p_funcId)
		...
		function fnsetTitle(){ 
				  if(parent.gwinFuncId=="RDDFNCGN" || parent.gwinFuncId=="RDDLNPGE"){
						 setInnerText(document.getElementById("fnTtl"),"Customer Landing Page");
...
<body  onload="fnsetTitle();getSchemadetails();loadDOM();fnLoadRad();enableHeaderAction();disableAll2();paintTreeMenu();getGlobalLovs();disableHeaderButtons();" onclick ="setWindowAct();" onKeyDown="return shortcut(event)" onKeyDown="parent.windowCtrl(event);" onhelp="disableDefault();">         
    <div class="WNDcontainer" id="DIVWNDContainer" border="2">
            ...
            <div class="WNDcontent" id="DIVScrContainer">
              <div id="ResTree">        
                <div id="Dtop">
                   <jsp:include page="RadMain_C.jsp" flush="true" /> 
                </div>  
                <div id="Dleft" style="display:block">						
                    <jsp:include page="RadTree_C.jsp" flush="true" />
                </div>             
                <div  id="Dright" style="display:block">              
                <jsp:include page="RadDetails_C.jsp" flush="true" />                
                </div>                
              </div>            
            </div>         
        </div>
