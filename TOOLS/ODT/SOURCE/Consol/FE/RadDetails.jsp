...
<html lang="en" >
    ...
    <body class="BODYDetails">
        ...
        <div id="SSC" style="display:none; "><%@include file="RadScreens.jsp"%></div>
		...
		<div id="TAB" style="display:none; "><%@include file="RadTabs.jsp"%></div>
        <div id="SEC" style="display:none; "><%@include file="RadSections.jsp"%></div>
        <div id="FLD" style="display:none; "><%@include file="RadFieldSetGrid.jsp"%></div>
        <div id="FDN" style="display:none; "><%@include file="RadFieldSet.jsp"%></div>
        ...
        <div id="SUM" style="display:none; "><%@include file="RadSummary.jsp"%></div>
