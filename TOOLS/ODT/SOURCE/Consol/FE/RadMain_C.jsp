...
<td align="center" width="25px"><BUTTON class="BUTTONToolbar" title="Labels" name="missingLabels" id="missingLabels" onclick="if(isNotDoubleClick('missingLabels')) fnfetchmissingLabelCodes();fnMissinglabels();"><img  src="Images/Label.gif" alt="Labels" ></BUTTON></td>
...
<div class="DIVHeader" style="width:100% ">
			<table role="presentation" summary="" class="TABLELyt" width="100%"  border="0" TYPE="SINGLE" NAME="RADMN" id="RADMN" VIEW="NO" cellpadding="1" cellspacing="0">
                        ...
                        <option selected="OTHERS" value="OTHERS">Detail</option>
		...
		<div style="display:none">
					...
					<SELECT aria-required="false" name="FUNCTION_TYPE" id="FUNCTION_TYPE" style="visibility:hidden;width:1px">
					<option value="LNC">Master</option>
					<option selected="LNM" value="LNM">Child</option> 
					</SELECT>
