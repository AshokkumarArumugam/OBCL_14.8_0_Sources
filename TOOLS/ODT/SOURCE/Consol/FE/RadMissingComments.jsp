<!--
  **
  **
  ** File Name  : RadMissingComments.jsp
  **
  ** 
...
<head>
	...
	<script type="text/javascript" src="Script/JS/RadCommentCode.js"></script>
...
<div  id="DIVWNDContainer1"> 
	<div class="WNDtitlebar" id="WNDtitlebar" >
		<div class="WNDtitle" onmousedown="startDrag('ChildWin', event)"><h1 class="WNDtitletxt">Comments</h1>                                      
...
<div  class="DIVMultipleBig" id="ResTree"  style="height:500px;position:relative; margin-top:40px; margin-left:20px; margin-right:20px;width:95%">
	<div class="MEButtons"  id="mlabelCode_ME" name="mlabelCode_ME">
        ...
        <BUTTON class="BTNimg" title="Add Row" onclick="addNewRow('mannotationCode')" name="ADD" value="ADD"><img src="Images/Addrow.gif" alt="Add Row"></BUTTON>
        <BUTTON class="BTNimg" title="Remove Row" name="DEL" value="DEL" class="trigger" onclick="delRow('mannotationCode')"><img src="Images/Delrow.gif" alt="Del Row"></BUTTON>&nbsp;&nbsp;   
  	</div> 
	<div class="DIVmultiplebox">
		<div class="DIVMultipleBigInner" style="height:440px;overflow-x:hidden" >
			<table onKeyDown="FnAcessTblkeys(this,event);"  id="mannotationCode" name="mannotationCode" summary="Multi Tenor" width="100%" TYPE="MULTIPLE" PARENT="YES" VIEW="NO"  class="TBLgrid" caption="Multi Tenor" border="0" cellpadding="0" cellspacing="0">
			    <thead>
			    	<tr>
			    	<th scope="col" class="THgrid1"><INPUT aria-required="false" title="Select All Rows" id="SEL_ALL_PREF" name="SEL_ALL_PREF" class="CHKstd" type="checkbox" onclick="checkAll('mannotationCode','checkgroup','SEL_ALL_PREF')"><span class="LBLinv">Select All Rows</span></th>
			    	<th scope="col" class="THgrid"><span class="SPNtext">Comment Id</span></th>
			    	<th scope="col" class="THgrid"><span class="SPNtext">Comment Description</span></th>					
			    	<th scope="col" class="THgrid"><span class="SPNtext">Operation</span></th>
			    	</tr>
			    </thead>
			    <tbody></tbody>
			    <tfoot><tr><td scope="row" tabindex="0" id="mannotationCode_TE" name="mannotationCode_TE" colspan="8"><span class="LBLinv">End of table</span>&nbsp;</td></tr></tfoot>
			</table>
		</div>
	</div>
	<div style="text-align:right; margin-top:10px; clear:both">
        <BUTTON class="BTNfooter" id="FetchAll" onclick="fnLoadAlllabels(document.getElementById('mannotationCode'));" style="height:25px;width :150px;">Fetch All Comments</BUTTON>
		<BUTTON class="BTNfooter" id="Fetch" onclick="fnLoadmissinglabels(document.getElementById('mannotationCode'));" style="height:25px;width :180px;">Fetch Missing Comments</BUTTON>		
