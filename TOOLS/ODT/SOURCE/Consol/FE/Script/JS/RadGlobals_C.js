...
elementArray_Actions['RAD_ACTIONS'] = "RAD_XSD_TYPE_NAME~OPERATION_ID~SERVICE_NAME~XSD_MODULE_FOLDER";
elementArray_Actions['RAD_ACTION'] = "ACTION_CODE~OPERATION_CODE~WEBSERVICE_APPLICABLE~ACTION_STAGE_TYPE";
var elementArray_Summary = new Array();
elementArray_Summary['RAD_SUMMARY'] = "TITLE~RAD_SUMMARY_WHERECLAUSE~RSLT_DATABLK~RSLT_DATASRC~SUMMARY_TYPE~RAD_SUMMARY_ORDERBY~RAD_MULTIBRN_WHERECLAUSE~MAIN_SUMM_SCR~SUM_SCREEN_SIZE~SUMMARY_WEBSERVICE_REQD~SUM_QUERYORDER~SUM_RESULTORDER~BLIND_SEARCH~DETAIL_REQ~SUM_RESULT_ROWS";
elementArray_Summary['SUMMARY_DETAILS'] = "FIELD_NAME~QUERY~A_QUERY~RESULT";
...
elementArray['RAD_DATASOURCES'] = "DATASRC_NAME~DATASRC_ALIAS~PARENT_DATASRC~RELATION_WITH_PARENT~RELATION_TYPE~DEFAULT_WHERE~IS_MANDATORY~MULTI_RECORD~MASTER_DATASRC~PK_COLS~PK_TYPES~DEFAULT_ORDER_BY~DATASRC_TYPE~CHILD_DATASRC~RELEASE_TYPE~RELEASE_NAME~UPLOAD_TABLE~UP_TBL_PK_COLS~UP_TBL_WHERE_CLAUSE";
...
elementArray['RAD_TABS'] = "TAB_NAME~SCREEN_NAME~TAB_LABEL~RELEASE_TYPE~RELEASE_NAME~DEPENDENT_ON~TAB_TYPE~TAB_VISIBLE~TAB_ORDER~TAB_FUNC_ID";
elementArray['RAD_SECTIONS'] = "SECTION_NAME~SCREEN_PORTION~TAB_NAME~RELEASE_TYPE~RELEASE_NAME~SEC_VISIBLE~SEC_ORDER~COLLAPSE~COLLAPSE_EXPAND~SECTION_LBL~MULTIPLE_SEC~SECTION_FUNC_ID~SECTION_TYPE";
elementArray['RAD_DATA_BLOCKS'] = "BLOCK_NAME~BLOCK_TITLE~MASTER_BLOCK~VIEW_TYPE~MULTI_RECORD~BLOCK_PARENT~XSD_NODE~RELATION_TYPE~BLOCK_TYPE~RELEASE_TYPE~RELEASE_NAME~NEW_ALLOWED_IN~DELETE_ALLOWED_IN~ALL_RECORDS~MANDATORY_IN~BLK_PK_FLD~DATA_BLK_ORDER~BLK_ANNOTATION";
//VINIT
elementArray['RAD_BLK_FIELDS'] = "FIELD_NAME~FIELD_SIZE~DATATYPE~MAX_LENGTH~REQUIRED~DISPLAY_TYPE~CLASSID~LABEL_CODE~DEFAULT_VALUE~RELATED_BLOCK~RELATED_FIELD~PARENT_FIELD~LOV_NAME~GLOBAL_LOV_NAME~OFF_LINE_LOV_NAME~GLOBAL_OFF_LINE_LOV_NAME~POPEDIT_REQUIRED~INPUT_ONLY_BY_LOV~XSD_TAG~FLD_ANNOTATION~DBT~DBC~FIELDSET_NAME~READ_ONLY~CALENDAR_TEXT~SUBSYSTEM_DEPENDANT~MIN_VAL~MAX_VAL~MAX_DECIMALS~CHECKED~TXTAREA_ROWS~ITEM_TYPE~VISIBLE~CHK_UPPERCASE~TXTAREA_COLS~AMENDABLE_IN~RELEASE_TYPE~RELEASE_NAME~NOT_REQD_IN_XSD~LOV_VAL_REQ~PREVIEW_VALUE~MASK_ID~BLK_FIELD_ORDER~REPORT_PARAMETER~XSD_ANNOTATION~FORMAT_REQD~HOTKEYREQ~FOCUSREQ~EXACT_FETCH~CHK_TRIM";
...
elementArray['RAD_LOVS'] = "LOV_NAME~LOV_QUERY~RELEASE_NAME~RELEASE_TYPE";
...
elementArray['RAD_MAIN'] = "FUNCTION_ID~FUNCTION_TYPE~FUNCTION_CATEGORY~FUNCTION_ORIGIN~RELEASE_TYPE~CALL_FORM_TYPE~PARENT_ORIGIN~LANG_CODE~OPERATION~ORIGINATION_DATE~USER_ID~RELEASE_CODE~MODIFIED_IN_KERNEL~MODIFIED_IN_CLUSTER~MODIFIED_IN_CUSTOM~MODIFIED_IN_CUSTOMER~PARENT_MODIFIED_IN_KERNEL~PARENT_MODIFIED_IN_CLUSTER~PARENT_MODIFIED_IN_CUSTOM~PARENT_MODIFIED_IN_CUSTOMER~TEMP_CORRECTION_DONE~ORDER_CORRECTION_DONE~LANDING_PAGE_COMPONENT";
...
elementArray['RAD_ACTION'] = "ACTION_CODE~OPERATION_CODE~WEBSERVICE_APPLICABLE~ACTION_STAGE_TYPE";
elementArray['RAD_SUMMARY'] = "TITLE~RAD_SUMMARY_WHERECLAUSE~RSLT_DATABLK~RSLT_DATASRC~SUMMARY_TYPE~RAD_SUMMARY_ORDERBY~RAD_MULTIBRN_WHERECLAUSE~MAIN_SUMM_SCR~SUM_SCREEN_SIZE~SUMMARY_WEBSERVICE_REQD~SUM_QUERYORDER~SUM_RESULTORDER~BLIND_SEARCH~DETAIL_REQ~SUM_RESULT_ROWS";
elementArray['SUMMARY_DETAILS'] = "FIELD_NAME~QUERY~A_QUERY~RESULT";
...
elementArray['RAD_FUNC_PREFERENCES'] = "MODULE_ID~MODULE_DESC~AUTO_AUTH~HO_FUNCTION~LOGGING_REQD~FIELD_LOG_REQD~BRANCH_PROGRAM_ID~PROCESS_CODE~TANK_MODIFICATIONS~VCS_FOLDER~TXN_BLOCK_NAME~TXN_FIELD_NAME~MULTI_BRANCH_ACCESS~EXPORT_REQD~ELCM_FUNCTION~MODULE_GROUP_ID~MODULE_AUTO_AUTH";
...
nodeNonCompareArray['RAD_DATA_BLOCKS'] = "FIELDSET_NAME~RELEASE_TYPE~RELEASE_NAME";
nodeNonCompareArray['RAD_BLK_FIELDS'] = "GLOBAL_LOV_NAME~GLOBAL_OFF_LINE_LOV_NAME~NOT_REQD_IN_XSD~FIELDSET_NAME~RELEASE_TYPE~RELEASE_NAME~PREVIEW_VALUE";
nodeNonCompareArray['BLK_DATASOURCES'] = "FIELDSET_NAME~RELEASE_TYPE~RELEASE_NAME";
nodeNonCompareArray['RAD_CALLFORM'] = "CHILD_CALLFORM~FIELDSET_NAME~RELEASE_TYPE~RELEASE_NAME~CALLFORM_MST_DATA_SRC~CALLFORM_MST_BLOCK~CALLFORM_MST_XSD_NODE~CALLFORM_XSD_TYPE_DESC~CALLFORM_MST_MULTI_REC~CALLFORM_MODULE~IS_UPLOAD_TABLE_PRESENT";
