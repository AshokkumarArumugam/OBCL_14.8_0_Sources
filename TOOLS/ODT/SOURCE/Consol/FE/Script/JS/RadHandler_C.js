...
function enableCustAttributes() {
    ...
    if (document.getElementById("XSD_TAG").value == "") {
        document.getElementById("FLD_ANNOTATION").disabled = true;
        document.getElementById("FLD_ANNOTATION").className = "TXTro";
    }
    else {
        document.getElementById("FLD_ANNOTATION").disabled = false;
        document.getElementById("FLD_ANNOTATION").className = "TXTstd";
...
function fn_show_Fields_SEC(){
if(document.getElementById("FUNCTION_CATEGORY").value =="MASTER"){
document.getElementById("PARTITION_DETAILS_DIV").style.display = "none";
document.getElementById("SECTION_FUNC_ID_DIV").style.display = "block";
document.getElementById("MULTIPLE_SECTION_DIV").style.display = "none";
document.getElementById("COLLAPSE_SEC_DIV").style.display = "none";
document.getElementById("SECTION_TYPE_DIV").style.display = "block";
}
else{
document.getElementById("PARTITION_DETAILS_DIV").style.display = "block";
document.getElementById("SECTION_FUNC_ID_DIV").style.display = "none"; 
document.getElementById("MULTIPLE_SECTION_DIV").style.display = "block";
document.getElementById("COLLAPSE_SEC_DIV").style.display = "block";
document.getElementById("SECTION_TYPE_DIV").style.display = "none";
} 
}

function fn_show_Fields_TABS(){
if(document.getElementById("FUNCTION_CATEGORY").value =="TABS"){
document.getElementById("TAB_TYPE_TABS_DIV").style.display = "block";
document.getElementById("TAB_FUNC_ID_DIV").style.display = "block"; 
}
else{ 
document.getElementById("TAB_TYPE_TABS_DIV").style.display = "none";  
document.getElementById("TAB_FUNC_ID_DIV").style.display = "none";
} 
}