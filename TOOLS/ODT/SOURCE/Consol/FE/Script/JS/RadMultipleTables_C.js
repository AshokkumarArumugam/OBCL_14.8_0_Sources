...
function getTabelRow(tableName) {
    ...
    if (tableName == 'datasources') {
        ...
        trow = "<TD><INPUT aria-required=\"false\" type=checkbox name=checkgroup id=checkgroup> </TD>" + "<TD><INPUT aria-required=\"false\" id=ATTR_NAME size=40 name=ATTR_NAME type=\"text\"><BUTTON class=\"BTNimg\" title=\"List Of Values\" tabindex=\"-1\"  onclick=\"LOV_LABEL_CODE.show_lov('ATTR_NAME~','frmBlkFldDtls','', 'Label Code', 'Label Code~Label Description', 'Label Code~Label Description',event)\"><span class=\"ICOlov\"></span></BUTTON></TD>" + "<TD><INPUT aria-required=\"false\" id=ATTR_VALUE size=75 name=ATTR_VALUE type=\"text\"> </TD>" + "<TD><SELECT aria-required=\"false\" id=ACTIVE  name=ACTIVE onchange=\"fnAttrival(event)\"><OPTION value=Y>Yes</OPTION> <OPTION value=N>No</OPTION></SELECT></TD>" + "<TD><INPUT aria-required=\"false\" id=ATTR_POSITION  name=ATTR_POSITION type=\"text\"> </TD>" + "<TD><INPUT aria-required=\"false\" id=SELECTED  name=SELECTED  type=hidden ></TD>" + "<TD><INPUT aria-required=\"false\" id=RELEASE_TYPE name=RELEASE_TYPE   type=hidden></TD>" + "<TD><INPUT aria-required=\"false\" id=RELEASE_NAME   name=RELEASE_NAME   type=hidden></TD>"
    }
	...
	*/
        ...
        trow = "<TD align=\"center\"><INPUT aria-required=\"false\" type=checkbox name=checkgroup id=checkgroup></TD>" + "<TD><INPUT aria-required=\"false\" size=\"20\" STYLE=\"width: 130px\" name=\"FIELD_NAME\" id=\"FIELD_NAME_GRID\" readonly=\"yes\" font=\"Arial\" type=\"text\" ></TD>" + "<TD  align=\"left\"><INPUT aria-required=\"false\" type=checkbox name=\"QUERY\" id=\"QUERY\"  ></TD>" + "<TD  align=\"center\"><INPUT aria-required=\"false\" type=checkbox name=\"A_QUERY\" id=\"A_QUERY\"  ></TD>"  + "<TD  align=\"center\"><INPUT aria-required=\"false\" type=checkbox name=\"RESULT\" id=\"RESULT\"  ></TD>"
    }
...
function addTableRow(tableName) {
    ...
    for (var j = 0;j < trCellArray.length - 1;j++) {
		...
		if(tableName=="SUM_DTLS")
		{
		newRow.cells[j].setAttribute("align", "center");
		}
