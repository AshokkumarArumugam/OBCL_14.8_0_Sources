/*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : RADDragNDropHandler.js
  **
  ** 
...
var list = new Image();
var list2 = new Image();
//imageFolder = 'FCJRADTool/../Images/';
closefolder = 'FCJRADTool/../Images/dhtmlgoodies_plus.png';
openfolder = 'FCJRADTool/../Images/dhtmlgoodies_minus.png';
//list = 'FCJRADTool/../Images/dhtmlgoodies_folder.gif';
//list2 = 'FCJRADTool/../Images/dhtmlgoodies_folder.gif';
...
, 
  ...
  /*  setFolderImage : function (imagePath) {
    ...
    fnAccesstree : function (e, inputId) {
        ...
        if (thisNode != undefined) {
            ...
            if (e.keyCode == 9) {
                ...
                var ul = parentNode.getElementsByTagName('UL')[0];
                if (ul) {
                    if (ul.getElementsByTagName("A")[0])
                        ul.getElementsByTagName("A")[0].focus();
                }
            }
                ...
                if (getToolBarPreviousSibling(elem.parentNode) != null) {
                    ...
                    try {
                        ...
                        if (getToolBarPreviousSibling(elem.parentNode.parentNode) != null)
                            getToolBarPreviousSibling(elem.parentNode.parentNode).parentNode.focus();
                    }
                }
            }
            if (e.keyCode == 13) {
                ...
                gndt[12] = "PFD";
				 gndt[13] = "PCL";
                for (var gn = 0;gn < gndt.length;gn++) {
                    if (gndt[gn] == (elem.id).substring(1, 4)) {
                        getNodeDetails((elem.id).substring(1, 4));
                        return;
                    }
                    else if (gndt[gn] == (elem.id).split("~")[0]) {
                        getNodeDetails(elem.id);
                        return;
                    }
                }
            }
    ...
    initDrag : function (e) {
        if (this.tagName == 'IMG') {
            getNodeDetails(this.nextSibling.id);
        }
    ...
    initTree : function () {
        ...
        for (var no = 0;no < menuItems.length;no++) {
            try {
                var imt = menuItems[no].firstChild.tagName;
                // No children var set ?
        ...
        if (initExpandedNodes) {
            ...
            for (var no = 0;no < nodes.length;no++) {
                if (nodes[no]) {
                    ...
                    this.fnAccesstree(event, nodes[no]);
                }
            }
        }
