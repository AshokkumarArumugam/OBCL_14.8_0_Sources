create or replace force view olvw_cusip_entries_history 
as
/*----------------------------------------------------------------------------------------------------
**
** File Name	: olvw_cusip_entries_history.vw
**
** Module	: INTERFACE
**
**
...
-- 27-NOV-2012 FLEXCUBE Universal Banking 3.3.0.0.0CITI_R712 RETRO  15185 changes starts
--where  delete_stat <> 'D'
where  NVL(delete_stat,'X') <> 'D'
-- 27-NOV-2012 FLEXCUBE Universal Banking 3.3.0.0.0CITI_R712 RETRO  15185 changes ends
/