CREATE OR REPLACE force VIEW olvw_product_currency_pairs ( PRODUCT_CODE, 
BOT_CCY, SOLD_CCY ) AS 
/*-----------------------------------------------------------------------------------------------
**
** File Name    : olvw_product_currency_pairs.VW
**
...
*/
(( SELECT PR.product_code product_code
 	, CCY1.ccy_code bot_ccy
 	, CCY2.ccy_code sold_ccy
 ...
 AND	 CCY1.auth_stat = 'A'
 AND	 CCY1.record_stat = 'O'
 AND	 CCY2.auth_stat = 'A'
 AND	 CCY2.record_stat = 'O'
 AND	 CCY1.ccy_code <> CCY2.ccy_code
 MINUS
 SELECT PR.product_code product_code
 	, PRCCY.bought_deal_ccy bot_ccy
 	, PRCCY.sold_ccy sold_ccy
 FROM oltms_product PR
 	, oltms_product_ccy_disallow PRCCY
 WHERE PR.currencies_list = 'D'
 AND	 PRCCY.product_code = PR.product_code
...
--OBCL_14.3_SUPPORT_BUG#31381563 CHANGES ENDS
 ...
 AND CCY1.ccy_code <> CCY2.ccy_code
/
create or replace synonym olvws_product_currency_pairs  for olvw_product_currency_pairs 
/