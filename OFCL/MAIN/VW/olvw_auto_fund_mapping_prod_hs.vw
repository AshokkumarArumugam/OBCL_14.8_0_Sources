CREATE OR REPLACE FORCE VIEW olvw_auto_fund_mapping_prod_hs(PRODUCT_CODE,PRODUCT_DESCRIPTION,PRODUCT_TYPE,BRANCH_CODE,DEPARTMENT_CODE) AS 
/*----------------------------------------------------------------------------------------------------
**
** File Name	: olvw_auto_fund_mapping_prod_hs.VW
**
