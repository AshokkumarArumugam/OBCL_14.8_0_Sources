...
olvw_treasury_queue_hst(ROW_ID,MODULE_CODE,DEPARTMENT_CODE,BRANCH,TREASURY_SOURCE,CONTRACT_REF_NO,USER_REF_NO,CUSTOM_REF_NO,EVENT_SEQ_NO,EVENT_CODE,COUNTERPARTY,BOOKING_DATE,DEAL_DATE,VALUE_DATE,MATURITY_DATE,CURRENCY,AMOUNT,WORKFLOW_STATUS,RATE_REVISION_STATUS) AS
/*----------------------------------------------------------------------------------------------------
**
** File Name	: olvw_treasury_queue_hst.VW
**
