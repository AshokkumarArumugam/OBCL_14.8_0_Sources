CREATE OR REPLACE FORCE VIEW	olvw_unmatched_movements
AS
/*----------------------------------------------------------------------------------------------------
**
** File Name	: olvw_unmatched_movements.VW
**
...
05-JAN-2005	PLC46080023		Retro of PLC40506065 - Lcy had been hard-coded to GBP.  This has been replaced to global.lcy
---------------------------------------------------------------------------------------------------- 
*/
SELECT		module,
		trn_ref_no,
...
/
CREATE OR REPLACE SYNONYM olvws_unmatched_movements FOR olvw_unmatched_movements
/