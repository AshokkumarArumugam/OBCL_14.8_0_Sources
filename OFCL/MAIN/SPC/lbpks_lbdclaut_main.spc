CREATE OR REPLACE PACKAGE  lbpks_lbdclaut_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdclaut_main.spc
  **
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdclaut          IN OUT  lbpks_lbdclaut_Main.Ty_lbdclaut,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_lbdclaut          IN lbpks_lbdclaut_Main.Ty_lbdclaut,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdclaut     IN  lbpks_lbdclaut_Main.Ty_lbdclaut,
p_Wrk_lbdclaut      IN OUT  lbpks_lbdclaut_Main.Ty_lbdclaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdclaut     IN  lbpks_lbdclaut_Main.Ty_lbdclaut,
p_Prev_lbdclaut IN OUT  lbpks_lbdclaut_Main.Ty_lbdclaut,
p_Wrk_lbdclaut      IN OUT  lbpks_lbdclaut_Main.Ty_lbdclaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbdclaut     IN  lbpks_lbdclaut_Main.Ty_lbdclaut,
p_Prev_lbdclaut     IN  lbpks_lbdclaut_Main.Ty_lbdclaut,
p_Wrk_lbdclaut      IN OUT  lbpks_lbdclaut_Main.Ty_lbdclaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbdclaut IN  lbpks_lbdclaut_Main.Ty_lbdclaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdclaut_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdclaut_main FOR lbpks_lbdclaut_main
/