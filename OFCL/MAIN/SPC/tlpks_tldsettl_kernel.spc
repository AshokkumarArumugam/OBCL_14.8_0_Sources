CREATE OR REPLACE PACKAGE  tlpks_tldsettl_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldsettl_kernel.spc
  **
...
END tlpks_tldsettl_kernel;
/
CREATE OR REPLACE SYNONYM tlpkss_tldsettl_kernel FOR tlpks_tldsettl_kernel
/