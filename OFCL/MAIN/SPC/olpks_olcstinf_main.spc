CREATE OR REPLACE PACKAGE  olpks_olcstinf_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_olcstinf_main.spc
  **
...
TYPE ty_tb_olvw_settlement_info__as IS TABLE OF olvw_settlement_info%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_lvw_settlement_info__det IS TABLE OF olvw_settlement_info%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_olcstinf IS RECORD (
     v_olvw_settlement_info     olvw_settlement_info%ROWTYPE,
     v_olvw_settlement_info__as    ty_tb_olvw_settlement_info__as,
     v_olvw_settlement_info__det    ty_tb_lvw_settlement_info__det,
...
p_Wrk_olcstinf IN  olpks_olcstinf_Main.Ty_olcstinf,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_olcstinf_main;
/
CREATE OR REPLACE SYNONYM olpkss_olcstinf_main FOR olpks_olcstinf_main
/