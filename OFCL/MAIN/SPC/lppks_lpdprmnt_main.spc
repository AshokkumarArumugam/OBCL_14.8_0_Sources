CREATE OR REPLACE PACKAGE  lppks_lpdprmnt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lppks_lpdprmnt_main.spc
  **
...
TYPE ty_lpdprmnt IS RECORD (
     v_oltms_product     oltm_product%ROWTYPE,
     v_lptms_product_master     lptm_product_master%ROWTYPE,
                 ...
                 ty_lfclpicf Lfpks_Lfclpicf_Main.ty_lfclpicf,
...
FUNCTION Fn_Get_Key_Information (p_Source    IN  VARCHAR2, 
                        ...
                        p_Function_id       IN     VARCHAR2,
                        p_Action_Code       IN     VARCHAR2,
p_lpdprmnt       IN  OUT lppks_lpdprmnt_Main.Ty_lpdprmnt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lppks_lpdprmnt_main;
/
CREATE OR REPLACE SYNONYM lppkss_lpdprmnt_main FOR lppks_lpdprmnt_main
/