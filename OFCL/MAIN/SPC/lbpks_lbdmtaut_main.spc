CREATE OR REPLACE PACKAGE  lbpks_lbdmtaut_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdmtaut_main.spc
  **
...
TYPE ty_tb_v_lbtbs_borrower_payment IS TABLE OF lbtb_borrower_payment%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbdmtaut IS RECORD (
     ...
     v_lbtbs_borrower_payment    ty_tb_v_lbtbs_borrower_payment,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdmtaut          IN OUT  lbpks_lbdmtaut_Main.Ty_lbdmtaut,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Wrk_lbdmtaut IN  lbpks_lbdmtaut_Main.Ty_lbdmtaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdmtaut_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdmtaut_main FOR lbpks_lbdmtaut_main
/