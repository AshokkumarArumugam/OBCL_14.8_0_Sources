CREATE OR REPLACE PACKAGE  olpks_oldccyrf_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldccyrf_main.spc
  **
  ** Module     : OL
  ** 
...
TYPE ty_oldccyrf IS RECORD (
     v_ccy_rate_fixing_days     oltm_ccy_rate_fixing_days%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldccyrf_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldccyrf_main FOR olpks_oldccyrf_main
/