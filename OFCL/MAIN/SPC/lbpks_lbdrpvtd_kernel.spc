CREATE OR REPLACE PACKAGE  lbpks_lbdrpvtd_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdrpvtd_kernel.spc
  **
  ...
  ** India
  ...
  Change Description : OBCL_14.5_LS_Restructure_Contract_Service
...
END lbpks_lbdrpvtd_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdrpvtd_kernel FOR lbpks_lbdrpvtd_Kernel
/