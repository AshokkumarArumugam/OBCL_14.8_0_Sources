CREATE OR REPLACE PACKAGE lbpks_upload_addon_cluster IS

  /*------------------------------------------------------------------------------
  ** File Name      : lbpks_upload_addon_cluster.SPC
  **
...
FUNCTION fn_PRE_upload_contract(PSOURCECODE            IN OLTBS_UPLOAD_MASTER.SOURCE_CODE%TYPE,
                              ...
                              l_Tb_Cluster_Data     in out Global.Ty_Tb_cluster_Data, --custom data
...
END lbpks_upload_addon_cluster;
/