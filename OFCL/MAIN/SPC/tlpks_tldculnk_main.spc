CREATE OR REPLACE PACKAGE  tlpks_tldculnk_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldculnk_main.spc
  **
...
TYPE ty_tb__lbtb_cusip_swing_detail IS TABLE OF lbtb_cusip_swing_detail%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_tldculnk IS RECORD (
     v_lbtbs_cusip_swing_master     lbtb_cusip_swing_master%ROWTYPE,
     v_lbtb_cusip_swing_detail    ty_tb__lbtb_cusip_swing_detail,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tldculnk_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tldculnk_main FOR tlpks_tldculnk_main
/