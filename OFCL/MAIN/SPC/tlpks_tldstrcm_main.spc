CREATE OR REPLACE PACKAGE  tlpks_tldstrcm_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldstrcm_main.spc
  **
...
TYPE ty_tldstrcm IS RECORD (
     v_tltm_strategy_mapping     tltm_strategy_mapping%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tldstrcm_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tldstrcm_main FOR tlpks_tldstrcm_main
/