CREATE OR REPLACE PACKAGE  lbpks_lbdinstr_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdinstr_main.spc
  **
...
TYPE ty_lbdinstr IS RECORD (
     v_oltms_instr     oltm_instr%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdinstr_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdinstr_main FOR lbpks_lbdinstr_main
/