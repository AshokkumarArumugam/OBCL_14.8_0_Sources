CREATE OR REPLACE PACKAGE  olpks_olddsbvw_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_olddsbvw_main.spc
  **
  ** Module     : OL
  ** 
...
TYPE ty_tb__oltbs_contract_dsbr_sch IS TABLE OF oltb_contract_dsbr_sch%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_olddsbvw IS RECORD (
     v_oltbs_contract     oltb_contract%ROWTYPE,
     v_oltbs_contract_dsbr_sch    ty_tb__oltbs_contract_dsbr_sch,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_olddsbvw          IN OUT  olpks_olddsbvw_Main.Ty_olddsbvw,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_olddsbvw          IN olpks_olddsbvw_Main.Ty_olddsbvw,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_olddsbvw     IN  olpks_olddsbvw_Main.Ty_olddsbvw,
p_Wrk_olddsbvw      IN OUT  olpks_olddsbvw_Main.Ty_olddsbvw,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_olddsbvw     IN  olpks_olddsbvw_Main.Ty_olddsbvw,
p_Prev_olddsbvw IN OUT  olpks_olddsbvw_Main.Ty_olddsbvw,
p_Wrk_olddsbvw      IN OUT  olpks_olddsbvw_Main.Ty_olddsbvw,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_olddsbvw     IN  olpks_olddsbvw_Main.Ty_olddsbvw,
p_Prev_olddsbvw     IN  olpks_olddsbvw_Main.Ty_olddsbvw,
p_Wrk_olddsbvw      IN OUT  olpks_olddsbvw_Main.Ty_olddsbvw,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_olddsbvw IN  olpks_olddsbvw_Main.Ty_olddsbvw,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_olddsbvw_main;
/
CREATE OR REPLACE SYNONYM olpkss_olddsbvw_main FOR olpks_olddsbvw_main
/