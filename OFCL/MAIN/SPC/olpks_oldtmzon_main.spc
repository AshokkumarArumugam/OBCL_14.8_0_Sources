CREATE OR REPLACE PACKAGE  olpks_oldtmzon_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldtmzon_main.spc
  **
...
TYPE ty_oldtmzon IS RECORD (
     v_oltms_time_zone     oltm_time_zone%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldtmzon_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldtmzon_main FOR olpks_oldtmzon_main
/