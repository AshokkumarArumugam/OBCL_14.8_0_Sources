CREATE OR REPLACE PACKAGE  olpks_oldadmin_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldadmin_main.spc
  **
...
TYPE ty_oldadmin IS RECORD (
     v_oltms_administrator     oltm_administrator%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldadmin_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldadmin_main FOR olpks_oldadmin_main
/