CREATE OR REPLACE PACKAGE lfpks_lfctrchg_utils_cluster AS
/*----------------------------------------------------------------------------------------------------
**
** File Name	: lfpks_lfctrchg_utils_cluster.SPC
**
...
END lfpks_lfctrchg_utils_cluster;
/


CREATE or replace SYNONYM lfpkss_lfctrchg_utils_cluster FOR lfpks_lfctrchg_utils_cluster
/