CREATE OR REPLACE PACKAGE  lbpks_lbdinsvw_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdinsvw_kernel.spc
  **
...
END lbpks_lbdinsvw_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdinsvw_kernel FOR lbpks_lbdinsvw_Kernel
/