CREATE OR REPLACE PACKAGE  lbpks_lbdpruat_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdpruat_main.spc
  **
...
TYPE ty_lbdpruat IS RECORD (
     v_upl_master__pr_aut_mas     lbtb_pay_recv_upl_master%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdpruat          IN OUT  lbpks_lbdpruat_Main.Ty_lbdpruat,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_lbdpruat          IN lbpks_lbdpruat_Main.Ty_lbdpruat,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdpruat     IN  lbpks_lbdpruat_Main.Ty_lbdpruat,
p_Wrk_lbdpruat      IN OUT  lbpks_lbdpruat_Main.Ty_lbdpruat,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdpruat     IN  lbpks_lbdpruat_Main.Ty_lbdpruat,
p_Prev_lbdpruat IN OUT  lbpks_lbdpruat_Main.Ty_lbdpruat,
p_Wrk_lbdpruat      IN OUT  lbpks_lbdpruat_Main.Ty_lbdpruat,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbdpruat     IN  lbpks_lbdpruat_Main.Ty_lbdpruat,
p_Prev_lbdpruat     IN  lbpks_lbdpruat_Main.Ty_lbdpruat,
p_Wrk_lbdpruat      IN OUT  lbpks_lbdpruat_Main.Ty_lbdpruat,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbdpruat IN  lbpks_lbdpruat_Main.Ty_lbdpruat,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdpruat_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdpruat_main FOR lbpks_lbdpruat_main
/