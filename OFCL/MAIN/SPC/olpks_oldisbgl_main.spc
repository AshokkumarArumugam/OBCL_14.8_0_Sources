CREATE OR REPLACE PACKAGE  olpks_oldisbgl_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldisbgl_main.spc
  **
...
TYPE ty_oldisbgl IS RECORD (
     v_oltms_extsys_isbgl     oltm_extsys_isbgl%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldisbgl_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldisbgl_main FOR olpks_oldisbgl_main
/