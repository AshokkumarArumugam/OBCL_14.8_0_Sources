CREATE OR REPLACE PACKAGE olpks_olrpstat_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_olrpstat_kernel.spc
  **
  ...
  ** India
  ...
  Change Description : Changes done to generate the report-OLRPSTAT
  Date               : 20/07/2016
 ...
 pm_current_user smtb_user.user_id%TYPE;--VARCHAR2(11);--Bug#29125889 Changes
  ...
  PM_APPLICATION_DATE       VARCHAR2(11);
 ...
 PRM_customer sttm_core_customer.customer_no%TYPE;
  ...
  FUNCTION cf_2formula(component_ccy IN VARCHAR2, overdue_amount IN NUMBER)
    RETURN varchar2;
  FUNCTION cf_1formula(earliest_due_date IN DATE, maturity_date IN DATE)
    RETURN varchar2;
  FUNCTION cf_3formula(summary_component_ccy  IN VARCHAR2,
                       summary_overdue_amount IN NUMBER) RETURN VARCHAR2;
  FUNCTION CF_BOOK_DATEFormula(BOOK_DATE IN DATE) RETURN VARCHAR2;
  ...
  FUNCTION Fn_Post_Build_Type_Structure(p_Source           IN VARCHAR2,
                                        ...
                                        p_olrpstat         IN OUT olpks_olrpstat_main.ty_olrpstat,
  ...
  FUNCTION Fn_Post_Check_Mandatory(p_Source           IN VARCHAR2,
                                   ...
                                   p_olrpstat         IN olpks_olrpstat_main.ty_olrpstat,
                                   p_Err_Code         IN OUT VARCHAR2,
                                   p_Err_Params       IN OUT VARCHAR2)
    RETURN BOOLEAN;
  ...
  FUNCTION Fn_Pre_Default_And_Validate(p_source           IN VARCHAR2,
                                       ...
                                       p_Child_Function   IN VARCHAR2,
                                       p_olrpstat         IN olpks_olrpstat_main.ty_olrpstat,
                                       p_wrk_olrpstat     IN OUT olpks_olrpstat_main.ty_olrpstat,
                                       p_Err_Code         IN OUT VARCHAR2,
                                       p_Err_Params       IN OUT VARCHAR2)
    RETURN BOOLEAN;
