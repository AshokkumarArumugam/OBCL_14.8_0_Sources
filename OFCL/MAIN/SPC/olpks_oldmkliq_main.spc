CREATE OR REPLACE PACKAGE  olpks_oldmkliq_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldmkliq_main.spc
  **
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldmkliq          IN OUT  olpks_oldmkliq_Main.Ty_oldmkliq,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_oldmkliq          IN olpks_oldmkliq_Main.Ty_oldmkliq,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldmkliq     IN  olpks_oldmkliq_Main.Ty_oldmkliq,
p_Wrk_oldmkliq      IN OUT  olpks_oldmkliq_Main.Ty_oldmkliq,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldmkliq     IN  olpks_oldmkliq_Main.Ty_oldmkliq,
p_Prev_oldmkliq IN OUT  olpks_oldmkliq_Main.Ty_oldmkliq,
p_Wrk_oldmkliq      IN OUT  olpks_oldmkliq_Main.Ty_oldmkliq,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldmkliq     IN  olpks_oldmkliq_Main.Ty_oldmkliq,
p_Prev_oldmkliq     IN  olpks_oldmkliq_Main.Ty_oldmkliq,
p_Wrk_oldmkliq      IN OUT  olpks_oldmkliq_Main.Ty_oldmkliq,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldmkliq IN  olpks_oldmkliq_Main.Ty_oldmkliq,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldmkliq_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldmkliq_main FOR olpks_oldmkliq_main
/