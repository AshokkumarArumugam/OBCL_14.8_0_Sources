CREATE OR REPLACE PACKAGE  olpks_oldpsaut_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldpsaut_main.spc
  **
...
TYPE ty_tb_v_schedule_upload__payau IS TABLE OF oltb_schedule_upload%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_ltbs_contract_change_log IS TABLE OF oltb_contract_change_log%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_oltbs_contract_ovd IS TABLE OF oltb_contract_ovd%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_oldpsaut IS RECORD (
     v_upload_master__payau     oltb_schedule_upload_master%ROWTYPE,
     v_schedule_upload__payau    ty_tb_v_schedule_upload__payau,
     v_oltbs_contract_change_log    ty_tb_ltbs_contract_change_log,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldpsaut          IN OUT  olpks_oldpsaut_Main.Ty_oldpsaut,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_oldpsaut          IN olpks_oldpsaut_Main.Ty_oldpsaut,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldpsaut     IN  olpks_oldpsaut_Main.Ty_oldpsaut,
p_Wrk_oldpsaut      IN OUT  olpks_oldpsaut_Main.Ty_oldpsaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldpsaut     IN  olpks_oldpsaut_Main.Ty_oldpsaut,
p_Prev_oldpsaut IN OUT  olpks_oldpsaut_Main.Ty_oldpsaut,
p_Wrk_oldpsaut      IN OUT  olpks_oldpsaut_Main.Ty_oldpsaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldpsaut     IN  olpks_oldpsaut_Main.Ty_oldpsaut,
p_Prev_oldpsaut     IN  olpks_oldpsaut_Main.Ty_oldpsaut,
p_Wrk_oldpsaut      IN OUT  olpks_oldpsaut_Main.Ty_oldpsaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldpsaut IN  olpks_oldpsaut_Main.Ty_oldpsaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldpsaut_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldpsaut_main FOR olpks_oldpsaut_main
/