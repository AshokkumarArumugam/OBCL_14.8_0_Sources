CREATE OR REPLACE PACKAGE  tlpks_tldamfau_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldamfau_main.spc
  **
...
TYPE ty_tldamfau IS RECORD (
     v_amend_fee_master__auth     tltb_amend_fee_master%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_tldamfau          IN OUT  tlpks_tldamfau_Main.Ty_tldamfau,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_tldamfau          IN tlpks_tldamfau_Main.Ty_tldamfau,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_tldamfau     IN  tlpks_tldamfau_Main.Ty_tldamfau,
p_Wrk_tldamfau      IN OUT  tlpks_tldamfau_Main.Ty_tldamfau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_tldamfau     IN  tlpks_tldamfau_Main.Ty_tldamfau,
p_Prev_tldamfau IN OUT  tlpks_tldamfau_Main.Ty_tldamfau,
p_Wrk_tldamfau      IN OUT  tlpks_tldamfau_Main.Ty_tldamfau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_tldamfau     IN  tlpks_tldamfau_Main.Ty_tldamfau,
p_Prev_tldamfau     IN  tlpks_tldamfau_Main.Ty_tldamfau,
p_Wrk_tldamfau      IN OUT  tlpks_tldamfau_Main.Ty_tldamfau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_tldamfau IN  tlpks_tldamfau_Main.Ty_tldamfau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tldamfau_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tldamfau_main FOR tlpks_tldamfau_main
/