CREATE OR REPLACE PACKAGE  lfpks_lfcfeecf_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lfpks_lfcfeecf_kernel.spc
  **
  ** Module     : The ICCF
  ** 
...
END lfpks_lfcfeecf_kernel;
/
CREATE OR REPLACE SYNONYM lfpkss_lfcfeecf_kernel FOR lfpks_lfcfeecf_kernel
/