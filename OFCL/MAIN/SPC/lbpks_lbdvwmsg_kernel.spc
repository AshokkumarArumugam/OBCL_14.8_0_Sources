CREATE OR REPLACE PACKAGE lbpks_lbdvwmsg_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdvwmsg_kernel.spc
  **
...
END lbpks_lbdvwmsg_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdvwmsg_kernel FOR lbpks_lbdvwmsg_kernel
/