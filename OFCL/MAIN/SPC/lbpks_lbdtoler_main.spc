CREATE OR REPLACE PACKAGE  lbpks_lbdtoler_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdtoler_main.spc
  **
...
TYPE ty_lbdtoler IS RECORD (
     v_lbtbs_borr_part_diff     lbtb_borr_part_diff%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdtoler_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdtoler_main FOR lbpks_lbdtoler_main
/