CREATE OR REPLACE PACKAGE  lbpks_lbdrefnd_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdrefnd_main.spc
  **
...
TYPE ty_tb_v_contract_refund_detail IS TABLE OF lbtb_contract_refund_detail%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb__cont_refund_amount_paid IS TABLE OF lbtb_cont_refund_amount_paid%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_refund_amount_paid__borr IS TABLE OF lbtb_cont_refund_amount_paid%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbdrefnd IS RECORD (
     v_oltbs_contract     oltb_contract%ROWTYPE,
     v_contract_refund_master     lbtb_contract_refund_master%ROWTYPE,
     v_contract_refund_detail    ty_tb_v_contract_refund_detail,
     v_cont_refund_amount_paid    ty_tb__cont_refund_amount_paid,
     v_oltbs_contract_event_log     oltb_contract_event_log%ROWTYPE,
     v_refund_amount_paid__borr    ty_tb_refund_amount_paid__borr,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdrefnd          IN OUT  lbpks_lbdrefnd_Main.Ty_lbdrefnd,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Wrk_lbdrefnd IN  lbpks_lbdrefnd_Main.Ty_lbdrefnd,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdrefnd_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdrefnd_main FOR lbpks_lbdrefnd_main
/