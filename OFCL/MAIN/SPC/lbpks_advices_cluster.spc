CREATE OR REPLACE PACKAGE lbpks_advices_cluster AS

/*----------------------------------------------------------------------------------------------------
**
** File Name	: lbpks_advices_cluster.SPC
**
** Module		: LS
**
...
END lbpks_advices_cluster;
/
CREATE or replace SYNONYM lbpkss_advices_cluster FOR lbpks_advices_cluster
/