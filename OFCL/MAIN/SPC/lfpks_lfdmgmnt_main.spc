CREATE OR REPLACE PACKAGE  lfpks_lfdmgmnt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lfpks_lfdmgmnt_main.spc
  **
  ** Module     : The ICCF
  ** 
...
TYPE ty_lfdmgmnt IS RECORD (
     v_lftms_margin_definition     lftm_margin_definition%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lfpks_lfdmgmnt_main;
/
CREATE OR REPLACE SYNONYM lfpkss_lfdmgmnt_main FOR lfpks_lfdmgmnt_main
/