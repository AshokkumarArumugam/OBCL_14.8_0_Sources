CREATE OR REPLACE PACKAGE olpks_olduplod_utils_cluster AS
/*----------------------------------------------------------------------------------------------------
**
** File Name	: olpks_olduplod_utils_cluster.SPC
**
...
END olpks_olduplod_utils_cluster;
/


CREATE or replace SYNONYM olpkss_olduplod_utils_cluster FOR olpks_olduplod_utils_cluster
/