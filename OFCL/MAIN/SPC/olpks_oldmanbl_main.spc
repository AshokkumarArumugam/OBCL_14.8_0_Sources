CREATE OR REPLACE PACKAGE  olpks_oldmanbl_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldmanbl_main.spc
  **
...
TYPE ty_tb_v_manual_billing_detail IS TABLE OF oltb_manual_billing_detail%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_oldmanbl IS RECORD (
     v_manual_billing_master     oltb_manual_billing_master%ROWTYPE,
     v_manual_billing_detail    ty_tb_v_manual_billing_detail,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldmanbl          IN OUT  olpks_oldmanbl_Main.Ty_oldmanbl,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldmanbl     IN  olpks_oldmanbl_Main.Ty_oldmanbl,
p_Prev_oldmanbl IN OUT  olpks_oldmanbl_Main.Ty_oldmanbl,
p_Wrk_oldmanbl      IN OUT  olpks_oldmanbl_Main.Ty_oldmanbl,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldmanbl     IN  olpks_oldmanbl_Main.Ty_oldmanbl,
p_Prev_oldmanbl     IN  olpks_oldmanbl_Main.Ty_oldmanbl,
p_Wrk_oldmanbl      IN OUT  olpks_oldmanbl_Main.Ty_oldmanbl,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldmanbl IN  olpks_oldmanbl_Main.Ty_oldmanbl,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldmanbl_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldmanbl_main FOR olpks_oldmanbl_main
/