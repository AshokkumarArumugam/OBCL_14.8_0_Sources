CREATE OR REPLACE PACKAGE  olpks_oldrtaut_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldrtaut_kernel.spc
  **
  ** Module     : LD
  ** 
...
END olpks_oldrtaut_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldrtaut_kernel FOR olpks_oldrtaut_kernel
/