CREATE OR REPLACE PACKAGE  lbpks_lbrinisp_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbrinisp_kernel.spc
  **
...
p_lbrinisp     IN  OUT lbpks_lbrinisp_Main.Ty_lbrinisp,
...
p_lbrinisp IN   lbpks_lbrinisp_Main.ty_lbrinisp,
p_Err_Code       IN  OUT VARCHAR2,
p_Err_Params     IN  OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Child_Function    IN  VARCHAR2,
p_lbrinisp IN   lbpks_lbrinisp_Main.Ty_lbrinisp,
p_Wrk_lbrinisp IN OUT  lbpks_lbrinisp_Main.Ty_lbrinisp,
p_Err_Code       IN  OUT VARCHAR2,
p_Err_Params     IN  OUT VARCHAR2)
RETURN BOOLEAN;
...
END lbpks_lbrinisp_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbrinisp_kernel FOR lbpks_lbrinisp_kernel
/