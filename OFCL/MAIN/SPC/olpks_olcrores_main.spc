CREATE OR REPLACE PACKAGE  olpks_olcrores_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_olcrores_main.spc
  **
  ** Module     : OL
  ** 
...
TYPE ty_tb_v_oltb_contract_liq_resd IS TABLE OF oltb_contract_liq_resd%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_olcrores IS RECORD (
     v_oltb_contract___res     oltb_contract%ROWTYPE,
     v_oltb_contract_liq_resd    ty_tb_v_oltb_contract_liq_resd,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_olcrores          IN OUT  olpks_olcrores_Main.Ty_olcrores,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Main_Function    IN  VARCHAR2,
p_olcrores       IN    olpks_olcrores_Main.ty_olcrores,
...
p_Main_Function    IN  VARCHAR2,
p_olcrores     IN  olpks_olcrores_Main.Ty_olcrores,
p_Prev_olcrores IN OUT  olpks_olcrores_Main.Ty_olcrores,
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_olcrores     IN  olpks_olcrores_Main.Ty_olcrores,
p_Prev_olcrores     IN  olpks_olcrores_Main.Ty_olcrores,
p_Wrk_olcrores      IN OUT  olpks_olcrores_Main.Ty_olcrores,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_olcrores IN  olpks_olcrores_Main.Ty_olcrores,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_olcrores_main;
/
CREATE OR REPLACE SYNONYM olpkss_olcrores_main FOR olpks_olcrores_main
/