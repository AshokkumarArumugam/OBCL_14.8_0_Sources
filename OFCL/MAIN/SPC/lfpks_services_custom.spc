CREATE OR REPLACE package lfpks_services_custom is
/*----------------------------------------------------------------------------------------------------
**
** File Name    : lfpks_services_custom.SPC
**
...
end lfpks_services_custom;
/
create or replace synonym lfpkss_services_custom for lfpks_services_custom
/