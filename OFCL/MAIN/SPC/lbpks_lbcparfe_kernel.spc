CREATE OR REPLACE PACKAGE  lbpks_lbcparfe_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbcparfe_kernel.spc
  **
...
END lbpks_lbcparfe_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbcparfe_kernel FOR lbpks_lbcparfe_kernel
/