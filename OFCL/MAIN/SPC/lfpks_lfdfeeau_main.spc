CREATE OR REPLACE PACKAGE  lfpks_lfdfeeau_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lfpks_lfdfeeau_main.spc
  **
  ** Module     : The ICCF
  ** 
...
TYPE ty_lfdfeeau IS RECORD (
     v_oltbs_contract__fee_auth     oltb_contract%ROWTYPE,
     v_event_log__fee_auth     oltb_contract_event_log%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lfdfeeau          IN OUT  lfpks_lfdfeeau_Main.Ty_lfdfeeau,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_lfdfeeau          IN lfpks_lfdfeeau_Main.Ty_lfdfeeau,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lfdfeeau     IN  lfpks_lfdfeeau_Main.Ty_lfdfeeau,
p_Wrk_lfdfeeau      IN OUT  lfpks_lfdfeeau_Main.Ty_lfdfeeau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lfdfeeau     IN  lfpks_lfdfeeau_Main.Ty_lfdfeeau,
p_Prev_lfdfeeau IN OUT  lfpks_lfdfeeau_Main.Ty_lfdfeeau,
p_Wrk_lfdfeeau      IN OUT  lfpks_lfdfeeau_Main.Ty_lfdfeeau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lfdfeeau     IN  lfpks_lfdfeeau_Main.Ty_lfdfeeau,
p_Prev_lfdfeeau     IN  lfpks_lfdfeeau_Main.Ty_lfdfeeau,
p_Wrk_lfdfeeau      IN OUT  lfpks_lfdfeeau_Main.Ty_lfdfeeau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lfdfeeau IN  lfpks_lfdfeeau_Main.Ty_lfdfeeau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lfpks_lfdfeeau_main;
/
CREATE OR REPLACE SYNONYM lfpkss_lfdfeeau_main FOR lfpks_lfdfeeau_main
/