CREATE OR REPLACE PACKAGE  lbpks_lbdiraut_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdiraut_main.spc
  **
...
TYPE ty_lbdiraut IS RECORD (
     v_lbtbs_rate_fixing_details     lbtb_rate_fixing_details%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdiraut          IN OUT  lbpks_lbdiraut_Main.Ty_lbdiraut,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_lbdiraut          IN lbpks_lbdiraut_Main.Ty_lbdiraut,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdiraut     IN  lbpks_lbdiraut_Main.Ty_lbdiraut,
p_Wrk_lbdiraut      IN OUT  lbpks_lbdiraut_Main.Ty_lbdiraut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdiraut     IN  lbpks_lbdiraut_Main.Ty_lbdiraut,
p_Prev_lbdiraut IN OUT  lbpks_lbdiraut_Main.Ty_lbdiraut,
p_Wrk_lbdiraut      IN OUT  lbpks_lbdiraut_Main.Ty_lbdiraut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbdiraut     IN  lbpks_lbdiraut_Main.Ty_lbdiraut,
p_Prev_lbdiraut     IN  lbpks_lbdiraut_Main.Ty_lbdiraut,
p_Wrk_lbdiraut      IN OUT  lbpks_lbdiraut_Main.Ty_lbdiraut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbdiraut IN  lbpks_lbdiraut_Main.Ty_lbdiraut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdiraut_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdiraut_main FOR lbpks_lbdiraut_main
/