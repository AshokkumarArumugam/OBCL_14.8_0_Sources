CREATE OR REPLACE PACKAGE  olpks_oldpnwvr_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldpnwvr_main.spc
  **
...
TYPE ty_oldpnwvr IS RECORD (
     v_oltbs_contract__sp     oltb_contract%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldpnwvr          IN OUT  olpks_oldpnwvr_Main.Ty_oldpnwvr,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldpnwvr     IN  olpks_oldpnwvr_Main.Ty_oldpnwvr,
p_Prev_oldpnwvr IN OUT  olpks_oldpnwvr_Main.Ty_oldpnwvr,
p_Wrk_oldpnwvr      IN OUT  olpks_oldpnwvr_Main.Ty_oldpnwvr,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Wrk_oldpnwvr IN  olpks_oldpnwvr_Main.Ty_oldpnwvr,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldpnwvr_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldpnwvr_main FOR olpks_oldpnwvr_main
/