CREATE OR REPLACE PACKAGE  lbpks_lbcrplex_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbcrplex_kernel.spc
  **
...
END lbpks_lbcrplex_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbcrplex_kernel FOR lbpks_lbcrplex_kernel
/