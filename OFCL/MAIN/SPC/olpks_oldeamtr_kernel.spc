CREATE OR REPLACE PACKAGE  olpks_oldeamtr_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldeamtr_kernel.spc
  **
...
END olpks_oldeamtr_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldeamtr_kernel FOR olpks_oldeamtr_Kernel
/