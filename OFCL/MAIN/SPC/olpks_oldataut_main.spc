CREATE OR REPLACE PACKAGE  olpks_oldataut_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldataut_main.spc
  **
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldataut          IN OUT  olpks_oldataut_Main.Ty_oldataut,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldataut     IN  olpks_oldataut_Main.Ty_oldataut,
p_Prev_oldataut IN OUT  olpks_oldataut_Main.Ty_oldataut,
p_Wrk_oldataut      IN OUT  olpks_oldataut_Main.Ty_oldataut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldataut     IN  olpks_oldataut_Main.Ty_oldataut,
p_Prev_oldataut     IN  olpks_oldataut_Main.Ty_oldataut,
p_Wrk_oldataut      IN OUT  olpks_oldataut_Main.Ty_oldataut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldataut IN  olpks_oldataut_Main.Ty_oldataut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldataut_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldataut_main FOR olpks_oldataut_main
/