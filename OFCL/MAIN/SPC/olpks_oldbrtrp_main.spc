CREATE OR REPLACE PACKAGE  olpks_oldbrtrp_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldbrtrp_main.spc
  **
...
TYPE ty_oldbrtrp IS RECORD (
     v_oltms_brn_treas_params     oltm_brn_treas_params%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldbrtrp_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldbrtrp_main FOR olpks_oldbrtrp_main
/