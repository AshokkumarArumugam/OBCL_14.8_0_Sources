CREATE OR REPLACE PACKAGE  olpks_oldpdequ_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldpdequ_main.spc
  **
  ** Module     : Messaging
  ** 
...
TYPE ty_oldpdequ IS RECORD (
     v_oltms_branch     oltm_branch%ROWTYPE,
     v_oltbs_dly_msg_out    ty_tb_v_oltbs_dly_msg_out,
     v_olvws_dly_msg     olvw_dly_msg%ROWTYPE,
     v_olvws_all_msg_out     olvw_all_msg_out%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldpdequ          IN OUT  olpks_oldpdequ_Main.Ty_oldpdequ,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_oldpdequ          IN olpks_oldpdequ_Main.Ty_oldpdequ,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldpdequ     IN  olpks_oldpdequ_Main.Ty_oldpdequ,
p_Wrk_oldpdequ      IN OUT  olpks_oldpdequ_Main.Ty_oldpdequ,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldpdequ     IN  olpks_oldpdequ_Main.Ty_oldpdequ,
p_Prev_oldpdequ IN OUT  olpks_oldpdequ_Main.Ty_oldpdequ,
p_Wrk_oldpdequ      IN OUT  olpks_oldpdequ_Main.Ty_oldpdequ,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldpdequ     IN  olpks_oldpdequ_Main.Ty_oldpdequ,
p_Prev_oldpdequ     IN  olpks_oldpdequ_Main.Ty_oldpdequ,
p_Wrk_oldpdequ      IN OUT  olpks_oldpdequ_Main.Ty_oldpdequ,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldpdequ IN  olpks_oldpdequ_Main.Ty_oldpdequ,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldpdequ_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldpdequ_main FOR olpks_oldpdequ_main
/