CREATE OR REPLACE PACKAGE  lbpks_lbdtraut_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdtraut_main.spc
  **
...
TYPE ty_lbdtraut IS RECORD (
     ...
     v_contract_event_log__taut     oltb_contract_event_log%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdtraut          IN OUT  lbpks_lbdtraut_Main.Ty_lbdtraut,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdtraut     IN  lbpks_lbdtraut_Main.Ty_lbdtraut,
p_Prev_lbdtraut IN OUT  lbpks_lbdtraut_Main.Ty_lbdtraut,
p_Wrk_lbdtraut      IN OUT  lbpks_lbdtraut_Main.Ty_lbdtraut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbdtraut     IN  lbpks_lbdtraut_Main.Ty_lbdtraut,
p_Prev_lbdtraut     IN  lbpks_lbdtraut_Main.Ty_lbdtraut,
p_Wrk_lbdtraut      IN OUT  lbpks_lbdtraut_Main.Ty_lbdtraut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbdtraut IN  lbpks_lbdtraut_Main.Ty_lbdtraut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdtraut_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdtraut_main FOR lbpks_lbdtraut_main
/