CREATE OR REPLACE PACKAGE  lbpks_lbdreasn_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdreasn_kernel.spc
  **
...
END lbpks_lbdreasn_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdreasn_kernel FOR lbpks_lbdreasn_Kernel
/