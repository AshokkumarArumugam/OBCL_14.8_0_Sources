CREATE OR REPLACE PACKAGE  olpks_oldffmcu_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldffmcu_kernel.spc
  **
...
END olpks_oldffmcu_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldffmcu_kernel FOR olpks_oldffmcu_Kernel
/