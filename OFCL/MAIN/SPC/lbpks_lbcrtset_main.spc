CREATE OR REPLACE PACKAGE  lbpks_lbcrtset_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbcrtset_main.spc
  **
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbcrtset          IN OUT  lbpks_lbcrtset_Main.Ty_lbcrtset,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Main_Function    IN  VARCHAR2,
p_lbcrtset       IN    lbpks_lbcrtset_Main.ty_lbcrtset,
...
p_Main_Function    IN  VARCHAR2,
p_lbcrtset     IN  lbpks_lbcrtset_Main.Ty_lbcrtset,
p_Prev_lbcrtset IN OUT  lbpks_lbcrtset_Main.Ty_lbcrtset,
p_Wrk_lbcrtset IN OUT  lbpks_lbcrtset_Main.Ty_lbcrtset,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbcrtset     IN  lbpks_lbcrtset_Main.Ty_lbcrtset,
p_Prev_lbcrtset     IN  lbpks_lbcrtset_Main.Ty_lbcrtset,
p_Wrk_lbcrtset      IN OUT  lbpks_lbcrtset_Main.Ty_lbcrtset,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbcrtset IN  lbpks_lbcrtset_Main.Ty_lbcrtset,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbcrtset_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbcrtset_main FOR lbpks_lbcrtset_main
/