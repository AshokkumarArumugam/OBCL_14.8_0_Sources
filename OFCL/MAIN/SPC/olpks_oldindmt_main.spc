CREATE OR REPLACE PACKAGE  olpks_oldindmt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldindmt_main.spc
  **
  ** Module     : Messaging
  ** 
...
TYPE ty_oldindmt IS RECORD (
     v_oltms_industry     oltm_industry%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldindmt_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldindmt_main FOR olpks_oldindmt_main
/