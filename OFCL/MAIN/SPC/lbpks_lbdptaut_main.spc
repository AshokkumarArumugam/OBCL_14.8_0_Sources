CREATE OR REPLACE PACKAGE  lbpks_lbdptaut_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdptaut_main.spc
  **
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdptaut          IN OUT  lbpks_lbdptaut_Main.Ty_lbdptaut,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_lbdptaut          IN lbpks_lbdptaut_Main.Ty_lbdptaut,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdptaut     IN  lbpks_lbdptaut_Main.Ty_lbdptaut,
p_Prev_lbdptaut IN OUT  lbpks_lbdptaut_Main.Ty_lbdptaut,
p_Wrk_lbdptaut      IN OUT  lbpks_lbdptaut_Main.Ty_lbdptaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbdptaut     IN  lbpks_lbdptaut_Main.Ty_lbdptaut,
p_Prev_lbdptaut     IN  lbpks_lbdptaut_Main.Ty_lbdptaut,
p_Wrk_lbdptaut      IN OUT  lbpks_lbdptaut_Main.Ty_lbdptaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbdptaut IN  lbpks_lbdptaut_Main.Ty_lbdptaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdptaut_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdptaut_main FOR lbpks_lbdptaut_main
/