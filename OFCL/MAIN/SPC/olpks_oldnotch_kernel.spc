CREATE OR REPLACE PACKAGE  olpks_oldnotch_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldnotch_kernel.spc
  **
...
END olpks_oldnotch_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldnotch_kernel FOR olpks_oldnotch_kernel
/