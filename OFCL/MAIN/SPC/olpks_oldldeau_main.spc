CREATE OR REPLACE PACKAGE  olpks_oldldeau_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldldeau_main.spc
  **
...
TYPE ty_tb_ltbs_contract_adj_detail IS TABLE OF oltb_contract_adj_detail%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_oldldeau IS RECORD (
     v_oltbs_contract     oltb_contract%ROWTYPE,
     v_oltbs_contract_adj_master     oltb_contract_adj_master%ROWTYPE,
     v_oltbs_contract_adj_detail    ty_tb_ltbs_contract_adj_detail,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldldeau          IN OUT  olpks_oldldeau_Main.Ty_oldldeau,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_oldldeau          IN olpks_oldldeau_Main.Ty_oldldeau,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldldeau     IN  olpks_oldldeau_Main.Ty_oldldeau,
p_Wrk_oldldeau      IN OUT  olpks_oldldeau_Main.Ty_oldldeau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldldeau     IN  olpks_oldldeau_Main.Ty_oldldeau,
p_Prev_oldldeau IN OUT  olpks_oldldeau_Main.Ty_oldldeau,
p_Wrk_oldldeau      IN OUT  olpks_oldldeau_Main.Ty_oldldeau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldldeau     IN  olpks_oldldeau_Main.Ty_oldldeau,
p_Prev_oldldeau     IN  olpks_oldldeau_Main.Ty_oldldeau,
p_Wrk_oldldeau      IN OUT  olpks_oldldeau_Main.Ty_oldldeau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldldeau IN  olpks_oldldeau_Main.Ty_oldldeau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldldeau_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldldeau_main FOR olpks_oldldeau_main
/