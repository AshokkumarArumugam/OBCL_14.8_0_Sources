CREATE OR REPLACE PACKAGE  tlpks_tldfeamd_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldfeamd_main.spc
  **
...
TYPE ty_tldfeamd IS RECORD (
     v_oltbs_contract__tlfeamd     oltb_contract%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_tldfeamd          IN OUT  tlpks_tldfeamd_Main.Ty_tldfeamd,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Wrk_tldfeamd IN  tlpks_tldfeamd_Main.Ty_tldfeamd,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tldfeamd_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tldfeamd_main FOR tlpks_tldfeamd_main
/