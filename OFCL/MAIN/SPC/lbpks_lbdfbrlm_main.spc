CREATE OR REPLACE PACKAGE  lbpks_lbdfbrlm_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdfbrlm_main.spc
  **
...
TYPE ty_tb_borr_lmt_txndet__tranche IS TABLE OF lbtb_tranche_borr_lmt_txndet%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_borr_lmt_txndet__borr IS TABLE OF lbtb_tranche_borr_lmt_txndet%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbdfbrlm IS RECORD (
     v_lbtbs_syndication_master     lbtb_syndication_master%ROWTYPE,
     v_lbtbs_contract_borrowers    ty_tb_lbtbs_contract_borrowers,
     v_borr_lmt_txndet__tranche    ty_tb_borr_lmt_txndet__tranche,
     v_borr_lmt_txndet__borr    ty_tb_v_borr_lmt_txndet__borr,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdfbrlm          IN OUT  lbpks_lbdfbrlm_Main.Ty_lbdfbrlm,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_lbdfbrlm          IN lbpks_lbdfbrlm_Main.Ty_lbdfbrlm,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdfbrlm     IN  lbpks_lbdfbrlm_Main.Ty_lbdfbrlm,
p_Wrk_lbdfbrlm      IN OUT  lbpks_lbdfbrlm_Main.Ty_lbdfbrlm,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdfbrlm     IN  lbpks_lbdfbrlm_Main.Ty_lbdfbrlm,
p_Prev_lbdfbrlm IN OUT  lbpks_lbdfbrlm_Main.Ty_lbdfbrlm,
p_Wrk_lbdfbrlm      IN OUT  lbpks_lbdfbrlm_Main.Ty_lbdfbrlm,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbdfbrlm     IN  lbpks_lbdfbrlm_Main.Ty_lbdfbrlm,
p_Prev_lbdfbrlm     IN  lbpks_lbdfbrlm_Main.Ty_lbdfbrlm,
p_Wrk_lbdfbrlm      IN OUT  lbpks_lbdfbrlm_Main.Ty_lbdfbrlm,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbdfbrlm IN  lbpks_lbdfbrlm_Main.Ty_lbdfbrlm,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdfbrlm_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdfbrlm_main FOR lbpks_lbdfbrlm_main
/