CREATE OR REPLACE PACKAGE  olpks_oldcuinf_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldcuinf_main.spc
  **
...
TYPE ty_tb_v_oltbs_contract_master IS TABLE OF oltb_contract_master%ROWTYPE INDEX BY BINARY_INTEGER;
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldcuinf          IN OUT  olpks_oldcuinf_Main.Ty_oldcuinf,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_oldcuinf          IN olpks_oldcuinf_Main.Ty_oldcuinf,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldcuinf     IN  olpks_oldcuinf_Main.Ty_oldcuinf,
p_Wrk_oldcuinf      IN OUT  olpks_oldcuinf_Main.Ty_oldcuinf,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldcuinf     IN  olpks_oldcuinf_Main.Ty_oldcuinf,
p_Prev_oldcuinf IN OUT  olpks_oldcuinf_Main.Ty_oldcuinf,
p_Wrk_oldcuinf      IN OUT  olpks_oldcuinf_Main.Ty_oldcuinf,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldcuinf     IN  olpks_oldcuinf_Main.Ty_oldcuinf,
p_Prev_oldcuinf     IN  olpks_oldcuinf_Main.Ty_oldcuinf,
p_Wrk_oldcuinf      IN OUT  olpks_oldcuinf_Main.Ty_oldcuinf,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldcuinf IN  olpks_oldcuinf_Main.Ty_oldcuinf,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldcuinf_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldcuinf_main FOR olpks_oldcuinf_main
/