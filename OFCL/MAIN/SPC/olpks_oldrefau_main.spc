CREATE OR REPLACE PACKAGE  olpks_oldrefau_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldrefau_main.spc
  **
...
TYPE ty_tb_v_oltbs_contract_refund IS TABLE OF oltb_contract_refund%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_oltbs_contract_ovd IS TABLE OF oltb_contract_ovd%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_oldrefau IS RECORD (
     v_oltbs_contract     oltb_contract%ROWTYPE,
     v_contract_refund_summary     oltb_contract_refund_summary%ROWTYPE,
     v_oltbs_contract_refund    ty_tb_v_oltbs_contract_refund,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldrefau          IN OUT  olpks_oldrefau_Main.Ty_oldrefau,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_oldrefau          IN olpks_oldrefau_Main.Ty_oldrefau,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldrefau     IN  olpks_oldrefau_Main.Ty_oldrefau,
p_Wrk_oldrefau      IN OUT  olpks_oldrefau_Main.Ty_oldrefau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldrefau     IN  olpks_oldrefau_Main.Ty_oldrefau,
p_Prev_oldrefau IN OUT  olpks_oldrefau_Main.Ty_oldrefau,
p_Wrk_oldrefau      IN OUT  olpks_oldrefau_Main.Ty_oldrefau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldrefau     IN  olpks_oldrefau_Main.Ty_oldrefau,
p_Prev_oldrefau     IN  olpks_oldrefau_Main.Ty_oldrefau,
p_Wrk_oldrefau      IN OUT  olpks_oldrefau_Main.Ty_oldrefau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldrefau IN  olpks_oldrefau_Main.Ty_oldrefau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldrefau_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldrefau_main FOR olpks_oldrefau_main
/