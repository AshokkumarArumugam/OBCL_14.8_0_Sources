CREATE OR REPLACE PACKAGE  olpks_oldppmnt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldppmnt_main.spc
  **
  ** Module     : OL
  ** 
...
TYPE ty_oldppmnt IS RECORD (
     v_oltms_property_master     oltm_property_master%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldppmnt_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldppmnt_main FOR olpks_oldppmnt_main
/