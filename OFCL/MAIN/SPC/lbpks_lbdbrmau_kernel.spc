CREATE OR REPLACE PACKAGE  lbpks_lbdbrmau_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdbrmau_kernel.spc
  **
...
END lbpks_lbdbrmau_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdbrmau_kernel FOR lbpks_lbdbrmau_kernel
/