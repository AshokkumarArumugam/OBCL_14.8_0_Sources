CREATE OR REPLACE PACKAGE  lbpks_lbdrsbrw_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdrsbrw_main.spc
  **
...
TYPE ty_tb_v_auto_rate_browser_excp IS TABLE OF lbtb_auto_rate_browser_excp%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbdrsbrw IS RECORD (
     v_lbvws_rsbrw     lbvw_rsbrw%ROWTYPE,
     v_auto_rate_browser_excp    ty_tb_v_auto_rate_browser_excp,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdrsbrw          IN OUT  lbpks_lbdrsbrw_Main.Ty_lbdrsbrw,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_lbdrsbrw          IN lbpks_lbdrsbrw_Main.Ty_lbdrsbrw,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdrsbrw     IN  lbpks_lbdrsbrw_Main.Ty_lbdrsbrw,
p_Wrk_lbdrsbrw      IN OUT  lbpks_lbdrsbrw_Main.Ty_lbdrsbrw,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdrsbrw     IN  lbpks_lbdrsbrw_Main.Ty_lbdrsbrw,
p_Prev_lbdrsbrw IN OUT  lbpks_lbdrsbrw_Main.Ty_lbdrsbrw,
p_Wrk_lbdrsbrw      IN OUT  lbpks_lbdrsbrw_Main.Ty_lbdrsbrw,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbdrsbrw     IN  lbpks_lbdrsbrw_Main.Ty_lbdrsbrw,
p_Prev_lbdrsbrw     IN  lbpks_lbdrsbrw_Main.Ty_lbdrsbrw,
p_Wrk_lbdrsbrw      IN OUT  lbpks_lbdrsbrw_Main.Ty_lbdrsbrw,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbdrsbrw IN  lbpks_lbdrsbrw_Main.Ty_lbdrsbrw,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdrsbrw_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdrsbrw_main FOR lbpks_lbdrsbrw_main
/