CREATE OR REPLACE PACKAGE  tlpks_tldcpmgm_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldcpmgm_main.spc
  **
...
TYPE ty_tldcpmgm IS RECORD (
     v_cpty_mnemonic_mapping     oltm_cpty_mnemonic_mapping%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tldcpmgm_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tldcpmgm_main FOR tlpks_tldcpmgm_main
/