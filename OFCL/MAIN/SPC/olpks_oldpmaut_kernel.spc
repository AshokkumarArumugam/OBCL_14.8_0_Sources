CREATE OR REPLACE PACKAGE  olpks_oldpmaut_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldpmaut_kernel.spc
  **
...
END olpks_oldpmaut_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldpmaut_kernel FOR olpks_oldpmaut_kernel
/