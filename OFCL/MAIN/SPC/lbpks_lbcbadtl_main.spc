CREATE OR REPLACE PACKAGE  lbpks_lbcbadtl_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbcbadtl_main.spc
  **
...
TYPE ty_lbcbadtl IS RECORD (
     v_contract__ba_details     oltb_contract%ROWTYPE,
     v_oltbs_contract_master     oltb_contract_master%ROWTYPE,
     v_oltb_contract_ba_details     oltb_contract_ba_details%ROWTYPE,
...
p_Wrk_lbcbadtl IN  lbpks_lbcbadtl_Main.Ty_lbcbadtl,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbcbadtl_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbcbadtl_main FOR lbpks_lbcbadtl_main
/