create or replace package lfpks_spread_utils is
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lfpks_spread_utils.spc
  **
...
end lfpks_spread_utils;
/
CREATE OR REPLACE SYNONYM lfpkss_spread_utils FOR lfpks_spread_utils
/