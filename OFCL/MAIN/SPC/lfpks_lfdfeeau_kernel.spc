CREATE OR REPLACE PACKAGE  lfpks_lfdfeeau_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lfpks_lfdfeeau_kernel.spc
  **
  ** Module     : The ICCF
  ** 
...
END lfpks_lfdfeeau_kernel;
/
CREATE OR REPLACE SYNONYM lfpkss_lfdfeeau_kernel FOR lfpks_lfdfeeau_kernel
/