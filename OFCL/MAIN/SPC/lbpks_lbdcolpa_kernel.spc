CREATE OR REPLACE PACKAGE  lbpks_lbdcolpa_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdcolpa_kernel.spc
  **
...
END lbpks_lbdcolpa_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdcolpa_kernel FOR lbpks_lbdcolpa_kernel
/