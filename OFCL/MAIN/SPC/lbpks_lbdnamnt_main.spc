CREATE OR REPLACE PACKAGE  lbpks_lbdnamnt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdnamnt_main.spc
  **
...
TYPE ty_lbdnamnt IS RECORD (
     v_lbtms_named_agent     lbtm_named_agent%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdnamnt_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdnamnt_main FOR lbpks_lbdnamnt_main
/