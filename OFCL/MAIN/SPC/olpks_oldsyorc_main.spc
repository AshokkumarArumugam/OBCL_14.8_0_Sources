CREATE OR REPLACE PACKAGE  olpks_oldsyorc_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldsyorc_main.spc
  **
...
TYPE ty_oldsyorc IS RECORD (
     v_synd_orig_cust_mapping     oltm_synd_orig_cust_mapping%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldsyorc_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldsyorc_main FOR olpks_oldsyorc_main
/