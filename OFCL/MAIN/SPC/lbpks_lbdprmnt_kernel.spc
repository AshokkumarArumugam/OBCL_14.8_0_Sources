CREATE OR REPLACE PACKAGE  lbpks_lbdprmnt_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdprmnt_kernel.spc
  **
...
END lbpks_lbdprmnt_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdprmnt_kernel FOR lbpks_lbdprmnt_kernel
/