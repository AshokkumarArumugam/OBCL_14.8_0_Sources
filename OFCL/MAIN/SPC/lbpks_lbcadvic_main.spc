CREATE OR REPLACE PACKAGE  lbpks_lbcadvic_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbcadvic_main.spc
  **
...
TYPE ty_tb_v_gtemp_event_advice__as IS TABLE OF oltb_gtemp_event_advice%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbcadvic IS RECORD (
     v_oltbs_gtemp_event_advice     oltb_gtemp_event_advice%ROWTYPE,
     v_gtemp_event_advice__as    ty_tb_v_gtemp_event_advice__as,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbcadvic          IN OUT  lbpks_lbcadvic_Main.Ty_lbcadvic,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Main_Function    IN  VARCHAR2,
p_lbcadvic     IN  lbpks_lbcadvic_Main.Ty_lbcadvic,
p_Prev_lbcadvic IN OUT  lbpks_lbcadvic_Main.Ty_lbcadvic,
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbcadvic     IN  lbpks_lbcadvic_Main.Ty_lbcadvic,
p_Prev_lbcadvic     IN  lbpks_lbcadvic_Main.Ty_lbcadvic,
p_Wrk_lbcadvic      IN OUT  lbpks_lbcadvic_Main.Ty_lbcadvic,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbcadvic IN  lbpks_lbcadvic_Main.Ty_lbcadvic,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbcadvic_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbcadvic_main FOR lbpks_lbcadvic_main
/