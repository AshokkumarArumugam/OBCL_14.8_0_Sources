CREATE OR REPLACE PACKAGE  tlpks_tldamfeh_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldamfeh_main.spc
  **
...
TYPE ty_tb__amend_fee_history__dtls IS TABLE OF tltb_amend_fee_history%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_tldamfeh IS RECORD (
     v_tltbs_amend_fee_history     tltb_amend_fee_history%ROWTYPE,
     v_amend_fee_history__dtls    ty_tb__amend_fee_history__dtls,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_tldamfeh          IN OUT  tlpks_tldamfeh_Main.Ty_tldamfeh,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_tldamfeh          IN tlpks_tldamfeh_Main.Ty_tldamfeh,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_tldamfeh     IN  tlpks_tldamfeh_Main.Ty_tldamfeh,
p_Wrk_tldamfeh      IN OUT  tlpks_tldamfeh_Main.Ty_tldamfeh,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_tldamfeh     IN  tlpks_tldamfeh_Main.Ty_tldamfeh,
p_Prev_tldamfeh IN OUT  tlpks_tldamfeh_Main.Ty_tldamfeh,
p_Wrk_tldamfeh      IN OUT  tlpks_tldamfeh_Main.Ty_tldamfeh,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_tldamfeh     IN  tlpks_tldamfeh_Main.Ty_tldamfeh,
p_Prev_tldamfeh     IN  tlpks_tldamfeh_Main.Ty_tldamfeh,
p_Wrk_tldamfeh      IN OUT  tlpks_tldamfeh_Main.Ty_tldamfeh,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_tldamfeh IN  tlpks_tldamfeh_Main.Ty_tldamfeh,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tldamfeh_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tldamfeh_main FOR tlpks_tldamfeh_main
/