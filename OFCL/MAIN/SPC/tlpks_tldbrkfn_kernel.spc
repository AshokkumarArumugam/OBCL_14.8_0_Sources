CREATE OR REPLACE PACKAGE  tlpks_tldbrkfn_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldbrkfn_kernel.spc
  **
...
END tlpks_tldbrkfn_kernel;
/
CREATE OR REPLACE SYNONYM tlpkss_tldbrkfn_kernel FOR tlpks_tldbrkfn_Kernel
/