CREATE OR REPLACE PACKAGE  olpks_oldrlink_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldrlink_main.spc
  **
...
FUNCTION Fn_Get_Key_Information (p_Source    IN  VARCHAR2, 
                        ...
                        p_Function_id       IN     VARCHAR2,
                        p_Action_Code       IN     VARCHAR2,
p_oldrlink       IN  OUT olpks_oldrlink_Main.Ty_oldrlink,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldrlink_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldrlink_main FOR olpks_oldrlink_main
/