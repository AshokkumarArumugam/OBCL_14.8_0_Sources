CREATE OR REPLACE PACKAGE olpks_olrpamsc_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_olrpamsc_kernel.spc
  **
 ...
 pm_current_user smtb_user.user_id%TYPE;
  ...
  PM_REFNUM       VARCHAR2(200);
	PM_PRODUCT       VARCHAR2(200);
  PM_WHERE_CLAUSE1 VARCHAR2(2000);
  PM_WHERE_CLAUSE2 VARCHAR2(2000);
...
p_olrpamsc     IN  OUT olpks_olrpamsc_main.ty_olrpamsc,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;

/*FUNCTION SumInt_duePerYear(end_date IN DATE) RETURN VARCHAR2;*/
...
p_olrpamsc IN   olpks_olrpamsc_main.ty_olrpamsc,
p_Err_Code       IN  OUT VARCHAR2,
p_Err_Params     IN  OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Child_Function    IN  VARCHAR2,
p_olrpamsc IN   olpks_olrpamsc_main.ty_olrpamsc,
p_wrk_olrpamsc IN OUT  olpks_olrpamsc_main.ty_olrpamsc,
p_Err_Code       IN  OUT VARCHAR2,
p_Err_Params     IN  OUT VARCHAR2)
RETURN BOOLEAN;
...
END olpks_olrpamsc_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_olrpamsc_kernel FOR olpks_olrpamsc_kernel
/