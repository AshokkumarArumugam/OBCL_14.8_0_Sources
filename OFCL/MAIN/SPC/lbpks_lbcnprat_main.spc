CREATE OR REPLACE PACKAGE  lbpks_lbcnprat_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbcnprat_main.spc
  **
...
TYPE ty_tb_v_part_nonprorata_ratio IS TABLE OF lbtb_part_nonprorata_ratio%ROWTYPE INDEX BY BINARY_INTEGER;
...
TYPE ty_lbcnprat IS RECORD (
     v_oltbs_contract__cnpr     oltb_contract%ROWTYPE,
     v_part_nonprorata_ratio    ty_tb_v_part_nonprorata_ratio,
     v_contract_participant     lbtw_contract_participant%ROWTYPE,
     v_gtemp_part_proc_stat     lbtb_gtemp_part_proc_stat%ROWTYPE,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbcnprat          IN OUT  lbpks_lbcnprat_Main.Ty_lbcnprat,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Main_Function    IN  VARCHAR2,
p_lbcnprat       IN    lbpks_lbcnprat_Main.ty_lbcnprat,
...
p_Main_Function    IN  VARCHAR2,
p_lbcnprat     IN  lbpks_lbcnprat_Main.Ty_lbcnprat,
p_Prev_lbcnprat IN OUT  lbpks_lbcnprat_Main.Ty_lbcnprat,
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbcnprat     IN  lbpks_lbcnprat_Main.Ty_lbcnprat,
p_Prev_lbcnprat     IN  lbpks_lbcnprat_Main.Ty_lbcnprat,
p_Wrk_lbcnprat      IN OUT  lbpks_lbcnprat_Main.Ty_lbcnprat,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbcnprat IN  lbpks_lbcnprat_Main.Ty_lbcnprat,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbcnprat_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbcnprat_main FOR lbpks_lbcnprat_main
/