CREATE OR REPLACE PACKAGE  lbpks_lbdbrmnc_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdbrmnc_kernel.spc
  **
...
END lbpks_lbdbrmnc_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdbrmnc_kernel FOR lbpks_lbdbrmnc_kernel
/