CREATE OR REPLACE PACKAGE Olpks_Batch_Cluster AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : Olpks_Batch_Cluster.spc
  **
...
END Olpks_Batch_Cluster;
/
create or replace synonym Olpkss_Batch_Cluster for Olpks_Batch_Cluster
/