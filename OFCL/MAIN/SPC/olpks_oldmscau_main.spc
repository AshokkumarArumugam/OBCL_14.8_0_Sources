CREATE OR REPLACE PACKAGE  olpks_oldmscau_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldmscau_main.spc
  **
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldmscau          IN OUT  olpks_oldmscau_Main.Ty_oldmscau,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldmscau     IN  olpks_oldmscau_Main.Ty_oldmscau,
p_Prev_oldmscau IN OUT  olpks_oldmscau_Main.Ty_oldmscau,
p_Wrk_oldmscau      IN OUT  olpks_oldmscau_Main.Ty_oldmscau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldmscau     IN  olpks_oldmscau_Main.Ty_oldmscau,
p_Prev_oldmscau     IN  olpks_oldmscau_Main.Ty_oldmscau,
p_Wrk_oldmscau      IN OUT  olpks_oldmscau_Main.Ty_oldmscau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldmscau IN  olpks_oldmscau_Main.Ty_oldmscau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldmscau_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldmscau_main FOR olpks_oldmscau_main
/