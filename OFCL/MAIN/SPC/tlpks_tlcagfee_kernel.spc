CREATE OR REPLACE PACKAGE  tlpks_tlcagfee_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tlcagfee_kernel.spc
  **
...
END tlpks_tlcagfee_kernel;
/
CREATE OR REPLACE SYNONYM tlpkss_tlcagfee_kernel FOR tlpks_tlcagfee_kernel
/