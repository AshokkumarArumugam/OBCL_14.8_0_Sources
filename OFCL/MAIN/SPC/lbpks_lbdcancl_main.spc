CREATE OR REPLACE PACKAGE  lbpks_lbdcancl_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdcancl_main.spc
  **
...
TYPE ty_lbdcancl IS RECORD (
     v_oltbs_contract__tc     oltb_contract%ROWTYPE,
     v_lbtbs_tranche_canc     lbtb_tranche_canc%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdcancl          IN OUT  lbpks_lbdcancl_Main.Ty_lbdcancl,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Wrk_lbdcancl IN  lbpks_lbdcancl_Main.Ty_lbdcancl,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdcancl_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdcancl_main FOR lbpks_lbdcancl_main
/