CREATE OR REPLACE PACKAGE  olpks_oldcontr_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldcontr_main.spc
  **
...
TYPE ty_oldcontr IS RECORD (
     v_oltbs_contract     oltb_contract%ROWTYPE,
     v_oltbs_contra_balance     oltb_contra_balance%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldcontr          IN OUT  olpks_oldcontr_Main.Ty_oldcontr,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldcontr     IN  olpks_oldcontr_Main.Ty_oldcontr,
p_Prev_oldcontr IN OUT  olpks_oldcontr_Main.Ty_oldcontr,
p_Wrk_oldcontr      IN OUT  olpks_oldcontr_Main.Ty_oldcontr,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Wrk_oldcontr IN  olpks_oldcontr_Main.Ty_oldcontr,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldcontr_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldcontr_main FOR olpks_oldcontr_main
/