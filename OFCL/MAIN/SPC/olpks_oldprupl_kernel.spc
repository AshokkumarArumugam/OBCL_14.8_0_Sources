CREATE OR REPLACE PACKAGE  olpks_oldprupl_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldprupl_kernel.spc
  **
...
END olpks_oldprupl_kernel;
/
CREATE OR REPLACE Synonym olpkss_oldprupl_kernel FOR olpks_oldprupl_kernel
/