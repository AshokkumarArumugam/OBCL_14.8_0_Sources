CREATE OR REPLACE PACKAGE  olpks_oldjraut_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldjraut_main.spc
  **
...
TYPE ty_oldjraut IS RECORD (
     v_oltbs_jrnl_log_de     oltb_jrnl_log_de%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldjraut          IN OUT  olpks_oldjraut_Main.Ty_oldjraut,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldjraut     IN  olpks_oldjraut_Main.Ty_oldjraut,
p_Wrk_oldjraut      IN OUT  olpks_oldjraut_Main.Ty_oldjraut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldjraut     IN  olpks_oldjraut_Main.Ty_oldjraut,
p_Prev_oldjraut IN OUT  olpks_oldjraut_Main.Ty_oldjraut,
p_Wrk_oldjraut      IN OUT  olpks_oldjraut_Main.Ty_oldjraut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldjraut     IN  olpks_oldjraut_Main.Ty_oldjraut,
p_Prev_oldjraut     IN  olpks_oldjraut_Main.Ty_oldjraut,
p_Wrk_oldjraut      IN OUT  olpks_oldjraut_Main.Ty_oldjraut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldjraut IN  olpks_oldjraut_Main.Ty_oldjraut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldjraut_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldjraut_main FOR olpks_oldjraut_main
/