CREATE OR REPLACE PACKAGE lbpks_lbdrlovr_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdrlovr_kernel.spc
  **
...
g_Lbdddonl lbpks_lbdddonl_Main.Ty_lbdddonl;
g_lbdrlovr lbpks_lbdrlovr_Main.Ty_lbdrlovr;
...
END lbpks_lbdrlovr_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdrlovr_kernel FOR lbpks_lbdrlovr_kernel
/