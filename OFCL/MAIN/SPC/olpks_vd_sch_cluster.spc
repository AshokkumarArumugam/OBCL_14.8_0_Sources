create or replace package olpks_vd_sch_cluster is
  /*----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_vd_sch_cluster.spc
  **
  ** Module   : OL
  **
...
end olpks_vd_sch_cluster;
/
create or replace synonym olpkss_vd_sch_cluster for olpks_vd_sch_cluster
/