CREATE OR REPLACE PACKAGE  lbpks_lbdrsmnt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdrsmnt_main.spc
  **
...
TYPE ty_lbdrsmnt IS RECORD (
     v_oltm_reason     oltm_reason%ROWTYPE,
...
FUNCTION Fn_Sys_Query_Desc_Fields  ( p_Source    IN     VARCHAR2,
                        ...
                        p_Wrk_lbdrsmnt  IN   OUT lbpks_lbdrsmnt_Main.ty_lbdrsmnt,
...
FUNCTION Fn_Populate_Record_Master (p_Source            IN     VARCHAR2,
                        ...
                        p_Function_Id       IN     VARCHAR2,
                        p_Action_Code       IN     VARCHAR2,
                        p_lbdrsmnt          IN  lbpks_lbdrsmnt_Main.Ty_lbdrsmnt,
...
FUNCTION Fn_Get_Key_Information (p_Source    IN  VARCHAR2, 
                        ...
                        p_Function_id       IN     VARCHAR2,
                        p_Action_Code       IN     VARCHAR2,
p_lbdrsmnt       IN  OUT lbpks_lbdrsmnt_Main.Ty_lbdrsmnt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdrsmnt_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdrsmnt_main FOR lbpks_lbdrsmnt_main
/