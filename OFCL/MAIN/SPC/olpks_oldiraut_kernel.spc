CREATE OR REPLACE PACKAGE  olpks_oldiraut_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldiraut_kernel.spc
  **
...
END olpks_oldiraut_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldiraut_kernel FOR olpks_oldiraut_kernel
/