CREATE OR REPLACE PACKAGE  tlpks_tldtdupl_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldtdupl_main.spc
  **
...
TYPE ty_tldtdupl IS RECORD (
     v_tltbs_upload_master     tltb_upload_master%ROWTYPE,
     v_tltbs_upload_master__sum     tltb_upload_master%ROWTYPE,
                 ty_tlcswupl Tlpks_Tlcswupl_Main.ty_tlcswupl,
                 ty_tlcupfee Tlpks_Tlcupfee_Main.ty_tlcupfee,
                 ty_tlcupssi Tlpks_Tlcupssi_Main.ty_tlcupssi,
                 ty_tlcupudf Tlpks_Tlcupudf_Main.ty_tlcupudf,
                 ty_tlceronl Tlpks_Tlceronl_Main.ty_tlceronl,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_tldtdupl          IN OUT  tlpks_tldtdupl_Main.Ty_tldtdupl,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Wrk_tldtdupl IN  tlpks_tldtdupl_Main.Ty_tldtdupl,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tldtdupl_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tldtdupl_main FOR tlpks_tldtdupl_main
/