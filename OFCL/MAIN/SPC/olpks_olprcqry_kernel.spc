CREATE OR REPLACE PACKAGE  olpks_olprcqry_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_olprcqry_kernel.spc
  **
  ** Module     : Reconciliation System
  ** 
...
END olpks_olprcqry_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_olprcqry_kernel FOR olpks_olprcqry_kernel
/