CREATE OR REPLACE PACKAGE  olpks_oldadftp_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldadftp_main.spc
  **
...
TYPE ty_oldadftp IS RECORD (
     v_oltb_adv_file_format     oltb_adv_file_format%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldadftp_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldadftp_main FOR olpks_oldadftp_main
/