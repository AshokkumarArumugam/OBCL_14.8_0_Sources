CREATE OR REPLACE PACKAGE  olpks_olcmemge_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_olcmemge_main.spc
  **
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_olcmemge          IN OUT  olpks_olcmemge_Main.Ty_olcmemge,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Main_Function    IN  VARCHAR2,
p_olcmemge       IN    olpks_olcmemge_Main.ty_olcmemge,
...
p_Main_Function    IN  VARCHAR2,
p_olcmemge     IN  olpks_olcmemge_Main.Ty_olcmemge,
p_Prev_olcmemge IN OUT  olpks_olcmemge_Main.Ty_olcmemge,
p_Wrk_olcmemge IN OUT  olpks_olcmemge_Main.Ty_olcmemge,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_olcmemge     IN  olpks_olcmemge_Main.Ty_olcmemge,
p_Prev_olcmemge     IN  olpks_olcmemge_Main.Ty_olcmemge,
p_Wrk_olcmemge      IN OUT  olpks_olcmemge_Main.Ty_olcmemge,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_olcmemge IN  olpks_olcmemge_Main.Ty_olcmemge,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_olcmemge_main;
/
CREATE OR REPLACE SYNONYM olpkss_olcmemge_main FOR olpks_olcmemge_main
/