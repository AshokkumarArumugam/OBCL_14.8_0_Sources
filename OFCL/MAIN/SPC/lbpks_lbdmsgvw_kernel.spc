CREATE OR REPLACE PACKAGE  lbpks_lbdmsgvw_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdmsgvw_kernel.spc
  **
...
END lbpks_lbdmsgvw_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdmsgvw_kernel FOR lbpks_lbdmsgvw_kernel
/