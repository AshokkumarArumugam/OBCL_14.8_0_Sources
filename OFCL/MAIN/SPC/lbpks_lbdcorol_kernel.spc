CREATE OR REPLACE PACKAGE  lbpks_lbdcorol_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdcorol_kernel.spc
  **
  ...
  **  Change Description : global variable for passing counterparty
  **  Search String      : Bug#37226600
  -------------------------------------------------------------------------------------------------------
  */

G_COUNTERPARTY  OLTB_CONTRACT.COUNTERPARTY%TYPE;--Bug#37226600
...
END lbpks_lbdcorol_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdcorol_kernel FOR lbpks_lbdcorol_Kernel
/