CREATE OR REPLACE PACKAGE  tlpks_tldbrkfn_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldbrkfn_main.spc
  **
...
TYPE ty_tb_v_tlvw_bff_fee_detail IS TABLE OF tlvw_bff_fee_detail%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_bff_computation_detail IS TABLE OF tlvw_bff_computation_detail%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_tldbrkfn IS RECORD (
     v_oltbs_contract__dcf     oltb_contract%ROWTYPE,
     v_tlvw_bff_fee_detail    ty_tb_v_tlvw_bff_fee_detail,
     v_bff_computation_detail    ty_tb_v_bff_computation_detail,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_tldbrkfn          IN OUT  tlpks_tldbrkfn_Main.Ty_tldbrkfn,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_tldbrkfn          IN tlpks_tldbrkfn_Main.Ty_tldbrkfn,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_tldbrkfn     IN  tlpks_tldbrkfn_Main.Ty_tldbrkfn,
p_Wrk_tldbrkfn      IN OUT  tlpks_tldbrkfn_Main.Ty_tldbrkfn,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_tldbrkfn     IN  tlpks_tldbrkfn_Main.Ty_tldbrkfn,
p_Prev_tldbrkfn IN OUT  tlpks_tldbrkfn_Main.Ty_tldbrkfn,
p_Wrk_tldbrkfn      IN OUT  tlpks_tldbrkfn_Main.Ty_tldbrkfn,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_tldbrkfn     IN  tlpks_tldbrkfn_Main.Ty_tldbrkfn,
p_Prev_tldbrkfn     IN  tlpks_tldbrkfn_Main.Ty_tldbrkfn,
p_Wrk_tldbrkfn      IN OUT  tlpks_tldbrkfn_Main.Ty_tldbrkfn,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_tldbrkfn IN  tlpks_tldbrkfn_Main.Ty_tldbrkfn,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tldbrkfn_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tldbrkfn_main FOR tlpks_tldbrkfn_main
/