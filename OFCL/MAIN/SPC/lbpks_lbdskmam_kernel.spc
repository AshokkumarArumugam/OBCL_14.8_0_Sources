CREATE OR REPLACE PACKAGE  lbpks_lbdskmam_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdskmam_kernel.spc
  **
...
END lbpks_lbdskmam_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdskmam_kernel FOR lbpks_lbdskmam_kernel
/