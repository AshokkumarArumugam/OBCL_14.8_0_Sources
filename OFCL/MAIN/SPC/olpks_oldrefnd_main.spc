CREATE OR REPLACE PACKAGE  olpks_oldrefnd_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldrefnd_main.spc
  **
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldrefnd          IN OUT  olpks_oldrefnd_Main.Ty_oldrefnd,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Wrk_oldrefnd IN  olpks_oldrefnd_Main.Ty_oldrefnd,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldrefnd_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldrefnd_main FOR olpks_oldrefnd_main
/