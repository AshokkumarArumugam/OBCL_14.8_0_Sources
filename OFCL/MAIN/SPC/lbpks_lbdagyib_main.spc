CREATE OR REPLACE PACKAGE  lbpks_lbdagyib_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdagyib_main.spc
  **
...
TYPE ty_tb_v_wrapper_tr_dd_summary IS TABLE OF lbvw_wrapper_tr_dd_summary%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_ltbs_upload_exception_cs IS TABLE OF oltb_upload_exception_cs%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbdagyib IS RECORD (
     v_agency_wrapper_browser     lbtb_agency_wrapper_browser%ROWTYPE,
     v_wrapper_tr_dd_summary    ty_tb_v_wrapper_tr_dd_summary,
...
FUNCTION Fn_Sys_Query_Desc_Fields  ( p_Source    IN     VARCHAR2,
                        ...
                        p_Wrk_lbdagyib  IN   OUT lbpks_lbdagyib_Main.ty_lbdagyib,
...
FUNCTION Fn_Populate_Record_Master (p_Source            IN     VARCHAR2,
                        ...
                        p_Function_Id       IN     VARCHAR2,
                        p_Action_Code       IN     VARCHAR2,
                        p_lbdagyib          IN  lbpks_lbdagyib_Main.Ty_lbdagyib,
...
FUNCTION Fn_Get_Key_Information (p_Source    IN  VARCHAR2, 
                        ...
                        p_Function_id       IN     VARCHAR2,
                        p_Action_Code       IN     VARCHAR2,
p_lbdagyib       IN  OUT lbpks_lbdagyib_Main.Ty_lbdagyib,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdagyib_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdagyib_main FOR lbpks_lbdagyib_main
/