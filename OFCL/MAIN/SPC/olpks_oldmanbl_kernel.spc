CREATE OR REPLACE PACKAGE  olpks_oldmanbl_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldmanbl_kernel.spc
  **
...
g_prm_cont_stat oltbs_contract.contract_status%TYPE;
...
END olpks_oldmanbl_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldmanbl_kernel FOR olpks_oldmanbl_kernel
/