CREATE OR REPLACE PACKAGE  olpks_oldllrsv_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldllrsv_kernel.spc
  **
  ...
  */
    ...
    g_esn oltbs_contract.latest_event_seq_no%type; --current ESN from table
...
END olpks_oldllrsv_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldllrsv_kernel FOR olpks_oldllrsv_kernel
/