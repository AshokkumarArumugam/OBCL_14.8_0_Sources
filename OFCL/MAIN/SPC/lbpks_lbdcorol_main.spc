CREATE OR REPLACE PACKAGE  lbpks_lbdcorol_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdcorol_main.spc
  **
...
TYPE ty_tb_v_contract_consol_detail IS TABLE OF lbtb_contract_consol_detail%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_ntract_roll_int_rates__s IS TABLE OF oltb_contract_roll_int_rates%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_roll_margin_details__s IS TABLE OF lbtb_roll_margin_details%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb__contract_split_rollover IS TABLE OF oltb_contract_split_rollover%ROWTYPE INDEX BY BINARY_INTEGER;
...
TYPE ty_tb_v_roll_part_borr_linkage IS TABLE OF lbtb_roll_part_borr_linkage%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_participant_share_amt IS TABLE OF lbtb_participant_share_amt%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb__lftbs_cont_addl_int_dtl IS TABLE OF lftb_cont_addl_int_dtl%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_cont_addl_int_dtl__s IS TABLE OF lftb_cont_addl_int_dtl%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbdcorol IS RECORD (
     v_oltbs_contract     oltb_contract%ROWTYPE,
     v_contract_consol_master     lbtb_contract_consol_master%ROWTYPE,
     v_contract_consol_detail    ty_tb_v_contract_consol_detail,
     v_ontract_roll_int_rates__s    ty_tb_ntract_roll_int_rates__s,
     v_roll_margin_details__s    ty_tb_v_roll_margin_details__s,
     v_contract_split_rollover    ty_tb__contract_split_rollover,
     ...
     v_lbtb_rate_setting_rules     lbtb_rate_setting_rules%ROWTYPE,
     v_roll_part_borr_linkage    ty_tb_v_roll_part_borr_linkage,
     v_oltbs_contract_event_log     oltb_contract_event_log%ROWTYPE,
     v_participant_share_amt    ty_tb_v_participant_share_amt,
     v_lbtbs_roll_intrate_fixing     lbtb_roll_intrate_fixing%ROWTYPE,
     v_exrate_fixing_details     lbtb_exrate_fixing_details%ROWTYPE,
     v_lftbs_cont_addl_int_dtl    ty_tb__lftbs_cont_addl_int_dtl,
     v_cont_addl_int_dtl__s    ty_tb_v_cont_addl_int_dtl__s,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdcorol          IN OUT  lbpks_lbdcorol_Main.Ty_lbdcorol,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Wrk_lbdcorol IN  lbpks_lbdcorol_Main.Ty_lbdcorol,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdcorol_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdcorol_main FOR lbpks_lbdcorol_main
/