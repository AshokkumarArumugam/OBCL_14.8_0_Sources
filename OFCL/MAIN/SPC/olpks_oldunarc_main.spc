CREATE OR REPLACE PACKAGE  olpks_oldunarc_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldunarc_main.spc
  **
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldunarc_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldunarc_main FOR olpks_oldunarc_main
/