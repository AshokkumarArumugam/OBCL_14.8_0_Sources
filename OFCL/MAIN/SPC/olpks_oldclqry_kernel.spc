CREATE OR REPLACE PACKAGE olpks_oldclqry_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldclqry_kernel.spc
  **
...
END olpks_oldclqry_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldclqry_kernel FOR olpks_oldclqry_kernel
/