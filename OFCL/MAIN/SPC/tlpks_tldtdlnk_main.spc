CREATE OR REPLACE PACKAGE  tlpks_tldtdlnk_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldtdlnk_main.spc
  **
...
TYPE ty_tldtdlnk IS RECORD (
     v_tltb_trade_linkage     tltb_trade_linkage%ROWTYPE,
...
FUNCTION Fn_Get_Key_Information (p_Source    IN  VARCHAR2, 
                        ...
                        p_Function_id       IN     VARCHAR2,
                        p_Action_Code       IN     VARCHAR2,
p_tldtdlnk       IN  OUT tlpks_tldtdlnk_Main.Ty_tldtdlnk,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tldtdlnk_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tldtdlnk_main FOR tlpks_tldtdlnk_main
/