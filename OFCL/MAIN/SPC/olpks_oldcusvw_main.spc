CREATE OR REPLACE PACKAGE  olpks_oldcusvw_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldcusvw_main.spc
  **
...
TYPE ty_tb_v_olvw_360_cont_det IS TABLE OF olvw_360_cont_det%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_olvw_360_comp_sch_det IS TABLE OF olvw_360_comp_sch_det%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_oldcusvw IS RECORD (
     v_olvw_360_cont_det    ty_tb_v_olvw_360_cont_det,
     v_olvw_360_comp_sch_det    ty_tb_v_olvw_360_comp_sch_det,
     v_oltm_customer     oltm_customer%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldcusvw          IN OUT  olpks_oldcusvw_Main.Ty_oldcusvw,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_oldcusvw          IN olpks_oldcusvw_Main.Ty_oldcusvw,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldcusvw     IN  olpks_oldcusvw_Main.Ty_oldcusvw,
p_Wrk_oldcusvw      IN OUT  olpks_oldcusvw_Main.Ty_oldcusvw,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldcusvw     IN  olpks_oldcusvw_Main.Ty_oldcusvw,
p_Prev_oldcusvw IN OUT  olpks_oldcusvw_Main.Ty_oldcusvw,
p_Wrk_oldcusvw      IN OUT  olpks_oldcusvw_Main.Ty_oldcusvw,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldcusvw     IN  olpks_oldcusvw_Main.Ty_oldcusvw,
p_Prev_oldcusvw     IN  olpks_oldcusvw_Main.Ty_oldcusvw,
p_Wrk_oldcusvw      IN OUT  olpks_oldcusvw_Main.Ty_oldcusvw,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldcusvw IN  olpks_oldcusvw_Main.Ty_oldcusvw,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldcusvw_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldcusvw_main FOR olpks_oldcusvw_main
/