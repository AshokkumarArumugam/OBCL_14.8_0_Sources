CREATE OR REPLACE PACKAGE  lfpks_lfdfeaut_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lfpks_lfdfeaut_kernel.spc
  **
  ** Module     : The ICCF
  ** 
...
END lfpks_lfdfeaut_kernel;
/
CREATE OR REPLACE SYNONYM lfpkss_lfdfeaut_kernel FOR lfpks_lfdfeaut_kernel
/