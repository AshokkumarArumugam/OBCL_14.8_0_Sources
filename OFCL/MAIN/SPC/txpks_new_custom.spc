CREATE OR REPLACE PACKAGE txpks_new_custom AS
/*----------------------------------------------------------------------------------------------------
**
** File Name	: txpks_new_custom.SPC
**
...
END txpks_new_custom;

/
CREATE or replace SYNONYM txpkss_new_custom FOR  txpks_new_custom
/