CREATE OR REPLACE PACKAGE Olpks_Oldmndsb_Subsystem AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldmndsb_subsystem.spc
  **
...
END Olpks_Oldmndsb_Subsystem;
/
CREATE OR REPLACE Synonym Olpkss_Oldmndsb_Subsystem FOR Olpks_Oldmndsb_Subsystem
/