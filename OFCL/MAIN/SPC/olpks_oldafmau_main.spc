CREATE OR REPLACE PACKAGE  olpks_oldafmau_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldafmau_main.spc
  **
...
TYPE ty_oldafmau IS RECORD (
     v_oltms_auto_fund_mapping     oltm_auto_fund_mapping%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldafmau          IN OUT  olpks_oldafmau_Main.Ty_oldafmau,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_oldafmau          IN olpks_oldafmau_Main.Ty_oldafmau,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldafmau     IN  olpks_oldafmau_Main.Ty_oldafmau,
p_Wrk_oldafmau      IN OUT  olpks_oldafmau_Main.Ty_oldafmau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldafmau     IN  olpks_oldafmau_Main.Ty_oldafmau,
p_Prev_oldafmau IN OUT  olpks_oldafmau_Main.Ty_oldafmau,
p_Wrk_oldafmau      IN OUT  olpks_oldafmau_Main.Ty_oldafmau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldafmau     IN  olpks_oldafmau_Main.Ty_oldafmau,
p_Prev_oldafmau     IN  olpks_oldafmau_Main.Ty_oldafmau,
p_Wrk_oldafmau      IN OUT  olpks_oldafmau_Main.Ty_oldafmau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldafmau IN  olpks_oldafmau_Main.Ty_oldafmau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldafmau_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldafmau_main FOR olpks_oldafmau_main
/