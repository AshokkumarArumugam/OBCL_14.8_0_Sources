CREATE OR REPLACE PACKAGE  tlpks_tlcexssi_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tlcexssi_main.spc
  **
...
TYPE ty_tb_v_tlvw_ext_tkt_cusip_det IS TABLE OF tlvw_ext_tkt_cusip_det%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_tltb_ext_cpty_curr_det IS TABLE OF tltb_ext_cpty_curr_det%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_tltb_ext_cpty_entity IS TABLE OF tltb_ext_cpty_entity%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_tlcexssi IS RECORD (
     v_tlvw_ext_tkt_cusip_det__v     tlvw_ext_tkt_cusip_det%ROWTYPE,
     v_tlvw_ext_tkt_cusip_det    ty_tb_v_tlvw_ext_tkt_cusip_det,
     v_tltb_ext_cpty_curr_det    ty_tb_v_tltb_ext_cpty_curr_det,
     v_tltb_ext_cpty_entity    ty_tb_v_tltb_ext_cpty_entity,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_tlcexssi          IN OUT  tlpks_tlcexssi_Main.Ty_tlcexssi,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Main_Function    IN  VARCHAR2,
p_tlcexssi     IN  tlpks_tlcexssi_Main.Ty_tlcexssi,
p_Prev_tlcexssi IN OUT  tlpks_tlcexssi_Main.Ty_tlcexssi,
...
p_Wrk_tlcexssi IN  tlpks_tlcexssi_Main.Ty_tlcexssi,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tlcexssi_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tlcexssi_main FOR tlpks_tlcexssi_main
/