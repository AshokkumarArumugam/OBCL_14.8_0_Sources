CREATE OR REPLACE PACKAGE olpks_oldcontr_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldcontr_kernel.spc
  **
...
END olpks_oldcontr_kernel;
/
Create Or Replace Synonym olpkss_oldcontr_kernel for olpks_oldcontr_kernel
/