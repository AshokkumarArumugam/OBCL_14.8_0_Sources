create or replace package olpks_status_rule_gen_custom is
  /*----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_status_rule_gen_custom.spc
  **
  ** Module   : OL
  **
...
end olpks_status_rule_gen_custom;
/
CREATE or replace SYNONYM olpkss_status_rule_gen_custom FOR olpks_status_rule_gen_custom
/
