CREATE OR REPLACE PACKAGE  lbpks_lbddkmnt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbddkmnt_main.spc
  **
...
TYPE ty_lbddkmnt IS RECORD (
     v_lbtm_desk     lbtm_desk%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbddkmnt_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbddkmnt_main FOR lbpks_lbddkmnt_main
/