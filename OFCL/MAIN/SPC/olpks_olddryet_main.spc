CREATE OR REPLACE PACKAGE  olpks_olddryet_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_olddryet_main.spc
  **
...
TYPE ty_olddryet IS RECORD (
     ...
     v_cstbs_ui_columns__diary     cstb_ui_columns%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_olddryet_main;
/
CREATE OR REPLACE SYNONYM olpkss_olddryet_main FOR olpks_olddryet_main
/