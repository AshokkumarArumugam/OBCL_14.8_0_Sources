CREATE OR REPLACE PACKAGE  lbpks_lbdfeelq_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdfeelq_kernel.spc
  **
...
END lbpks_lbdfeelq_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdfeelq_kernel FOR lbpks_lbdfeelq_Kernel
/