CREATE OR REPLACE PACKAGE olpks_oldvamnd_val_cluster AS
  /*-----------------------------------------------------------------------------------------------------
    **
    ** File Name  : olpks_oldvamnd_val_cluster.spc
    **
  ...
  */
  ...
  PROCEDURE Post_Pr_Log_Error(p_Function_Id in VARCHAR2,
                              ...
                              p_Err_Code    VARCHAR2,
                              p_Err_Params  VARCHAR2);
END olpks_oldvamnd_val_cluster;
/
create or replace synonym olpkss_oldvamnd_val_cluster for olpks_oldvamnd_val_cluster
/