CREATE OR REPLACE PACKAGE  lbpks_lbdcolpt_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdcolpt_kernel.spc
  **
...
END lbpks_lbdcolpt_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdcolpt_kernel FOR lbpks_lbdcolpt_kernel
/