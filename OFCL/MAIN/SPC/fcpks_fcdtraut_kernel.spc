CREATE OR REPLACE PACKAGE  fcpks_fcdtraut_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : fcpks_fcdtraut_kernel.spc
  **
...
END fcpks_fcdtraut_kernel;
/
CREATE OR REPLACE SYNONYM fcpkss_fcdtraut_kernel FOR fcpks_fcdtraut_kernel
/