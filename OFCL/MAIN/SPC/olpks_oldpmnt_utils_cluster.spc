CREATE OR REPLACE PACKAGE olpks_oldpmnt_utils_cluster AS
/*----------------------------------------------------------------------------------------------------
**
** File Name	: olpks_oldpmnt_utils_cluster.SPC
**
...
END olpks_oldpmnt_utils_cluster;
/


CREATE or replace SYNONYM olpkss_oldpmnt_utils_cluster FOR olpks_oldpmnt_utils_cluster
/