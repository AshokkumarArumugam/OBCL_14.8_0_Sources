CREATE OR REPLACE PACKAGE  lbpks_lbdrsaut_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdrsaut_main.spc
  **
...
p_Wrk_lbdrsaut IN  lbpks_lbdrsaut_Main.Ty_lbdrsaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdrsaut_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdrsaut_main FOR lbpks_lbdrsaut_main
/