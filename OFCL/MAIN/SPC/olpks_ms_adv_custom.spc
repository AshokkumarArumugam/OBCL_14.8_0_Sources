create or replace package olpks_ms_adv_custom is

/*--------------------------------------------------------------------------------------------------------
    **
    ** File Name	: olpks_ms_adv_custom.SPC
    **
...
end olpks_ms_adv_custom;
/
CREATE OR REPLACE Synonym olpkss_ms_adv_custom FOR olpks_ms_adv_custom
/