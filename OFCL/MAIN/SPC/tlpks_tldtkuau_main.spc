CREATE OR REPLACE PACKAGE  tlpks_tldtkuau_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldtkuau_main.spc
  **
...
TYPE ty_tldtkuau IS RECORD (
     v_ticket_trade_master__auth     tltb_ticket_trade_master%ROWTYPE,
...
p_Wrk_tldtkuau IN  tlpks_tldtkuau_Main.Ty_tldtkuau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tldtkuau_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tldtkuau_main FOR tlpks_tldtkuau_main
/