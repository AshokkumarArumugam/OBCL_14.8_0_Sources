CREATE OR REPLACE PACKAGE olpks_oldexamd_utils_cluster AS
  /*-----------------------------------------------------------------------------------------------------
    **
    ** File Name  : olpks_oldexamd_utils_cluster.spc
    **
  ...
  */
  ...
  PROCEDURE Post_Pr_Log_Error(p_Function_Id in VARCHAR2,
                              ...
                              p_Err_Code    VARCHAR2,
                              p_Err_Params  VARCHAR2);
END olpks_oldexamd_utils_cluster;
/
create or replace synonym olpkss_oldexamd_utils_cluster for olpks_oldexamd_utils_cluster
/