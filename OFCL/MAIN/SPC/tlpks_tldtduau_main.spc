CREATE OR REPLACE PACKAGE  tlpks_tldtduau_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldtduau_main.spc
  **
...
TYPE ty_tldtduau IS RECORD (
     v_tltbs_upload_master     tltb_upload_master%ROWTYPE,
     v_upload_master__rekey     tltb_upload_master%ROWTYPE,
...
p_Wrk_tldtduau IN  tlpks_tldtduau_Main.Ty_tldtduau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tldtduau_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tldtduau_main FOR tlpks_tldtduau_main
/