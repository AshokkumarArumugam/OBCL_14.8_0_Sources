CREATE OR REPLACE PACKAGE  lbpks_lbdprupl_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdprupl_main.spc
  **
...
TYPE ty_tb_v_lbtbs_pay_recv_upload IS TABLE OF lbtb_pay_recv_upload%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_ltbs_upload_exception_cs IS TABLE OF oltb_upload_exception_cs%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbdprupl IS RECORD (
     v_lbtbs_pay_recv_upl_master     lbtb_pay_recv_upl_master%ROWTYPE,
     v_lbtbs_pay_recv_upload    ty_tb_v_lbtbs_pay_recv_upload,
     v_pay_recv_upl_master__ex     lbtb_pay_recv_upl_master%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdprupl          IN OUT  lbpks_lbdprupl_Main.Ty_lbdprupl,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_lbdprupl          IN lbpks_lbdprupl_Main.Ty_lbdprupl,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdprupl     IN  lbpks_lbdprupl_Main.Ty_lbdprupl,
p_Wrk_lbdprupl      IN OUT  lbpks_lbdprupl_Main.Ty_lbdprupl,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdprupl     IN  lbpks_lbdprupl_Main.Ty_lbdprupl,
p_Prev_lbdprupl IN OUT  lbpks_lbdprupl_Main.Ty_lbdprupl,
p_Wrk_lbdprupl      IN OUT  lbpks_lbdprupl_Main.Ty_lbdprupl,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbdprupl     IN  lbpks_lbdprupl_Main.Ty_lbdprupl,
p_Prev_lbdprupl     IN  lbpks_lbdprupl_Main.Ty_lbdprupl,
p_Wrk_lbdprupl      IN OUT  lbpks_lbdprupl_Main.Ty_lbdprupl,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbdprupl IN  lbpks_lbdprupl_Main.Ty_lbdprupl,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdprupl_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdprupl_main FOR lbpks_lbdprupl_main
/