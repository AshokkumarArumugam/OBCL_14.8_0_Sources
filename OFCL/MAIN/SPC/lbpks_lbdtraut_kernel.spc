CREATE OR REPLACE PACKAGE  lbpks_lbdtraut_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdtraut_kernel.spc
  **
...
END lbpks_lbdtraut_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdtraut_kernel FOR lbpks_lbdtraut_kernel
/