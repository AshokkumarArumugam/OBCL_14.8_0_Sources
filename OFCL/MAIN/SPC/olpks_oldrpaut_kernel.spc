CREATE OR REPLACE PACKAGE olpks_oldrpaut_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldrpaut_kernel.spc
  **
...
END olpks_oldrpaut_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldrpaut_kernel FOR olpks_oldrpaut_kernel
/