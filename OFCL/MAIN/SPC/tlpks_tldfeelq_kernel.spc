CREATE OR REPLACE PACKAGE tlpks_tldfeelq_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldfeelq_kernel.spc
  **
...
END tlpks_tldfeelq_kernel;
/
CREATE OR REPLACE SYNONYM tlpkss_tldfeelq_kernel FOR tlpks_tldfeelq_kernel
/