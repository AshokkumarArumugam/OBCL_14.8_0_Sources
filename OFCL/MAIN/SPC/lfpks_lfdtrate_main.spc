CREATE OR REPLACE PACKAGE  lfpks_lfdtrate_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lfpks_lfdtrate_main.spc
  **
  ** Module     : The ICCF
  ** 
...
TYPE ty_lfdtrate IS RECORD (
     v_lftm_treasury_rate_code     lftm_treasury_rate_code%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lfpks_lfdtrate_main;
/
CREATE OR REPLACE SYNONYM lfpkss_lfdtrate_main FOR lfpks_lfdtrate_main
/