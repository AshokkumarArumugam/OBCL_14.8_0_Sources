CREATE OR REPLACE PACKAGE  olpks_oldhldcr_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldhldcr_main.spc
  **
...
TYPE ty_oldhldcr IS RECORD (
     v_oltms_hold_criteria     oltm_hold_criteria%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldhldcr_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldhldcr_main FOR olpks_oldhldcr_main
/