CREATE OR REPLACE PACKAGE olpks_adv_func_custom AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_adv_func_custom.spc
  **
...
END olpks_adv_func_custom;
/
CREATE OR REPLACE SYNONYM olpkss_adv_func_custom FOR olpks_adv_func_custom
/