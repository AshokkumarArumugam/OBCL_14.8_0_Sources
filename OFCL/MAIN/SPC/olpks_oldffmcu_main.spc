CREATE OR REPLACE PACKAGE  olpks_oldffmcu_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldffmcu_main.spc
  **
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldffmcu          IN OUT  olpks_oldffmcu_Main.Ty_oldffmcu,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Wrk_oldffmcu IN  olpks_oldffmcu_Main.Ty_oldffmcu,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldffmcu_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldffmcu_main FOR olpks_oldffmcu_main
/