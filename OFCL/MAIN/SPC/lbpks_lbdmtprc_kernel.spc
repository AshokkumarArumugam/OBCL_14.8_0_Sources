CREATE OR REPLACE PACKAGE  lbpks_lbdmtprc_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdmtprc_kernel.spc
  **
...
END lbpks_lbdmtprc_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdmtprc_kernel FOR lbpks_lbdmtprc_kernel
/