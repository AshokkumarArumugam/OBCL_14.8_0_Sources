CREATE OR REPLACE PACKAGE  lbpks_lbrinidl_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbrinidl_kernel.spc
  **
...
p_lbrinidl     IN  OUT lbpks_lbrinidl_Main.Ty_lbrinidl,
...
p_lbrinidl IN   lbpks_lbrinidl_Main.ty_lbrinidl,
p_Err_Code       IN  OUT VARCHAR2,
p_Err_Params     IN  OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Child_Function    IN  VARCHAR2,
p_lbrinidl IN   lbpks_lbrinidl_Main.Ty_lbrinidl,
p_Wrk_lbrinidl IN OUT  lbpks_lbrinidl_Main.Ty_lbrinidl,
p_Err_Code       IN  OUT VARCHAR2,
p_Err_Params     IN  OUT VARCHAR2)
RETURN BOOLEAN;
...
END lbpks_lbrinidl_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbrinidl_kernel FOR lbpks_lbrinidl_kernel
/