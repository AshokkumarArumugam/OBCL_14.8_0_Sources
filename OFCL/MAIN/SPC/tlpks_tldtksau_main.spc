CREATE OR REPLACE PACKAGE  tlpks_tldtksau_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldtksau_main.spc
  **
...
TYPE ty_tb_v_tckt_fmem_ccy_details IS TABLE OF tlvw_tckt_fmem_ccy_details%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_olcetmvw IS TABLE OF Olpks_Olcetmvw_Main.ty_olcetmvw INDEX BY PLS_INTEGER;

TYPE ty_tldtksau IS RECORD (
     ...
     v_tckt_fmem_ccy_details    ty_tb_v_tckt_fmem_ccy_details,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_tldtksau          IN OUT  tlpks_tldtksau_Main.Ty_tldtksau,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_tldtksau          IN tlpks_tldtksau_Main.Ty_tldtksau,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_tldtksau     IN  tlpks_tldtksau_Main.Ty_tldtksau,
p_Wrk_tldtksau      IN OUT  tlpks_tldtksau_Main.Ty_tldtksau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_tldtksau     IN  tlpks_tldtksau_Main.Ty_tldtksau,
p_Prev_tldtksau IN OUT  tlpks_tldtksau_Main.Ty_tldtksau,
p_Wrk_tldtksau      IN OUT  tlpks_tldtksau_Main.Ty_tldtksau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_tldtksau     IN  tlpks_tldtksau_Main.Ty_tldtksau,
p_Prev_tldtksau     IN  tlpks_tldtksau_Main.Ty_tldtksau,
p_Wrk_tldtksau      IN OUT  tlpks_tldtksau_Main.Ty_tldtksau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_tldtksau IN  tlpks_tldtksau_Main.Ty_tldtksau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tldtksau_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tldtksau_main FOR tlpks_tldtksau_main
/