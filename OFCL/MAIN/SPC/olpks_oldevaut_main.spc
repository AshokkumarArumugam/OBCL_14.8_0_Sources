CREATE OR REPLACE PACKAGE  olpks_oldevaut_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldevaut_main.spc
  **
  ** Module     : OL
  ** 
...
TYPE ty_tb_v_olvws_contract_liq IS TABLE OF olvw_contract_liq%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_oltbs_contract_ovd IS TABLE OF oltb_contract_ovd%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_oldevaut IS RECORD (
     v_olvws_contract_event     olvw_contract_event%ROWTYPE,
     v_contract_liq_summary     olvw_contract_liq_summary%ROWTYPE,
     v_olvws_contract_liq    ty_tb_v_olvws_contract_liq,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldevaut          IN OUT  olpks_oldevaut_Main.Ty_oldevaut,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_oldevaut          IN olpks_oldevaut_Main.Ty_oldevaut,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldevaut     IN  olpks_oldevaut_Main.Ty_oldevaut,
p_Wrk_oldevaut      IN OUT  olpks_oldevaut_Main.Ty_oldevaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldevaut     IN  olpks_oldevaut_Main.Ty_oldevaut,
p_Prev_oldevaut IN OUT  olpks_oldevaut_Main.Ty_oldevaut,
p_Wrk_oldevaut      IN OUT  olpks_oldevaut_Main.Ty_oldevaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldevaut     IN  olpks_oldevaut_Main.Ty_oldevaut,
p_Prev_oldevaut     IN  olpks_oldevaut_Main.Ty_oldevaut,
p_Wrk_oldevaut      IN OUT  olpks_oldevaut_Main.Ty_oldevaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldevaut IN  olpks_oldevaut_Main.Ty_oldevaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldevaut_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldevaut_main FOR olpks_oldevaut_main
/