CREATE OR REPLACE PACKAGE  lbpks_lbccolet_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbccolet_main.spc
  **
...
TYPE ty_tb_v_tranche_collent_coll IS TABLE OF lbtm_tranche_collent_coll%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_tranche_collent_entity IS TABLE OF lbtm_tranche_collent_entity%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbccolet IS RECORD (
     v_tranche_collent_effdate     lbtm_tranche_collent_effdate%ROWTYPE,
     v_tranche_collent_coll    ty_tb_v_tranche_collent_coll,
     v_tranche_collent_entity    ty_tb_v_tranche_collent_entity,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbccolet          IN OUT  lbpks_lbccolet_Main.Ty_lbccolet,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Main_Function    IN  VARCHAR2,
p_lbccolet       IN    lbpks_lbccolet_Main.ty_lbccolet,
...
p_Main_Function    IN  VARCHAR2,
p_lbccolet     IN  lbpks_lbccolet_Main.Ty_lbccolet,
p_Prev_lbccolet IN OUT  lbpks_lbccolet_Main.Ty_lbccolet,
...
p_Wrk_lbccolet IN  lbpks_lbccolet_Main.Ty_lbccolet,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbccolet_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbccolet_main FOR lbpks_lbccolet_main
/