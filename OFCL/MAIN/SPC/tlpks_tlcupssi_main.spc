CREATE OR REPLACE PACKAGE  tlpks_tlcupssi_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tlcupssi_main.spc
  **
  ** Module     : TL
  ** 
...
TYPE ty_tb_upload_ssi__counterparty IS TABLE OF tltb_upload_ssi%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_tlcupssi IS RECORD (
     v_tltbs_upload_master__ssi     tltb_upload_master%ROWTYPE,
     v_tltbs_upload_ssi__agent     tltb_upload_ssi%ROWTYPE,
     v_upload_ssi__counterparty    ty_tb_upload_ssi__counterparty,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_tlcupssi          IN OUT  tlpks_tlcupssi_Main.Ty_tlcupssi,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Main_Function    IN  VARCHAR2,
p_tlcupssi     IN  tlpks_tlcupssi_Main.Ty_tlcupssi,
p_Prev_tlcupssi IN OUT  tlpks_tlcupssi_Main.Ty_tlcupssi,
...
p_Wrk_tlcupssi IN  tlpks_tlcupssi_Main.Ty_tlcupssi,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tlcupssi_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tlcupssi_main FOR tlpks_tlcupssi_main
/