CREATE OR REPLACE PACKAGE lfpks_lfdacfin_utils_cluster AS
  /*-----------------------------------------------------------------------------------------------------
    **
    ** File Name  : lfpks_lfdacfin_utils_cluster.spc
    **
...
END lfpks_lfdacfin_utils_cluster;

/
CREATE OR REPLACE Synonym lfpkss_lfdacfin_utils_cluster FOR lfpks_lfdacfin_utils_cluster
/