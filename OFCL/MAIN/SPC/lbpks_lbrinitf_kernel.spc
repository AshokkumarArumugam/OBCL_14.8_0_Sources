CREATE OR REPLACE PACKAGE  lbpks_lbrinitf_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbrinitf_kernel.spc
  **
...
p_lbrinitf     IN  OUT lbpks_lbrinitf_Main.Ty_lbrinitf,
...
p_lbrinitf IN   lbpks_lbrinitf_Main.ty_lbrinitf,
p_Err_Code       IN  OUT VARCHAR2,
p_Err_Params     IN  OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Child_Function    IN  VARCHAR2,
p_lbrinitf IN   lbpks_lbrinitf_Main.Ty_lbrinitf,
p_Wrk_lbrinitf IN OUT  lbpks_lbrinitf_Main.Ty_lbrinitf,
p_Err_Code       IN  OUT VARCHAR2,
p_Err_Params     IN  OUT VARCHAR2)
RETURN BOOLEAN;
...
END lbpks_lbrinitf_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbrinitf_kernel FOR lbpks_lbrinitf_kernel
/