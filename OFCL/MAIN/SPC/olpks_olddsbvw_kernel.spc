CREATE OR REPLACE PACKAGE  olpks_olddsbvw_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_olddsbvw_kernel.spc
  **
  ** Module     : OL
  ** 
...
END olpks_olddsbvw_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_olddsbvw_kernel FOR olpks_olddsbvw_Kernel
/