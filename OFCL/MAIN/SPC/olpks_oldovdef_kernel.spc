CREATE OR REPLACE PACKAGE  olpks_oldovdef_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldovdef_kernel.spc
  **
...
END olpks_oldovdef_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldovdef_kernel FOR olpks_oldovdef_Kernel
/