CREATE OR REPLACE PACKAGE  lbpks_lbdjobrn_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdjobrn_kernel.spc
  **
...
END lbpks_lbdjobrn_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdjobrn_kernel FOR lbpks_lbdjobrn_kernel
/