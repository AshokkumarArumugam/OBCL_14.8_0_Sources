CREATE OR REPLACE PACKAGE  tlpks_tldtrfee_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldtrfee_kernel.spc
  **
  ** Module     : TL
  ** 
...
END tlpks_tldtrfee_kernel;
/
CREATE OR REPLACE SYNONYM tlpkss_tldtrfee_kernel FOR tlpks_tldtrfee_kernel
/