CREATE OR REPLACE PACKAGE  olpks_oldlraut_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldlraut_main.spc
  **
...
TYPE ty_oldlraut IS RECORD (
     ...
     v_oltbs_contract_reserve     oltb_contract_reserve%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldlraut          IN OUT  olpks_oldlraut_Main.Ty_oldlraut,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_oldlraut          IN olpks_oldlraut_Main.Ty_oldlraut,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldlraut     IN  olpks_oldlraut_Main.Ty_oldlraut,
p_Wrk_oldlraut      IN OUT  olpks_oldlraut_Main.Ty_oldlraut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldlraut     IN  olpks_oldlraut_Main.Ty_oldlraut,
p_Prev_oldlraut IN OUT  olpks_oldlraut_Main.Ty_oldlraut,
p_Wrk_oldlraut      IN OUT  olpks_oldlraut_Main.Ty_oldlraut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldlraut     IN  olpks_oldlraut_Main.Ty_oldlraut,
p_Prev_oldlraut     IN  olpks_oldlraut_Main.Ty_oldlraut,
p_Wrk_oldlraut      IN OUT  olpks_oldlraut_Main.Ty_oldlraut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldlraut IN  olpks_oldlraut_Main.Ty_oldlraut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldlraut_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldlraut_main FOR olpks_oldlraut_main
/