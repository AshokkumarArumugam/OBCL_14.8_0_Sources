CREATE OR REPLACE PACKAGE  olpks_olcintrt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_olcintrt_main.spc
  **
...
TYPE ty_tb_v_oltbs_contract_irr IS TABLE OF oltb_contract_irr%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_olcintrt IS RECORD (
     v_oltbs_contract_master__ic     oltb_contract_master%ROWTYPE,
     v_oltbs_contract_irr    ty_tb_v_oltbs_contract_irr,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_olcintrt          IN OUT  olpks_olcintrt_Main.Ty_olcintrt,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Main_Function    IN  VARCHAR2,
p_olcintrt       IN    olpks_olcintrt_Main.ty_olcintrt,
...
p_Main_Function    IN  VARCHAR2,
p_olcintrt     IN  olpks_olcintrt_Main.Ty_olcintrt,
p_Prev_olcintrt IN OUT  olpks_olcintrt_Main.Ty_olcintrt,
p_Wrk_olcintrt IN OUT  olpks_olcintrt_Main.Ty_olcintrt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_olcintrt     IN  olpks_olcintrt_Main.Ty_olcintrt,
p_Prev_olcintrt     IN  olpks_olcintrt_Main.Ty_olcintrt,
p_Wrk_olcintrt      IN OUT  olpks_olcintrt_Main.Ty_olcintrt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_olcintrt IN  olpks_olcintrt_Main.Ty_olcintrt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_olcintrt_main;
/
CREATE OR REPLACE SYNONYM olpkss_olcintrt_main FOR olpks_olcintrt_main
/