CREATE OR REPLACE PACKAGE  olpks_olprlink_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_olprlink_main.spc
  **
...
TYPE ty_olprlink IS RECORD (
     v_lbtm_stp_contract_relink     lbtm_stp_contract_relink%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_olprlink_main;
/
CREATE OR REPLACE SYNONYM olpkss_olprlink_main FOR olpks_olprlink_main
/