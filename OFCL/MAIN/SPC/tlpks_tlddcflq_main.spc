CREATE OR REPLACE PACKAGE  tlpks_tlddcflq_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tlddcflq_main.spc
  **
  ** Module     : TL
  ** 
...
TYPE ty_tb_liqd_trade_detail__tlltd IS TABLE OF tltb_dcf_liqd_trade_detail%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb__liqd_comp_detail__tllcd IS TABLE OF tltb_dcf_liqd_comp_detail%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_iqd_entity_detail__tlled IS TABLE OF tltb_dcf_liqd_entity_detail%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_tlddcflq IS RECORD (
     v_liqd_agency_master__tllam     tltb_dcf_liqd_agency_master%ROWTYPE,
     v_liqd_trade_detail__tlltd    ty_tb_liqd_trade_detail__tlltd,
     v_liqd_comp_detail__tllcd    ty_tb__liqd_comp_detail__tllcd,
     v_contract_event_log__olcel     oltb_contract_event_log%ROWTYPE,
     v_liqd_entity_detail__tlled    ty_tb_iqd_entity_detail__tlled,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_tlddcflq          IN OUT  tlpks_tlddcflq_Main.Ty_tlddcflq,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_tlddcflq     IN  tlpks_tlddcflq_Main.Ty_tlddcflq,
p_Prev_tlddcflq IN OUT  tlpks_tlddcflq_Main.Ty_tlddcflq,
p_Wrk_tlddcflq      IN OUT  tlpks_tlddcflq_Main.Ty_tlddcflq,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_tlddcflq     IN  tlpks_tlddcflq_Main.Ty_tlddcflq,
p_Prev_tlddcflq     IN  tlpks_tlddcflq_Main.Ty_tlddcflq,
p_Wrk_tlddcflq      IN OUT  tlpks_tlddcflq_Main.Ty_tlddcflq,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_tlddcflq IN  tlpks_tlddcflq_Main.Ty_tlddcflq,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tlddcflq_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tlddcflq_main FOR tlpks_tlddcflq_main
/