CREATE OR REPLACE PACKAGE  lbpks_lbdptadv_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdptadv_main.spc
  **
...
TYPE ty_tb_v_lbvw_pram_msg_regen IS TABLE OF lbvw_pram_msg_regen%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_lbtb_pram_msg_regen IS TABLE OF lbtb_pram_msg_regen%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbdptadv IS RECORD (
     v_oltbs_contract     oltb_contract%ROWTYPE,
     v_lbvw_pram_msg_regen    ty_tb_v_lbvw_pram_msg_regen,
     v_lbtb_pram_msg_regen    ty_tb_v_lbtb_pram_msg_regen,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdptadv          IN OUT  lbpks_lbdptadv_Main.Ty_lbdptadv,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_lbdptadv          IN lbpks_lbdptadv_Main.Ty_lbdptadv,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdptadv     IN  lbpks_lbdptadv_Main.Ty_lbdptadv,
p_Wrk_lbdptadv      IN OUT  lbpks_lbdptadv_Main.Ty_lbdptadv,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdptadv     IN  lbpks_lbdptadv_Main.Ty_lbdptadv,
p_Prev_lbdptadv IN OUT  lbpks_lbdptadv_Main.Ty_lbdptadv,
p_Wrk_lbdptadv      IN OUT  lbpks_lbdptadv_Main.Ty_lbdptadv,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbdptadv     IN  lbpks_lbdptadv_Main.Ty_lbdptadv,
p_Prev_lbdptadv     IN  lbpks_lbdptadv_Main.Ty_lbdptadv,
p_Wrk_lbdptadv      IN OUT  lbpks_lbdptadv_Main.Ty_lbdptadv,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbdptadv IN  lbpks_lbdptadv_Main.Ty_lbdptadv,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdptadv_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdptadv_main FOR lbpks_lbdptadv_main
/