CREATE OR REPLACE PACKAGE  olpks_oldaccls_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldaccls_main.spc
  **
...
TYPE ty_tb_ntract_closure_check__ch IS TABLE OF oltb_contract_closure_check%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_oldaccls IS RECORD (
     v_contract_closure_check     oltb_contract_closure_check%ROWTYPE,
     v_ontract_closure_check__ch    ty_tb_ntract_closure_check__ch,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldaccls          IN OUT  olpks_oldaccls_Main.Ty_oldaccls,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_oldaccls          IN olpks_oldaccls_Main.Ty_oldaccls,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldaccls     IN  olpks_oldaccls_Main.Ty_oldaccls,
p_Wrk_oldaccls      IN OUT  olpks_oldaccls_Main.Ty_oldaccls,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldaccls     IN  olpks_oldaccls_Main.Ty_oldaccls,
p_Prev_oldaccls IN OUT  olpks_oldaccls_Main.Ty_oldaccls,
p_Wrk_oldaccls      IN OUT  olpks_oldaccls_Main.Ty_oldaccls,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldaccls     IN  olpks_oldaccls_Main.Ty_oldaccls,
p_Prev_oldaccls     IN  olpks_oldaccls_Main.Ty_oldaccls,
p_Wrk_oldaccls      IN OUT  olpks_oldaccls_Main.Ty_oldaccls,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldaccls IN  olpks_oldaccls_Main.Ty_oldaccls,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldaccls_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldaccls_main FOR olpks_oldaccls_main
/