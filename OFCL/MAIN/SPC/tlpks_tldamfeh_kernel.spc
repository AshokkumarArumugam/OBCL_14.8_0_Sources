CREATE OR REPLACE PACKAGE tlpks_tldamfeh_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldamfeh_kernel.spc
  **
...
END tlpks_tldamfeh_kernel;
/
CREATE OR REPLACE SYNONYM tlpkss_tldamfeh_kernel FOR tlpks_tldamfeh_kernel
/