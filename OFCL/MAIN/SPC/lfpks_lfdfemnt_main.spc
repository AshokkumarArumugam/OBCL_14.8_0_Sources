CREATE OR REPLACE PACKAGE  lfpks_lfdfemnt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lfpks_lfdfemnt_main.spc
  **
  ** Module     : The ICCF
  ** 
...
TYPE ty_lfdfemnt IS RECORD (
     v_lftms_fee_definition     lftm_fee_definition%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lfpks_lfdfemnt_main;
/
CREATE OR REPLACE SYNONYM lfpkss_lfdfemnt_main FOR lfpks_lfdfemnt_main
/