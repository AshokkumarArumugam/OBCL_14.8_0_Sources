CREATE OR REPLACE PACKAGE  lbpks_lbdstpmp_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdstpmp_main.spc
  **
  ** Module     : LB
  ** 
...
TYPE ty_tb__stp_mark_process_detail IS TABLE OF lbtm_stp_mark_process_detail%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbdstpmp IS RECORD (
     v_lbtbs_part_proc_stat     lbtb_part_proc_stat%ROWTYPE,
     v_stp_mark_process_master     lbtm_stp_mark_process_master%ROWTYPE,
     v_stp_mark_process_detail    ty_tb__stp_mark_process_detail,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdstpmp          IN OUT  lbpks_lbdstpmp_Main.Ty_lbdstpmp,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_lbdstpmp          IN lbpks_lbdstpmp_Main.Ty_lbdstpmp,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdstpmp     IN  lbpks_lbdstpmp_Main.Ty_lbdstpmp,
p_Prev_lbdstpmp IN OUT  lbpks_lbdstpmp_Main.Ty_lbdstpmp,
p_Wrk_lbdstpmp      IN OUT  lbpks_lbdstpmp_Main.Ty_lbdstpmp,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbdstpmp     IN  lbpks_lbdstpmp_Main.Ty_lbdstpmp,
p_Prev_lbdstpmp     IN  lbpks_lbdstpmp_Main.Ty_lbdstpmp,
p_Wrk_lbdstpmp      IN OUT  lbpks_lbdstpmp_Main.Ty_lbdstpmp,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbdstpmp IN  lbpks_lbdstpmp_Main.Ty_lbdstpmp,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdstpmp_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdstpmp_main FOR lbpks_lbdstpmp_main
/