CREATE OR REPLACE PACKAGE  lfpks_lfdacfcl_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lfpks_lfdacfcl_main.spc
  **
  ** Module     : The ICCF
  ** 
...
TYPE ty_lfdacfcl IS RECORD (
     v_oltm_class     oltm_class%ROWTYPE,
     v_lftms_accr_fee_class     lftm_accr_fee_class%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lfpks_lfdacfcl_main;
/
CREATE OR REPLACE SYNONYM lfpkss_lfdacfcl_main FOR lfpks_lfdacfcl_main
/