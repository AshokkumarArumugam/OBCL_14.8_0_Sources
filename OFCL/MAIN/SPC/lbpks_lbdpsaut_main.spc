CREATE OR REPLACE PACKAGE  lbpks_lbdpsaut_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdpsaut_main.spc
  **
...
TYPE ty_tb_v_schedule_upload__payau IS TABLE OF lbtb_schedule_upload%ROWTYPE INDEX BY BINARY_INTEGER;
...
TYPE ty_lbdpsaut IS RECORD (
     v_upload_master__payau     lbtb_schedule_upload_master%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdpsaut          IN OUT  lbpks_lbdpsaut_Main.Ty_lbdpsaut,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbdpsaut     IN  lbpks_lbdpsaut_Main.Ty_lbdpsaut,
p_Prev_lbdpsaut     IN  lbpks_lbdpsaut_Main.Ty_lbdpsaut,
p_Wrk_lbdpsaut      IN OUT  lbpks_lbdpsaut_Main.Ty_lbdpsaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbdpsaut IN  lbpks_lbdpsaut_Main.Ty_lbdpsaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdpsaut_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdpsaut_main FOR lbpks_lbdpsaut_main
/