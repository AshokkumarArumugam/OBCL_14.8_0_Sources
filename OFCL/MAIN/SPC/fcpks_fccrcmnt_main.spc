CREATE OR REPLACE PACKAGE  fcpks_fccrcmnt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : fcpks_fccrcmnt_main.spc
  **
...
TYPE ty_tb_ntract_participant__part IS TABLE OF lbtb_contract_participant%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_fccrcmnt IS RECORD (
     v_oltbs_contract__mrgn     oltb_contract%ROWTYPE,
     ...
     v_ontract_participant__part    ty_tb_ntract_participant__part,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_fccrcmnt          IN OUT  fcpks_fccrcmnt_Main.Ty_fccrcmnt,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Main_Function    IN  VARCHAR2,
p_fccrcmnt       IN    fcpks_fccrcmnt_Main.ty_fccrcmnt,
...
p_Main_Function    IN  VARCHAR2,
p_fccrcmnt     IN  fcpks_fccrcmnt_Main.Ty_fccrcmnt,
p_Prev_fccrcmnt IN OUT  fcpks_fccrcmnt_Main.Ty_fccrcmnt,
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_fccrcmnt     IN  fcpks_fccrcmnt_Main.Ty_fccrcmnt,
p_Prev_fccrcmnt     IN  fcpks_fccrcmnt_Main.Ty_fccrcmnt,
p_Wrk_fccrcmnt      IN OUT  fcpks_fccrcmnt_Main.Ty_fccrcmnt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_fccrcmnt IN  fcpks_fccrcmnt_Main.Ty_fccrcmnt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END fcpks_fccrcmnt_main;
/
CREATE OR REPLACE SYNONYM fcpkss_fccrcmnt_main FOR fcpks_fccrcmnt_main
/