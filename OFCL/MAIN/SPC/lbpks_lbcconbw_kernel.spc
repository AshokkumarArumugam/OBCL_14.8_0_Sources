CREATE OR REPLACE PACKAGE lbpks_lbcconbw_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbcconbw_kernel.spc
  **
...
END lbpks_lbcconbw_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbcconbw_kernel FOR lbpks_lbcconbw_kernel
/