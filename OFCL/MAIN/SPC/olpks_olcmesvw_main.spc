CREATE OR REPLACE PACKAGE  olpks_olcmesvw_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_olcmesvw_main.spc
  **
  ** Module     : Messaging
  ** 
...
FUNCTION Fn_Sys_Query_Desc_Fields  ( p_Source    IN     VARCHAR2,
                        ...
                        p_Wrk_olcmesvw  IN   OUT olpks_olcmesvw_Main.ty_olcmesvw,
...
p_olcmesvw       IN   OUT olpks_olcmesvw_Main.Ty_olcmesvw,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Main_Function    IN  VARCHAR2,
p_olcmesvw          IN olpks_olcmesvw_Main.Ty_olcmesvw,
...
p_olcmesvw     IN  olpks_olcmesvw_Main.Ty_olcmesvw,
p_Prev_olcmesvw IN OUT  olpks_olcmesvw_Main.Ty_olcmesvw,
p_Wrk_olcmesvw IN OUT  olpks_olcmesvw_Main.Ty_olcmesvw,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_olcmesvw     IN  olpks_olcmesvw_Main.Ty_olcmesvw,
p_Prev_olcmesvw     IN  olpks_olcmesvw_Main.Ty_olcmesvw,
p_Wrk_olcmesvw      IN OUT  olpks_olcmesvw_Main.Ty_olcmesvw,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Mod_No    IN  NUMBER,
                        p_Prev_olcmesvw          IN  olpks_olcmesvw_Main.Ty_olcmesvw,
                        p_Wrk_olcmesvw          IN  olpks_olcmesvw_Main.Ty_olcmesvw,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_olcmesvw_main;
/
CREATE OR REPLACE SYNONYM olpkss_olcmesvw_main FOR olpks_olcmesvw_main
/