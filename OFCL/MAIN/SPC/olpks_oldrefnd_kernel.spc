CREATE OR REPLACE PACKAGE  olpks_oldrefnd_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldrefnd_kernel.spc
  **
...
END olpks_oldrefnd_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldrefnd_kernel FOR olpks_oldrefnd_kernel
/