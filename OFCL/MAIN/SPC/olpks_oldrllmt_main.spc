CREATE OR REPLACE PACKAGE  olpks_oldrllmt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldrllmt_main.spc
  **
...
TYPE ty_oldrllmt IS RECORD (
     v_oltb_role_limit     oltb_role_limit%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldrllmt_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldrllmt_main FOR olpks_oldrllmt_main
/