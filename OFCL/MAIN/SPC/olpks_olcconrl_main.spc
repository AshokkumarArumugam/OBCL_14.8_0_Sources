CREATE OR REPLACE PACKAGE  olpks_olcconrl_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_olcconrl_main.spc
  **
...
TYPE ty_tb_oltms_contract_relations IS TABLE OF oltm_contract_relations%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_olcconrl IS RECORD (
     v_oltbs_contract__crl     oltb_contract%ROWTYPE,
     v_oltms_contract_relations    ty_tb_oltms_contract_relations,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_olcconrl          IN OUT  olpks_olcconrl_Main.Ty_olcconrl,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Main_Function    IN  VARCHAR2,
p_olcconrl       IN    olpks_olcconrl_Main.ty_olcconrl,
...
p_Main_Function    IN  VARCHAR2,
p_olcconrl     IN  olpks_olcconrl_Main.Ty_olcconrl,
p_Prev_olcconrl IN OUT  olpks_olcconrl_Main.Ty_olcconrl,
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_olcconrl     IN  olpks_olcconrl_Main.Ty_olcconrl,
p_Prev_olcconrl     IN  olpks_olcconrl_Main.Ty_olcconrl,
p_Wrk_olcconrl      IN OUT  olpks_olcconrl_Main.Ty_olcconrl,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_olcconrl IN  olpks_olcconrl_Main.Ty_olcconrl,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_olcconrl_main;
/
CREATE OR REPLACE SYNONYM olpkss_olcconrl_main FOR olpks_olcconrl_main
/