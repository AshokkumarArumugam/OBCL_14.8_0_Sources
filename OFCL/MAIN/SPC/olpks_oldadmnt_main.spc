CREATE OR REPLACE PACKAGE  olpks_oldadmnt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldadmnt_main.spc
  **
...
TYPE ty_oldadmnt IS RECORD (
     v_oltms_other_addresses     oltm_other_addresses%ROWTYPE,
...
FUNCTION Fn_Sys_Query_Desc_Fields  ( p_Source    IN     VARCHAR2,
                        ...
                        p_Wrk_oldadmnt  IN   OUT olpks_oldadmnt_Main.ty_oldadmnt,
...
FUNCTION Fn_Populate_Record_Master (p_Source            IN     VARCHAR2,
                        ...
                        p_Function_Id       IN     VARCHAR2,
                        p_Action_Code       IN     VARCHAR2,
                        p_oldadmnt          IN  olpks_oldadmnt_Main.Ty_oldadmnt,
...
FUNCTION Fn_Get_Key_Information (p_Source    IN  VARCHAR2, 
                        ...
                        p_Function_id       IN     VARCHAR2,
                        p_Action_Code       IN     VARCHAR2,
p_oldadmnt       IN  OUT olpks_oldadmnt_Main.Ty_oldadmnt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldadmnt_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldadmnt_main FOR olpks_oldadmnt_main
/