CREATE OR REPLACE PACKAGE  lbpks_lbdtfrqu_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdtfrqu_main.spc
  **
...
TYPE ty_lbdtfrqu IS RECORD (
     v_lbvws_trade_process_queue     lbvw_trade_process_queue%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdtfrqu          IN OUT  lbpks_lbdtfrqu_Main.Ty_lbdtfrqu,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_lbdtfrqu          IN lbpks_lbdtfrqu_Main.Ty_lbdtfrqu,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdtfrqu     IN  lbpks_lbdtfrqu_Main.Ty_lbdtfrqu,
p_Wrk_lbdtfrqu      IN OUT  lbpks_lbdtfrqu_Main.Ty_lbdtfrqu,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdtfrqu     IN  lbpks_lbdtfrqu_Main.Ty_lbdtfrqu,
p_Prev_lbdtfrqu IN OUT  lbpks_lbdtfrqu_Main.Ty_lbdtfrqu,
p_Wrk_lbdtfrqu      IN OUT  lbpks_lbdtfrqu_Main.Ty_lbdtfrqu,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbdtfrqu     IN  lbpks_lbdtfrqu_Main.Ty_lbdtfrqu,
p_Prev_lbdtfrqu     IN  lbpks_lbdtfrqu_Main.Ty_lbdtfrqu,
p_Wrk_lbdtfrqu      IN OUT  lbpks_lbdtfrqu_Main.Ty_lbdtfrqu,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbdtfrqu IN  lbpks_lbdtfrqu_Main.Ty_lbdtfrqu,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdtfrqu_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdtfrqu_main FOR lbpks_lbdtfrqu_main
/