CREATE OR REPLACE PACKAGE  lbpks_lbdpyaut_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdpyaut_main.spc
  **
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdpyaut          IN OUT  lbpks_lbdpyaut_Main.Ty_lbdpyaut,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbdpyaut     IN  lbpks_lbdpyaut_Main.Ty_lbdpyaut,
p_Prev_lbdpyaut     IN  lbpks_lbdpyaut_Main.Ty_lbdpyaut,
p_Wrk_lbdpyaut      IN OUT  lbpks_lbdpyaut_Main.Ty_lbdpyaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbdpyaut IN  lbpks_lbdpyaut_Main.Ty_lbdpyaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdpyaut_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdpyaut_main FOR lbpks_lbdpyaut_main
/