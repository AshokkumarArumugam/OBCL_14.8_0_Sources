CREATE OR REPLACE PACKAGE  lfpks_lfdacaut_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lfpks_lfdacaut_main.spc
  **
  ** Module     : LF
  ** 
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lfdacaut          IN OUT  lfpks_lfdacaut_Main.Ty_lfdacaut,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_lfdacaut          IN lfpks_lfdacaut_Main.Ty_lfdacaut,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lfdacaut     IN  lfpks_lfdacaut_Main.Ty_lfdacaut,
p_Wrk_lfdacaut      IN OUT  lfpks_lfdacaut_Main.Ty_lfdacaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lfdacaut     IN  lfpks_lfdacaut_Main.Ty_lfdacaut,
p_Prev_lfdacaut IN OUT  lfpks_lfdacaut_Main.Ty_lfdacaut,
p_Wrk_lfdacaut      IN OUT  lfpks_lfdacaut_Main.Ty_lfdacaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lfdacaut     IN  lfpks_lfdacaut_Main.Ty_lfdacaut,
p_Prev_lfdacaut     IN  lfpks_lfdacaut_Main.Ty_lfdacaut,
p_Wrk_lfdacaut      IN OUT  lfpks_lfdacaut_Main.Ty_lfdacaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lfdacaut IN  lfpks_lfdacaut_Main.Ty_lfdacaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lfpks_lfdacaut_main;
/
CREATE OR REPLACE SYNONYM lfpkss_lfdacaut_main FOR lfpks_lfdacaut_main
/