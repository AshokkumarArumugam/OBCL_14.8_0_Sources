CREATE OR REPLACE PACKAGE  lbpks_lbdjobrn_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdjobrn_main.spc
  **
...
TYPE ty_lbdjobrn IS RECORD (
     v_lbvws_prjobrn     lbvw_prjobrn%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdjobrn          IN OUT  lbpks_lbdjobrn_Main.Ty_lbdjobrn,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_lbdjobrn          IN lbpks_lbdjobrn_Main.Ty_lbdjobrn,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdjobrn     IN  lbpks_lbdjobrn_Main.Ty_lbdjobrn,
p_Wrk_lbdjobrn      IN OUT  lbpks_lbdjobrn_Main.Ty_lbdjobrn,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdjobrn     IN  lbpks_lbdjobrn_Main.Ty_lbdjobrn,
p_Prev_lbdjobrn IN OUT  lbpks_lbdjobrn_Main.Ty_lbdjobrn,
p_Wrk_lbdjobrn      IN OUT  lbpks_lbdjobrn_Main.Ty_lbdjobrn,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbdjobrn     IN  lbpks_lbdjobrn_Main.Ty_lbdjobrn,
p_Prev_lbdjobrn     IN  lbpks_lbdjobrn_Main.Ty_lbdjobrn,
p_Wrk_lbdjobrn      IN OUT  lbpks_lbdjobrn_Main.Ty_lbdjobrn,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbdjobrn IN  lbpks_lbdjobrn_Main.Ty_lbdjobrn,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdjobrn_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdjobrn_main FOR lbpks_lbdjobrn_main
/