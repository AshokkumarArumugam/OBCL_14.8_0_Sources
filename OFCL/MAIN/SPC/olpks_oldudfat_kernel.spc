create or replace PACKAGE  olpks_oldudfat_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldudfat_kernel.spc
  **
...
END olpks_oldudfat_kernel;
/
CREATE OR REPLACE Synonym olpkss_oldudfat_kernel FOR olpks_oldudfat_kernel
/