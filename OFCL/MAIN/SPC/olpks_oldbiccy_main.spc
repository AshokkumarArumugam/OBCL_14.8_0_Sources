CREATE OR REPLACE PACKAGE  olpks_oldbiccy_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldbiccy_main.spc
  **
...
TYPE ty_oldbiccy IS RECORD (
     v_oltms_bic_cover_maint     oltm_bic_cover_maint%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldbiccy_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldbiccy_main FOR olpks_oldbiccy_main
/