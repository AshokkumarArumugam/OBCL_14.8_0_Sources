CREATE OR REPLACE PACKAGE lbpks_lbdrpaut_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdrpaut_kernel.spc
  **
...
END lbpks_lbdrpaut_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdrpaut_kernel for lbpks_lbdrpaut_kernel
/