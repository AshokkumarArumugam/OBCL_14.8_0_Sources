CREATE OR REPLACE PACKAGE olpks_oldpdequ_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldpdequ_kernel.spc
  **
  ** Module     : Messaging
  **
...
END olpks_oldpdequ_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldpdequ_kernel FOR olpks_oldpdequ_kernel
/