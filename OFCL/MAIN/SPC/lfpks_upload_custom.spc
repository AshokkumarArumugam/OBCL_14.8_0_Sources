create or replace package LFPKS_UPLOAD_CUSTOM as

   /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : LFPKS_UPLOAD_CUSTOM.spc
  **
...
end LFPKS_UPLOAD_CUSTOM;
/
CREATE OR REPLACE Synonym LFPKSS_UPLOAD_CUSTOM FOR LFPKS_UPLOAD_CUSTOM
/