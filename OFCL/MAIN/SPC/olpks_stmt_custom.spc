create or replace package olpks_stmt_custom is
  /*----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_stmt_custom.spc
  **
  ** Module   : OL
  **
...
end olpks_stmt_custom;
/
create or replace synonym olpkss_stmt_custom for olpks_stmt_custom
/