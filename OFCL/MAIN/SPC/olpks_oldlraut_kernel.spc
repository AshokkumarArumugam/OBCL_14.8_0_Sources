CREATE OR REPLACE PACKAGE  olpks_oldlraut_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldlraut_kernel.spc
  **
...
END olpks_oldlraut_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldlraut_kernel FOR olpks_oldlraut_kernel
/