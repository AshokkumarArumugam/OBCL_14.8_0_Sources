CREATE OR REPLACE PACKAGE  tlpks_tldpodau_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldpodau_main.spc
  **
...
TYPE ty_tldpodau IS RECORD (
     v_position_dcf_stat_change     tltb_position_dcf_stat_change%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_tldpodau          IN OUT  tlpks_tldpodau_Main.Ty_tldpodau,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_tldpodau          IN tlpks_tldpodau_Main.Ty_tldpodau,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_tldpodau     IN  tlpks_tldpodau_Main.Ty_tldpodau,
p_Wrk_tldpodau      IN OUT  tlpks_tldpodau_Main.Ty_tldpodau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_tldpodau     IN  tlpks_tldpodau_Main.Ty_tldpodau,
p_Prev_tldpodau IN OUT  tlpks_tldpodau_Main.Ty_tldpodau,
p_Wrk_tldpodau      IN OUT  tlpks_tldpodau_Main.Ty_tldpodau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_tldpodau     IN  tlpks_tldpodau_Main.Ty_tldpodau,
p_Prev_tldpodau     IN  tlpks_tldpodau_Main.Ty_tldpodau,
p_Wrk_tldpodau      IN OUT  tlpks_tldpodau_Main.Ty_tldpodau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_tldpodau IN  tlpks_tldpodau_Main.Ty_tldpodau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tldpodau_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tldpodau_main FOR tlpks_tldpodau_main
/