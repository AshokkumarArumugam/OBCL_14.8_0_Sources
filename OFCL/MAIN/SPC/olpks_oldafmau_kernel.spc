CREATE OR REPLACE PACKAGE  olpks_oldafmau_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldafmau_kernel.spc
  **
...
END olpks_oldafmau_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldafmau_kernel FOR olpks_oldafmau_kernel
/