create or replace package olpks_schedules_cluster is
  /*----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_schedules_cluster.spc
  **
  ** Module   : OL
  **
  ...
  **Change Description : Hook added for the FN_POPULATE_AMOUNT_DUE and FN_VALIDATE_SCHEDULES Functions
  **Search String      : OBCL-14.3_SUPPORT_BUG#31539681
    ...
    **Search String      : OBCL_14.1_SUPPORT_BUG#31914765
 ...
 --OBCL-14.3_SUPPORT_BUG#31539681 Starts
  ...
  --OBCL_14.1_SUPPORT_BUG#31914765 CHANGES STARTS
  ...
  --OBCL_14.1_SUPPORT_BUG#31914765 CHANGES ENDS
  ...
  RETURN BOOLEAN;
  --Bug#35958182 End
end olpks_schedules_cluster;
/
CREATE or replace SYNONYM olpkss_schedules_cluster FOR olpks_schedules_cluster
/