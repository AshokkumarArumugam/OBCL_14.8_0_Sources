CREATE OR REPLACE PACKAGE  pipks_pidecaqu_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : pipks_pidecaqu_kernel.spc
  **
...
END pipks_pidecaqu_kernel;
/
CREATE OR REPLACE SYNONYM pipkss_pidecaqu_kernel FOR pipks_pidecaqu_Kernel
/