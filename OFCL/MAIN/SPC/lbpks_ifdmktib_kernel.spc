CREATE OR REPLACE PACKAGE lbpks_ifdmktib_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_ifdmktib_kernel.spc
  **
...
END lbpks_ifdmktib_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_ifdmktib_kernel FOR lbpks_ifdmktib_kernel
/