CREATE OR REPLACE PACKAGE olpks_interest_cluster AS
/*----------------------------------------------------------------------------------------------------
**
** File Name	: olpks_interest_cluster.SPC
**
...
FUNCTION FN_NEW_REDEF
  ...
  FUNCTION fn_int_computation_exp(p_ty_int          IN lfpks_computation.ty_int,
     ...
     RETURN BOOLEAN;
  --Bug#35322288 Ends
END olpks_interest_cluster;
/


CREATE or replace SYNONYM olpkss_interest_cluster FOR olpks_interest_cluster
/