CREATE OR REPLACE PACKAGE  olpks_olcescam_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_olcescam_main.spc
  **
...
TYPE ty_tb_contract_escrow_linkages IS TABLE OF oltb_contract_escrow_linkages%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_olcescam IS RECORD (
     v_oltbs_contract__escro     oltb_contract%ROWTYPE,
     v_contract_escrow_linkages    ty_tb_contract_escrow_linkages,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_olcescam          IN OUT  olpks_olcescam_Main.Ty_olcescam,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Main_Function    IN  VARCHAR2,
p_olcescam       IN    olpks_olcescam_Main.ty_olcescam,
...
p_Main_Function    IN  VARCHAR2,
p_olcescam     IN  olpks_olcescam_Main.Ty_olcescam,
p_Prev_olcescam IN OUT  olpks_olcescam_Main.Ty_olcescam,
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_olcescam     IN  olpks_olcescam_Main.Ty_olcescam,
p_Prev_olcescam     IN  olpks_olcescam_Main.Ty_olcescam,
p_Wrk_olcescam      IN OUT  olpks_olcescam_Main.Ty_olcescam,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_olcescam IN  olpks_olcescam_Main.Ty_olcescam,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_olcescam_main;
/
CREATE OR REPLACE SYNONYM olpkss_olcescam_main FOR olpks_olcescam_main
/