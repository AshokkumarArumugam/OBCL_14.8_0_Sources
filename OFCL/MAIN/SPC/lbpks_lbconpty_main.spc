CREATE OR REPLACE PACKAGE  lbpks_lbconpty_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbconpty_main.spc
  **
...
TYPE ty_tb_ntract_party_details__as IS TABLE OF oltb_contract_party_details%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbconpty IS RECORD (
     v_contract_party_details     oltb_contract_party_details%ROWTYPE,
     v_ontract_party_details__as    ty_tb_ntract_party_details__as,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbconpty          IN OUT  lbpks_lbconpty_Main.Ty_lbconpty,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Main_Function    IN  VARCHAR2,
p_lbconpty       IN    lbpks_lbconpty_Main.ty_lbconpty,
...
p_Main_Function    IN  VARCHAR2,
p_lbconpty     IN  lbpks_lbconpty_Main.Ty_lbconpty,
p_Prev_lbconpty IN OUT  lbpks_lbconpty_Main.Ty_lbconpty,
p_Wrk_lbconpty IN OUT  lbpks_lbconpty_Main.Ty_lbconpty,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbconpty     IN  lbpks_lbconpty_Main.Ty_lbconpty,
p_Prev_lbconpty     IN  lbpks_lbconpty_Main.Ty_lbconpty,
p_Wrk_lbconpty      IN OUT  lbpks_lbconpty_Main.Ty_lbconpty,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbconpty IN  lbpks_lbconpty_Main.Ty_lbconpty,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbconpty_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbconpty_main FOR lbpks_lbconpty_main
/