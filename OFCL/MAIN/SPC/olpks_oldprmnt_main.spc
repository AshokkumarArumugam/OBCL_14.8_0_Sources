CREATE OR REPLACE PACKAGE  olpks_oldprmnt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldprmnt_main.spc
  **
...
TYPE ty_tb_oduct_fincentre_dtl__rvn IS TABLE OF oltm_product_fincentre_dtl%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_oduct_fincentre_dtl__mat IS TABLE OF oltm_product_fincentre_dtl%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_oduct_fincentre_dtl__prn IS TABLE OF oltm_product_fincentre_dtl%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_oldprmnt IS RECORD (
     ...
     v_roduct_fincentre_dtl__rvn    ty_tb_oduct_fincentre_dtl__rvn,
     v_roduct_fincentre_dtl__mat    ty_tb_oduct_fincentre_dtl__mat,
     v_roduct_fincentre_dtl__prn    ty_tb_oduct_fincentre_dtl__prn,
                 ...
                 ty_lfcintcl Lfpks_Lfcintcl_Main.ty_lfcintcl,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldprmnt_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldprmnt_main FOR olpks_oldprmnt_main
/