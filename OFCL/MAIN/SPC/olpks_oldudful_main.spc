CREATE OR REPLACE PACKAGE  olpks_oldudful_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldudful_main.spc
  **
...
TYPE ty_tb_v_oltbs_udf_upload IS TABLE OF oltb_udf_upload%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_ltbs_upload_exception_cs IS TABLE OF oltb_upload_exception_cs%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_oldudful IS RECORD (
     v_oltbs_udf_upload_master     oltb_udf_upload_master%ROWTYPE,
     v_oltbs_udf_upload    ty_tb_v_oltbs_udf_upload,
     v_udf_upload_master__exp     oltb_udf_upload_master%ROWTYPE,
     v_olvws_udf_upload_summary     olvw_udf_upload_summary%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldudful          IN OUT  olpks_oldudful_Main.Ty_oldudful,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldudful     IN  olpks_oldudful_Main.Ty_oldudful,
p_Prev_oldudful     IN  olpks_oldudful_Main.Ty_oldudful,
p_Wrk_oldudful      IN OUT  olpks_oldudful_Main.Ty_oldudful,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldudful IN  olpks_oldudful_Main.Ty_oldudful,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldudful_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldudful_main FOR olpks_oldudful_main
/