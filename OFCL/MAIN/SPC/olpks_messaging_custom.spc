CREATE OR REPLACE PACKAGE olpks_messaging_custom AS
/*----------------------------------------------------------------------------------------------------
**
** File Name	: olpks_messaging_custom.SPC
**
...
END olpks_messaging_custom;
/


CREATE or replace SYNONYM olpkss_messaging_custom FOR olpks_messaging_custom
/