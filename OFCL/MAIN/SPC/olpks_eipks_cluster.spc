CREATE OR REPLACE PACKAGE olpks_eipks_cluster AS
/*----------------------------------------------------------------------------------------------------
**
** File Name	: olpks_eipks_cluster.SPC
**
...
END olpks_eipks_cluster;
/


CREATE or replace SYNONYM olpkss_eipks_cluster FOR olpks_eipks_cluster
/