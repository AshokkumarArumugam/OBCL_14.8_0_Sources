CREATE OR REPLACE PACKAGE  olpks_olcsprol_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_olcsprol_main.spc
  **
...
TYPE ty_olcsprol IS RECORD (
     v_oltbs_contract__sr     oltb_contract%ROWTYPE,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_olcsprol          IN OUT  olpks_olcsprol_Main.Ty_olcsprol,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Main_Function    IN  VARCHAR2,
p_olcsprol     IN  olpks_olcsprol_Main.Ty_olcsprol,
p_Prev_olcsprol IN OUT  olpks_olcsprol_Main.Ty_olcsprol,
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_olcsprol     IN  olpks_olcsprol_Main.Ty_olcsprol,
p_Prev_olcsprol     IN  olpks_olcsprol_Main.Ty_olcsprol,
p_Wrk_olcsprol      IN OUT  olpks_olcsprol_Main.Ty_olcsprol,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_olcsprol IN  olpks_olcsprol_Main.Ty_olcsprol,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_olcsprol_main;
/
CREATE OR REPLACE SYNONYM olpkss_olcsprol_main FOR olpks_olcsprol_main
/