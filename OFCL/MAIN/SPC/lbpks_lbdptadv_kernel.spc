CREATE OR REPLACE PACKAGE  lbpks_lbdptadv_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdptadv_kernel.spc
  **
...
END lbpks_lbdptadv_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdptadv_kernel FOR lbpks_lbdptadv_kernel
/