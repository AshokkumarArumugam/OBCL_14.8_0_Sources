CREATE OR REPLACE PACKAGE olpks_fuam_custom AS
/*----------------------------------------------------------------------------------------------------
**
** File Name	: olpks_fuam_custom.SPC
**
...
END olpks_fuam_custom;
/


CREATE or replace SYNONYM olpkss_fuam_custom FOR olpks_fuam_custom
/