CREATE OR REPLACE PACKAGE  olpks_oldblkin_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldblkin_kernel.spc
  **
...
END olpks_oldblkin_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldblkin_kernel FOR olpks_oldblkin_Kernel
/