CREATE OR REPLACE PACKAGE  olpks_olprcqry_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_olprcqry_main.spc
  **
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_olprcqry          IN OUT  olpks_olprcqry_Main.Ty_olprcqry,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_olprcqry          IN olpks_olprcqry_Main.Ty_olprcqry,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_olprcqry     IN  olpks_olprcqry_Main.Ty_olprcqry,
p_Wrk_olprcqry      IN OUT  olpks_olprcqry_Main.Ty_olprcqry,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_olprcqry     IN  olpks_olprcqry_Main.Ty_olprcqry,
p_Prev_olprcqry IN OUT  olpks_olprcqry_Main.Ty_olprcqry,
p_Wrk_olprcqry      IN OUT  olpks_olprcqry_Main.Ty_olprcqry,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_olprcqry     IN  olpks_olprcqry_Main.Ty_olprcqry,
p_Prev_olprcqry     IN  olpks_olprcqry_Main.Ty_olprcqry,
p_Wrk_olprcqry      IN OUT  olpks_olprcqry_Main.Ty_olprcqry,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_olprcqry IN  olpks_olprcqry_Main.Ty_olprcqry,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_olprcqry_main;
/
CREATE OR REPLACE SYNONYM olpkss_olprcqry_main FOR olpks_olprcqry_main
/