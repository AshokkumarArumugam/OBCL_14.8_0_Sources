CREATE OR REPLACE PACKAGE  olpks_oldvmaut_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldvmaut_kernel.spc
  **
  ** Module     : LD
  ** 
...
END olpks_oldvmaut_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldvmaut_kernel FOR olpks_oldvmaut_kernel
/