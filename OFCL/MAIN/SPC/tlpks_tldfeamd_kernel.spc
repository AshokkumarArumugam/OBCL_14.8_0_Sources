CREATE OR REPLACE PACKAGE  tlpks_tldfeamd_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldfeamd_kernel.spc
  **
...
END tlpks_tldfeamd_kernel;
/
CREATE OR REPLACE SYNONYM tlpkss_tldfeamd_kernel FOR tlpks_tldfeamd_kernel
/