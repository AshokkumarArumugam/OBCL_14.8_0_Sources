CREATE OR REPLACE PACKAGE  tlpks_tldpodcf_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldpodcf_kernel.spc
  **
...
END tlpks_tldpodcf_kernel;
/
CREATE OR REPLACE SYNONYM tlpkss_tldpodcf_kernel FOR tlpks_tldpodcf_kernel
/