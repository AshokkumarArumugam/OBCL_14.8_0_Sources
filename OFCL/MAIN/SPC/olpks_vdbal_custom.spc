create or replace package olpks_vdbal_custom is
  /*-----------------------------------------------------------------------------------------------------
    **
    ** File Name  : olpks_vdbal_custom.spc
    **
...
end olpks_vdbal_custom;
/
create or replace synonym olpkss_vdbal_custom for olpks_vdbal_custom
/