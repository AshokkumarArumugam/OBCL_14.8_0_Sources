CREATE OR REPLACE PACKAGE  olpks_oldpruat_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldpruat_kernel.spc
  **
...
END olpks_oldpruat_kernel;
/
CREATE OR REPLACE Synonym olpkss_oldpruat_kernel FOR olpks_oldpruat_kernel
/