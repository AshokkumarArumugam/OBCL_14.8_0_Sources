CREATE OR REPLACE PACKAGE  olpks_oldpruat_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldpruat_main.spc
  **
...
TYPE ty_oldpruat IS RECORD (
     v_upl_master__pr_aut_mas     oltb_pay_recv_upl_master%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldpruat          IN OUT  olpks_oldpruat_Main.Ty_oldpruat,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_oldpruat          IN olpks_oldpruat_Main.Ty_oldpruat,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldpruat     IN  olpks_oldpruat_Main.Ty_oldpruat,
p_Wrk_oldpruat      IN OUT  olpks_oldpruat_Main.Ty_oldpruat,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldpruat     IN  olpks_oldpruat_Main.Ty_oldpruat,
p_Prev_oldpruat IN OUT  olpks_oldpruat_Main.Ty_oldpruat,
p_Wrk_oldpruat      IN OUT  olpks_oldpruat_Main.Ty_oldpruat,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldpruat     IN  olpks_oldpruat_Main.Ty_oldpruat,
p_Prev_oldpruat     IN  olpks_oldpruat_Main.Ty_oldpruat,
p_Wrk_oldpruat      IN OUT  olpks_oldpruat_Main.Ty_oldpruat,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldpruat IN  olpks_oldpruat_Main.Ty_oldpruat,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldpruat_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldpruat_main FOR olpks_oldpruat_main
/