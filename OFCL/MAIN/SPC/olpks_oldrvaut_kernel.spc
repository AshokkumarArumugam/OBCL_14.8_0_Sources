CREATE OR REPLACE PACKAGE  olpks_oldrvaut_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldrvaut_kernel.spc
  **
...
END olpks_oldrvaut_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldrvaut_kernel FOR olpks_oldrvaut_kernel
/