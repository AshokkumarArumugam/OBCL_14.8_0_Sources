CREATE OR REPLACE PACKAGE lppks_lpdcomnt_utils AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lppks_lpdcomnt_kernel.spc
  **
  ...
  */
  ...
  FUNCTION fn_delete_participant(p_Source       IN VARCHAR2,
                                 p_Function_Id  IN VARCHAR2,
                                 p_Wrk_lpdcomnt IN OUT lppks_lpdcomnt_Main.Ty_lpdcomnt,
                                 p_Err_Code     IN OUT VARCHAR2,
