CREATE OR REPLACE PACKAGE  olpks_oldpmnsi_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldpmnsi_kernel.spc
  **
...
END olpks_oldpmnsi_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldpmnsi_kernel FOR olpks_oldpmnsi_Kernel
/