CREATE OR REPLACE PACKAGE lfpks_adhoc_fee_event_Custom AS
  /*----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lfpks_adhoc_fee_event_custom.spc
  **
  ** Module   : LF
  **
...
END lfpks_adhoc_fee_event_Custom;
/
CREATE or replace SYNONYM lfpkss_adhoc_fee_event_Custom FOR lfpks_adhoc_fee_event_Custom
/