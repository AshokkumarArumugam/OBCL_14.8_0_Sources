CREATE OR REPLACE PACKAGE  olpks_oldcuety_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldcuety_main.spc
  **
...
TYPE ty_oldcuety IS RECORD (
     v_customer_entity_type     oltm_customer_entity_type%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldcuety_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldcuety_main FOR olpks_oldcuety_main
/