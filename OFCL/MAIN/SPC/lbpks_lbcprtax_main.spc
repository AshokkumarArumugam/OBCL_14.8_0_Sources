CREATE OR REPLACE PACKAGE  lbpks_lbcprtax_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbcprtax_main.spc
  **
...
TYPE ty_tb_v_txtbs_txnrule IS TABLE OF txtb_txnrule%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_txtbs_txnrule_detail IS TABLE OF txtb_txnrule_detail%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbcprtax IS RECORD (
     v_oltbs_contract__tax     oltb_contract%ROWTYPE,
     v_contract_participant    ty_tb_v_contract_participant,
     v_lbtbs_contract_tax_pref    ty_tb__lbtbs_contract_tax_pref,
     v_txtbs_maintxn     txtb_maintxn%ROWTYPE,
     v_txtbs_txnrule    ty_tb_v_txtbs_txnrule,
     v_txtbs_txnrule_detail    ty_tb_v_txtbs_txnrule_detail,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbcprtax          IN OUT  lbpks_lbcprtax_Main.Ty_lbcprtax,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Main_Function    IN  VARCHAR2,
p_lbcprtax       IN    lbpks_lbcprtax_Main.ty_lbcprtax,
...
p_Main_Function    IN  VARCHAR2,
p_lbcprtax     IN  lbpks_lbcprtax_Main.Ty_lbcprtax,
p_Prev_lbcprtax IN OUT  lbpks_lbcprtax_Main.Ty_lbcprtax,
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbcprtax     IN  lbpks_lbcprtax_Main.Ty_lbcprtax,
p_Prev_lbcprtax     IN  lbpks_lbcprtax_Main.Ty_lbcprtax,
p_Wrk_lbcprtax      IN OUT  lbpks_lbcprtax_Main.Ty_lbcprtax,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbcprtax IN  lbpks_lbcprtax_Main.Ty_lbcprtax,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbcprtax_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbcprtax_main FOR lbpks_lbcprtax_main
/