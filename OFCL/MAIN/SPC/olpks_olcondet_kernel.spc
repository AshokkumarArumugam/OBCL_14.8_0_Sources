CREATE OR REPLACE PACKAGE  olpks_olcondet_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_olcondet_kernel.spc
  **
  ** Module     : IS
  ** 
...
END olpks_olcondet_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_olcondet_kernel FOR olpks_olcondet_kernel
/