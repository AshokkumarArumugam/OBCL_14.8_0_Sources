CREATE OR REPLACE PACKAGE  lbpks_lbdptcni_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdptcni_kernel.spc
  **
...
END lbpks_lbdptcni_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdptcni_kernel FOR lbpks_lbdptcni_Kernel
/