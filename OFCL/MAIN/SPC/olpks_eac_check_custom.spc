CREATE OR REPLACE PACKAGE olpks_eac_check_custom AS
  /*----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_eac_check_custom.SPC
  **
  ** Module   : OL
  **
...
FUNCTION Fn_Log_Sync_EAC_Validate(p_Ref            	IN VARCHAR2,
			...
			RETURN BOOLEAN;
--Bug#33830522 ends
END olpks_eac_check_custom;
/
Create or replace synonym olpkss_eac_check_custom for olpks_eac_check_custom
/