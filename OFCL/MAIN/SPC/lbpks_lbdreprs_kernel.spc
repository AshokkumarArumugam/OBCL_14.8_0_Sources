CREATE OR REPLACE PACKAGE  lbpks_lbdreprs_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdreprs_kernel.spc
  **
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
g_action_code VARCHAR2(30); --OBCL_14.4_SOFR_Reprice
END lbpks_lbdreprs_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdreprs_kernel FOR lbpks_lbdreprs_kernel
/