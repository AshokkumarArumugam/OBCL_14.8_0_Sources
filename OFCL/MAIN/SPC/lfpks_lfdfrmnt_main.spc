CREATE OR REPLACE PACKAGE  lfpks_lfdfrmnt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lfpks_lfdfrmnt_main.spc
  **
  ** Module     : The ICCF
  ** 
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lfpks_lfdfrmnt_main;
/
CREATE OR REPLACE SYNONYM lfpkss_lfdfrmnt_main FOR lfpks_lfdfrmnt_main
/