CREATE OR REPLACE PACKAGE olpks_link_custom AS
/*----------------------------------------------------------------------------------------------------
**
** File Name	: olpks_link_custom.SPC
**
...
END olpks_link_custom;
/


CREATE or replace SYNONYM olpkss_link_custom FOR olpks_link_custom
/