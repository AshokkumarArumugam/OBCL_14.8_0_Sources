CREATE OR REPLACE PACKAGE olpks_oldcorol_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldcorol_kernel.spc
  **
  ...
  ** India
  ...
  Change Description :
	...
	**  Date               : 13-APR-2022
	**  Change Description : Added code for 24/7 Consolidated Rollover operation.                                                                   
  ...
  */
  ...
  g_27_7_processing            VARCHAR2(1) := 'N'; --OBCL_14.5_24_7_P3 Changes
...
END olpks_oldcorol_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldcorol_kernel FOR olpks_oldcorol_kernel
/