CREATE OR REPLACE PACKAGE  lbpks_lbdglamt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdglamt_main.spc
  **
...
TYPE ty_lbdglamt IS RECORD (
     v_oltbs_contract     oltb_contract%ROWTYPE,
     v_contract_global_amount     lbtb_contract_global_amount%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdglamt          IN OUT  lbpks_lbdglamt_Main.Ty_lbdglamt,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_lbdglamt          IN lbpks_lbdglamt_Main.Ty_lbdglamt,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdglamt     IN  lbpks_lbdglamt_Main.Ty_lbdglamt,
p_Prev_lbdglamt IN OUT  lbpks_lbdglamt_Main.Ty_lbdglamt,
p_Wrk_lbdglamt      IN OUT  lbpks_lbdglamt_Main.Ty_lbdglamt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbdglamt     IN  lbpks_lbdglamt_Main.Ty_lbdglamt,
p_Prev_lbdglamt     IN  lbpks_lbdglamt_Main.Ty_lbdglamt,
p_Wrk_lbdglamt      IN OUT  lbpks_lbdglamt_Main.Ty_lbdglamt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbdglamt IN  lbpks_lbdglamt_Main.Ty_lbdglamt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdglamt_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdglamt_main FOR lbpks_lbdglamt_main
/