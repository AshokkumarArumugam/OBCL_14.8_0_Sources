CREATE OR REPLACE PACKAGE  lbpks_lbdvamnd_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdvamnd_kernel.spc
  **
...
END lbpks_lbdvamnd_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdvamnd_kernel FOR lbpks_lbdvamnd_kernel
/