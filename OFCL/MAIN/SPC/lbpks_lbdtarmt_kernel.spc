CREATE OR REPLACE PACKAGE  lbpks_lbdtarmt_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdtarmt_kernel.spc
  **
...
END lbpks_lbdtarmt_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdtarmt_kernel FOR lbpks_lbdtarmt_kernel
/