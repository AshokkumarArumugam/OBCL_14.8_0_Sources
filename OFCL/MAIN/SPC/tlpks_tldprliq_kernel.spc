CREATE OR REPLACE PACKAGE  tlpks_tldprliq_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldprliq_kernel.spc
  **
  ** Module     : TL
  ** 
...
END tlpks_tldprliq_kernel;
/
CREATE OR REPLACE SYNONYM tlpkss_tldprliq_kernel FOR tlpks_tldprliq_kernel
/