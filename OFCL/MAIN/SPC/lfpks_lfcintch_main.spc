CREATE OR REPLACE PACKAGE  lfpks_lfcintch_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lfpks_lfcintch_main.spc
  **
  ** Module     : The ICCF
  ** 
...
TYPE ty_tb_ltbs_rate_fixing_details IS TABLE OF oltb_rate_fixing_details%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_lftms_spread_ccy IS TABLE OF lftm_spread_ccy%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_lftms_spread_effdate IS TABLE OF lftm_spread_effdate%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_lftms_spread_rate IS TABLE OF lftm_spread_rate%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_contract_agency_rate IS TABLE OF lftb_contract_agency_rate%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lfcintch IS RECORD (
     v_oltbs_contract__int     oltb_contract%ROWTYPE,
     v_lftbs_contract_interest    ty_tb__lftbs_contract_interest,
     v_oltbs_rate_fixing_details    ty_tb_ltbs_rate_fixing_details,
     v_lftms_spread_master     lftm_spread_master%ROWTYPE,
     v_lftms_spread_ccy    ty_tb_v_lftms_spread_ccy,
     v_lftms_spread_effdate    ty_tb_v_lftms_spread_effdate,
     v_lftms_spread_rate    ty_tb_v_lftms_spread_rate,
     v_contract_agency_rate    ty_tb_v_contract_agency_rate,
...
p_Main_Function    IN  VARCHAR2,
p_lfcintch     IN  lfpks_lfcintch_Main.Ty_lfcintch,
p_Prev_lfcintch IN OUT  lfpks_lfcintch_Main.Ty_lfcintch,
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lfcintch     IN  lfpks_lfcintch_Main.Ty_lfcintch,
p_Prev_lfcintch     IN  lfpks_lfcintch_Main.Ty_lfcintch,
p_Wrk_lfcintch      IN OUT  lfpks_lfcintch_Main.Ty_lfcintch,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lfcintch IN  lfpks_lfcintch_Main.Ty_lfcintch,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lfpks_lfcintch_main;
/
CREATE OR REPLACE SYNONYM lfpkss_lfcintch_main FOR lfpks_lfcintch_main
/