CREATE OR REPLACE PACKAGE  olpks_oldintdt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldintdt_main.spc
  **
...
TYPE ty_tb_v_interest_detail__as IS TABLE OF lftb_contract_interest_detail%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_oldintdt IS RECORD (
     v_contract_interest_detail     lftb_contract_interest_detail%ROWTYPE,
     v_interest_detail__as    ty_tb_v_interest_detail__as,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldintdt          IN OUT  olpks_oldintdt_Main.Ty_oldintdt,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_oldintdt          IN olpks_oldintdt_Main.Ty_oldintdt,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldintdt     IN  olpks_oldintdt_Main.Ty_oldintdt,
p_Wrk_oldintdt      IN OUT  olpks_oldintdt_Main.Ty_oldintdt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldintdt     IN  olpks_oldintdt_Main.Ty_oldintdt,
p_Prev_oldintdt IN OUT  olpks_oldintdt_Main.Ty_oldintdt,
p_Wrk_oldintdt      IN OUT  olpks_oldintdt_Main.Ty_oldintdt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldintdt     IN  olpks_oldintdt_Main.Ty_oldintdt,
p_Prev_oldintdt     IN  olpks_oldintdt_Main.Ty_oldintdt,
p_Wrk_oldintdt      IN OUT  olpks_oldintdt_Main.Ty_oldintdt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldintdt IN  olpks_oldintdt_Main.Ty_oldintdt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldintdt_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldintdt_main FOR olpks_oldintdt_main
/