CREATE OR REPLACE PACKAGE olpks_contract_cluster AS
/*----------------------------------------------------------------------------------------------------
**
** File Name	: olpks_contract_cluster.SPC
**
...
/*----------------------------------CHANGE HISTORY----------------------------------
	...
	**Changed By         : Ramya M
    **Date               : 18-May-2023
    **Change Description : Added hook for Fn_create_new_version
...
END olpks_contract_cluster;
/
CREATE or replace SYNONYM olpkss_contract_cluster FOR olpks_contract_cluster
/