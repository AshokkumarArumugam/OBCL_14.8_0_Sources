CREATE OR REPLACE PACKAGE  lbpks_lbdblkpt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdblkpt_main.spc
  **
...
TYPE ty_tb_v_oltbs_contract IS TABLE OF oltb_contract%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_contract_liq_summary IS TABLE OF oltb_contract_liq_summary%ROWTYPE INDEX BY BINARY_INTEGER;
...
TYPE ty_lbdblkpt IS RECORD (
     v_oltb_bulk_pymnt_master     oltb_bulk_pymnt_master%ROWTYPE,
     v_oltbs_contract    ty_tb_v_oltbs_contract,
     v_contract_liq_summary    ty_tb_v_contract_liq_summary,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdblkpt          IN OUT  lbpks_lbdblkpt_Main.Ty_lbdblkpt,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_lbdblkpt          IN lbpks_lbdblkpt_Main.Ty_lbdblkpt,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdblkpt     IN  lbpks_lbdblkpt_Main.Ty_lbdblkpt,
p_Wrk_lbdblkpt      IN OUT  lbpks_lbdblkpt_Main.Ty_lbdblkpt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdblkpt     IN  lbpks_lbdblkpt_Main.Ty_lbdblkpt,
p_Prev_lbdblkpt IN OUT  lbpks_lbdblkpt_Main.Ty_lbdblkpt,
p_Wrk_lbdblkpt      IN OUT  lbpks_lbdblkpt_Main.Ty_lbdblkpt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbdblkpt     IN  lbpks_lbdblkpt_Main.Ty_lbdblkpt,
p_Prev_lbdblkpt     IN  lbpks_lbdblkpt_Main.Ty_lbdblkpt,
p_Wrk_lbdblkpt      IN OUT  lbpks_lbdblkpt_Main.Ty_lbdblkpt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbdblkpt IN  lbpks_lbdblkpt_Main.Ty_lbdblkpt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdblkpt_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdblkpt_main FOR lbpks_lbdblkpt_main
/