CREATE OR REPLACE PACKAGE lbpks_interest_cluster AS
/*----------------------------------------------------------------------------------------------------
**
** File Name	: lbpks_interest_cluster.SPC
**
...
END lbpks_interest_cluster;
/


CREATE or replace SYNONYM lbpkss_interest_cluster FOR lbpks_interest_cluster
/