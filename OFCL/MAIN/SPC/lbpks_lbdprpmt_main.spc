CREATE OR REPLACE PACKAGE  lbpks_lbdprpmt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdprpmt_main.spc
  **
...
TYPE ty_tb_v_lbtbs_pay_recv_detail IS TABLE OF lbtb_pay_recv_detail%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_pay_recv_amount_paid IS TABLE OF lbtb_pay_recv_amount_paid%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_recv_amount_paid__borr IS TABLE OF lbtb_pay_recv_amount_paid%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbdprpmt IS RECORD (
     v_lbtbs_pay_recv_master     lbtb_pay_recv_master%ROWTYPE,
     v_lbtbs_pay_recv_detail    ty_tb_v_lbtbs_pay_recv_detail,
     v_pay_recv_amount_paid    ty_tb_v_pay_recv_amount_paid,
     v_oltbs_contract_event_log     oltb_contract_event_log%ROWTYPE,
     v_recv_amount_paid__borr    ty_tb_v_recv_amount_paid__borr,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdprpmt          IN OUT  lbpks_lbdprpmt_Main.Ty_lbdprpmt,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbdprpmt     IN  lbpks_lbdprpmt_Main.Ty_lbdprpmt,
p_Prev_lbdprpmt     IN  lbpks_lbdprpmt_Main.Ty_lbdprpmt,
p_Wrk_lbdprpmt      IN OUT  lbpks_lbdprpmt_Main.Ty_lbdprpmt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbdprpmt IN  lbpks_lbdprpmt_Main.Ty_lbdprpmt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdprpmt_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdprpmt_main FOR lbpks_lbdprpmt_main
/