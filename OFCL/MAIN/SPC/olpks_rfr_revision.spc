CREATE OR REPLACE PACKAGE olpks_rfr_revision AS
  /*----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_rfr_revision.SPC
  **
  ...
  **Change Description : Hooks provided for fn_rfr_rate_revision
  ...
  */
  ...
  g_RFR_MSGID VARCHAR2(100); --- OBCL_14.4_SOFR changes

  FUNCTION fn_fire_job(pm_branch    IN cftms_float_rate_master.branch_code%TYPE,
  ...
  FUNCTION fn_irrn_for_a_contract(pm_branch      IN oltbs_contract.branch%TYPE,
  ...
  FUNCTION fn_recomp_norm(pm_branch    IN oltbs_contract.branch%TYPE,
                          pm_reference IN oltbs_contract.contract_ref_no%TYPE,
  ...
  FUNCTION fn_propagate_Rates(pHO       IN oltms_branch.branch_code%TYPE,
  ...
  FUNCTION fn_process_irrn_during_init(pm_contract_ref_no IN oltbs_contract.contract_ref_no%TYPE,
  ...
  FUNCTION fn_margin_revisions(pm_branch    IN oltms_branch.branch_code%TYPE,
  ...
  FUNCTION fn_insert_amount_due(pm_reference     IN oltbs_contract.contract_ref_no%TYPE,
                                ...
                                pm_flag          IN varchar2) RETURN BOOLEAN;
  ...
  FUNCTION Fn_fpm_rate_revision(pm_branch          IN oltms_branch.branch_code%TYPE,
                                pm_module          IN oltbs_contract.module_code%TYPE,
                                pm_product         IN oltms_product_master_ld.product%TYPE,
  ...
  FUNCTION Fn_insert_rate_fixing_detail(p_contract_ref_no IN oltbs_contract.CONTRACT_REF_NO%TYPE,
    ...
    RETURN BOOLEAN;
  -------CITIPBGDEVLOT2,MANUAL RATE REVISION,KUNAL
  FUNCTION fn_process_month_end(pm_branch      IN oltms_branch.branch_code%TYPE,
                                pm_user        IN sstbs_user.user_id%TYPE,
                                pm_cont_ref_no IN oltbs_contract.contract_ref_no%TYPE,
                                pm_eff_date    IN oltbs_contract_frrn_due.eff_date%TYPE,
                                pm_err_code    IN OUT ertbs_msgs.err_code%TYPE,
    ...
    FUNCTION Fn_Log_irrn_temp_amt_due(p_Ref       IN VARCHAR2,
  ...
  FUNCTION fn_pop_floating_automatic_rate(p_contract_ref_no IN oltbs_contract.contract_ref_no%TYPE,
...
END olpks_rfr_revision;
/
CREATE or replace SYNONYM olpkss_rfr_revision FOR olpks_rfr_revision
/