CREATE OR REPLACE PACKAGE olpks_oldcbaut_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldcbaut_kernel.spc
  **
...
END olpks_oldcbaut_kernel;
/
Create Or Replace Synonym olpkss_oldcbaut_kernel for olpks_oldcbaut_kernel
/