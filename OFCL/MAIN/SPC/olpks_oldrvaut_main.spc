CREATE OR REPLACE PACKAGE  olpks_oldrvaut_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldrvaut_main.spc
  **
...
TYPE ty_oldrvaut IS RECORD (
     v_oltbs_contract     oltb_contract%ROWTYPE,
     v_oltbs_coc_event_log     oltb_coc_event_log%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldrvaut          IN OUT  olpks_oldrvaut_Main.Ty_oldrvaut,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_oldrvaut          IN olpks_oldrvaut_Main.Ty_oldrvaut,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldrvaut     IN  olpks_oldrvaut_Main.Ty_oldrvaut,
p_Wrk_oldrvaut      IN OUT  olpks_oldrvaut_Main.Ty_oldrvaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldrvaut     IN  olpks_oldrvaut_Main.Ty_oldrvaut,
p_Prev_oldrvaut IN OUT  olpks_oldrvaut_Main.Ty_oldrvaut,
p_Wrk_oldrvaut      IN OUT  olpks_oldrvaut_Main.Ty_oldrvaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldrvaut     IN  olpks_oldrvaut_Main.Ty_oldrvaut,
p_Prev_oldrvaut     IN  olpks_oldrvaut_Main.Ty_oldrvaut,
p_Wrk_oldrvaut      IN OUT  olpks_oldrvaut_Main.Ty_oldrvaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldrvaut IN  olpks_oldrvaut_Main.Ty_oldrvaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldrvaut_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldrvaut_main FOR olpks_oldrvaut_main
/