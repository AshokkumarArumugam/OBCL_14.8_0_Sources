CREATE OR REPLACE PACKAGE olpks_drcradv_custom AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_drcradv_custom.spc
  **
...
END olpks_drcradv_custom;
/
CREATE OR REPLACE SYNONYM olpkss_drcradv_custom FOR olpks_drcradv_custom
/