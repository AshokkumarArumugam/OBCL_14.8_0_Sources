CREATE OR REPLACE PACKAGE  olpks_oldreprc_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldreprc_main.spc
  **
...
TYPE ty_tb_v_contract_merge_detail IS TABLE OF oltb_contract_merge_detail%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_oldreprc IS RECORD (
...
p_Wrk_oldreprc IN  olpks_oldreprc_Main.Ty_oldreprc,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldreprc_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldreprc_main FOR olpks_oldreprc_main
/