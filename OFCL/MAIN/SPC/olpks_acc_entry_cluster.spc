create or replace package olpks_acc_entry_cluster is
  /*----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_acc_entry_cluster.spc
  **
  ** Module   : OL
  **
	...
	SFR		   : 30331201   
	Date 		: 27-SEP-2019
	NAME	   : Selvam Manickam
	Description: Provided Hook for fn_pass_entry
	Search String: Bug#30331201
  ----------------------------------------------------------------------------------------------------
  */
  ...
  FUNCTION fn_post_acc_entry (
   ...
   ,p_tb_cluster_data 		  IN OUT 	GLOBAL.TY_TB_CLUSTER_DATA) RETURN BOOLEAN;
   
--End:Bug#30331201
	
end olpks_acc_entry_cluster;
/
create or replace synonym olpkss_acc_entry_cluster for olpks_acc_entry_cluster
/