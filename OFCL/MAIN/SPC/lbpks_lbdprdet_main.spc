CREATE OR REPLACE PACKAGE  lbpks_lbdprdet_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdprdet_main.spc
  **
...
TYPE ty_tb_v_lbvws_pay_recv_comps IS TABLE OF lbvw_pay_recv_comps%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_btbs_pay_recv_due_detail IS TABLE OF lbtb_pay_recv_due_detail%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbdprdet IS RECORD (
     v_lbvws_pay_recv_master     lbvw_pay_recv_master%ROWTYPE,
     v_lbvws_pay_recv_comps    ty_tb_v_lbvws_pay_recv_comps,
     v_lbtbs_pay_recv_due_detail    ty_tb_btbs_pay_recv_due_detail,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdprdet          IN OUT  lbpks_lbdprdet_Main.Ty_lbdprdet,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_lbdprdet          IN lbpks_lbdprdet_Main.Ty_lbdprdet,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdprdet     IN  lbpks_lbdprdet_Main.Ty_lbdprdet,
p_Wrk_lbdprdet      IN OUT  lbpks_lbdprdet_Main.Ty_lbdprdet,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdprdet     IN  lbpks_lbdprdet_Main.Ty_lbdprdet,
p_Prev_lbdprdet IN OUT  lbpks_lbdprdet_Main.Ty_lbdprdet,
p_Wrk_lbdprdet      IN OUT  lbpks_lbdprdet_Main.Ty_lbdprdet,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbdprdet     IN  lbpks_lbdprdet_Main.Ty_lbdprdet,
p_Prev_lbdprdet     IN  lbpks_lbdprdet_Main.Ty_lbdprdet,
p_Wrk_lbdprdet      IN OUT  lbpks_lbdprdet_Main.Ty_lbdprdet,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbdprdet IN  lbpks_lbdprdet_Main.Ty_lbdprdet,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdprdet_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdprdet_main FOR lbpks_lbdprdet_main
/