CREATE OR REPLACE PACKAGE  lbpks_lbdreasn_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdreasn_main.spc
  **
...
TYPE ty_lbdreasn IS RECORD (
     v_lbtbs_reassign_log     lbtb_reassign_log%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdreasn          IN OUT  lbpks_lbdreasn_Main.Ty_lbdreasn,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_lbdreasn          IN lbpks_lbdreasn_Main.Ty_lbdreasn,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdreasn     IN  lbpks_lbdreasn_Main.Ty_lbdreasn,
p_Wrk_lbdreasn      IN OUT  lbpks_lbdreasn_Main.Ty_lbdreasn,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdreasn     IN  lbpks_lbdreasn_Main.Ty_lbdreasn,
p_Prev_lbdreasn IN OUT  lbpks_lbdreasn_Main.Ty_lbdreasn,
p_Wrk_lbdreasn      IN OUT  lbpks_lbdreasn_Main.Ty_lbdreasn,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbdreasn     IN  lbpks_lbdreasn_Main.Ty_lbdreasn,
p_Prev_lbdreasn     IN  lbpks_lbdreasn_Main.Ty_lbdreasn,
p_Wrk_lbdreasn      IN OUT  lbpks_lbdreasn_Main.Ty_lbdreasn,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbdreasn IN  lbpks_lbdreasn_Main.Ty_lbdreasn,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdreasn_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdreasn_main FOR lbpks_lbdreasn_main
/