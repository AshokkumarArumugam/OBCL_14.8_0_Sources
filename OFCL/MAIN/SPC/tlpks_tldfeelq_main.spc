CREATE OR REPLACE PACKAGE  tlpks_tldfeelq_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldfeelq_main.spc
  **
...
TYPE ty_tb_v_tltbs_fee_liqd_detail IS TABLE OF tltb_fee_liqd_detail%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_tldfeelq IS RECORD (
     v_oltbs_contract     oltb_contract%ROWTYPE,
     v_tltbs_contract_master     tltb_contract_master%ROWTYPE,
     v_tltbs_fee_liqd_master     tltb_fee_liqd_master%ROWTYPE,
     v_tltbs_fee_liqd_detail    ty_tb_v_tltbs_fee_liqd_detail,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_tldfeelq          IN OUT  tlpks_tldfeelq_Main.Ty_tldfeelq,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Wrk_tldfeelq IN  tlpks_tldfeelq_Main.Ty_tldfeelq,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tldfeelq_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tldfeelq_main FOR tlpks_tldfeelq_main
/