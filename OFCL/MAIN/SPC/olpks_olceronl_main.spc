CREATE OR REPLACE PACKAGE  olpks_olceronl_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_olceronl_main.spc
  **
...
TYPE ty_tb_v_upload_adj_exception IS TABLE OF olvw_upload_adj_exception%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_olceronl IS RECORD (
     v_oltbs_upload_xldtls     oltb_upload_xldtls%ROWTYPE,
     v_upload_adj_exception    ty_tb_v_upload_adj_exception,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_olceronl          IN OUT  olpks_olceronl_Main.Ty_olceronl,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Main_Function    IN  VARCHAR2,
p_olceronl       IN    olpks_olceronl_Main.ty_olceronl,
...
p_Main_Function    IN  VARCHAR2,
p_olceronl     IN  olpks_olceronl_Main.Ty_olceronl,
p_Prev_olceronl IN OUT  olpks_olceronl_Main.Ty_olceronl,
p_Wrk_olceronl IN OUT  olpks_olceronl_Main.Ty_olceronl,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_olceronl     IN  olpks_olceronl_Main.Ty_olceronl,
p_Prev_olceronl     IN  olpks_olceronl_Main.Ty_olceronl,
p_Wrk_olceronl      IN OUT  olpks_olceronl_Main.Ty_olceronl,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_olceronl IN  olpks_olceronl_Main.Ty_olceronl,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_olceronl_main;
/
CREATE OR REPLACE SYNONYM olpkss_olceronl_main FOR olpks_olceronl_main
/