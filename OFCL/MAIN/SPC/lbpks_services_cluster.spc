CREATE OR REPLACE PACKAGE Lbpks_Services_Cluster AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_services_cluster.spc
  **
...
END Lbpks_Services_Cluster;
/
CREATE OR REPLACE Synonym Lbpkss_Services_Cluster FOR Lbpks_Services_Cluster
/