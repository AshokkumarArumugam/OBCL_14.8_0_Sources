CREATE OR REPLACE PACKAGE  lppks_lpcentty_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lppks_lpcentty_main.spc
  **
...
TYPE ty_tb_icipant_entities___entty IS TABLE OF lptm_participant_entities%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lpcentty IS RECORD (
     v_oltbs_contract___entty     oltb_contract%ROWTYPE,
     v_ticipant_entities___entty    ty_tb_icipant_entities___entty,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lpcentty          IN OUT  lppks_lpcentty_Main.Ty_lpcentty,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Main_Function    IN  VARCHAR2,
p_lpcentty       IN    lppks_lpcentty_Main.ty_lpcentty,
...
p_Main_Function    IN  VARCHAR2,
p_lpcentty     IN  lppks_lpcentty_Main.Ty_lpcentty,
p_Prev_lpcentty IN OUT  lppks_lpcentty_Main.Ty_lpcentty,
p_Wrk_lpcentty IN OUT  lppks_lpcentty_Main.Ty_lpcentty,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lpcentty     IN  lppks_lpcentty_Main.Ty_lpcentty,
p_Prev_lpcentty     IN  lppks_lpcentty_Main.Ty_lpcentty,
p_Wrk_lpcentty      IN OUT  lppks_lpcentty_Main.Ty_lpcentty,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lpcentty IN  lppks_lpcentty_Main.Ty_lpcentty,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lppks_lpcentty_main;
/
CREATE OR REPLACE SYNONYM lppkss_lpcentty_main FOR lppks_lpcentty_main
/