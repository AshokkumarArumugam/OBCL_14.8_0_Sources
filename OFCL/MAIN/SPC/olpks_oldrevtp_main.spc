CREATE OR REPLACE PACKAGE  olpks_oldrevtp_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldrevtp_main.spc
  **
...
TYPE ty_oldrevtp IS RECORD (
     v_oltms_reversal_trn_type     oltm_reversal_trn_type%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldrevtp_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldrevtp_main FOR olpks_oldrevtp_main
/