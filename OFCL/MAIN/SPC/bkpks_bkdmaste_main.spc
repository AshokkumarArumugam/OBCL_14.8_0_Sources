CREATE OR REPLACE PACKAGE  bkpks_bkdmaste_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : bkpks_bkdmaste_main.spc
  **
  ** Module     : Brokerage
  ** 
...
TYPE ty_bkdmaste IS RECORD (
     v_bktms_brmaster     bktm_brmaster%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END bkpks_bkdmaste_main;
/
CREATE OR REPLACE SYNONYM bkpkss_bkdmaste_main FOR bkpks_bkdmaste_main
/