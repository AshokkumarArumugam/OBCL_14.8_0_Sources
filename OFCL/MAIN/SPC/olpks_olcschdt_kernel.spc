CREATE OR REPLACE PACKAGE  olpks_olcschdt_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_olcschdt_kernel.spc
  **
...
END olpks_olcschdt_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_olcschdt_kernel FOR olpks_olcschdt_kernel
/