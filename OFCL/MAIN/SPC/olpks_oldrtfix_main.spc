CREATE OR REPLACE PACKAGE  olpks_oldrtfix_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldrtfix_main.spc
  **
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldrtfix          IN OUT  olpks_oldrtfix_Main.Ty_oldrtfix,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldrtfix     IN  olpks_oldrtfix_Main.Ty_oldrtfix,
p_Prev_oldrtfix     IN  olpks_oldrtfix_Main.Ty_oldrtfix,
p_Wrk_oldrtfix      IN OUT  olpks_oldrtfix_Main.Ty_oldrtfix,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldrtfix IN  olpks_oldrtfix_Main.Ty_oldrtfix,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldrtfix_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldrtfix_main FOR olpks_oldrtfix_main
/