CREATE OR REPLACE PACKAGE  lfpks_lfdratmt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lfpks_lfdratmt_main.spc
  **
  ** Module     : The ICCF
  ** 
...
TYPE ty_lfdratmt IS RECORD (
     v_lftms_rate_type_defn     lftm_rate_type_defn%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lfpks_lfdratmt_main;
/
CREATE OR REPLACE SYNONYM lfpkss_lfdratmt_main FOR lfpks_lfdratmt_main
/