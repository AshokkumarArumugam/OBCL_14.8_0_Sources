CREATE OR REPLACE PACKAGE lbpks_lbdtxrfc_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdtxrfc_kernel.spc
  **
  ...
  ** India
  ...
  Change Description : Changes done for LBDTXRFC
