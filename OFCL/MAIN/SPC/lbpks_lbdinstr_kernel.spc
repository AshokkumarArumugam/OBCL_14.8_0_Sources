CREATE OR REPLACE PACKAGE lbpks_lbdinstr_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdinstr_kernel.spc
  **
...
END lbpks_lbdinstr_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdinstr_kernel FOR lbpks_lbdinstr_kernel
/