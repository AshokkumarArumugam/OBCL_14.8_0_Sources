CREATE OR REPLACE PACKAGE  tlpks_tldtdupl_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldtdupl_kernel.spc
  **
...
END tlpks_tldtdupl_kernel;
/
CREATE OR REPLACE SYNONYM tlpkss_tldtdupl_kernel FOR tlpks_tldtdupl_kernel
/