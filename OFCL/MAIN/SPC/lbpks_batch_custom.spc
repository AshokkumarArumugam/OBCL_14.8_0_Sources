CREATE OR REPLACE PACKAGE lbpks_batch_custom AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_batch_custom.spc
  **
...
END lbpks_batch_custom;
/
CREATE or replace SYNONYM lbpkss_batch_custom FOR lbpks_batch_custom
/