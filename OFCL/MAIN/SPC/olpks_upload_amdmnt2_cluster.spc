CREATE OR REPLACE PACKAGE olpks_upload_amdmnt2_cluster AS
/*----------------------------------------------------------------------------------------------------
**
** File Name	: olpks_upload_amdmnt2_cluster.SPC
**
...
END olpks_upload_amdmnt2_cluster;
/

CREATE or replace SYNONYM olpkss_upload_amdmnt2_cluster FOR olpks_upload_amdmnt2_cluster
/