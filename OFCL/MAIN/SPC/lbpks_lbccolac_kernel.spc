CREATE OR REPLACE PACKAGE  lbpks_lbccolac_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbccolac_kernel.spc
  **
...
END lbpks_lbccolac_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbccolac_kernel FOR lbpks_lbccolac_kernel
/