CREATE OR REPLACE PACKAGE  olpks_oldfftmp_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldfftmp_main.spc
  **
...
TYPE ty_oldfftmp IS RECORD (
     v_oltms_message_template     oltm_message_template%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldfftmp_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldfftmp_main FOR olpks_oldfftmp_main
/