CREATE OR REPLACE PACKAGE Lbpks_Stp_Interface_Custom AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_stp_interface_custom.spc
  **
...
END Lbpks_Stp_Interface_Custom;
/
CREATE OR REPLACE Synonym Lbpkss_Stp_Interface_Custom FOR Lbpks_Stp_Interface_Custom
/