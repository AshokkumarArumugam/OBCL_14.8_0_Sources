CREATE OR REPLACE PACKAGE  olpks_oldlfund_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldlfund_main.spc
  **
  ** Module     : OL
  ** 
...
TYPE ty_oldlfund IS RECORD (
     v_oltms_long_term_funding     oltm_long_term_funding%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldlfund_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldlfund_main FOR olpks_oldlfund_main
/