CREATE OR REPLACE PACKAGE  olpks_oldafmap_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldafmap_main.spc
  **
  ** Module     : OL
  ** 
...
TYPE ty_oldafmap IS RECORD (
     v_oltm_auto_fund_mapping     oltm_auto_fund_mapping%ROWTYPE,
...
FUNCTION Fn_Get_Key_Information (p_Source    IN  VARCHAR2, 
                        ...
                        p_Function_id       IN     VARCHAR2,
                        p_Action_Code       IN     VARCHAR2,
p_oldafmap       IN  OUT olpks_oldafmap_Main.Ty_oldafmap,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldafmap_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldafmap_main FOR olpks_oldafmap_main
/