CREATE OR REPLACE PACKAGE  lbpks_lbdbrlmt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdbrlmt_main.spc
  **
...
TYPE ty_tb__lbvws_borr_sublimit__as IS TABLE OF lbvw_borr_sublimit%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_lbvws_borr_prod_vdutil IS TABLE OF lbvw_borr_prod_vdutil%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbdbrlmt IS RECORD (
     v_lbvws_borr_sublimit__as    ty_tb__lbvws_borr_sublimit__as,
     v_lbvws_borr_prod_vdutil    ty_tb_v_lbvws_borr_prod_vdutil,
     v_contract_master__lmt     oltb_contract_master%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdbrlmt          IN OUT  lbpks_lbdbrlmt_Main.Ty_lbdbrlmt,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_lbdbrlmt          IN lbpks_lbdbrlmt_Main.Ty_lbdbrlmt,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdbrlmt     IN  lbpks_lbdbrlmt_Main.Ty_lbdbrlmt,
p_Wrk_lbdbrlmt      IN OUT  lbpks_lbdbrlmt_Main.Ty_lbdbrlmt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdbrlmt     IN  lbpks_lbdbrlmt_Main.Ty_lbdbrlmt,
p_Prev_lbdbrlmt IN OUT  lbpks_lbdbrlmt_Main.Ty_lbdbrlmt,
p_Wrk_lbdbrlmt      IN OUT  lbpks_lbdbrlmt_Main.Ty_lbdbrlmt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbdbrlmt     IN  lbpks_lbdbrlmt_Main.Ty_lbdbrlmt,
p_Prev_lbdbrlmt     IN  lbpks_lbdbrlmt_Main.Ty_lbdbrlmt,
p_Wrk_lbdbrlmt      IN OUT  lbpks_lbdbrlmt_Main.Ty_lbdbrlmt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbdbrlmt IN  lbpks_lbdbrlmt_Main.Ty_lbdbrlmt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdbrlmt_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdbrlmt_main FOR lbpks_lbdbrlmt_main
/