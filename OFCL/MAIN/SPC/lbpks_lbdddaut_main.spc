CREATE OR REPLACE PACKAGE  lbpks_lbdddaut_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdddaut_main.spc
  **
...
TYPE ty_lbdddaut IS RECORD (
     ...
     v_contract_event_log__daut     oltb_contract_event_log%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdddaut          IN OUT  lbpks_lbdddaut_Main.Ty_lbdddaut,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdddaut     IN  lbpks_lbdddaut_Main.Ty_lbdddaut,
p_Prev_lbdddaut IN OUT  lbpks_lbdddaut_Main.Ty_lbdddaut,
p_Wrk_lbdddaut      IN OUT  lbpks_lbdddaut_Main.Ty_lbdddaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbdddaut     IN  lbpks_lbdddaut_Main.Ty_lbdddaut,
p_Prev_lbdddaut     IN  lbpks_lbdddaut_Main.Ty_lbdddaut,
p_Wrk_lbdddaut      IN OUT  lbpks_lbdddaut_Main.Ty_lbdddaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbdddaut IN  lbpks_lbdddaut_Main.Ty_lbdddaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdddaut_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdddaut_main FOR lbpks_lbdddaut_main
/