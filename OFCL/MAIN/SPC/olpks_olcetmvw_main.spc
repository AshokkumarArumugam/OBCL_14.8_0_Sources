CREATE OR REPLACE PACKAGE  olpks_olcetmvw_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_olcetmvw_main.spc
  **
...
TYPE ty_tb_v_olvw_settlement_info IS TABLE OF olvw_settlement_info%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_olcetmvw IS RECORD (
     v_contract__tlsetlinfo     oltb_contract%ROWTYPE,
     v_olvw_settlement_info    ty_tb_v_olvw_settlement_info,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_olcetmvw          IN OUT  olpks_olcetmvw_Main.Ty_olcetmvw,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Main_Function    IN  VARCHAR2,
p_olcetmvw       IN    olpks_olcetmvw_Main.ty_olcetmvw,
...
p_Main_Function    IN  VARCHAR2,
p_olcetmvw     IN  olpks_olcetmvw_Main.Ty_olcetmvw,
p_Prev_olcetmvw IN OUT  olpks_olcetmvw_Main.Ty_olcetmvw,
p_Wrk_olcetmvw IN OUT  olpks_olcetmvw_Main.Ty_olcetmvw,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_olcetmvw     IN  olpks_olcetmvw_Main.Ty_olcetmvw,
p_Prev_olcetmvw     IN  olpks_olcetmvw_Main.Ty_olcetmvw,
p_Wrk_olcetmvw      IN OUT  olpks_olcetmvw_Main.Ty_olcetmvw,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_olcetmvw IN  olpks_olcetmvw_Main.Ty_olcetmvw,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_olcetmvw_main;
/
CREATE OR REPLACE SYNONYM olpkss_olcetmvw_main FOR olpks_olcetmvw_main
/