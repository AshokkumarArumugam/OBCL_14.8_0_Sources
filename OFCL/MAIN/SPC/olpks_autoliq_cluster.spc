CREATE OR REPLACE PACKAGE olpks_autoliq_cluster AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_autoliq_cluster.spc
  **
...
/*OBCL_14.3_SUPPORT_BUG#32078438 ends*/
	...
	p_Tb_cluster_data  IN OUT   GLOBAL.Ty_Tb_cluster_Data, --OBCL_14.3_BUG#30331208
	pErrorcode		   IN OUT 	VARCHAR2,
	pErrorParam		   IN OUT 	Varchar2)
     Return Boolean;
...
FUNCTION fn_liquidate_sch
   ...
   pProcessingDate    IN      date,
   p_skip_comp	      IN	  oltbs_contract_master.main_comp%type,
   p_Tb_cluster_data  IN OUT  GLOBAL.Ty_Tb_cluster_Data, --Bug#30331212
   p_BALTAB           IN OUT  OLPKS_AUTOLIQ.TY_BAL_TAB, --Bug#30331212
   pErrorCode         IN OUT  VARCHAR2,
   pErrorParam        IN OUT  Varchar2
   )
...
END olpks_autoliq_cluster;
/
CREATE OR REPLACE SYNONYM  olpkss_autoliq_cluster FOR olpks_autoliq_cluster
/