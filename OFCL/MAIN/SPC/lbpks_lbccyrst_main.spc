CREATE OR REPLACE PACKAGE  lbpks_lbccyrst_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbccyrst_main.spc
  **
...
TYPE ty_tb_v_part_ccy_restr_master IS TABLE OF lbtb_part_ccy_restr_master%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_part_ccy_restr_detail IS TABLE OF lbtb_part_ccy_restr_detail%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbccyrst IS RECORD (
     v_oltbs_contract__ccyr     oltb_contract%ROWTYPE,
     v_part_ccy_restr_master    ty_tb_v_part_ccy_restr_master,
     v_part_ccy_restr_detail    ty_tb_v_part_ccy_restr_detail,
...
p_Wrk_lbccyrst IN  lbpks_lbccyrst_Main.Ty_lbccyrst,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbccyrst_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbccyrst_main FOR lbpks_lbccyrst_main
/