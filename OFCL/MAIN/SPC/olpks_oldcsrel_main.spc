CREATE OR REPLACE PACKAGE  olpks_oldcsrel_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldcsrel_main.spc
  **
...
TYPE ty_oldcsrel IS RECORD (
     v_oltbs_relation     oltb_relation%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldcsrel_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldcsrel_main FOR olpks_oldcsrel_main
/