CREATE OR REPLACE PACKAGE lbpks_lbdreprc_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdreprc_kernel.spc
  **
...
END lbpks_lbdreprc_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdreprc_kernel for lbpks_lbdreprc_kernel
/