CREATE OR REPLACE PACKAGE  olpks_oldpoolf_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldpoolf_main.spc
  **
...
TYPE ty_oldpoolf IS RECORD (
     v_oltms_pool_funding_master     oltm_pool_funding_master%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldpoolf_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldpoolf_main FOR olpks_oldpoolf_main
/