CREATE OR REPLACE PACKAGE  lbpks_lbdcorau_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdcorau_main.spc
  **
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdcorau          IN OUT  lbpks_lbdcorau_Main.Ty_lbdcorau,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_lbdcorau          IN lbpks_lbdcorau_Main.Ty_lbdcorau,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdcorau     IN  lbpks_lbdcorau_Main.Ty_lbdcorau,
p_Prev_lbdcorau IN OUT  lbpks_lbdcorau_Main.Ty_lbdcorau,
p_Wrk_lbdcorau      IN OUT  lbpks_lbdcorau_Main.Ty_lbdcorau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbdcorau     IN  lbpks_lbdcorau_Main.Ty_lbdcorau,
p_Prev_lbdcorau     IN  lbpks_lbdcorau_Main.Ty_lbdcorau,
p_Wrk_lbdcorau      IN OUT  lbpks_lbdcorau_Main.Ty_lbdcorau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbdcorau IN  lbpks_lbdcorau_Main.Ty_lbdcorau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdcorau_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdcorau_main FOR lbpks_lbdcorau_main
/