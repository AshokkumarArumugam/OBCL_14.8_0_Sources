create or replace PACKAGE  lbpks_lbdtrupl_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdtrupl_kernel.spc
  **
...
END lbpks_lbdtrupl_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdtrupl_kernel FOR lbpks_lbdtrupl_kernel
/