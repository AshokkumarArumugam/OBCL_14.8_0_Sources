CREATE OR REPLACE PACKAGE  olpks_oldratlg_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldratlg_kernel.spc
  **
...
END olpks_oldratlg_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldratlg_kernel FOR olpks_oldratlg_Kernel
/