CREATE OR REPLACE PACKAGE  olpks_oldifptd_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldifptd_main.spc
  **
...
TYPE ty_tb_v_olvw_liq_breakup IS TABLE OF olvw_liq_breakup%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_olvw_all_ac_entries IS TABLE OF olvw_all_ac_entries%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_oldifptd IS RECORD (
     v_olvw_liq_summary     olvw_liq_summary%ROWTYPE,
     v_olvw_liq_breakup    ty_tb_v_olvw_liq_breakup,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldifptd          IN OUT  olpks_oldifptd_Main.Ty_oldifptd,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldifptd     IN  olpks_oldifptd_Main.Ty_oldifptd,
p_Prev_oldifptd IN OUT  olpks_oldifptd_Main.Ty_oldifptd,
p_Wrk_oldifptd      IN OUT  olpks_oldifptd_Main.Ty_oldifptd,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Wrk_oldifptd IN  olpks_oldifptd_Main.Ty_oldifptd,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldifptd_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldifptd_main FOR olpks_oldifptd_main
/