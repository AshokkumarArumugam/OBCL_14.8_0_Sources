CREATE OR REPLACE PACKAGE  lbpks_lbdcorau_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdcorau_kernel.spc
  **
...
END lbpks_lbdcorau_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdcorau_kernel FOR lbpks_lbdcorau_Kernel
/