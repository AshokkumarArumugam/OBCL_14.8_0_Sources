CREATE OR REPLACE PACKAGE Olpks_Oldcuinf_Kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldcuinf_kernel.spc
  **
...
END Olpks_Oldcuinf_Kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldcuinf_kernel FOR olpks_oldcuinf_Kernel
/