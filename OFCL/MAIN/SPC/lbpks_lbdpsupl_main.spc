CREATE OR REPLACE PACKAGE  lbpks_lbdpsupl_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdpsupl_main.spc
  **
...
TYPE ty_tb_v_lbtbs_schedule_upload IS TABLE OF lbtb_schedule_upload%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_ltbs_upload_exception_cs IS TABLE OF oltb_upload_exception_cs%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbdpsupl IS RECORD (
     v_schedule_upload_master     lbtb_schedule_upload_master%ROWTYPE,
     v_lbtbs_schedule_upload    ty_tb_v_lbtbs_schedule_upload,
     v_hedule_upload_master__exp     lbtb_schedule_upload_master%ROWTYPE,
     v_schedule_upload_summary     lbvw_schedule_upload_summary%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdpsupl          IN OUT  lbpks_lbdpsupl_Main.Ty_lbdpsupl,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbdpsupl     IN  lbpks_lbdpsupl_Main.Ty_lbdpsupl,
p_Prev_lbdpsupl     IN  lbpks_lbdpsupl_Main.Ty_lbdpsupl,
p_Wrk_lbdpsupl      IN OUT  lbpks_lbdpsupl_Main.Ty_lbdpsupl,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbdpsupl IN  lbpks_lbdpsupl_Main.Ty_lbdpsupl,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdpsupl_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdpsupl_main FOR lbpks_lbdpsupl_main
/