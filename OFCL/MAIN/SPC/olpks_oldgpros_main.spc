CREATE OR REPLACE PACKAGE  olpks_oldgpros_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldgpros_main.spc
  **
...
TYPE ty_tb_v_olvws_msg_summary IS TABLE OF olvw_msg_summary%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_oltbs_dly_msg_out IS TABLE OF oltb_dly_msg_out%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_oltbs_bg_status___al IS TABLE OF oltb_bg_status%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_oldgpros IS RECORD (
     v_oltbs_bg_status     oltb_bg_status%ROWTYPE,
     v_olvws_msg_summary    ty_tb_v_olvws_msg_summary,
     v_oltbs_dly_msg_out    ty_tb_v_oltbs_dly_msg_out,
     v_oltbs_bg_status___al    ty_tb_v_oltbs_bg_status___al,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldgpros          IN OUT  olpks_oldgpros_Main.Ty_oldgpros,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldgpros     IN  olpks_oldgpros_Main.Ty_oldgpros,
p_Prev_oldgpros IN OUT  olpks_oldgpros_Main.Ty_oldgpros,
p_Wrk_oldgpros      IN OUT  olpks_oldgpros_Main.Ty_oldgpros,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldgpros     IN  olpks_oldgpros_Main.Ty_oldgpros,
p_Prev_oldgpros     IN  olpks_oldgpros_Main.Ty_oldgpros,
p_Wrk_oldgpros      IN OUT  olpks_oldgpros_Main.Ty_oldgpros,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldgpros IN  olpks_oldgpros_Main.Ty_oldgpros,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldgpros_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldgpros_main FOR olpks_oldgpros_main
/