CREATE OR REPLACE PACKAGE lbpks_upload_payment AS
/*----------------------------------------------------------------------------------------------------
**
** File Name	: lbpks_upload_payment.SQL
**
** Module	: LS
**
...
/*
CHANGE_HISTORY
04-JUL-2007	FLEXCUBE V.CL Release 7.3 LIQDUPLOAD CHANGES - NEW UNIT
*/

TYPE				g_upl_ratio_record_type
IS RECORD			(
...
TYPE				g_upl_ratio_table_type
IS TABLE OF			g_upl_ratio_record_type
...
p_upload_part_pay_ratio_record	IN	g_upl_ratio_table_type,
