CREATE OR REPLACE PACKAGE  lbpks_lbcrplif_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbcrplif_kernel.spc
  **
...
END lbpks_lbcrplif_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbcrplif_kernel FOR lbpks_lbcrplif_kernel
/