CREATE OR REPLACE PACKAGE  lbpks_lbcondet_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbcondet_main.spc
  **
...
TYPE ty_lbcondet IS RECORD (
     v_oltbs_contract__ocrt     oltb_contract%ROWTYPE,
     v_borrower_details__lbbd     lbvw_borrower_details%ROWTYPE,
     v_participant_details__lbpd     lbvw_participant_details%ROWTYPE,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbcondet          IN OUT  lbpks_lbcondet_Main.Ty_lbcondet,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Main_Function    IN  VARCHAR2,
p_lbcondet       IN    lbpks_lbcondet_Main.ty_lbcondet,
...
p_Main_Function    IN  VARCHAR2,
p_lbcondet     IN  lbpks_lbcondet_Main.Ty_lbcondet,
p_Prev_lbcondet IN OUT  lbpks_lbcondet_Main.Ty_lbcondet,
p_Wrk_lbcondet IN OUT  lbpks_lbcondet_Main.Ty_lbcondet,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbcondet     IN  lbpks_lbcondet_Main.Ty_lbcondet,
p_Prev_lbcondet     IN  lbpks_lbcondet_Main.Ty_lbcondet,
p_Wrk_lbcondet      IN OUT  lbpks_lbcondet_Main.Ty_lbcondet,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbcondet IN  lbpks_lbcondet_Main.Ty_lbcondet,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbcondet_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbcondet_main FOR lbpks_lbcondet_main
/