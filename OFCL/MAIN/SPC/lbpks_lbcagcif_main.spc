CREATE OR REPLACE PACKAGE  lbpks_lbcagcif_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbcagcif_main.spc
  **
...
TYPE ty_tb_v_orig_ssi_maint_detail IS TABLE OF lbtb_orig_ssi_maint_detail%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbcagcif IS RECORD (
     v_orig_ssi_maint_master     lbtb_orig_ssi_maint_master%ROWTYPE,
     v_orig_ssi_maint_detail    ty_tb_v_orig_ssi_maint_detail,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbcagcif          IN OUT  lbpks_lbcagcif_Main.Ty_lbcagcif,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Main_Function    IN  VARCHAR2,
p_lbcagcif       IN    lbpks_lbcagcif_Main.ty_lbcagcif,
...
p_Main_Function    IN  VARCHAR2,
p_lbcagcif     IN  lbpks_lbcagcif_Main.Ty_lbcagcif,
p_Prev_lbcagcif IN OUT  lbpks_lbcagcif_Main.Ty_lbcagcif,
p_Wrk_lbcagcif IN OUT  lbpks_lbcagcif_Main.Ty_lbcagcif,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbcagcif     IN  lbpks_lbcagcif_Main.Ty_lbcagcif,
p_Prev_lbcagcif     IN  lbpks_lbcagcif_Main.Ty_lbcagcif,
p_Wrk_lbcagcif      IN OUT  lbpks_lbcagcif_Main.Ty_lbcagcif,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbcagcif IN  lbpks_lbcagcif_Main.Ty_lbcagcif,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbcagcif_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbcagcif_main FOR lbpks_lbcagcif_main
/