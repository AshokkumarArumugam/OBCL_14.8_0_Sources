CREATE OR REPLACE PACKAGE  olpks_oldstmtp_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldstmtp_main.spc
  **
...
TYPE ty_oldstmtp IS RECORD (
     v_oltms_1098_param     oltm_1098_param%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldstmtp_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldstmtp_main FOR olpks_oldstmtp_main
/