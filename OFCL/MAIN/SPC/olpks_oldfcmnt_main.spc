CREATE OR REPLACE PACKAGE  olpks_oldfcmnt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldfcmnt_main.spc
  **
...
TYPE ty_oldfcmnt IS RECORD (
     v_oltms_fin_centre     oltm_fin_centre%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldfcmnt_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldfcmnt_main FOR olpks_oldfcmnt_main
/