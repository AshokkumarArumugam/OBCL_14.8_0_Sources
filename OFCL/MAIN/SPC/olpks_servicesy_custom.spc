create or replace PACKAGE olpks_servicesy_custom AS
  /*----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_servicesy_custom.spc
  **
  ** Module    : OL
  **
  ...
  */
  ...
  FUNCTION fn_Pre_authorise(Pcontractrefno IN Oltbs_Contract.Contract_Ref_No%TYPE,
...
END olpks_servicesy_custom;
/
CREATE OR REPLACE SYNONYM olpkss_servicesy_custom FOR olpks_servicesy_custom
/