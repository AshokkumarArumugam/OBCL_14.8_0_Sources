CREATE OR REPLACE PACKAGE  olpks_olctrmis_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_olctrmis_kernel.spc
  **
  ** Module     : MI
  ** 
...
END olpks_olctrmis_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_olctrmis_kernel FOR olpks_olctrmis_kernel
/