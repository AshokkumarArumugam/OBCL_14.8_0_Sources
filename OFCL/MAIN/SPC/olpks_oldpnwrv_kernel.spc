CREATE OR REPLACE PACKAGE  olpks_oldpnwrv_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldpnwrv_kernel.spc
  **
...
END olpks_oldpnwrv_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldpnwrv_kernel FOR olpks_oldpnwrv_kernel
/