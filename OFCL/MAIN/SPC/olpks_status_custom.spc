CREATE OR REPLACE PACKAGE olpks_status_custom AS
/*----------------------------------------------------------------------------------------------------
**
** File Name	: olpks_status_custom.SPC
**
...
END olpks_status_custom;
/
CREATE or replace SYNONYM olpkss_status_custom FOR olpks_status_custom
/