CREATE OR REPLACE PACKAGE lbpks_lbdpsaut_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdpsaut_kernel.spc
  **
...
END lbpks_lbdpsaut_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdpsaut_kernel FOR lbpks_lbdpsaut_kernel
/