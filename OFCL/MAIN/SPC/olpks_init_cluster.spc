CREATE OR REPLACE PACKAGE olpks_init_cluster AS
/*----------------------------------------------------------------------------------------------------
**
** File Name	: olpks_init_cluster.SPC
**
...
--Bug#30020026
END olpks_init_cluster;
/


CREATE or replace SYNONYM olpkss_init_cluster FOR olpks_init_cluster
/