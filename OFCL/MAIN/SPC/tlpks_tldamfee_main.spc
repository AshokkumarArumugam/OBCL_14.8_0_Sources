CREATE OR REPLACE PACKAGE  tlpks_tldamfee_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldamfee_main.spc
  **
...
TYPE ty_tb_v_tltbs_amend_fee_detail IS TABLE OF tltb_amend_fee_detail%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_tldamfee IS RECORD (
     v_tltbs_amend_fee_master     tltb_amend_fee_master%ROWTYPE,
     v_tltbs_amend_fee_detail    ty_tb_v_tltbs_amend_fee_detail,
     v_amend_fee_master__summry     tltb_amend_fee_master%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_tldamfee          IN OUT  tlpks_tldamfee_Main.Ty_tldamfee,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_tldamfee          IN tlpks_tldamfee_Main.Ty_tldamfee,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_tldamfee     IN  tlpks_tldamfee_Main.Ty_tldamfee,
p_Prev_tldamfee IN OUT  tlpks_tldamfee_Main.Ty_tldamfee,
p_Wrk_tldamfee      IN OUT  tlpks_tldamfee_Main.Ty_tldamfee,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_tldamfee     IN  tlpks_tldamfee_Main.Ty_tldamfee,
p_Prev_tldamfee     IN  tlpks_tldamfee_Main.Ty_tldamfee,
p_Wrk_tldamfee      IN OUT  tlpks_tldamfee_Main.Ty_tldamfee,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_tldamfee IN  tlpks_tldamfee_Main.Ty_tldamfee,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tldamfee_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tldamfee_main FOR tlpks_tldamfee_main
/