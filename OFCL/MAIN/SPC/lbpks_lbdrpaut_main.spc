CREATE OR REPLACE PACKAGE  lbpks_lbdrpaut_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdrpaut_main.spc
  **
...
TYPE ty_tb_v_contract_merge_detail IS TABLE OF lbtb_contract_merge_detail%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_oltbs_contract_ovd IS TABLE OF oltb_contract_ovd%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbdrpaut IS RECORD (
     v_oltbs_contract     oltb_contract%ROWTYPE,
     v_contract_merge_master     lbtb_contract_merge_master%ROWTYPE,
     v_contract_merge_detail    ty_tb_v_contract_merge_detail,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdrpaut          IN OUT  lbpks_lbdrpaut_Main.Ty_lbdrpaut,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_lbdrpaut          IN lbpks_lbdrpaut_Main.Ty_lbdrpaut,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdrpaut     IN  lbpks_lbdrpaut_Main.Ty_lbdrpaut,
p_Wrk_lbdrpaut      IN OUT  lbpks_lbdrpaut_Main.Ty_lbdrpaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdrpaut     IN  lbpks_lbdrpaut_Main.Ty_lbdrpaut,
p_Prev_lbdrpaut IN OUT  lbpks_lbdrpaut_Main.Ty_lbdrpaut,
p_Wrk_lbdrpaut      IN OUT  lbpks_lbdrpaut_Main.Ty_lbdrpaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbdrpaut     IN  lbpks_lbdrpaut_Main.Ty_lbdrpaut,
p_Prev_lbdrpaut     IN  lbpks_lbdrpaut_Main.Ty_lbdrpaut,
p_Wrk_lbdrpaut      IN OUT  lbpks_lbdrpaut_Main.Ty_lbdrpaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbdrpaut IN  lbpks_lbdrpaut_Main.Ty_lbdrpaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdrpaut_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdrpaut_main FOR lbpks_lbdrpaut_main
/