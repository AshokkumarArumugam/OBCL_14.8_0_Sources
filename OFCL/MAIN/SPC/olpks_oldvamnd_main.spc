CREATE OR REPLACE PACKAGE  olpks_oldvamnd_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldvamnd_main.spc
  **
...
p_Wrk_oldvamnd IN  olpks_oldvamnd_Main.Ty_oldvamnd,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldvamnd_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldvamnd_main FOR olpks_oldvamnd_main
/