CREATE OR REPLACE PACKAGE  txpks_txctrtax_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : txpks_txctrtax_main.spc
  **
  ** Module     : TX
  ** 
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_txctrtax          IN OUT  txpks_txctrtax_Main.Ty_txctrtax,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Main_Function    IN  VARCHAR2,
p_txctrtax       IN    txpks_txctrtax_Main.ty_txctrtax,
...
p_Main_Function    IN  VARCHAR2,
p_txctrtax     IN  txpks_txctrtax_Main.Ty_txctrtax,
p_Prev_txctrtax IN OUT  txpks_txctrtax_Main.Ty_txctrtax,
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_txctrtax     IN  txpks_txctrtax_Main.Ty_txctrtax,
p_Prev_txctrtax     IN  txpks_txctrtax_Main.Ty_txctrtax,
p_Wrk_txctrtax      IN OUT  txpks_txctrtax_Main.Ty_txctrtax,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_txctrtax IN  txpks_txctrtax_Main.Ty_txctrtax,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END txpks_txctrtax_main;
/
CREATE OR REPLACE SYNONYM txpkss_txctrtax_main FOR txpks_txctrtax_main
/