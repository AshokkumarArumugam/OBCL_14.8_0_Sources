CREATE OR REPLACE PACKAGE  olpks_oldcusmt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldcusmt_main.spc
  **
...
TYPE ty_oldcusmt IS RECORD (
     v_sytms_sttm_customer     sytm_sttm_customer%ROWTYPE,
...
FUNCTION Fn_Get_Key_Information (p_Source    IN  VARCHAR2, 
                        ...
                        p_Function_id       IN     VARCHAR2,
                        p_Action_Code       IN     VARCHAR2,
p_oldcusmt       IN  OUT olpks_oldcusmt_Main.Ty_oldcusmt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldcusmt_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldcusmt_main FOR olpks_oldcusmt_main
/