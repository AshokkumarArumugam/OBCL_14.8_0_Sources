CREATE OR REPLACE PACKAGE  lbpks_lbrinitd_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbrinitd_kernel.spc
  **
...
p_lbrinitd     IN  OUT lbpks_lbrinitd_Main.Ty_lbrinitd,
...
p_lbrinitd IN   lbpks_lbrinitd_Main.ty_lbrinitd,
p_Err_Code       IN  OUT VARCHAR2,
p_Err_Params     IN  OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Child_Function    IN  VARCHAR2,
p_lbrinitd IN   lbpks_lbrinitd_Main.Ty_lbrinitd,
p_Wrk_lbrinitd IN OUT  lbpks_lbrinitd_Main.Ty_lbrinitd,
p_Err_Code       IN  OUT VARCHAR2,
p_Err_Params     IN  OUT VARCHAR2)
RETURN BOOLEAN;
...
END lbpks_lbrinitd_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbrinitd_kernel FOR lbpks_lbrinitd_kernel
/