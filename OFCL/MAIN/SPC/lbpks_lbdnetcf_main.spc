CREATE OR REPLACE PACKAGE  lbpks_lbdnetcf_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdnetcf_main.spc
  **
...
TYPE ty_tb__netting_detail__netting IS TABLE OF lbtb_cashflow_netting_detail%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_netting_detail__other IS TABLE OF lbtb_cashflow_netting_detail%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbdnetcf IS RECORD (
     v_cashflow_netting_master     lbtb_cashflow_netting_master%ROWTYPE,
     v_netting_detail__netting    ty_tb__netting_detail__netting,
     v_netting_detail__other    ty_tb_v_netting_detail__other,
     v_lbvws_cashflow_netting     lbvw_cashflow_netting%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdnetcf          IN OUT  lbpks_lbdnetcf_Main.Ty_lbdnetcf,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_lbdnetcf          IN lbpks_lbdnetcf_Main.Ty_lbdnetcf,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdnetcf     IN  lbpks_lbdnetcf_Main.Ty_lbdnetcf,
p_Prev_lbdnetcf IN OUT  lbpks_lbdnetcf_Main.Ty_lbdnetcf,
p_Wrk_lbdnetcf      IN OUT  lbpks_lbdnetcf_Main.Ty_lbdnetcf,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbdnetcf     IN  lbpks_lbdnetcf_Main.Ty_lbdnetcf,
p_Prev_lbdnetcf     IN  lbpks_lbdnetcf_Main.Ty_lbdnetcf,
p_Wrk_lbdnetcf      IN OUT  lbpks_lbdnetcf_Main.Ty_lbdnetcf,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbdnetcf IN  lbpks_lbdnetcf_Main.Ty_lbdnetcf,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdnetcf_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdnetcf_main FOR lbpks_lbdnetcf_main
/