CREATE OR REPLACE PACKAGE  tlpks_tldtrdsa_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldtrdsa_kernel.spc
  **
...
END tlpks_tldtrdsa_kernel;
/
CREATE OR REPLACE SYNONYM tlpkss_tldtrdsa_kernel FOR tlpks_tldtrdsa_Kernel
/