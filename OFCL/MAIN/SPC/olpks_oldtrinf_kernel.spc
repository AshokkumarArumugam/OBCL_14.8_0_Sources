CREATE OR REPLACE PACKAGE olpks_oldtrinf_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldtrinf_kernel.spc
  **
...
END olpks_oldtrinf_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldtrinf_kernel FOR olpks_oldtrinf_Kernel
/