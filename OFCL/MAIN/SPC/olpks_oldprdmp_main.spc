CREATE OR REPLACE PACKAGE  olpks_oldprdmp_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldprdmp_main.spc
  **
...
TYPE ty_oldprdmp IS RECORD (
     v_oltms_msg_prod_map     oltm_msg_prod_map%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldprdmp_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldprdmp_main FOR olpks_oldprdmp_main
/