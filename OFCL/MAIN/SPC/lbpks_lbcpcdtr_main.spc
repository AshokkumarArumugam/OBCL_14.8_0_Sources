CREATE OR REPLACE PACKAGE  lbpks_lbcpcdtr_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbcpcdtr_main.spc
  **
...
TYPE ty_lbcpcdtr IS RECORD (
     v_oltbs_contract__process     oltb_contract%ROWTYPE,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbcpcdtr          IN OUT  lbpks_lbcpcdtr_Main.Ty_lbcpcdtr,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Main_Function    IN  VARCHAR2,
p_lbcpcdtr       IN    lbpks_lbcpcdtr_Main.ty_lbcpcdtr,
...
p_Main_Function    IN  VARCHAR2,
p_lbcpcdtr     IN  lbpks_lbcpcdtr_Main.Ty_lbcpcdtr,
p_Prev_lbcpcdtr IN OUT  lbpks_lbcpcdtr_Main.Ty_lbcpcdtr,
p_Wrk_lbcpcdtr IN OUT  lbpks_lbcpcdtr_Main.Ty_lbcpcdtr,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbcpcdtr     IN  lbpks_lbcpcdtr_Main.Ty_lbcpcdtr,
p_Prev_lbcpcdtr     IN  lbpks_lbcpcdtr_Main.Ty_lbcpcdtr,
p_Wrk_lbcpcdtr      IN OUT  lbpks_lbcpcdtr_Main.Ty_lbcpcdtr,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbcpcdtr IN  lbpks_lbcpcdtr_Main.Ty_lbcpcdtr,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbcpcdtr_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbcpcdtr_main FOR lbpks_lbcpcdtr_main
/