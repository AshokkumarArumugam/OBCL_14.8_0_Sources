CREATE OR REPLACE PACKAGE  tlpks_tldpomnt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldpomnt_main.spc
  **
...
TYPE ty_tldpomnt IS RECORD (
     v_tltms_portfolio     tltm_portfolio%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tldpomnt_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tldpomnt_main FOR tlpks_tldpomnt_main
/