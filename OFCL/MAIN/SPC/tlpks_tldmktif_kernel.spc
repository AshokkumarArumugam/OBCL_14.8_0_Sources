CREATE OR REPLACE PACKAGE  tlpks_tldmktif_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldmktif_kernel.spc
  **
...
END tlpks_tldmktif_kernel;
/
CREATE OR REPLACE SYNONYM tlpkss_tldmktif_kernel FOR tlpks_tldmktif_kernel
/