CREATE OR REPLACE PACKAGE  lbpks_lbdinsvw_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdinsvw_main.spc
  **
...
TYPE ty_tb_v_oltms_instr IS TABLE OF oltm_instr%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbdinsvw IS RECORD (
     v_oltms_customer__insvw     oltm_customer%ROWTYPE,
     v_oltms_instr    ty_tb_v_oltms_instr,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdinsvw          IN OUT  lbpks_lbdinsvw_Main.Ty_lbdinsvw,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_lbdinsvw          IN lbpks_lbdinsvw_Main.Ty_lbdinsvw,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdinsvw     IN  lbpks_lbdinsvw_Main.Ty_lbdinsvw,
p_Wrk_lbdinsvw      IN OUT  lbpks_lbdinsvw_Main.Ty_lbdinsvw,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdinsvw     IN  lbpks_lbdinsvw_Main.Ty_lbdinsvw,
p_Prev_lbdinsvw IN OUT  lbpks_lbdinsvw_Main.Ty_lbdinsvw,
p_Wrk_lbdinsvw      IN OUT  lbpks_lbdinsvw_Main.Ty_lbdinsvw,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbdinsvw     IN  lbpks_lbdinsvw_Main.Ty_lbdinsvw,
p_Prev_lbdinsvw     IN  lbpks_lbdinsvw_Main.Ty_lbdinsvw,
p_Wrk_lbdinsvw      IN OUT  lbpks_lbdinsvw_Main.Ty_lbdinsvw,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbdinsvw IN  lbpks_lbdinsvw_Main.Ty_lbdinsvw,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdinsvw_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdinsvw_main FOR lbpks_lbdinsvw_main
/