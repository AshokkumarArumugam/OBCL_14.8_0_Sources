CREATE OR REPLACE PACKAGE  olpks_oldudfat_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldudfat_main.spc
  **
...
TYPE ty_tb__oltbs_udf_upload__payau IS TABLE OF oltb_udf_upload%ROWTYPE INDEX BY BINARY_INTEGER;
...
TYPE ty_oldudfat IS RECORD (
     v_udf_upload_master__payau     oltb_udf_upload_master%ROWTYPE,
     v_oltbs_udf_upload__payau    ty_tb__oltbs_udf_upload__payau,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldudfat          IN OUT  olpks_oldudfat_Main.Ty_oldudfat,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldudfat     IN  olpks_oldudfat_Main.Ty_oldudfat,
p_Prev_oldudfat     IN  olpks_oldudfat_Main.Ty_oldudfat,
p_Wrk_oldudfat      IN OUT  olpks_oldudfat_Main.Ty_oldudfat,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldudfat IN  olpks_oldudfat_Main.Ty_oldudfat,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldudfat_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldudfat_main FOR olpks_oldudfat_main
/