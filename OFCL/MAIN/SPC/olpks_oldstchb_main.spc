CREATE OR REPLACE PACKAGE  olpks_oldstchb_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldstchb_main.spc
  **
...
TYPE ty_tb_v_oltb_bulk_stch_detail IS TABLE OF oltb_bulk_stch_detail%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_oldstchb IS RECORD (
     v_oltb_bulk_stch_master     oltb_bulk_stch_master%ROWTYPE,
     v_oltb_bulk_stch_detail    ty_tb_v_oltb_bulk_stch_detail,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldstchb          IN OUT  olpks_oldstchb_Main.Ty_oldstchb,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_oldstchb          IN olpks_oldstchb_Main.Ty_oldstchb,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldstchb     IN  olpks_oldstchb_Main.Ty_oldstchb,
p_Wrk_oldstchb      IN OUT  olpks_oldstchb_Main.Ty_oldstchb,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldstchb     IN  olpks_oldstchb_Main.Ty_oldstchb,
p_Prev_oldstchb IN OUT  olpks_oldstchb_Main.Ty_oldstchb,
p_Wrk_oldstchb      IN OUT  olpks_oldstchb_Main.Ty_oldstchb,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldstchb     IN  olpks_oldstchb_Main.Ty_oldstchb,
p_Prev_oldstchb     IN  olpks_oldstchb_Main.Ty_oldstchb,
p_Wrk_oldstchb      IN OUT  olpks_oldstchb_Main.Ty_oldstchb,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldstchb IN  olpks_oldstchb_Main.Ty_oldstchb,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldstchb_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldstchb_main FOR olpks_oldstchb_main
/