CREATE OR REPLACE PACKAGE  olpks_oldmscdt_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldmscdt_kernel.spc
  **
...
**  Modified On     : 11-AUG-2022
**  Modified Reason : code call ACCR function during Manual Status Change for RFR contracts
**  Search String   : Bug#34468908
 
  -------------------------------------------------------------------------------------------------------
  */
  
G_STAT_CHANGE VARCHAR2(1) :='N';---Bug#34468908
...
p_oldmscdt     IN  OUT olpks_oldmscdt_main.ty_oldmscdt,
...
p_Child_Function    IN  VARCHAR2,
p_oldmscdt IN   olpks_oldmscdt_main.ty_oldmscdt,
p_prev_oldmscdt IN OUT olpks_oldmscdt_main.ty_oldmscdt,
...
END olpks_oldmscdt_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldmscdt_kernel FOR olpks_oldmscdt_kernel
/