CREATE OR REPLACE PACKAGE  lbpks_lbdvwmsg_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdvwmsg_main.spc
  **
...
TYPE ty_tb__part_dly_msg_out__multi IS TABLE OF olvw_part_dly_msg_out%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbdvwmsg IS RECORD (
     v_part_dly_msg_out__single     olvw_part_dly_msg_out%ROWTYPE,
     v_part_dly_msg_out__multi    ty_tb__part_dly_msg_out__multi,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdvwmsg          IN OUT  lbpks_lbdvwmsg_Main.Ty_lbdvwmsg,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_lbdvwmsg          IN lbpks_lbdvwmsg_Main.Ty_lbdvwmsg,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdvwmsg     IN  lbpks_lbdvwmsg_Main.Ty_lbdvwmsg,
p_Wrk_lbdvwmsg      IN OUT  lbpks_lbdvwmsg_Main.Ty_lbdvwmsg,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdvwmsg     IN  lbpks_lbdvwmsg_Main.Ty_lbdvwmsg,
p_Prev_lbdvwmsg IN OUT  lbpks_lbdvwmsg_Main.Ty_lbdvwmsg,
p_Wrk_lbdvwmsg      IN OUT  lbpks_lbdvwmsg_Main.Ty_lbdvwmsg,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbdvwmsg     IN  lbpks_lbdvwmsg_Main.Ty_lbdvwmsg,
p_Prev_lbdvwmsg     IN  lbpks_lbdvwmsg_Main.Ty_lbdvwmsg,
p_Wrk_lbdvwmsg      IN OUT  lbpks_lbdvwmsg_Main.Ty_lbdvwmsg,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbdvwmsg IN  lbpks_lbdvwmsg_Main.Ty_lbdvwmsg,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdvwmsg_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdvwmsg_main FOR lbpks_lbdvwmsg_main
/