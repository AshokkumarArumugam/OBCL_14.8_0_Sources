CREATE OR REPLACE PACKAGE  olpks_oldccydt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldccydt_main.spc
  **
...
TYPE ty_oldccydt IS RECORD (
     v_oltm_ccy_settle_master     oltm_ccy_settle_master%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldccydt_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldccydt_main FOR olpks_oldccydt_main
/