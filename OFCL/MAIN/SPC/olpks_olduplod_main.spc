CREATE OR REPLACE PACKAGE  olpks_olduplod_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_olduplod_main.spc
  **
...
TYPE ty_olduplod IS RECORD (
     v_sytbs_upload_master     sytb_upload_master%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_olduplod          IN OUT  olpks_olduplod_Main.Ty_olduplod,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_olduplod     IN  olpks_olduplod_Main.Ty_olduplod,
p_Prev_olduplod IN OUT  olpks_olduplod_Main.Ty_olduplod,
p_Wrk_olduplod      IN OUT  olpks_olduplod_Main.Ty_olduplod,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Wrk_olduplod IN  olpks_olduplod_Main.Ty_olduplod,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_olduplod_main;
/
CREATE OR REPLACE SYNONYM olpkss_olduplod_main FOR olpks_olduplod_main
/