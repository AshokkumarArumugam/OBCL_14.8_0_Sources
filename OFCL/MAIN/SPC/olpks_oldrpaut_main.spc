CREATE OR REPLACE PACKAGE  olpks_oldrpaut_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldrpaut_main.spc
  **
...
TYPE ty_oldrpaut IS RECORD (
     v_contract_merge_master     oltb_contract_merge_master%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldrpaut          IN OUT  olpks_oldrpaut_Main.Ty_oldrpaut,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Wrk_oldrpaut IN  olpks_oldrpaut_Main.Ty_oldrpaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldrpaut_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldrpaut_main FOR olpks_oldrpaut_main
/