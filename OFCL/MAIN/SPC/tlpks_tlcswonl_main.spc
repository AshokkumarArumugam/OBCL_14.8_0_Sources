CREATE OR REPLACE PACKAGE  tlpks_tlcswonl_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tlcswonl_main.spc
  **
...
TYPE ty_tb_v_tltbs_swap IS TABLE OF tltb_swap%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_tlcswonl IS RECORD (
     v_tltbs_contract_master__sw     tltb_contract_master%ROWTYPE,
     v_tltbs_swap    ty_tb_v_tltbs_swap,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_tlcswonl          IN OUT  tlpks_tlcswonl_Main.Ty_tlcswonl,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_tlcswonl     IN  tlpks_tlcswonl_Main.Ty_tlcswonl,
p_Prev_tlcswonl     IN  tlpks_tlcswonl_Main.Ty_tlcswonl,
p_Wrk_tlcswonl      IN OUT  tlpks_tlcswonl_Main.Ty_tlcswonl,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_tlcswonl IN  tlpks_tlcswonl_Main.Ty_tlcswonl,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tlcswonl_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tlcswonl_main FOR tlpks_tlcswonl_main
/