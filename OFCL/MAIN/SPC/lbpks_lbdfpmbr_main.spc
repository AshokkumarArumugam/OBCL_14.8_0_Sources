CREATE OR REPLACE PACKAGE  lbpks_lbdfpmbr_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdfpmbr_main.spc
  **
...
TYPE ty_tb_v_oltbs_fpml_msg_detail IS TABLE OF oltb_fpml_msg_detail%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbdfpmbr IS RECORD (
     v_lbvws_mssfpmbr     lbvw_mssfpmbr%ROWTYPE,
     v_oltbs_fpml_msg_detail    ty_tb_v_oltbs_fpml_msg_detail,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdfpmbr          IN OUT  lbpks_lbdfpmbr_Main.Ty_lbdfpmbr,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_lbdfpmbr          IN lbpks_lbdfpmbr_Main.Ty_lbdfpmbr,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdfpmbr     IN  lbpks_lbdfpmbr_Main.Ty_lbdfpmbr,
p_Wrk_lbdfpmbr      IN OUT  lbpks_lbdfpmbr_Main.Ty_lbdfpmbr,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdfpmbr     IN  lbpks_lbdfpmbr_Main.Ty_lbdfpmbr,
p_Prev_lbdfpmbr IN OUT  lbpks_lbdfpmbr_Main.Ty_lbdfpmbr,
p_Wrk_lbdfpmbr      IN OUT  lbpks_lbdfpmbr_Main.Ty_lbdfpmbr,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbdfpmbr     IN  lbpks_lbdfpmbr_Main.Ty_lbdfpmbr,
p_Prev_lbdfpmbr     IN  lbpks_lbdfpmbr_Main.Ty_lbdfpmbr,
p_Wrk_lbdfpmbr      IN OUT  lbpks_lbdfpmbr_Main.Ty_lbdfpmbr,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbdfpmbr IN  lbpks_lbdfpmbr_Main.Ty_lbdfpmbr,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdfpmbr_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdfpmbr_main FOR lbpks_lbdfpmbr_main
/