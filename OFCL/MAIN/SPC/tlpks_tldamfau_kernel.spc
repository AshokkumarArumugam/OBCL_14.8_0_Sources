CREATE OR REPLACE PACKAGE  tlpks_tldamfau_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldamfau_kernel.spc
  **
...
END tlpks_tldamfau_kernel;
/
CREATE OR REPLACE SYNONYM tlpkss_tldamfau_kernel FOR tlpks_tldamfau_Kernel
/