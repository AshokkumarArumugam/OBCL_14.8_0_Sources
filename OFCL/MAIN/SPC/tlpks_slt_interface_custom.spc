CREATE OR REPLACE PACKAGE Tlpks_Slt_Interface_Custom AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : Tlpks_Slt_Interface_Custom.spc
  **
...
END Tlpks_Slt_Interface_Custom;
/
CREATE OR REPLACE Synonym Tlpkss_Slt_Interface_Custom FOR Tlpks_Slt_Interface_Custom
/