CREATE OR REPLACE PACKAGE olpks_irrn_custom AS
/*----------------------------------------------------------------------------------------------------
**
** File Name	: olpks_irrn_custom.SPC
**
...
END olpks_irrn_custom;
/
CREATE OR REPLACE SYNONYM OLPKSS_IRRN_CUSTOM FOR OLPKS_IRRN_CUSTOM
/