CREATE OR REPLACE PACKAGE  olpks_oldexamd_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldexamd_main.spc
  **
...
TYPE ty_tb__contract_exrate_details IS TABLE OF oltb_contract_exrate_details%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_oldexamd IS RECORD (
     v_contract_exrate_master     oltb_contract_exrate_master%ROWTYPE,
     v_contract_exrate_details    ty_tb__contract_exrate_details,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldexamd          IN OUT  olpks_oldexamd_Main.Ty_oldexamd,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldexamd     IN  olpks_oldexamd_Main.Ty_oldexamd,
p_Prev_oldexamd     IN  olpks_oldexamd_Main.Ty_oldexamd,
p_Wrk_oldexamd      IN OUT  olpks_oldexamd_Main.Ty_oldexamd,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldexamd IN  olpks_oldexamd_Main.Ty_oldexamd,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldexamd_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldexamd_main FOR olpks_oldexamd_main
/