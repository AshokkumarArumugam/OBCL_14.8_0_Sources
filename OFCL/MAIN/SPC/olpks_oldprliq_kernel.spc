CREATE OR REPLACE PACKAGE  olpks_oldprliq_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldprliq_kernel.spc
  **
...
END olpks_oldprliq_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldprliq_kernel FOR olpks_oldprliq_kernel
/