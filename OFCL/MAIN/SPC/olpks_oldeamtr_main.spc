CREATE OR REPLACE PACKAGE  olpks_oldeamtr_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldeamtr_main.spc
  **
...
TYPE ty_oldeamtr IS RECORD (
     v_batch_ext_acc_status     oltb_batch_ext_acc_status%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldeamtr          IN OUT  olpks_oldeamtr_Main.Ty_oldeamtr,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_oldeamtr          IN olpks_oldeamtr_Main.Ty_oldeamtr,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldeamtr     IN  olpks_oldeamtr_Main.Ty_oldeamtr,
p_Wrk_oldeamtr      IN OUT  olpks_oldeamtr_Main.Ty_oldeamtr,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldeamtr     IN  olpks_oldeamtr_Main.Ty_oldeamtr,
p_Prev_oldeamtr IN OUT  olpks_oldeamtr_Main.Ty_oldeamtr,
p_Wrk_oldeamtr      IN OUT  olpks_oldeamtr_Main.Ty_oldeamtr,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldeamtr     IN  olpks_oldeamtr_Main.Ty_oldeamtr,
p_Prev_oldeamtr     IN  olpks_oldeamtr_Main.Ty_oldeamtr,
p_Wrk_oldeamtr      IN OUT  olpks_oldeamtr_Main.Ty_oldeamtr,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldeamtr IN  olpks_oldeamtr_Main.Ty_oldeamtr,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldeamtr_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldeamtr_main FOR olpks_oldeamtr_main
/