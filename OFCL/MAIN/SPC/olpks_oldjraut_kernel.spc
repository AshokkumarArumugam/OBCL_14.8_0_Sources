CREATE OR REPLACE PACKAGE  olpks_oldjraut_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldjraut_kernel.spc
  **
...
END olpks_oldjraut_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldjraut_kernel FOR olpks_oldjraut_kernel
/