CREATE OR REPLACE PACKAGE  olpks_oldcscag_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldcscag_main.spc
  **
...
TYPE ty_oldcscag IS RECORD (
     v_oltms_customer_cat     oltm_customer_cat%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldcscag_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldcscag_main FOR olpks_oldcscag_main
/