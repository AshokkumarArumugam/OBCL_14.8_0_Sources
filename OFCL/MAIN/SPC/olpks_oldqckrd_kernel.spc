CREATE OR REPLACE PACKAGE  olpks_oldqckrd_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldqckrd_kernel.spc
  **
...
END olpks_oldqckrd_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldqckrd_kernel FOR olpks_oldqckrd_kernel
/