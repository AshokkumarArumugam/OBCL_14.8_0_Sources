CREATE OR REPLACE PACKAGE  olpks_oldedtrt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldedtrt_main.spc
  **
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldedtrt          IN OUT  olpks_oldedtrt_Main.Ty_oldedtrt,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_oldedtrt          IN olpks_oldedtrt_Main.Ty_oldedtrt,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldedtrt     IN  olpks_oldedtrt_Main.Ty_oldedtrt,
p_Wrk_oldedtrt      IN OUT  olpks_oldedtrt_Main.Ty_oldedtrt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldedtrt     IN  olpks_oldedtrt_Main.Ty_oldedtrt,
p_Prev_oldedtrt IN OUT  olpks_oldedtrt_Main.Ty_oldedtrt,
p_Wrk_oldedtrt      IN OUT  olpks_oldedtrt_Main.Ty_oldedtrt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldedtrt     IN  olpks_oldedtrt_Main.Ty_oldedtrt,
p_Prev_oldedtrt     IN  olpks_oldedtrt_Main.Ty_oldedtrt,
p_Wrk_oldedtrt      IN OUT  olpks_oldedtrt_Main.Ty_oldedtrt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldedtrt IN  olpks_oldedtrt_Main.Ty_oldedtrt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldedtrt_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldedtrt_main FOR olpks_oldedtrt_main
/