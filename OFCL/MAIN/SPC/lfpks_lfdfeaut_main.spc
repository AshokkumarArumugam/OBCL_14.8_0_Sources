CREATE OR REPLACE PACKAGE  lfpks_lfdfeaut_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lfpks_lfdfeaut_main.spc
  **
  ** Module     : The ICCF
  ** 
...
TYPE ty_lfdfeaut IS RECORD (
     v_oltbs_contract__feaut     oltb_contract%ROWTYPE,
     v_contract_event_log__feau     oltb_contract_event_log%ROWTYPE,
     v_ontract_liq_summary__feau     lftb_contract_liq_summary%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lfdfeaut          IN OUT  lfpks_lfdfeaut_Main.Ty_lfdfeaut,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Wrk_lfdfeaut IN  lfpks_lfdfeaut_Main.Ty_lfdfeaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lfpks_lfdfeaut_main;
/
CREATE OR REPLACE SYNONYM lfpkss_lfdfeaut_main FOR lfpks_lfdfeaut_main
/