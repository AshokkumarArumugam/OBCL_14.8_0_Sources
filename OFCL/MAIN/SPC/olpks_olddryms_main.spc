CREATE OR REPLACE PACKAGE  olpks_olddryms_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_olddryms_main.spc
  **
...
TYPE ty_olddryms IS RECORD (
     v_lftms_diary_event_msg     lftm_diary_event_msg%ROWTYPE,
...
FUNCTION Fn_Sys_Query_Desc_Fields  ( p_Source    IN     VARCHAR2,
                        ...
                        p_Wrk_olddryms  IN   OUT olpks_olddryms_Main.ty_olddryms,
...
FUNCTION Fn_Populate_Record_Master (p_Source            IN     VARCHAR2,
                        ...
                        p_Function_Id       IN     VARCHAR2,
                        p_Action_Code       IN     VARCHAR2,
                        p_olddryms          IN  olpks_olddryms_Main.Ty_olddryms,
...
FUNCTION Fn_Get_Key_Information (p_Source    IN  VARCHAR2, 
                        ...
                        p_Function_id       IN     VARCHAR2,
                        p_Action_Code       IN     VARCHAR2,
p_olddryms       IN  OUT olpks_olddryms_Main.Ty_olddryms,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_olddryms_main;
/
CREATE OR REPLACE SYNONYM olpkss_olddryms_main FOR olpks_olddryms_main
/