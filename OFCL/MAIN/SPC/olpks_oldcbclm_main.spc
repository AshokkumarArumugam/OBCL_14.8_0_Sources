CREATE OR REPLACE PACKAGE  olpks_oldcbclm_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldcbclm_main.spc
  **
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldcbclm_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldcbclm_main FOR olpks_oldcbclm_main
/