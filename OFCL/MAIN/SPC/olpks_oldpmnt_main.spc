CREATE OR REPLACE PACKAGE  olpks_oldpmnt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldpmnt_main.spc
  **
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldpmnt_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldpmnt_main FOR olpks_oldpmnt_main
/