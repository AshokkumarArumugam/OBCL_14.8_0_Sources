CREATE OR REPLACE PACKAGE  lbpks_lbdfpmlm_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdfpmlm_main.spc
  **
...
TYPE ty_tb__oltms_fpml_adhoc_msg_dd IS TABLE OF oltm_fpml_adhoc_msg_dd%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_ltms_fpml_adhoc_msg_part IS TABLE OF oltm_fpml_adhoc_msg_part%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbdfpmlm IS RECORD (
     v_oltbs_contract     oltb_contract%ROWTYPE,
     v_oltms_fpml_adhoc_msg     oltm_fpml_adhoc_msg%ROWTYPE,
     v_oltms_fpml_adhoc_msg_dd    ty_tb__oltms_fpml_adhoc_msg_dd,
     v_oltms_fpml_adhoc_msg_part    ty_tb_ltms_fpml_adhoc_msg_part,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdfpmlm          IN OUT  lbpks_lbdfpmlm_Main.Ty_lbdfpmlm,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_lbdfpmlm          IN lbpks_lbdfpmlm_Main.Ty_lbdfpmlm,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdfpmlm     IN  lbpks_lbdfpmlm_Main.Ty_lbdfpmlm,
p_Wrk_lbdfpmlm      IN OUT  lbpks_lbdfpmlm_Main.Ty_lbdfpmlm,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdfpmlm     IN  lbpks_lbdfpmlm_Main.Ty_lbdfpmlm,
p_Prev_lbdfpmlm IN OUT  lbpks_lbdfpmlm_Main.Ty_lbdfpmlm,
p_Wrk_lbdfpmlm      IN OUT  lbpks_lbdfpmlm_Main.Ty_lbdfpmlm,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbdfpmlm     IN  lbpks_lbdfpmlm_Main.Ty_lbdfpmlm,
p_Prev_lbdfpmlm     IN  lbpks_lbdfpmlm_Main.Ty_lbdfpmlm,
p_Wrk_lbdfpmlm      IN OUT  lbpks_lbdfpmlm_Main.Ty_lbdfpmlm,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbdfpmlm IN  lbpks_lbdfpmlm_Main.Ty_lbdfpmlm,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdfpmlm_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdfpmlm_main FOR lbpks_lbdfpmlm_main
/