CREATE OR REPLACE PACKAGE  olpks_oldtrcyp_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldtrcyp_main.spc
  **
...
TYPE ty_oldtrcyp IS RECORD (
     v_oltms_prod_ccy_params     oltm_prod_ccy_params%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldtrcyp_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldtrcyp_main FOR olpks_oldtrcyp_main
/