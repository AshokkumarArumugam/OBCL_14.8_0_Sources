CREATE OR REPLACE PACKAGE  lbpks_lbcukudf_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbcukudf_main.spc
  **
...
TYPE ty_lbcukudf IS RECORD (
     v_lbtbs_udf_field_vals     lbtb_udf_field_vals%ROWTYPE,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbcukudf          IN OUT  lbpks_lbcukudf_Main.Ty_lbcukudf,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Main_Function    IN  VARCHAR2,
p_lbcukudf       IN    lbpks_lbcukudf_Main.ty_lbcukudf,
...
p_Main_Function    IN  VARCHAR2,
p_lbcukudf     IN  lbpks_lbcukudf_Main.Ty_lbcukudf,
p_Prev_lbcukudf IN OUT  lbpks_lbcukudf_Main.Ty_lbcukudf,
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbcukudf     IN  lbpks_lbcukudf_Main.Ty_lbcukudf,
p_Prev_lbcukudf     IN  lbpks_lbcukudf_Main.Ty_lbcukudf,
p_Wrk_lbcukudf      IN OUT  lbpks_lbcukudf_Main.Ty_lbcukudf,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbcukudf IN  lbpks_lbcukudf_Main.Ty_lbcukudf,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbcukudf_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbcukudf_main FOR lbpks_lbcukudf_main
/