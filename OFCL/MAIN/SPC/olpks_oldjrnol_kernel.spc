CREATE OR REPLACE PACKAGE  olpks_oldjrnol_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldjrnol_kernel.spc
  **
...
END olpks_oldjrnol_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldjrnol_kernel FOR olpks_oldjrnol_kernel
/