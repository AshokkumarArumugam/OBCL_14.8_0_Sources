CREATE OR REPLACE PACKAGE olpks_oldmndsb_utils_custom AS
  /*-----------------------------------------------------------------------------------------------------
    **
    ** File Name  : olpks_oldmndsb_utils_custom.spc
    **
...
END olpks_oldmndsb_utils_custom;
/
CREATE OR REPLACE SYNONYM  olpkss_oldmndsb_utils_custom FOR olpks_oldmndsb_utils_custom
/