CREATE OR REPLACE PACKAGE  olpks_oldtmcnv_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldtmcnv_kernel.spc
  **
...
END olpks_oldtmcnv_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldtmcnv_kernel FOR olpks_oldtmcnv_kernel
/