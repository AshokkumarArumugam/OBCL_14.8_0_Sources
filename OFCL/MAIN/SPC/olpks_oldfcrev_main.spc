CREATE OR REPLACE PACKAGE  olpks_oldfcrev_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldfcrev_main.spc
  **
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldfcrev          IN OUT  olpks_oldfcrev_Main.Ty_oldfcrev,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_oldfcrev          IN olpks_oldfcrev_Main.Ty_oldfcrev,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldfcrev     IN  olpks_oldfcrev_Main.Ty_oldfcrev,
p_Wrk_oldfcrev      IN OUT  olpks_oldfcrev_Main.Ty_oldfcrev,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldfcrev     IN  olpks_oldfcrev_Main.Ty_oldfcrev,
p_Prev_oldfcrev IN OUT  olpks_oldfcrev_Main.Ty_oldfcrev,
p_Wrk_oldfcrev      IN OUT  olpks_oldfcrev_Main.Ty_oldfcrev,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldfcrev     IN  olpks_oldfcrev_Main.Ty_oldfcrev,
p_Prev_oldfcrev     IN  olpks_oldfcrev_Main.Ty_oldfcrev,
p_Wrk_oldfcrev      IN OUT  olpks_oldfcrev_Main.Ty_oldfcrev,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldfcrev IN  olpks_oldfcrev_Main.Ty_oldfcrev,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldfcrev_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldfcrev_main FOR olpks_oldfcrev_main
/