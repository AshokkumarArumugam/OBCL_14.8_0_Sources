CREATE OR REPLACE PACKAGE olpks_oldexamd_utils_custom AS
  /*-----------------------------------------------------------------------------------------------------
    **
    ** File Name  : olpks_oldexamd_utils_custom.spc
    **
  ...
  */
  ...
  PROCEDURE Post_Pr_Log_Error(p_Function_Id in VARCHAR2,
                              ...
                              p_Err_Code    VARCHAR2,
                              p_Err_Params  VARCHAR2);
END olpks_oldexamd_utils_custom;
/
create or replace synonym olpkss_oldexamd_utils_custom for olpks_oldexamd_utils_custom
/