CREATE OR REPLACE PACKAGE  olpks_oldtrosi_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldtrosi_main.spc
  **
...
p_Child_oldtrosi     IN  olpks_oldtrosi_Main.Ty_oldtrosi,
...
p_Child_oldtrosi     IN  OUT olpks_oldtrosi_Main.Ty_oldtrosi);
...
p_Wrk_oldtrosi IN  olpks_oldtrosi_Main.Ty_oldtrosi,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldtrosi_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldtrosi_main FOR olpks_oldtrosi_main
/