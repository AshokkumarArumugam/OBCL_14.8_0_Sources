CREATE OR REPLACE PACKAGE  tlpks_tlderonl_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tlderonl_main.spc
  **
...
TYPE ty_tlderonl IS RECORD (
     v_oltbs_contract__error     oltb_contract%ROWTYPE,
     v_tltbs_contract_exception    ty_tb_tltbs_contract_exception,
     v_contract_excep_summary     tlvw_contract_excep_summary%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_tlderonl          IN OUT  tlpks_tlderonl_Main.Ty_tlderonl,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_tlderonl          IN tlpks_tlderonl_Main.Ty_tlderonl,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_tlderonl     IN  tlpks_tlderonl_Main.Ty_tlderonl,
p_Wrk_tlderonl      IN OUT  tlpks_tlderonl_Main.Ty_tlderonl,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_tlderonl     IN  tlpks_tlderonl_Main.Ty_tlderonl,
p_Prev_tlderonl IN OUT  tlpks_tlderonl_Main.Ty_tlderonl,
p_Wrk_tlderonl      IN OUT  tlpks_tlderonl_Main.Ty_tlderonl,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_tlderonl     IN  tlpks_tlderonl_Main.Ty_tlderonl,
p_Prev_tlderonl     IN  tlpks_tlderonl_Main.Ty_tlderonl,
p_Wrk_tlderonl      IN OUT  tlpks_tlderonl_Main.Ty_tlderonl,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_tlderonl IN  tlpks_tlderonl_Main.Ty_tlderonl,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tlderonl_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tlderonl_main FOR tlpks_tlderonl_main
/