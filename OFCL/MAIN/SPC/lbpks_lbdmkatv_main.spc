CREATE OR REPLACE PACKAGE  lbpks_lbdmkatv_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdmkatv_main.spc
  **
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdmkatv          IN OUT  lbpks_lbdmkatv_Main.Ty_lbdmkatv,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdmkatv     IN  lbpks_lbdmkatv_Main.Ty_lbdmkatv,
p_Prev_lbdmkatv IN OUT  lbpks_lbdmkatv_Main.Ty_lbdmkatv,
p_Wrk_lbdmkatv      IN OUT  lbpks_lbdmkatv_Main.Ty_lbdmkatv,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbdmkatv     IN  lbpks_lbdmkatv_Main.Ty_lbdmkatv,
p_Prev_lbdmkatv     IN  lbpks_lbdmkatv_Main.Ty_lbdmkatv,
p_Wrk_lbdmkatv      IN OUT  lbpks_lbdmkatv_Main.Ty_lbdmkatv,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbdmkatv IN  lbpks_lbdmkatv_Main.Ty_lbdmkatv,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdmkatv_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdmkatv_main FOR lbpks_lbdmkatv_main
/