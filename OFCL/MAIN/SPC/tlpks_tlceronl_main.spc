CREATE OR REPLACE PACKAGE  tlpks_tlceronl_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tlceronl_main.spc
  **
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_tlceronl          IN OUT  tlpks_tlceronl_Main.Ty_tlceronl,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Main_Function    IN  VARCHAR2,
p_tlceronl       IN    tlpks_tlceronl_Main.ty_tlceronl,
...
p_Main_Function    IN  VARCHAR2,
p_tlceronl     IN  tlpks_tlceronl_Main.Ty_tlceronl,
p_Prev_tlceronl IN OUT  tlpks_tlceronl_Main.Ty_tlceronl,
p_Wrk_tlceronl IN OUT  tlpks_tlceronl_Main.Ty_tlceronl,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_tlceronl     IN  tlpks_tlceronl_Main.Ty_tlceronl,
p_Prev_tlceronl     IN  tlpks_tlceronl_Main.Ty_tlceronl,
p_Wrk_tlceronl      IN OUT  tlpks_tlceronl_Main.Ty_tlceronl,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_tlceronl IN  tlpks_tlceronl_Main.Ty_tlceronl,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tlceronl_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tlceronl_main FOR tlpks_tlceronl_main
/