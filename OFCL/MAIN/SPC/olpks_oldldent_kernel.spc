CREATE OR REPLACE PACKAGE  olpks_oldldent_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldldent_kernel.spc
  **
  ...
  ** India
  ...
  Change Description : Duplicate Acc Entries Occuring
  Search String		 : OFCL_12.3_27556403_Forward_Port  
  
  -------------------------------------------------------------------------------------------------------
  */
  
 g_cadj_esn       number; --OFCL_12.3_27556403_Forward_Port 
...
END olpks_oldldent_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldldent_kernel FOR olpks_oldldent_kernel
/