CREATE OR REPLACE PACKAGE  lbpks_lbdmenmc_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdmenmc_main.spc
  **
...
TYPE ty_tb_v_lbtbs_part_proc_stat IS TABLE OF lbtb_part_proc_stat%ROWTYPE INDEX BY BINARY_INTEGER;
...
TYPE ty_tb_art_settle_curr_det_temp IS TABLE OF lbtb_part_settle_curr_det_temp%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_contract_entity_temp IS TABLE OF oltb_contract_entity_temp%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbdmenmc IS RECORD (
     v_oltbs_contract__mnemonic     oltb_contract%ROWTYPE,
     v_lbtbs_part_proc_stat    ty_tb_v_lbtbs_part_proc_stat,
     v_part_settle_curr_det    ty_tb_v_part_settle_curr_det,
     v_oltbs_contract_entity    ty_tb_v_oltbs_contract_entity,
     v_part_settle_curr_det_temp    ty_tb_art_settle_curr_det_temp,
     v_contract_entity_temp    ty_tb_v_contract_entity_temp,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdmenmc          IN OUT  lbpks_lbdmenmc_Main.Ty_lbdmenmc,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdmenmc     IN  lbpks_lbdmenmc_Main.Ty_lbdmenmc,
p_Prev_lbdmenmc IN OUT  lbpks_lbdmenmc_Main.Ty_lbdmenmc,
p_Wrk_lbdmenmc      IN OUT  lbpks_lbdmenmc_Main.Ty_lbdmenmc,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Wrk_lbdmenmc IN  lbpks_lbdmenmc_Main.Ty_lbdmenmc,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdmenmc_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdmenmc_main FOR lbpks_lbdmenmc_main
/