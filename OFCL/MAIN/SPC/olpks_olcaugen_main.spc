CREATE OR REPLACE PACKAGE  olpks_olcaugen_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_olcaugen_main.spc
  **
  ** Module     : Messaging
  ** 
...
TYPE ty_tb_v_oltbs_dly_msg_out__as IS TABLE OF oltb_dly_msg_out%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_olcaugen IS RECORD (
     v_oltbs_dly_msg_out     oltb_dly_msg_out%ROWTYPE,
     v_oltbs_dly_msg_out__as    ty_tb_v_oltbs_dly_msg_out__as,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_olcaugen          IN OUT  olpks_olcaugen_Main.Ty_olcaugen,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Main_Function    IN  VARCHAR2,
p_olcaugen       IN    olpks_olcaugen_Main.ty_olcaugen,
...
p_Main_Function    IN  VARCHAR2,
p_olcaugen     IN  olpks_olcaugen_Main.Ty_olcaugen,
p_Prev_olcaugen IN OUT  olpks_olcaugen_Main.Ty_olcaugen,
p_Wrk_olcaugen IN OUT  olpks_olcaugen_Main.Ty_olcaugen,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_olcaugen     IN  olpks_olcaugen_Main.Ty_olcaugen,
p_Prev_olcaugen     IN  olpks_olcaugen_Main.Ty_olcaugen,
p_Wrk_olcaugen      IN OUT  olpks_olcaugen_Main.Ty_olcaugen,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_olcaugen IN  olpks_olcaugen_Main.Ty_olcaugen,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_olcaugen_main;
/
CREATE OR REPLACE SYNONYM olpkss_olcaugen_main FOR olpks_olcaugen_main
/