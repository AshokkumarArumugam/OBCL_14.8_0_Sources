CREATE OR REPLACE PACKAGE lbpks_lbdstpmp_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdstpmp_kernel.spc
  **
  ** Module     : LB
  **
...
END lbpks_lbdstpmp_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdstpmp_kernel FOR lbpks_lbdstpmp_kernel
/