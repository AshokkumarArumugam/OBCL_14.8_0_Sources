CREATE OR REPLACE PACKAGE  tlpks_tldprdmp_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldprdmp_main.spc
  **
...
TYPE ty_tldprdmp IS RECORD (
     v_oltms_product_mapping     oltm_product_mapping%ROWTYPE,
...
FUNCTION Fn_Sys_Query_Desc_Fields  ( p_Source    IN     VARCHAR2,
                        ...
                        p_Wrk_tldprdmp  IN   OUT tlpks_tldprdmp_Main.ty_tldprdmp,
...
FUNCTION Fn_Populate_Record_Master (p_Source            IN     VARCHAR2,
                        ...
                        p_Function_Id       IN     VARCHAR2,
                        p_Action_Code       IN     VARCHAR2,
                        p_tldprdmp          IN  tlpks_tldprdmp_Main.Ty_tldprdmp,
...
FUNCTION Fn_Get_Key_Information (p_Source    IN  VARCHAR2, 
                        ...
                        p_Function_id       IN     VARCHAR2,
                        p_Action_Code       IN     VARCHAR2,
p_tldprdmp       IN  OUT tlpks_tldprdmp_Main.Ty_tldprdmp,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tldprdmp_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tldprdmp_main FOR tlpks_tldprdmp_main
/