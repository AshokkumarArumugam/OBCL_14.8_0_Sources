CREATE OR REPLACE PACKAGE  tlpks_tldtrsau_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldtrsau_kernel.spc
  **
...
p_tldtrsau     IN  OUT tlpks_tldtrsau_Main.Ty_tldtrsau,
...
p_Child_Function    IN  VARCHAR2,
p_Pk_Or_Full     IN  VARCHAR2 DEFAULT 'FULL',
p_tldtrsau IN   tlpks_tldtrsau_Main.ty_tldtrsau,
p_Err_Code       IN  OUT VARCHAR2,
p_Err_Params     IN  OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Child_Function    IN  VARCHAR2,
p_tldtrsau IN   tlpks_tldtrsau_Main.Ty_tldtrsau,
p_Prev_tldtrsau IN OUT tlpks_tldtrsau_Main.Ty_tldtrsau,
p_Wrk_tldtrsau IN OUT  tlpks_tldtrsau_Main.Ty_tldtrsau,
p_Err_Code       IN  OUT VARCHAR2,
p_Err_Params     IN  OUT VARCHAR2)
RETURN BOOLEAN;
...
p_tldtrsau IN tlpks_tldtrsau_Main.Ty_tldtrsau,
p_Prev_tldtrsau IN tlpks_tldtrsau_Main.Ty_tldtrsau,
p_Wrk_tldtrsau IN OUT  tlpks_tldtrsau_Main.Ty_tldtrsau,
p_Err_Code       IN  OUT VARCHAR2,
p_Err_Params     IN  OUT VARCHAR2)
RETURN BOOLEAN;
...
END tlpks_tldtrsau_kernel;
/
CREATE OR REPLACE SYNONYM tlpkss_tldtrsau_kernel FOR tlpks_tldtrsau_kernel
/