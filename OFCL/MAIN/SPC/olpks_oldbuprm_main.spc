CREATE OR REPLACE PACKAGE  olpks_oldbuprm_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldbuprm_main.spc
  **
...
TYPE ty_oldbuprm IS RECORD (
     v_oltbs_blk_upld_params     oltb_blk_upld_params%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldbuprm_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldbuprm_main FOR olpks_oldbuprm_main
/