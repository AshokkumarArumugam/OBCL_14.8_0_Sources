CREATE OR REPLACE PACKAGE  olpks_oldldeau_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldldeau_kernel.spc
  **
...
END olpks_oldldeau_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldldeau_kernel FOR olpks_oldldeau_kernel
/