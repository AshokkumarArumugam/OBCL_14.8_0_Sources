CREATE OR REPLACE PACKAGE  olpks_oldmsprv_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldmsprv_main.spc
  **
...
TYPE ty_tb__oltbs_message_prev__msg IS TABLE OF oltb_message_prev%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_oldmsprv IS RECORD (
     v_oltbs_message_prev     oltb_message_prev%ROWTYPE,
     v_oltbs_message_prev__msg    ty_tb__oltbs_message_prev__msg,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldmsprv          IN OUT  olpks_oldmsprv_Main.Ty_oldmsprv,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_oldmsprv          IN olpks_oldmsprv_Main.Ty_oldmsprv,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldmsprv     IN  olpks_oldmsprv_Main.Ty_oldmsprv,
p_Wrk_oldmsprv      IN OUT  olpks_oldmsprv_Main.Ty_oldmsprv,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldmsprv     IN  olpks_oldmsprv_Main.Ty_oldmsprv,
p_Prev_oldmsprv IN OUT  olpks_oldmsprv_Main.Ty_oldmsprv,
p_Wrk_oldmsprv      IN OUT  olpks_oldmsprv_Main.Ty_oldmsprv,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldmsprv     IN  olpks_oldmsprv_Main.Ty_oldmsprv,
p_Prev_oldmsprv     IN  olpks_oldmsprv_Main.Ty_oldmsprv,
p_Wrk_oldmsprv      IN OUT  olpks_oldmsprv_Main.Ty_oldmsprv,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldmsprv IN  olpks_oldmsprv_Main.Ty_oldmsprv,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldmsprv_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldmsprv_main FOR olpks_oldmsprv_main
/