CREATE OR REPLACE PACKAGE  olpks_oldacgrp_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldacgrp_main.spc
  **
...
TYPE ty_oldacgrp IS RECORD (
     v_oltms_acc_group     oltm_acc_group%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldacgrp_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldacgrp_main FOR olpks_oldacgrp_main
/