CREATE OR REPLACE PACKAGE  lbpks_lbdcolpa_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdcolpa_main.spc
  **
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdcolpa          IN OUT  lbpks_lbdcolpa_Main.Ty_lbdcolpa,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_lbdcolpa          IN lbpks_lbdcolpa_Main.Ty_lbdcolpa,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdcolpa     IN  lbpks_lbdcolpa_Main.Ty_lbdcolpa,
p_Wrk_lbdcolpa      IN OUT  lbpks_lbdcolpa_Main.Ty_lbdcolpa,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdcolpa     IN  lbpks_lbdcolpa_Main.Ty_lbdcolpa,
p_Prev_lbdcolpa IN OUT  lbpks_lbdcolpa_Main.Ty_lbdcolpa,
p_Wrk_lbdcolpa      IN OUT  lbpks_lbdcolpa_Main.Ty_lbdcolpa,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbdcolpa     IN  lbpks_lbdcolpa_Main.Ty_lbdcolpa,
p_Prev_lbdcolpa     IN  lbpks_lbdcolpa_Main.Ty_lbdcolpa,
p_Wrk_lbdcolpa      IN OUT  lbpks_lbdcolpa_Main.Ty_lbdcolpa,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbdcolpa IN  lbpks_lbdcolpa_Main.Ty_lbdcolpa,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdcolpa_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdcolpa_main FOR lbpks_lbdcolpa_main
/