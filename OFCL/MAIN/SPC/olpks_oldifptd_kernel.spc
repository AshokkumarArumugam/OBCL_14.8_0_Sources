CREATE OR REPLACE PACKAGE  olpks_oldifptd_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldifptd_kernel.spc
  **
...
END olpks_oldifptd_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldifptd_kernel FOR olpks_oldifptd_Kernel
/