CREATE OR REPLACE PACKAGE  lbpks_lbdmtaut_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdmtaut_kernel.spc
  **
...
END lbpks_lbdmtaut_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdmtaut_kernel FOR lbpks_lbdmtaut_kernel
/