CREATE OR REPLACE PACKAGE  olpks_oldacamm_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldacamm_main.spc
  **
...
TYPE ty_oldacamm IS RECORD (
     v_ac_transaction_category     oltm_ac_transaction_category%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldacamm_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldacamm_main FOR olpks_oldacamm_main
/