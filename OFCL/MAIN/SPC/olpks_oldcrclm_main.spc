CREATE OR REPLACE PACKAGE  olpks_oldcrclm_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldcrclm_main.spc
  **
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldcrclm_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldcrclm_main FOR olpks_oldcrclm_main
/