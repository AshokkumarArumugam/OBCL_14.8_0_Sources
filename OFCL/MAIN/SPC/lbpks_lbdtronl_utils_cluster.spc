CREATE OR REPLACE PACKAGE lbpks_lbdtronl_utils_cluster AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdtronl_utils_cluster.spc
  **
...
END lbpks_lbdtronl_utils_cluster;
/
CREATE OR REPLACE Synonym lbpkss_lbdtronl_utils_cluster FOR lbpks_lbdtronl_utils_cluster
/