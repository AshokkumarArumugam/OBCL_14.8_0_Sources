CREATE OR REPLACE PACKAGE  olpks_olduplod_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_olduplod_kernel.spc
  **
...
END olpks_olduplod_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_olduplod_kernel FOR olpks_olduplod_Kernel
/