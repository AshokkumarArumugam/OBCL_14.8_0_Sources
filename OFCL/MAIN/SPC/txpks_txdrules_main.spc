CREATE OR REPLACE PACKAGE  txpks_txdrules_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : txpks_txdrules_main.spc
  **
  ** Module     : The Tax
  ** 
...
TYPE ty_tb_v_txtms_slab IS TABLE OF txtm_slab%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_txdrules IS RECORD (
     v_txtms_rule     txtm_rule%ROWTYPE,
     v_txtms_slab    ty_tb_v_txtms_slab,
...
FUNCTION Fn_Get_Key_Information (p_Source    IN  VARCHAR2, 
                        ...
                        p_Function_id       IN     VARCHAR2,
                        p_Action_Code       IN     VARCHAR2,
p_txdrules       IN  OUT txpks_txdrules_Main.Ty_txdrules,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END txpks_txdrules_main;
/
CREATE OR REPLACE SYNONYM txpkss_txdrules_main FOR txpks_txdrules_main
/