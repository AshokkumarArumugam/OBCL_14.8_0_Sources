CREATE OR REPLACE PACKAGE  olpks_oldcusgp_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldcusgp_main.spc
  **
  ** Module     : OL
  ** 
...
TYPE ty_oldcusgp IS RECORD (
     v_oltm_cust_group     oltm_cust_group%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldcusgp_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldcusgp_main FOR olpks_oldcusgp_main
/