CREATE OR REPLACE PACKAGE  olpks_oldblaut_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldblaut_main.spc
  **
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldblaut          IN OUT  olpks_oldblaut_Main.Ty_oldblaut,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldblaut     IN  olpks_oldblaut_Main.Ty_oldblaut,
p_Prev_oldblaut IN OUT  olpks_oldblaut_Main.Ty_oldblaut,
p_Wrk_oldblaut      IN OUT  olpks_oldblaut_Main.Ty_oldblaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldblaut     IN  olpks_oldblaut_Main.Ty_oldblaut,
p_Prev_oldblaut     IN  olpks_oldblaut_Main.Ty_oldblaut,
p_Wrk_oldblaut      IN OUT  olpks_oldblaut_Main.Ty_oldblaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldblaut IN  olpks_oldblaut_Main.Ty_oldblaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldblaut_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldblaut_main FOR olpks_oldblaut_main
/