CREATE OR REPLACE PACKAGE tlpks_conversion
AS
/*-------------------------------------------------------------------------------------------------
**
** File Name	:tlpks_conversion.SPC
**
...
RETURN BOOLEAN;
END tlpks_conversion;
/
CREATE OR REPLACE SYNONYM tlpkss_conversion FOR tlpks_conversion
/