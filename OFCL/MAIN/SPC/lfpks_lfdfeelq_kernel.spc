CREATE OR REPLACE PACKAGE  lfpks_lfdfeelq_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lfpks_lfdfeelq_kernel.spc
  **
  ** Module     : The ICCF
  ** 
...
END lfpks_lfdfeelq_kernel;
/
CREATE OR REPLACE SYNONYM lfpkss_lfdfeelq_kernel FOR lfpks_lfdfeelq_kernel
/