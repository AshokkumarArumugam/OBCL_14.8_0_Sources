CREATE OR REPLACE PACKAGE  olpks_oldblaut_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldblaut_kernel.spc
  **
...
END olpks_oldblaut_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldblaut_kernel FOR olpks_oldblaut_kernel
/