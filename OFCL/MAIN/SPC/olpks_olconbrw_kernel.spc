CREATE OR REPLACE PACKAGE  olpks_olconbrw_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_olconbrw_kernel.spc
  **
...
END olpks_olconbrw_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_olconbrw_kernel FOR olpks_olconbrw_kernel
/