CREATE OR REPLACE PACKAGE olpks_oldtronl_utils1_custom AS
  /*-----------------------------------------------------------------------------------------------------
    **
    ** File Name  : olpks_oldtronl_utils1_custom.spc
    **
...
END olpks_oldtronl_utils1_custom;
/
create or replace synonym olpkss_oldtronl_utils1_custom for olpks_oldtronl_utils1_custom
/