CREATE OR REPLACE PACKAGE  lppks_lpcrcmnt_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lppks_lpcrcmnt_kernel.spc
  **
...
PROCEDURE Pr_Skip_Handler  (P_Stage  IN  VARCHAR2);
  ...
  FUNCTION Fn_Validate_Borwr_Part_Margn(p_Wrk_lpcrcmnt    IN OUT lppks_lpcrcmnt_Main.Ty_lpcrcmnt,
...
END lppks_lpcrcmnt_kernel;
/
CREATE OR REPLACE SYNONYM lppkss_lpcrcmnt_kernel FOR lppks_lpcrcmnt_kernel
/