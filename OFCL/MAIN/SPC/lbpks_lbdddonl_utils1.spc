CREATE OR REPLACE PACKAGE lbpks_lbdddonl_utils1 AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ...
  */
  ...
  FUNCTION Fn_Validate_ContSched(p_Source           IN VARCHAR2,
                                 p_Source_Operation IN VARCHAR2,
                                 p_Function_Id      IN VARCHAR2,
                                 p_Action_Code      IN VARCHAR2,
                                 p_lbdddonl         IN lbpks_lbdddonl_Main.Ty_lbdddonl,
  ...
  FUNCTION Fn_Validate_Blk_ContSched(p_Source           IN VARCHAR2,
                                     p_Source_Operation IN VARCHAR2,
                                     p_Function_Id      IN VARCHAR2,
                                     p_Action_Code      IN VARCHAR2,
                                     p_lbdddonl         IN lbpks_lbdddonl_Main.Ty_lbdddonl,
