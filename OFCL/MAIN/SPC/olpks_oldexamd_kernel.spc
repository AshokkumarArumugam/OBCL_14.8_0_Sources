CREATE OR REPLACE PACKAGE  olpks_oldexamd_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldexamd_kernel.spc
  **
...
END olpks_oldexamd_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldexamd_kernel FOR olpks_oldexamd_kernel
/