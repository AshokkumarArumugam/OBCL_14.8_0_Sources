CREATE OR REPLACE PACKAGE tlpks_tldmtstl_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldmtstl_kernel.spc
  **
...
END tlpks_tldmtstl_kernel;
/
CREATE OR REPLACE SYNONYM tlpkss_tldmtstl_kernel FOR tlpks_tldmtstl_kernel
/