CREATE OR REPLACE PACKAGE  olpks_oldblkin_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldblkin_main.spc
  **
...
TYPE ty_tb__oltbs_contract_el_block IS TABLE OF oltb_contract_el_block%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_oldblkin IS RECORD (
     v_oltbs_contract     oltb_contract%ROWTYPE,
     v_oltbs_contract_el_block    ty_tb__oltbs_contract_el_block,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldblkin          IN OUT  olpks_oldblkin_Main.Ty_oldblkin,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_oldblkin          IN olpks_oldblkin_Main.Ty_oldblkin,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldblkin     IN  olpks_oldblkin_Main.Ty_oldblkin,
p_Wrk_oldblkin      IN OUT  olpks_oldblkin_Main.Ty_oldblkin,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldblkin     IN  olpks_oldblkin_Main.Ty_oldblkin,
p_Prev_oldblkin IN OUT  olpks_oldblkin_Main.Ty_oldblkin,
p_Wrk_oldblkin      IN OUT  olpks_oldblkin_Main.Ty_oldblkin,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldblkin     IN  olpks_oldblkin_Main.Ty_oldblkin,
p_Prev_oldblkin     IN  olpks_oldblkin_Main.Ty_oldblkin,
p_Wrk_oldblkin      IN OUT  olpks_oldblkin_Main.Ty_oldblkin,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldblkin IN  olpks_oldblkin_Main.Ty_oldblkin,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldblkin_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldblkin_main FOR olpks_oldblkin_main
/