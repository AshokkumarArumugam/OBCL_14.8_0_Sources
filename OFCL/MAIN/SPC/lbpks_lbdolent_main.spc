CREATE OR REPLACE PACKAGE  lbpks_lbdolent_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdolent_main.spc
  **
...
TYPE ty_lbdolent IS RECORD (
     v_lbtms_collateral_entity     lbtm_collateral_entity%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdolent_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdolent_main FOR lbpks_lbdolent_main
/