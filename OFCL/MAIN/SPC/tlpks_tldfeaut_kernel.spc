CREATE OR REPLACE PACKAGE  tlpks_tldfeaut_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldfeaut_kernel.spc
  **
...
END tlpks_tldfeaut_kernel;
/
CREATE OR REPLACE SYNONYM tlpkss_tldfeaut_kernel FOR tlpks_tldfeaut_kernel
/