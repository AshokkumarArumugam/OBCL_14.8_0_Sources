CREATE OR REPLACE PACKAGE  lbpks_lbcagdet_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbcagdet_main.spc
  **
...
TYPE ty_lbcagdet IS RECORD (
     v_oltbs_contract__agdet     oltb_contract%ROWTYPE,
     v_syndication_agreement     lbtb_syndication_agreement%ROWTYPE,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbcagdet          IN OUT  lbpks_lbcagdet_Main.Ty_lbcagdet,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Main_Function    IN  VARCHAR2,
p_lbcagdet       IN    lbpks_lbcagdet_Main.ty_lbcagdet,
...
p_Main_Function    IN  VARCHAR2,
p_lbcagdet     IN  lbpks_lbcagdet_Main.Ty_lbcagdet,
p_Prev_lbcagdet IN OUT  lbpks_lbcagdet_Main.Ty_lbcagdet,
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbcagdet     IN  lbpks_lbcagdet_Main.Ty_lbcagdet,
p_Prev_lbcagdet     IN  lbpks_lbcagdet_Main.Ty_lbcagdet,
p_Wrk_lbcagdet      IN OUT  lbpks_lbcagdet_Main.Ty_lbcagdet,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbcagdet IN  lbpks_lbcagdet_Main.Ty_lbcagdet,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbcagdet_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbcagdet_main FOR lbpks_lbcagdet_main
/