CREATE OR REPLACE PACKAGE  olpks_olcondet_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_olcondet_main.spc
  **
  ** Module     : OL
  ** 
...
TYPE ty_tb_oltbs_settlements__conis IS TABLE OF oltb_settlements%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb__oltbs_settlements__splm IS TABLE OF oltb_settlements%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_olcondet IS RECORD (
     v_oltbs_contract__sett     oltb_contract%ROWTYPE,
     v_oltbs_settlements__conis    ty_tb_oltbs_settlements__conis,
     v_oltbs_sett_details__det     oltb_sett_details%ROWTYPE,
     v_oltbs_settlements__splm    ty_tb__oltbs_settlements__splm,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_olcondet          IN OUT  olpks_olcondet_Main.Ty_olcondet,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_olcondet     IN  olpks_olcondet_Main.Ty_olcondet,
p_Prev_olcondet     IN  olpks_olcondet_Main.Ty_olcondet,
p_Wrk_olcondet      IN OUT  olpks_olcondet_Main.Ty_olcondet,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_olcondet IN  olpks_olcondet_Main.Ty_olcondet,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_olcondet_main;
/
CREATE OR REPLACE SYNONYM olpkss_olcondet_main FOR olpks_olcondet_main
/