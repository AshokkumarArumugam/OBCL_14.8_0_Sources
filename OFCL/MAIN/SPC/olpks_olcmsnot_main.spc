CREATE OR REPLACE PACKAGE  olpks_olcmsnot_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_olcmsnot_main.spc
  **
...
TYPE ty_tb__olvw_all_msg_out__multi IS TABLE OF olvw_all_msg_out%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_olcmsnot IS RECORD (
     v_olvw_all_msg_out__multi    ty_tb__olvw_all_msg_out__multi,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_olcmsnot          IN OUT  olpks_olcmsnot_Main.Ty_olcmsnot,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Main_Function    IN  VARCHAR2,
p_olcmsnot       IN    olpks_olcmsnot_Main.ty_olcmsnot,
...
p_Main_Function    IN  VARCHAR2,
p_olcmsnot     IN  olpks_olcmsnot_Main.Ty_olcmsnot,
p_Prev_olcmsnot IN OUT  olpks_olcmsnot_Main.Ty_olcmsnot,
p_Wrk_olcmsnot IN OUT  olpks_olcmsnot_Main.Ty_olcmsnot,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_olcmsnot     IN  olpks_olcmsnot_Main.Ty_olcmsnot,
p_Prev_olcmsnot     IN  olpks_olcmsnot_Main.Ty_olcmsnot,
p_Wrk_olcmsnot      IN OUT  olpks_olcmsnot_Main.Ty_olcmsnot,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_olcmsnot IN  olpks_olcmsnot_Main.Ty_olcmsnot,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_olcmsnot_main;
/
CREATE OR REPLACE SYNONYM olpkss_olcmsnot_main FOR olpks_olcmsnot_main
/