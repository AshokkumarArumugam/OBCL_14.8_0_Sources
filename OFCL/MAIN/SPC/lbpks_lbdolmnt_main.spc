CREATE OR REPLACE PACKAGE  lbpks_lbdolmnt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdolmnt_main.spc
  **
...
TYPE ty_lbdolmnt IS RECORD (
     v_lbtms_collateral     lbtm_collateral%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdolmnt_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdolmnt_main FOR lbpks_lbdolmnt_main
/