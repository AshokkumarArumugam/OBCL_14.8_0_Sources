CREATE OR REPLACE PACKAGE  olpks_oldmscdt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldmscdt_main.spc
  **
...
p_Wrk_oldmscdt IN  olpks_oldmscdt_Main.Ty_oldmscdt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldmscdt_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldmscdt_main FOR olpks_oldmscdt_main
/