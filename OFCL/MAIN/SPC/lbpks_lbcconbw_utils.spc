create or replace package lbpks_lbcconbw_utils is
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbcconbw_utils.spc
  **
  ** Module     : The ICCF
  **
  ...
  */
  ...
  FUNCTION Fn_Validate(p_Source           IN Cotms_Source.Source_Code%TYPE,
                       ...
                       p_Err_Code         IN OUT VARCHAR2,
                       p_Err_Params       IN OUT VARCHAR2) RETURN BOOLEAN;
end lbpks_lbcconbw_utils;
/
CREATE OR REPLACE Synonym lbpkss_lbcconbw_utils FOR lbpks_lbcconbw_utils
/