CREATE OR REPLACE PACKAGE lbpks_lbdpsupl_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdpsupl_kernel.spc
  **
...
END lbpks_lbdpsupl_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdpsupl_kernel FOR lbpks_lbdpsupl_kernel
/