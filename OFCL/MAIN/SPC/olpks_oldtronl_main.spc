CREATE OR REPLACE PACKAGE  olpks_oldtronl_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldtronl_main.spc
  **
...
p_Wrk_oldtronl IN  olpks_oldtronl_Main.Ty_oldtronl,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldtronl_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldtronl_main FOR olpks_oldtronl_main
/