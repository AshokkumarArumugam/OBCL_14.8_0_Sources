CREATE OR REPLACE PACKAGE  lbpks_lbdtxref_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdtxref_main.spc
  **
...
TYPE ty_tb_txtbs_tax_refund_summary IS TABLE OF txtb_tax_refund_summary%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb__txtbs_tax_refund_detail IS TABLE OF txtb_tax_refund_detail%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_oltbs_contract_ovd IS TABLE OF oltb_contract_ovd%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_olvws_all_ac_entries IS TABLE OF olvw_all_ac_entries%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb__olvws_all_ac_entries__a IS TABLE OF olvw_all_ac_entries%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_contract_event_log__a IS TABLE OF oltb_contract_event_log%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbdtxref IS RECORD (
     v_oltbs_contract     oltb_contract%ROWTYPE,
     v_txtbs_tax_refund_master     txtb_tax_refund_master%ROWTYPE,
     v_txtbs_tax_refund_summary    ty_tb_txtbs_tax_refund_summary,
     v_txtbs_tax_refund_detail    ty_tb__txtbs_tax_refund_detail,
     v_oltbs_contract_event_log     oltb_contract_event_log%ROWTYPE,
     v_oltbs_contract_ovd    ty_tb_v_oltbs_contract_ovd,
     v_olvws_all_ac_entries    ty_tb_v_olvws_all_ac_entries,
     v_olvws_all_ac_entries__a    ty_tb__olvws_all_ac_entries__a,
     v_contract_event_log__a    ty_tb_v_contract_event_log__a,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdtxref          IN OUT  lbpks_lbdtxref_Main.Ty_lbdtxref,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Wrk_lbdtxref IN  lbpks_lbdtxref_Main.Ty_lbdtxref,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdtxref_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdtxref_main FOR lbpks_lbdtxref_main
/