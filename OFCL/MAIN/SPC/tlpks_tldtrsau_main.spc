CREATE OR REPLACE PACKAGE  tlpks_tldtrsau_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldtrsau_main.spc
  **
...
p_Wrk_tldtrsau IN  tlpks_tldtrsau_Main.Ty_tldtrsau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tldtrsau_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tldtrsau_main FOR tlpks_tldtrsau_main
/