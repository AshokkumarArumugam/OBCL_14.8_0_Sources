CREATE OR REPLACE PACKAGE  lbpks_lbdexrau_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdexrau_main.spc
  **
...
TYPE ty_lbdexrau IS RECORD (
     ...
     v_contract_event_log__coaut     oltb_contract_event_log%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdexrau          IN OUT  lbpks_lbdexrau_Main.Ty_lbdexrau,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_lbdexrau          IN lbpks_lbdexrau_Main.Ty_lbdexrau,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdexrau     IN  lbpks_lbdexrau_Main.Ty_lbdexrau,
p_Wrk_lbdexrau      IN OUT  lbpks_lbdexrau_Main.Ty_lbdexrau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdexrau     IN  lbpks_lbdexrau_Main.Ty_lbdexrau,
p_Prev_lbdexrau IN OUT  lbpks_lbdexrau_Main.Ty_lbdexrau,
p_Wrk_lbdexrau      IN OUT  lbpks_lbdexrau_Main.Ty_lbdexrau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbdexrau     IN  lbpks_lbdexrau_Main.Ty_lbdexrau,
p_Prev_lbdexrau     IN  lbpks_lbdexrau_Main.Ty_lbdexrau,
p_Wrk_lbdexrau      IN OUT  lbpks_lbdexrau_Main.Ty_lbdexrau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbdexrau IN  lbpks_lbdexrau_Main.Ty_lbdexrau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdexrau_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdexrau_main FOR lbpks_lbdexrau_main
/