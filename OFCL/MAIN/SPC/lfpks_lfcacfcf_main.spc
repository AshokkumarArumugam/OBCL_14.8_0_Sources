CREATE OR REPLACE PACKAGE  lfpks_lfcacfcf_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lfpks_lfcacfcf_main.spc
  **
  ** Module     : The ICCF
  ** 
...
TYPE ty_tb__accr_fee_details__multi IS TABLE OF lfvw_accr_fee_details%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lfcacfcf IS RECORD (
     v_lfvws_accr_fee_details     lfvw_accr_fee_details%ROWTYPE,
     v_accr_fee_details__multi    ty_tb__accr_fee_details__multi,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lfcacfcf          IN OUT  lfpks_lfcacfcf_Main.Ty_lfcacfcf,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Main_Function    IN  VARCHAR2,
p_lfcacfcf       IN    lfpks_lfcacfcf_Main.ty_lfcacfcf,
...
p_Main_Function    IN  VARCHAR2,
p_lfcacfcf     IN  lfpks_lfcacfcf_Main.Ty_lfcacfcf,
p_Prev_lfcacfcf IN OUT  lfpks_lfcacfcf_Main.Ty_lfcacfcf,
p_Wrk_lfcacfcf IN OUT  lfpks_lfcacfcf_Main.Ty_lfcacfcf,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lfcacfcf     IN  lfpks_lfcacfcf_Main.Ty_lfcacfcf,
p_Prev_lfcacfcf     IN  lfpks_lfcacfcf_Main.Ty_lfcacfcf,
p_Wrk_lfcacfcf      IN OUT  lfpks_lfcacfcf_Main.Ty_lfcacfcf,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lfcacfcf IN  lfpks_lfcacfcf_Main.Ty_lfcacfcf,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lfpks_lfcacfcf_main;
/
CREATE OR REPLACE SYNONYM lfpkss_lfcacfcf_main FOR lfpks_lfcacfcf_main
/