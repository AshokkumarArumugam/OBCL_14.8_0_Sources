CREATE OR REPLACE PACKAGE  lbpks_lbdfpmlm_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdfpmlm_kernel.spc
  **
...
END lbpks_lbdfpmlm_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdfpmlm_kernel FOR lbpks_lbdfpmlm_kernel
/