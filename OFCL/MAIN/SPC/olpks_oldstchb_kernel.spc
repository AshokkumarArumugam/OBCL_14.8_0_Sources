CREATE OR REPLACE PACKAGE  olpks_oldstchb_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldstchb_kernel.spc
  **
  ** Module     : OL
  ** 
...
END olpks_oldstchb_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldstchb_kernel FOR olpks_oldstchb_Kernel
/