CREATE OR REPLACE PACKAGE  lbpks_lbrinirr_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbrinirr_kernel.spc
  **
...
p_lbrinirr     IN  OUT lbpks_lbrinirr_Main.Ty_lbrinirr,
...
p_lbrinirr IN   lbpks_lbrinirr_Main.ty_lbrinirr,
p_Err_Code       IN  OUT VARCHAR2,
p_Err_Params     IN  OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Child_Function    IN  VARCHAR2,
p_lbrinirr IN   lbpks_lbrinirr_Main.Ty_lbrinirr,
p_Wrk_lbrinirr IN OUT  lbpks_lbrinirr_Main.Ty_lbrinirr,
p_Err_Code       IN  OUT VARCHAR2,
p_Err_Params     IN  OUT VARCHAR2)
RETURN BOOLEAN;
...
END lbpks_lbrinirr_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbrinirr_kernel FOR lbpks_lbrinirr_kernel
/