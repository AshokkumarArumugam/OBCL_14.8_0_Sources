CREATE OR REPLACE PACKAGE  olpks_olddpmnt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_olddpmnt_main.spc
  **
...
TYPE ty_olddpmnt IS RECORD (
     v_oltms_department     oltm_department%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_olddpmnt_main;
/
CREATE OR REPLACE SYNONYM olpkss_olddpmnt_main FOR olpks_olddpmnt_main
/