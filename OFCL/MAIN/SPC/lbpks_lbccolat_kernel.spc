CREATE OR REPLACE PACKAGE  lbpks_lbccolat_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbccolat_kernel.spc
  **
...
END lbpks_lbccolat_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbccolat_kernel FOR lbpks_lbccolat_kernel
/