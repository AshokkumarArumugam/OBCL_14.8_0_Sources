CREATE OR REPLACE PACKAGE  olpks_oldcocrv_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldcocrv_main.spc
  **
...
TYPE ty_tb_v_oltbs_coc_event_log IS TABLE OF oltb_coc_event_log%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_oldcocrv IS RECORD (
     v_oltbs_contract     oltb_contract%ROWTYPE,
     v_oltbs_coc_event_log    ty_tb_v_oltbs_coc_event_log,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldcocrv          IN OUT  olpks_oldcocrv_Main.Ty_oldcocrv,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldcocrv     IN  olpks_oldcocrv_Main.Ty_oldcocrv,
p_Prev_oldcocrv IN OUT  olpks_oldcocrv_Main.Ty_oldcocrv,
p_Wrk_oldcocrv      IN OUT  olpks_oldcocrv_Main.Ty_oldcocrv,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldcocrv     IN  olpks_oldcocrv_Main.Ty_oldcocrv,
p_Prev_oldcocrv     IN  olpks_oldcocrv_Main.Ty_oldcocrv,
p_Wrk_oldcocrv      IN OUT  olpks_oldcocrv_Main.Ty_oldcocrv,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldcocrv IN  olpks_oldcocrv_Main.Ty_oldcocrv,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldcocrv_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldcocrv_main FOR olpks_oldcocrv_main
/