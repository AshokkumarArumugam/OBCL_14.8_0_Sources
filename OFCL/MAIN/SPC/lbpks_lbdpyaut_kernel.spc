CREATE OR REPLACE PACKAGE lbpks_lbdpyaut_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdpyaut_kernel.spc
  **
...
END lbpks_lbdpyaut_kernel;
/
CREATE OR REPLACE Synonym lbpkss_lbdpyaut_kernel FOR lbpks_lbdpyaut_kernel
/