CREATE OR REPLACE PACKAGE lbpks_lbdtronl_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdtronl_kernel.spc
  **
  ...
  */
  ...
  g_unlock_once_auth VARCHAR2(1) := 'Y';----Bug#36263303_1_ADL ADDED
...
END lbpks_lbdtronl_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdtronl_kernel FOR lbpks_lbdtronl_kernel
/