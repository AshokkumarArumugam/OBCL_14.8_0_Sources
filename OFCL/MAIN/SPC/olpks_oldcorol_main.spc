CREATE OR REPLACE PACKAGE  olpks_oldcorol_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldcorol_main.spc
  **
...
TYPE ty_tb_v_contract_consol_detail IS TABLE OF oltb_contract_consol_detail%ROWTYPE INDEX BY BINARY_INTEGER;
...
TYPE ty_oldcorol IS RECORD (
     v_oltbs_contract     oltb_contract%ROWTYPE,
     v_contract_consol_master     oltb_contract_consol_master%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldcorol          IN OUT  olpks_oldcorol_Main.Ty_oldcorol,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Wrk_oldcorol IN  olpks_oldcorol_Main.Ty_oldcorol,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldcorol_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldcorol_main FOR olpks_oldcorol_main
/