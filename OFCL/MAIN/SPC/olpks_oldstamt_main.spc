CREATE OR REPLACE PACKAGE  olpks_oldstamt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldstamt_main.spc
  **
...
TYPE ty_oldstamt IS RECORD (
     v_oltms_static_maintenance     oltm_static_maintenance%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldstamt_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldstamt_main FOR olpks_oldstamt_main
/