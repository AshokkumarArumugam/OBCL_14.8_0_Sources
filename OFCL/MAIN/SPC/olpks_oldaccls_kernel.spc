CREATE OR REPLACE PACKAGE  olpks_oldaccls_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldaccls_kernel.spc
  **
...
END olpks_oldaccls_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldaccls_kernel FOR olpks_oldaccls_Kernel
/