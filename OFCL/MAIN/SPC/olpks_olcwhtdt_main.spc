CREATE OR REPLACE PACKAGE  olpks_olcwhtdt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_olcwhtdt_main.spc
  **
...
TYPE ty_tb__contract_receipt_detail IS TABLE OF oltb_contract_receipt_detail%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_olcwhtdt IS RECORD (
     v_oltbs_contract     oltb_contract%ROWTYPE,
     v_contract_receipt_detail    ty_tb__contract_receipt_detail,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_olcwhtdt          IN OUT  olpks_olcwhtdt_Main.Ty_olcwhtdt,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Main_Function    IN  VARCHAR2,
p_olcwhtdt       IN    olpks_olcwhtdt_Main.ty_olcwhtdt,
...
p_Main_Function    IN  VARCHAR2,
p_olcwhtdt     IN  olpks_olcwhtdt_Main.Ty_olcwhtdt,
p_Prev_olcwhtdt IN OUT  olpks_olcwhtdt_Main.Ty_olcwhtdt,
p_Wrk_olcwhtdt IN OUT  olpks_olcwhtdt_Main.Ty_olcwhtdt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_olcwhtdt     IN  olpks_olcwhtdt_Main.Ty_olcwhtdt,
p_Prev_olcwhtdt     IN  olpks_olcwhtdt_Main.Ty_olcwhtdt,
p_Wrk_olcwhtdt      IN OUT  olpks_olcwhtdt_Main.Ty_olcwhtdt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_olcwhtdt IN  olpks_olcwhtdt_Main.Ty_olcwhtdt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_olcwhtdt_main;
/
CREATE OR REPLACE SYNONYM olpkss_olcwhtdt_main FOR olpks_olcwhtdt_main
/