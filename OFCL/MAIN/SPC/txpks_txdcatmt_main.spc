CREATE OR REPLACE PACKAGE  txpks_txdcatmt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : txpks_txdcatmt_main.spc
  **
  ** Module     : The Tax
  ** 
...
TYPE ty_txdcatmt IS RECORD (
     v_txtms_tax_category     txtm_tax_category%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END txpks_txdcatmt_main;
/
CREATE OR REPLACE SYNONYM txpkss_txdcatmt_main FOR txpks_txdcatmt_main
/