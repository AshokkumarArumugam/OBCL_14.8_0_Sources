CREATE OR REPLACE PACKAGE  lbpks_lbcparfe_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbcparfe_main.spc
  **
...
TYPE ty_tb_tdriven_fee__participant IS TABLE OF lftb_contract_partdriven_fee%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbcparfe IS RECORD (
     v_contract_partdriven_fee     lftb_contract_partdriven_fee%ROWTYPE,
     v_rtdriven_fee__participant    ty_tb_tdriven_fee__participant,
...
p_lbcparfe       IN   OUT lbpks_lbcparfe_Main.Ty_lbcparfe,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Mod_No    IN  NUMBER,
                        p_Prev_lbcparfe          IN  lbpks_lbcparfe_Main.Ty_lbcparfe,
                        p_Wrk_lbcparfe          IN  lbpks_lbcparfe_Main.Ty_lbcparfe,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbcparfe_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbcparfe_main FOR lbpks_lbcparfe_main
/