CREATE OR REPLACE PACKAGE  lbpks_lbdpystl_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdpystl_main.spc
  **
...
TYPE ty_lbdpystl IS RECORD (
     v_pay_agent_settle_det     lbtb_pay_agent_settle_det%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdpystl_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdpystl_main FOR lbpks_lbdpystl_main
/