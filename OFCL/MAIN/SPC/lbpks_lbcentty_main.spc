CREATE OR REPLACE PACKAGE  lbpks_lbcentty_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbcentty_main.spc
  **
...
TYPE ty_lbcentty IS RECORD (
     v_oltbs_contract__cennty     oltb_contract%ROWTYPE,
     v_lbtbs_contract_borrowers     lbtb_contract_borrowers%ROWTYPE,
     v_borr_settle_curr_det     lbtb_borr_settle_curr_det%ROWTYPE,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbcentty          IN OUT  lbpks_lbcentty_Main.Ty_lbcentty,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Main_Function    IN  VARCHAR2,
p_lbcentty       IN    lbpks_lbcentty_Main.ty_lbcentty,
...
p_Main_Function    IN  VARCHAR2,
p_lbcentty     IN  lbpks_lbcentty_Main.Ty_lbcentty,
p_Prev_lbcentty IN OUT  lbpks_lbcentty_Main.Ty_lbcentty,
p_Wrk_lbcentty IN OUT  lbpks_lbcentty_Main.Ty_lbcentty,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbcentty     IN  lbpks_lbcentty_Main.Ty_lbcentty,
p_Prev_lbcentty     IN  lbpks_lbcentty_Main.Ty_lbcentty,
p_Wrk_lbcentty      IN OUT  lbpks_lbcentty_Main.Ty_lbcentty,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbcentty IN  lbpks_lbcentty_Main.Ty_lbcentty,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbcentty_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbcentty_main FOR lbpks_lbcentty_main
/