CREATE OR REPLACE PACKAGE  bkpks_bkdassoc_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : bkpks_bkdassoc_main.spc
  **
  ** Module     : Brokerage
  ** 
...
TYPE ty_bkdassoc IS RECORD (
     v_bktms_assoc     bktm_assoc%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END bkpks_bkdassoc_main;
/
CREATE OR REPLACE SYNONYM bkpkss_bkdassoc_main FOR bkpks_bkdassoc_main
/