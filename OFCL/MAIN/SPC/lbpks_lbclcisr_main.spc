CREATE OR REPLACE PACKAGE  lbpks_lbclcisr_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbclcisr_main.spc
  **
...
TYPE ty_tb_contract_lcissuer_detail IS TABLE OF lbtb_contract_lcissuer_detail%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbclcisr IS RECORD (
     v_oltbs_contract__lc     oltb_contract%ROWTYPE,
     v_contract_lcissuer_detail    ty_tb_contract_lcissuer_detail,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbclcisr          IN OUT  lbpks_lbclcisr_Main.Ty_lbclcisr,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Main_Function    IN  VARCHAR2,
p_lbclcisr       IN    lbpks_lbclcisr_Main.ty_lbclcisr,
...
p_Main_Function    IN  VARCHAR2,
p_lbclcisr     IN  lbpks_lbclcisr_Main.Ty_lbclcisr,
p_Prev_lbclcisr IN OUT  lbpks_lbclcisr_Main.Ty_lbclcisr,
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbclcisr     IN  lbpks_lbclcisr_Main.Ty_lbclcisr,
p_Prev_lbclcisr     IN  lbpks_lbclcisr_Main.Ty_lbclcisr,
p_Wrk_lbclcisr      IN OUT  lbpks_lbclcisr_Main.Ty_lbclcisr,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbclcisr IN  lbpks_lbclcisr_Main.Ty_lbclcisr,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbclcisr_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbclcisr_main FOR lbpks_lbclcisr_main
/