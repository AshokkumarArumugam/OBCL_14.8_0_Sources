CREATE OR REPLACE PACKAGE  lbpks_lbdexrfx_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdexrfx_main.spc
  **
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdexrfx          IN OUT  lbpks_lbdexrfx_Main.Ty_lbdexrfx,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Wrk_lbdexrfx IN  lbpks_lbdexrfx_Main.Ty_lbdexrfx,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdexrfx_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdexrfx_main FOR lbpks_lbdexrfx_main
/