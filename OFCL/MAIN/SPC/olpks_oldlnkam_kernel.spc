CREATE OR REPLACE PACKAGE olpks_oldlnkam_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldlnkam_kernel.spc
  **
...
END olpks_oldlnkam_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldlnkam_kernel FOR olpks_oldlnkam_kernel
/