CREATE OR REPLACE PACKAGE fcpks_fcdtronl_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : fcpks_fcdtronl_kernel.spc
  **
  ** Module     : FC
  **
  ...
  ** India
  ...
  Changed Date       : 24-Jan-2024
  Change Description : Declaring the global variable to get the exact action code
  Search String      : Bug#36169017
  ...
  */
  ...
  FUNCTION Fn_Post_Query(p_Source           IN VARCHAR2,
                         ...
                         p_Err_Code         IN OUT VARCHAR2,
                         p_Err_Params       IN OUT VARCHAR2) RETURN BOOLEAN;
    g_sbf_fee_acr_online VARCHAR2(1); --OBCL_14.5_STAND_BY_FEE
    g_action_code varchar2(20);---Bug#36169017 ADDED
END fcpks_fcdtronl_kernel;
/