CREATE OR REPLACE PACKAGE  tlpks_tldorgqu_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldorgqu_main.spc
  **
...
TYPE ty_tldorgqu IS RECORD (
     v_tltbs_upload_master     tltb_upload_master%ROWTYPE,
     v_origination_trade_master     tltb_origination_trade_master%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_tldorgqu          IN OUT  tlpks_tldorgqu_Main.Ty_tldorgqu,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_tldorgqu     IN  tlpks_tldorgqu_Main.Ty_tldorgqu,
p_Prev_tldorgqu IN OUT  tlpks_tldorgqu_Main.Ty_tldorgqu,
p_Wrk_tldorgqu      IN OUT  tlpks_tldorgqu_Main.Ty_tldorgqu,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_tldorgqu     IN  tlpks_tldorgqu_Main.Ty_tldorgqu,
p_Prev_tldorgqu     IN  tlpks_tldorgqu_Main.Ty_tldorgqu,
p_Wrk_tldorgqu      IN OUT  tlpks_tldorgqu_Main.Ty_tldorgqu,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_tldorgqu IN  tlpks_tldorgqu_Main.Ty_tldorgqu,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tldorgqu_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tldorgqu_main FOR tlpks_tldorgqu_main
/