create or replace package olpks_penalty_custom is
  /*----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_penalty_custom.spc
  **
  ** Module   : OL
  **
...
-- Added as part of this Bug#36429314 Ends Here
  ...
  --Bug#33858554 Starts
  FUNCTION fn_insert_pensch(p_contract_ref_no   IN oltbs_contract.contract_ref_no%TYPE
                         ,p_processing_date   IN DATE
                         ...
                         ,p_basis_amount      IN lftms_product_iccf.basis_amount%TYPE
                         ,p_grace_days        IN oltms_product_master_ld.grace_days%TYPE
...
end olpks_penalty_custom;
/
CREATE or replace SYNONYM olpkss_penalty_custom FOR olpks_penalty_custom
/