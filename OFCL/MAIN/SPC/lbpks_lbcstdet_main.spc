CREATE OR REPLACE PACKAGE  lbpks_lbcstdet_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbcstdet_main.spc
  **
...
TYPE ty_tb__contract_settle_det__as IS TABLE OF lbtb_contract_settle_det%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbcstdet IS RECORD (
     v_lbtbs_contract_settle_det     lbtb_contract_settle_det%ROWTYPE,
     v_contract_settle_det__as    ty_tb__contract_settle_det__as,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbcstdet          IN OUT  lbpks_lbcstdet_Main.Ty_lbcstdet,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Main_Function    IN  VARCHAR2,
p_lbcstdet     IN  lbpks_lbcstdet_Main.Ty_lbcstdet,
p_Prev_lbcstdet IN OUT  lbpks_lbcstdet_Main.Ty_lbcstdet,
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbcstdet     IN  lbpks_lbcstdet_Main.Ty_lbcstdet,
p_Prev_lbcstdet     IN  lbpks_lbcstdet_Main.Ty_lbcstdet,
p_Wrk_lbcstdet      IN OUT  lbpks_lbcstdet_Main.Ty_lbcstdet,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbcstdet IN  lbpks_lbcstdet_Main.Ty_lbcstdet,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbcstdet_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbcstdet_main FOR lbpks_lbcstdet_main
/