CREATE OR REPLACE PACKAGE Olpks_Batch_Liqd_Custom AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : Olpks_Batch_Liqd_Custom.spc
  **
  ...
  */
  ...
  FUNCTION Fn_Process_For_Contract(p_Branch             IN Oltbs_Contract.Branch%TYPE,
                                   ...
                                   p_Tb_Custom_data     IN OUT GLOBAL.Ty_Tb_Custom_Data)--OBCL_14.3_SUPPORT_BUG#32035437 CHANGES
    RETURN BOOLEAN;
...
END Olpks_Batch_Liqd_Custom;
/
CREATE OR REPLACE Synonym Olpkss_Batch_Liqd_Custom FOR Olpks_Batch_Liqd_Custom
/