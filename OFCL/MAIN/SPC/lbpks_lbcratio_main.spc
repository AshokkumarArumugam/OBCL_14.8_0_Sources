CREATE OR REPLACE PACKAGE  lbpks_lbcratio_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbcratio_main.spc
  **
...
TYPE ty_tb_v_nonprorata_ratio__part IS TABLE OF lbtb_part_nonprorata_ratio%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbcratio IS RECORD (
     v_part_nonprorata_ratio     lbtb_part_nonprorata_ratio%ROWTYPE,
     v_nonprorata_ratio__part    ty_tb_v_nonprorata_ratio__part,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbcratio          IN OUT  lbpks_lbcratio_Main.Ty_lbcratio,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Main_Function    IN  VARCHAR2,
p_lbcratio       IN    lbpks_lbcratio_Main.ty_lbcratio,
...
p_Main_Function    IN  VARCHAR2,
p_lbcratio     IN  lbpks_lbcratio_Main.Ty_lbcratio,
p_Prev_lbcratio IN OUT  lbpks_lbcratio_Main.Ty_lbcratio,
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbcratio     IN  lbpks_lbcratio_Main.Ty_lbcratio,
p_Prev_lbcratio     IN  lbpks_lbcratio_Main.Ty_lbcratio,
p_Wrk_lbcratio      IN OUT  lbpks_lbcratio_Main.Ty_lbcratio,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbcratio IN  lbpks_lbcratio_Main.Ty_lbcratio,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbcratio_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbcratio_main FOR lbpks_lbcratio_main
/