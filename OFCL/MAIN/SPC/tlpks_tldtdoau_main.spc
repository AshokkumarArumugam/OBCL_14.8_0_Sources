CREATE OR REPLACE PACKAGE  tlpks_tldtdoau_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldtdoau_main.spc
  **
...
p_Wrk_tldtdoau IN  tlpks_tldtdoau_Main.Ty_tldtdoau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tldtdoau_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tldtdoau_main FOR tlpks_tldtdoau_main
/