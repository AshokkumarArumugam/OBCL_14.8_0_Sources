CREATE OR REPLACE PACKAGE  fcpks_fcdrcmnt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : fcpks_fcdrcmnt_main.spc
  **
...
TYPE ty_fcdrcmnt IS RECORD (
     v_lftms_margin_component     lftm_margin_component%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END fcpks_fcdrcmnt_main;
/
CREATE OR REPLACE SYNONYM fcpkss_fcdrcmnt_main FOR fcpks_fcdrcmnt_main
/