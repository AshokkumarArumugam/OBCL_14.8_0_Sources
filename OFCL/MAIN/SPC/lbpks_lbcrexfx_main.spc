CREATE OR REPLACE PACKAGE  lbpks_lbcrexfx_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbcrexfx_main.spc
  **
...
TYPE ty_lbcrexfx IS RECORD (
     v_oltbs_contract     oltb_contract%ROWTYPE,
     v_lbtbs_roll_exrate_fixing     lbtb_roll_exrate_fixing%ROWTYPE,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbcrexfx          IN OUT  lbpks_lbcrexfx_Main.Ty_lbcrexfx,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Main_Function    IN  VARCHAR2,
p_lbcrexfx       IN    lbpks_lbcrexfx_Main.ty_lbcrexfx,
...
p_Main_Function    IN  VARCHAR2,
p_lbcrexfx     IN  lbpks_lbcrexfx_Main.Ty_lbcrexfx,
p_Prev_lbcrexfx IN OUT  lbpks_lbcrexfx_Main.Ty_lbcrexfx,
p_Wrk_lbcrexfx IN OUT  lbpks_lbcrexfx_Main.Ty_lbcrexfx,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbcrexfx     IN  lbpks_lbcrexfx_Main.Ty_lbcrexfx,
p_Prev_lbcrexfx     IN  lbpks_lbcrexfx_Main.Ty_lbcrexfx,
p_Wrk_lbcrexfx      IN OUT  lbpks_lbcrexfx_Main.Ty_lbcrexfx,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbcrexfx IN  lbpks_lbcrexfx_Main.Ty_lbcrexfx,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbcrexfx_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbcrexfx_main FOR lbpks_lbcrexfx_main
/