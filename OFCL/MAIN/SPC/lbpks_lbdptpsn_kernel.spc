CREATE OR REPLACE PACKAGE  lbpks_lbdptpsn_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdptpsn_kernel.spc
  **
...
END lbpks_lbdptpsn_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdptpsn_kernel FOR lbpks_lbdptpsn_kernel
/