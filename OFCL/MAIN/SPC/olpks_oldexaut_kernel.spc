CREATE OR REPLACE PACKAGE  olpks_oldexaut_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldexaut_kernel.spc
  **
...
END olpks_oldexaut_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldexaut_kernel FOR olpks_oldexaut_kernel
/