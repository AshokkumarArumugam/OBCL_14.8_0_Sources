CREATE OR REPLACE PACKAGE  lbpks_lbdbrlmt_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdbrlmt_kernel.spc
  **
...
END lbpks_lbdbrlmt_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdbrlmt_kernel FOR lbpks_lbdbrlmt_kernel
/