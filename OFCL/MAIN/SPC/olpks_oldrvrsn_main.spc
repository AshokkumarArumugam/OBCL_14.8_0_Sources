CREATE OR REPLACE PACKAGE  olpks_oldrvrsn_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldrvrsn_main.spc
  **
...
TYPE ty_oldrvrsn IS RECORD (
     v_oltms_reason     oltm_reason%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldrvrsn_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldrvrsn_main FOR olpks_oldrvrsn_main
/