CREATE OR REPLACE PACKAGE lbpks_lbdreprs_utils_custom AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdreprs_utils_custom.spc
  **
...
END lbpks_lbdreprs_utils_custom;
/
CREATE OR REPLACE Synonym lbpkss_lbdreprs_utils_custom FOR lbpks_lbdreprs_utils_custom
/