CREATE OR REPLACE PACKAGE  olpks_oldostmt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldostmt_main.spc
  **
...
TYPE ty_oldostmt IS RECORD (
     v_oltbs_ovd_interest     oltb_ovd_interest%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldostmt_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldostmt_main FOR olpks_oldostmt_main
/