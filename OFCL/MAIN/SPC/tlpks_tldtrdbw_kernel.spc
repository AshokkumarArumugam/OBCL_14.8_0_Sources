CREATE OR REPLACE PACKAGE  tlpks_tldtrdbw_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldtrdbw_kernel.spc
  **
...
END tlpks_tldtrdbw_kernel;
/
CREATE OR REPLACE SYNONYM tlpkss_tldtrdbw_kernel FOR tlpks_tldtrdbw_kernel
/