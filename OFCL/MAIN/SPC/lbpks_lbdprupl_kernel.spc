create or replace PACKAGE  lbpks_lbdprupl_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdprupl_kernel.spc
  **
...
END lbpks_lbdprupl_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdprupl_kernel FOR lbpks_lbdprupl_kernel
/