CREATE OR REPLACE PACKAGE  tlpks_tlcagfee_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tlcagfee_main.spc
  **
...
TYPE ty_tlcagfee IS RECORD (
     v_tltbs_contract_fee__ca     tltb_contract_fee%ROWTYPE,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_tlcagfee          IN OUT  tlpks_tlcagfee_Main.Ty_tlcagfee,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Main_Function    IN  VARCHAR2,
p_tlcagfee     IN  tlpks_tlcagfee_Main.Ty_tlcagfee,
p_Prev_tlcagfee IN OUT  tlpks_tlcagfee_Main.Ty_tlcagfee,
...
p_Wrk_tlcagfee IN  tlpks_tlcagfee_Main.Ty_tlcagfee,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tlcagfee_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tlcagfee_main FOR tlpks_tlcagfee_main
/