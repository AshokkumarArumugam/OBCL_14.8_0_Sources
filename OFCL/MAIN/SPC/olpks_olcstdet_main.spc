CREATE OR REPLACE PACKAGE  olpks_olcstdet_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_olcstdet_main.spc
  **
...
TYPE ty_tb_contract_settle_det___as IS TABLE OF oltb_contract_settle_det%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_olcstdet IS RECORD (
     v_oltbs_contract_settle_det     oltb_contract_settle_det%ROWTYPE,
     v_contract_settle_det___as    ty_tb_contract_settle_det___as,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_olcstdet          IN OUT  olpks_olcstdet_Main.Ty_olcstdet,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Main_Function    IN  VARCHAR2,
p_olcstdet       IN    olpks_olcstdet_Main.ty_olcstdet,
...
p_Main_Function    IN  VARCHAR2,
p_olcstdet     IN  olpks_olcstdet_Main.Ty_olcstdet,
p_Prev_olcstdet IN OUT  olpks_olcstdet_Main.Ty_olcstdet,
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_olcstdet     IN  olpks_olcstdet_Main.Ty_olcstdet,
p_Prev_olcstdet     IN  olpks_olcstdet_Main.Ty_olcstdet,
p_Wrk_olcstdet      IN OUT  olpks_olcstdet_Main.Ty_olcstdet,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_olcstdet IN  olpks_olcstdet_Main.Ty_olcstdet,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_olcstdet_main;
/
CREATE OR REPLACE SYNONYM olpkss_olcstdet_main FOR olpks_olcstdet_main
/