CREATE OR REPLACE PACKAGE  lbpks_lbdautxr_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdautxr_main.spc
  **
...
p_Wrk_lbdautxr IN  lbpks_lbdautxr_Main.Ty_lbdautxr,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdautxr_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdautxr_main FOR lbpks_lbdautxr_main
/