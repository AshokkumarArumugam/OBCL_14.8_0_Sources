CREATE OR REPLACE PACKAGE  lbpks_lbrinica_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbrinica_kernel.spc
  **
...
p_lbrinica     IN  OUT lbpks_lbrinica_Main.Ty_lbrinica,
...
p_lbrinica IN   lbpks_lbrinica_Main.ty_lbrinica,
p_Err_Code       IN  OUT VARCHAR2,
p_Err_Params     IN  OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Child_Function    IN  VARCHAR2,
p_lbrinica IN   lbpks_lbrinica_Main.Ty_lbrinica,
p_Wrk_lbrinica IN OUT  lbpks_lbrinica_Main.Ty_lbrinica,
p_Err_Code       IN  OUT VARCHAR2,
p_Err_Params     IN  OUT VARCHAR2)
RETURN BOOLEAN;
...
END lbpks_lbrinica_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbrinica_kernel FOR lbpks_lbrinica_kernel
/