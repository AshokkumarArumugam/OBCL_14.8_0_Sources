CREATE OR REPLACE PACKAGE  tlpks_tldfeeau_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldfeeau_main.spc
  **
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_tldfeeau          IN OUT  tlpks_tldfeeau_Main.Ty_tldfeeau,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_tldfeeau          IN tlpks_tldfeeau_Main.Ty_tldfeeau,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_tldfeeau     IN  tlpks_tldfeeau_Main.Ty_tldfeeau,
p_Wrk_tldfeeau      IN OUT  tlpks_tldfeeau_Main.Ty_tldfeeau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_tldfeeau     IN  tlpks_tldfeeau_Main.Ty_tldfeeau,
p_Prev_tldfeeau IN OUT  tlpks_tldfeeau_Main.Ty_tldfeeau,
p_Wrk_tldfeeau      IN OUT  tlpks_tldfeeau_Main.Ty_tldfeeau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_tldfeeau     IN  tlpks_tldfeeau_Main.Ty_tldfeeau,
p_Prev_tldfeeau     IN  tlpks_tldfeeau_Main.Ty_tldfeeau,
p_Wrk_tldfeeau      IN OUT  tlpks_tldfeeau_Main.Ty_tldfeeau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_tldfeeau IN  tlpks_tldfeeau_Main.Ty_tldfeeau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tldfeeau_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tldfeeau_main FOR tlpks_tldfeeau_main
/