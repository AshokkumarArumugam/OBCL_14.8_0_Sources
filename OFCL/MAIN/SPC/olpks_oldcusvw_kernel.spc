CREATE OR REPLACE PACKAGE  olpks_oldcusvw_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldcusvw_kernel.spc
  **
...
END olpks_oldcusvw_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldcusvw_kernel FOR olpks_oldcusvw_Kernel
/