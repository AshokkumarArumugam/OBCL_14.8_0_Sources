CREATE OR REPLACE PACKAGE  olpks_oldtroic_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldtroic_kernel.spc
  **
...
G_oldtroic olpks_oldtroic_Main.Ty_oldtroic;
G_function_Action VARCHAR2(100);
...
END olpks_oldtroic_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldtroic_kernel FOR olpks_oldtroic_Kernel
/