CREATE OR REPLACE PACKAGE  tlpks_tldfeaut_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldfeaut_main.spc
  **
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_tldfeaut          IN OUT  tlpks_tldfeaut_Main.Ty_tldfeaut,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_tldfeaut          IN tlpks_tldfeaut_Main.Ty_tldfeaut,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_tldfeaut     IN  tlpks_tldfeaut_Main.Ty_tldfeaut,
p_Wrk_tldfeaut      IN OUT  tlpks_tldfeaut_Main.Ty_tldfeaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_tldfeaut     IN  tlpks_tldfeaut_Main.Ty_tldfeaut,
p_Prev_tldfeaut IN OUT  tlpks_tldfeaut_Main.Ty_tldfeaut,
p_Wrk_tldfeaut      IN OUT  tlpks_tldfeaut_Main.Ty_tldfeaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_tldfeaut     IN  tlpks_tldfeaut_Main.Ty_tldfeaut,
p_Prev_tldfeaut     IN  tlpks_tldfeaut_Main.Ty_tldfeaut,
p_Wrk_tldfeaut      IN OUT  tlpks_tldfeaut_Main.Ty_tldfeaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_tldfeaut IN  tlpks_tldfeaut_Main.Ty_tldfeaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tldfeaut_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tldfeaut_main FOR tlpks_tldfeaut_main
/