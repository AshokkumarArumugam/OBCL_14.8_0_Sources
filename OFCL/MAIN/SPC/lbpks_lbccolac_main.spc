CREATE OR REPLACE PACKAGE  lbpks_lbccolac_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbccolac_main.spc
  **
...
TYPE ty_tb_v_tranche_collac_effdate IS TABLE OF lbtm_tranche_collac_effdate%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_btms_tranche_collac_coll IS TABLE OF lbtm_tranche_collac_coll%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_tranche_collac_account IS TABLE OF lbtm_tranche_collac_account%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbccolac IS RECORD (
     v_oltbs_contract__colac     oltb_contract%ROWTYPE,
     v_tranche_collac_effdate    ty_tb_v_tranche_collac_effdate,
     v_lbtms_tranche_collac_coll    ty_tb_btms_tranche_collac_coll,
     v_tranche_collac_account    ty_tb_v_tranche_collac_account,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbccolac          IN OUT  lbpks_lbccolac_Main.Ty_lbccolac,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbccolac     IN  lbpks_lbccolac_Main.Ty_lbccolac,
p_Prev_lbccolac     IN  lbpks_lbccolac_Main.Ty_lbccolac,
p_Wrk_lbccolac      IN OUT  lbpks_lbccolac_Main.Ty_lbccolac,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbccolac IN  lbpks_lbccolac_Main.Ty_lbccolac,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbccolac_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbccolac_main FOR lbpks_lbccolac_main
/