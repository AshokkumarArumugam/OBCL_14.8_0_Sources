CREATE OR REPLACE PACKAGE  lbpks_lbcintsh_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbcintsh_main.spc
  **
...
TYPE ty_tb_v_share_amt__lbcintsh IS TABLE OF lbtb_participant_share_amt%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbcintsh IS RECORD (
     v_oltbs_contract__lbcintsh     oltb_contract%ROWTYPE,
     v_share_amt__lbcintsh    ty_tb_v_share_amt__lbcintsh,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbcintsh          IN OUT  lbpks_lbcintsh_Main.Ty_lbcintsh,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Main_Function    IN  VARCHAR2,
p_lbcintsh     IN  lbpks_lbcintsh_Main.Ty_lbcintsh,
p_Prev_lbcintsh IN OUT  lbpks_lbcintsh_Main.Ty_lbcintsh,
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbcintsh     IN  lbpks_lbcintsh_Main.Ty_lbcintsh,
p_Prev_lbcintsh     IN  lbpks_lbcintsh_Main.Ty_lbcintsh,
p_Wrk_lbcintsh      IN OUT  lbpks_lbcintsh_Main.Ty_lbcintsh,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbcintsh IN  lbpks_lbcintsh_Main.Ty_lbcintsh,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbcintsh_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbcintsh_main FOR lbpks_lbcintsh_main
/