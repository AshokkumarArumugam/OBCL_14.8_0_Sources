CREATE OR REPLACE PACKAGE olpks_oldtronl_utils_cluster AS
  /*-----------------------------------------------------------------------------------------------------
    **
    ** File Name  : olpks_oldtronl_utils_cluster.spc
    **
...
END olpks_oldtronl_utils_cluster;
/
CREATE OR REPLACE SYNONYM  olpkss_oldtronl_utils_cluster FOR olpks_oldtronl_utils_cluster
/