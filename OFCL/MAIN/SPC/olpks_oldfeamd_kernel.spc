CREATE OR REPLACE PACKAGE olpks_oldfeamd_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldfeamd_kernel.spc
  **
...
END olpks_oldfeamd_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldfeamd_kernel FOR olpks_oldfeamd_kernel
/