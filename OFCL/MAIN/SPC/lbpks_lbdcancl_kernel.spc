CREATE OR REPLACE PACKAGE  lbpks_lbdcancl_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdcancl_kernel.spc
  **
...
END lbpks_lbdcancl_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdcancl_kernel FOR lbpks_lbdcancl_kernel
/