CREATE OR REPLACE PACKAGE  tlpks_tlcswupl_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tlcswupl_main.spc
  **
...
TYPE ty_tb_v_tltbs_upload_swap IS TABLE OF tltb_upload_swap%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_tlcswupl IS RECORD (
     v_tltbs_upload_master__sw     tltb_upload_master%ROWTYPE,
     v_tltbs_upload_swap    ty_tb_v_tltbs_upload_swap,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_tlcswupl          IN OUT  tlpks_tlcswupl_Main.Ty_tlcswupl,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Main_Function    IN  VARCHAR2,
p_tlcswupl     IN  tlpks_tlcswupl_Main.Ty_tlcswupl,
p_Prev_tlcswupl IN OUT  tlpks_tlcswupl_Main.Ty_tlcswupl,
...
p_Wrk_tlcswupl IN  tlpks_tlcswupl_Main.Ty_tlcswupl,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tlcswupl_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tlcswupl_main FOR tlpks_tlcswupl_main
/