CREATE OR REPLACE PACKAGE  olpks_olcprefx_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_olcprefx_main.spc
  **
...
TYPE ty_olcprefx IS RECORD (
     v_oltbs_contract     oltb_contract%ROWTYPE,
     v_oltbs_roll_exrate_fix     oltb_roll_exrate_fix%ROWTYPE,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_olcprefx          IN OUT  olpks_olcprefx_Main.Ty_olcprefx,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Main_Function    IN  VARCHAR2,
p_olcprefx       IN    olpks_olcprefx_Main.ty_olcprefx,
...
p_Main_Function    IN  VARCHAR2,
p_olcprefx     IN  olpks_olcprefx_Main.Ty_olcprefx,
p_Prev_olcprefx IN OUT  olpks_olcprefx_Main.Ty_olcprefx,
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_olcprefx     IN  olpks_olcprefx_Main.Ty_olcprefx,
p_Prev_olcprefx     IN  olpks_olcprefx_Main.Ty_olcprefx,
p_Wrk_olcprefx      IN OUT  olpks_olcprefx_Main.Ty_olcprefx,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_olcprefx IN  olpks_olcprefx_Main.Ty_olcprefx,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_olcprefx_main;
/
CREATE OR REPLACE SYNONYM olpkss_olcprefx_main FOR olpks_olcprefx_main
/