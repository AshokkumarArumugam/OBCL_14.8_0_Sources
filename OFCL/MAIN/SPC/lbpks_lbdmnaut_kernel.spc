CREATE OR REPLACE PACKAGE  lbpks_lbdmnaut_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdmnaut_kernel.spc
  **
...
END lbpks_lbdmnaut_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdmnaut_kernel FOR lbpks_lbdmnaut_Kernel
/