CREATE OR REPLACE PACKAGE  tlpks_tldtkupl_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldtkupl_kernel.spc
  **
...
END tlpks_tldtkupl_kernel;
/
CREATE OR REPLACE SYNONYM tlpkss_tldtkupl_kernel FOR tlpks_tldtkupl_Kernel
/