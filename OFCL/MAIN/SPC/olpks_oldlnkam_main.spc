CREATE OR REPLACE PACKAGE  olpks_oldlnkam_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldlnkam_main.spc
  **
...
TYPE ty_oldlnkam IS RECORD (
     v_oltbs_contract     oltb_contract%ROWTYPE,
     v_contract_link_amendment     oltb_contract_link_amendment%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldlnkam          IN OUT  olpks_oldlnkam_Main.Ty_oldlnkam,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldlnkam     IN  olpks_oldlnkam_Main.Ty_oldlnkam,
p_Prev_oldlnkam IN OUT  olpks_oldlnkam_Main.Ty_oldlnkam,
p_Wrk_oldlnkam      IN OUT  olpks_oldlnkam_Main.Ty_oldlnkam,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldlnkam     IN  olpks_oldlnkam_Main.Ty_oldlnkam,
p_Prev_oldlnkam     IN  olpks_oldlnkam_Main.Ty_oldlnkam,
p_Wrk_oldlnkam      IN OUT  olpks_oldlnkam_Main.Ty_oldlnkam,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldlnkam IN  olpks_oldlnkam_Main.Ty_oldlnkam,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldlnkam_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldlnkam_main FOR olpks_oldlnkam_main
/