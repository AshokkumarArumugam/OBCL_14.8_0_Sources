CREATE OR REPLACE PACKAGE  tlpks_tldcfdet_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldcfdet_main.spc
  **
...
TYPE ty_tb_v_tlvws_dcf_fee_detail IS TABLE OF tlvw_dcf_fee_detail%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_dcf_computation_detail IS TABLE OF tlvw_dcf_computation_detail%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_tldcfdet IS RECORD (
     v_oltbs_contract__dcf     oltb_contract%ROWTYPE,
     v_tlvws_dcf_fee_detail    ty_tb_v_tlvws_dcf_fee_detail,
     v_dcf_computation_detail    ty_tb_v_dcf_computation_detail,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_tldcfdet          IN OUT  tlpks_tldcfdet_Main.Ty_tldcfdet,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_tldcfdet          IN tlpks_tldcfdet_Main.Ty_tldcfdet,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_tldcfdet     IN  tlpks_tldcfdet_Main.Ty_tldcfdet,
p_Wrk_tldcfdet      IN OUT  tlpks_tldcfdet_Main.Ty_tldcfdet,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_tldcfdet     IN  tlpks_tldcfdet_Main.Ty_tldcfdet,
p_Prev_tldcfdet IN OUT  tlpks_tldcfdet_Main.Ty_tldcfdet,
p_Wrk_tldcfdet      IN OUT  tlpks_tldcfdet_Main.Ty_tldcfdet,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_tldcfdet     IN  tlpks_tldcfdet_Main.Ty_tldcfdet,
p_Prev_tldcfdet     IN  tlpks_tldcfdet_Main.Ty_tldcfdet,
p_Wrk_tldcfdet      IN OUT  tlpks_tldcfdet_Main.Ty_tldcfdet,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_tldcfdet IN  tlpks_tldcfdet_Main.Ty_tldcfdet,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tldcfdet_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tldcfdet_main FOR tlpks_tldcfdet_main
/