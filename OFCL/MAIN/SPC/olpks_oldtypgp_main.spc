CREATE OR REPLACE PACKAGE  olpks_oldtypgp_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldtypgp_main.spc
  **
...
TYPE ty_oldtypgp IS RECORD (
     v_oltm_msg_type_grp_map     oltm_msg_type_grp_map%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldtypgp_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldtypgp_main FOR olpks_oldtypgp_main
/