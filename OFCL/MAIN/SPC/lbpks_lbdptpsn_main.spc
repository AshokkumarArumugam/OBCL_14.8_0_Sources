CREATE OR REPLACE PACKAGE  lbpks_lbdptpsn_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdptpsn_main.spc
  **
...
TYPE ty_lbdptpsn IS RECORD (
     v_part_position_summary     lbvw_part_position_summary%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdptpsn          IN OUT  lbpks_lbdptpsn_Main.Ty_lbdptpsn,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_lbdptpsn          IN lbpks_lbdptpsn_Main.Ty_lbdptpsn,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdptpsn     IN  lbpks_lbdptpsn_Main.Ty_lbdptpsn,
p_Wrk_lbdptpsn      IN OUT  lbpks_lbdptpsn_Main.Ty_lbdptpsn,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdptpsn     IN  lbpks_lbdptpsn_Main.Ty_lbdptpsn,
p_Prev_lbdptpsn IN OUT  lbpks_lbdptpsn_Main.Ty_lbdptpsn,
p_Wrk_lbdptpsn      IN OUT  lbpks_lbdptpsn_Main.Ty_lbdptpsn,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbdptpsn     IN  lbpks_lbdptpsn_Main.Ty_lbdptpsn,
p_Prev_lbdptpsn     IN  lbpks_lbdptpsn_Main.Ty_lbdptpsn,
p_Wrk_lbdptpsn      IN OUT  lbpks_lbdptpsn_Main.Ty_lbdptpsn,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbdptpsn IN  lbpks_lbdptpsn_Main.Ty_lbdptpsn,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdptpsn_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdptpsn_main FOR lbpks_lbdptpsn_main
/