CREATE OR REPLACE PACKAGE  tlpks_tldamfee_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldamfee_kernel.spc
  **
...
END tlpks_tldamfee_kernel;
/
CREATE OR REPLACE SYNONYM tlpkss_tldamfee_kernel FOR tlpks_tldamfee_Kernel
/