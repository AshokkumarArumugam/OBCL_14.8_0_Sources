CREATE OR REPLACE PACKAGE olpks_ld_utils_custom AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_ld_utils_custom.spc
  **
...
END olpks_ld_utils_custom;
/
CREATE OR REPLACE SYNONYM olpkss_ld_utils_custom FOR olpks_ld_utils_custom
/