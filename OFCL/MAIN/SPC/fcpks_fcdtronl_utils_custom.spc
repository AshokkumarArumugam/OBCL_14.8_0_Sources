create or replace package FCPKS_FCDTRONL_UTILS_CUSTOM as

  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : fcpks_fcdtronl_utils_custom.spc
  **
...
end FCPKS_FCDTRONL_UTILS_CUSTOM;
/
CREATE OR REPLACE Synonym FCPKSS_FCDTRONL_UTILS_CUSTOM FOR FCPKS_FCDTRONL_UTILS_CUSTOM
/