CREATE OR REPLACE PACKAGE  olpks_oldatmnt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldatmnt_main.spc
  **
...
TYPE ty_oldatmnt IS RECORD (
     v_oltms_account_type     oltm_account_type%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldatmnt_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldatmnt_main FOR olpks_oldatmnt_main
/