CREATE OR REPLACE PACKAGE  tlpks_tldrtmch_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldrtmch_main.spc
  **
...
TYPE ty_tb_ltms_rating_match_detail IS TABLE OF tltm_rating_match_detail%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_tldrtmch IS RECORD (
     v_tltms_rating_match_master     tltm_rating_match_master%ROWTYPE,
     v_tltms_rating_match_detail    ty_tb_ltms_rating_match_detail,
...
FUNCTION Fn_Get_Key_Information (p_Source    IN  VARCHAR2, 
                        ...
                        p_Function_id       IN     VARCHAR2,
                        p_Action_Code       IN     VARCHAR2,
p_tldrtmch       IN  OUT tlpks_tldrtmch_Main.Ty_tldrtmch,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tldrtmch_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tldrtmch_main FOR tlpks_tldrtmch_main
/