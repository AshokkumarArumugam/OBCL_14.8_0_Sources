CREATE OR REPLACE PACKAGE  olpks_oldafmap_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldafmap_kernel.spc
  **
  ** Module     : OL
  ** 
...
END olpks_oldafmap_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldafmap_kernel FOR olpks_oldafmap_kernel
/