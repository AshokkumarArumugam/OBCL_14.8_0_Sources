CREATE OR REPLACE PACKAGE  olpks_oldrefau_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldrefau_kernel.spc
  **
...
END olpks_oldrefau_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldrefau_kernel FOR olpks_oldrefau_kernel
/