CREATE OR REPLACE PACKAGE  lbpks_lbcfpmls_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbcfpmls_main.spc
  **
...
TYPE ty_tb_v_lbtbs_cont_part_media IS TABLE OF lbtb_cont_part_media%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbcfpmls IS RECORD (
     v_cont_media_for_all_part     lbtb_cont_media_for_all_part%ROWTYPE,
     v_lbtbs_cont_part_media    ty_tb_v_lbtbs_cont_part_media,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbcfpmls          IN OUT  lbpks_lbcfpmls_Main.Ty_lbcfpmls,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Main_Function    IN  VARCHAR2,
p_lbcfpmls       IN    lbpks_lbcfpmls_Main.ty_lbcfpmls,
...
p_Main_Function    IN  VARCHAR2,
p_lbcfpmls     IN  lbpks_lbcfpmls_Main.Ty_lbcfpmls,
p_Prev_lbcfpmls IN OUT  lbpks_lbcfpmls_Main.Ty_lbcfpmls,
p_Wrk_lbcfpmls IN OUT  lbpks_lbcfpmls_Main.Ty_lbcfpmls,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbcfpmls     IN  lbpks_lbcfpmls_Main.Ty_lbcfpmls,
p_Prev_lbcfpmls     IN  lbpks_lbcfpmls_Main.Ty_lbcfpmls,
p_Wrk_lbcfpmls      IN OUT  lbpks_lbcfpmls_Main.Ty_lbcfpmls,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbcfpmls IN  lbpks_lbcfpmls_Main.Ty_lbcfpmls,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbcfpmls_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbcfpmls_main FOR lbpks_lbcfpmls_main
/