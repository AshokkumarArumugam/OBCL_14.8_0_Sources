CREATE OR REPLACE PACKAGE Lbpks_Batch_Liqd_Cluster AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : Lbpks_Batch_Liqd_Cluster.spc
  **
...
END Lbpks_Batch_Liqd_Cluster;
/
CREATE OR REPLACE Synonym Lbpkss_Batch_Liqd_Cluster FOR Lbpks_Batch_Liqd_Cluster
/