CREATE OR REPLACE PACKAGE  pipks_pidecaqu_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : pipks_pidecaqu_main.spc
  **
  ** Module     : Product Interfacing
  ** 
...
TYPE ty_pidecaqu IS RECORD (
     v_covws_eca_queue     covw_eca_queue%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_pidecaqu          IN OUT  pipks_pidecaqu_Main.Ty_pidecaqu,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_pidecaqu          IN pipks_pidecaqu_Main.Ty_pidecaqu,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_pidecaqu     IN  pipks_pidecaqu_Main.Ty_pidecaqu,
p_Wrk_pidecaqu      IN OUT  pipks_pidecaqu_Main.Ty_pidecaqu,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_pidecaqu     IN  pipks_pidecaqu_Main.Ty_pidecaqu,
p_Prev_pidecaqu IN OUT  pipks_pidecaqu_Main.Ty_pidecaqu,
p_Wrk_pidecaqu      IN OUT  pipks_pidecaqu_Main.Ty_pidecaqu,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_pidecaqu     IN  pipks_pidecaqu_Main.Ty_pidecaqu,
p_Prev_pidecaqu     IN  pipks_pidecaqu_Main.Ty_pidecaqu,
p_Wrk_pidecaqu      IN OUT  pipks_pidecaqu_Main.Ty_pidecaqu,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_pidecaqu IN  pipks_pidecaqu_Main.Ty_pidecaqu,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END pipks_pidecaqu_main;
/
CREATE OR REPLACE SYNONYM pipkss_pidecaqu_main FOR pipks_pidecaqu_main
/