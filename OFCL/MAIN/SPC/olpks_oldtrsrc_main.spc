CREATE OR REPLACE PACKAGE  olpks_oldtrsrc_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldtrsrc_main.spc
  **
...
TYPE ty_oldtrsrc IS RECORD (
     v_oltms_treasury_source     oltm_treasury_source%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldtrsrc_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldtrsrc_main FOR olpks_oldtrsrc_main
/