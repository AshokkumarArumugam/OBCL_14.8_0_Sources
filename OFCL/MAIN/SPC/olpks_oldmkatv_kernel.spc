CREATE OR REPLACE PACKAGE  olpks_oldmkatv_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldmkatv_kernel.spc
  **
...
END olpks_oldmkatv_kernel;
/
CREATE OR REPLACE Synonym olpkss_oldmkatv_kernel FOR olpks_oldmkatv_kernel
/