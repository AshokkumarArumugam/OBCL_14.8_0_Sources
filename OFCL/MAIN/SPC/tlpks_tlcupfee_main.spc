CREATE OR REPLACE PACKAGE  tlpks_tlcupfee_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tlcupfee_main.spc
  **
...
TYPE ty_tb__tltbs_upload_fee_master IS TABLE OF tltb_upload_fee_master%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_tlcupfee IS RECORD (
     v_tltbs_upload_master__fee     tltb_upload_master%ROWTYPE,
     v_tltbs_upload_fee_master    ty_tb__tltbs_upload_fee_master,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_tlcupfee          IN OUT  tlpks_tlcupfee_Main.Ty_tlcupfee,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Main_Function    IN  VARCHAR2,
p_tlcupfee     IN  tlpks_tlcupfee_Main.Ty_tlcupfee,
p_Prev_tlcupfee IN OUT  tlpks_tlcupfee_Main.Ty_tlcupfee,
...
p_Wrk_tlcupfee IN  tlpks_tlcupfee_Main.Ty_tlcupfee,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tlcupfee_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tlcupfee_main FOR tlpks_tlcupfee_main
/