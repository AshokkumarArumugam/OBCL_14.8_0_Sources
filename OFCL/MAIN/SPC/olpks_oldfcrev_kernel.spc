CREATE OR REPLACE PACKAGE olpks_oldfcrev_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldfcrev_kernel.spc
  **
...
END olpks_oldfcrev_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldfcrev_kernel FOR olpks_oldfcrev_kernel
/