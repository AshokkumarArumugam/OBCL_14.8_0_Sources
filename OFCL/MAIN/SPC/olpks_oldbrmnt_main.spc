CREATE OR REPLACE PACKAGE  olpks_oldbrmnt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldbrmnt_main.spc
  **
...
TYPE ty_oldbrmnt IS RECORD (
     v_oltm_core_branch     oltm_core_branch%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldbrmnt_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldbrmnt_main FOR olpks_oldbrmnt_main
/