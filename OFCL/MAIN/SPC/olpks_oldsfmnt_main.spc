CREATE OR REPLACE PACKAGE  olpks_oldsfmnt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldsfmnt_main.spc
  **
  ** Module     : Core
  ** 
...
TYPE ty_oldsfmnt IS RECORD (
     v_oltms_static_field_vals     oltm_static_field_vals%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldsfmnt_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldsfmnt_main FOR olpks_oldsfmnt_main
/