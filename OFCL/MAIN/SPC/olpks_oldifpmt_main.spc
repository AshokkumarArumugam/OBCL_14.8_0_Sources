CREATE OR REPLACE PACKAGE  olpks_oldifpmt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldifpmt_main.spc
  **
...
TYPE ty_tb_oltbs_if_payment_process IS TABLE OF oltb_if_payment_process%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_oldifpmt IS RECORD (
     v_smtbs_modules     smtb_modules%ROWTYPE,
     v_oltbs_if_payment_process    ty_tb_oltbs_if_payment_process,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldifpmt          IN OUT  olpks_oldifpmt_Main.Ty_oldifpmt,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldifpmt     IN  olpks_oldifpmt_Main.Ty_oldifpmt,
p_Prev_oldifpmt     IN  olpks_oldifpmt_Main.Ty_oldifpmt,
p_Wrk_oldifpmt      IN OUT  olpks_oldifpmt_Main.Ty_oldifpmt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldifpmt IN  olpks_oldifpmt_Main.Ty_oldifpmt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldifpmt_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldifpmt_main FOR olpks_oldifpmt_main
/