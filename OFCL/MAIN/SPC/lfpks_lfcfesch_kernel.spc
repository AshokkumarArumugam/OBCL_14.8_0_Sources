CREATE OR REPLACE PACKAGE  lfpks_lfcfesch_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lfpks_lfcfesch_kernel.spc
  **
  ** Module     : The ICCF
  ** 
...
END lfpks_lfcfesch_kernel;
/
CREATE OR REPLACE SYNONYM lfpkss_lfcfesch_kernel FOR lfpks_lfcfesch_kernel
/