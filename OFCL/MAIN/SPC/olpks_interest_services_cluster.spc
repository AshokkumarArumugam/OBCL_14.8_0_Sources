CREATE OR REPLACE PACKAGE olpks_interest_services_cluster AS
/*----------------------------------------------------------------------------------------------------
**
** File Name	: olpks_interest_services_cluster.spc
**
...
*/
  ...
  FUNCTION fn_post_compute_cosif_rate(
                                 ...
                                 p_rate            IN OUT lftbs_contract_interest.rate%TYPE) RETURN BOOLEAN;
  --Bug#34500369 ends
END olpks_interest_services_cluster;
/
CREATE OR REPLACE SYNONYM olpkss_interest_services_cluster FOR olpks_interest_services_cluster;
/