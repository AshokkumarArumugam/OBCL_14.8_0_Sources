CREATE OR REPLACE PACKAGE  olpks_oldmdaut_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldmdaut_main.spc
  **
...
TYPE ty_oldmdaut IS RECORD (
     ...
     v_contract_event_log__traut     oltb_contract_event_log%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldmdaut          IN OUT  olpks_oldmdaut_Main.Ty_oldmdaut,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_oldmdaut          IN olpks_oldmdaut_Main.Ty_oldmdaut,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldmdaut     IN  olpks_oldmdaut_Main.Ty_oldmdaut,
p_Prev_oldmdaut IN OUT  olpks_oldmdaut_Main.Ty_oldmdaut,
p_Wrk_oldmdaut      IN OUT  olpks_oldmdaut_Main.Ty_oldmdaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldmdaut     IN  olpks_oldmdaut_Main.Ty_oldmdaut,
p_Prev_oldmdaut     IN  olpks_oldmdaut_Main.Ty_oldmdaut,
p_Wrk_oldmdaut      IN OUT  olpks_oldmdaut_Main.Ty_oldmdaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldmdaut IN  olpks_oldmdaut_Main.Ty_oldmdaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldmdaut_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldmdaut_main FOR olpks_oldmdaut_main
/