CREATE OR REPLACE PACKAGE  olpks_oldedtrt_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldedtrt_kernel.spc
  **
...
END olpks_oldedtrt_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldedtrt_kernel FOR olpks_oldedtrt_kernel
/