CREATE OR REPLACE PACKAGE  olpks_oldrsaut_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldrsaut_main.spc
  **
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldrsaut          IN OUT  olpks_oldrsaut_Main.Ty_oldrsaut,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Wrk_oldrsaut IN  olpks_oldrsaut_Main.Ty_oldrsaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldrsaut_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldrsaut_main FOR olpks_oldrsaut_main
/