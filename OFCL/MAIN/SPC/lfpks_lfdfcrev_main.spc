CREATE OR REPLACE PACKAGE  lfpks_lfdfcrev_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lfpks_lfdfcrev_main.spc
  **
  ** Module     : The ICCF
  ** 
...
TYPE ty_tb_v_contract_fee__lfwcnf IS TABLE OF lftw_contract_fee%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lfdfcrev IS RECORD (
     v_oltbs_contract__olcnt     oltb_contract%ROWTYPE,
     v_contract_fee__lfwcnf    ty_tb_v_contract_fee__lfwcnf,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lfdfcrev          IN OUT  lfpks_lfdfcrev_Main.Ty_lfdfcrev,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_lfdfcrev          IN lfpks_lfdfcrev_Main.Ty_lfdfcrev,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lfdfcrev     IN  lfpks_lfdfcrev_Main.Ty_lfdfcrev,
p_Wrk_lfdfcrev      IN OUT  lfpks_lfdfcrev_Main.Ty_lfdfcrev,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lfdfcrev     IN  lfpks_lfdfcrev_Main.Ty_lfdfcrev,
p_Prev_lfdfcrev IN OUT  lfpks_lfdfcrev_Main.Ty_lfdfcrev,
p_Wrk_lfdfcrev      IN OUT  lfpks_lfdfcrev_Main.Ty_lfdfcrev,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lfdfcrev     IN  lfpks_lfdfcrev_Main.Ty_lfdfcrev,
p_Prev_lfdfcrev     IN  lfpks_lfdfcrev_Main.Ty_lfdfcrev,
p_Wrk_lfdfcrev      IN OUT  lfpks_lfdfcrev_Main.Ty_lfdfcrev,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lfdfcrev IN  lfpks_lfdfcrev_Main.Ty_lfdfcrev,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lfpks_lfdfcrev_main;
/
CREATE OR REPLACE SYNONYM lfpkss_lfdfcrev_main FOR lfpks_lfdfcrev_main
/