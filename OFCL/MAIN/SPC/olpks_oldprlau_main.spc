CREATE OR REPLACE PACKAGE  olpks_oldprlau_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldprlau_main.spc
  **
...
TYPE ty_tb_ltbs_payrecv_paid__multi IS TABLE OF oltb_payrecv_paid%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_oldprlau IS RECORD (
     v_oltbs_contract__payau     oltb_contract%ROWTYPE,
     v_contract_event_log__payau     oltb_contract_event_log%ROWTYPE,
     v_oltbs_payrecv_paid__multi    ty_tb_ltbs_payrecv_paid__multi,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldprlau          IN OUT  olpks_oldprlau_Main.Ty_oldprlau,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldprlau     IN  olpks_oldprlau_Main.Ty_oldprlau,
p_Prev_oldprlau     IN  olpks_oldprlau_Main.Ty_oldprlau,
p_Wrk_oldprlau      IN OUT  olpks_oldprlau_Main.Ty_oldprlau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldprlau IN  olpks_oldprlau_Main.Ty_oldprlau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldprlau_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldprlau_main FOR olpks_oldprlau_main
/