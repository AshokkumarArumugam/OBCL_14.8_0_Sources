CREATE OR REPLACE PACKAGE  olpks_oldvwmsg_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldvwmsg_kernel.spc
  **
  ** Module     : Messaging
  ** 
...
END olpks_oldvwmsg_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldvwmsg_kernel FOR olpks_oldvwmsg_kernel
/