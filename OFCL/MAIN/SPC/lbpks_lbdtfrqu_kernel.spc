CREATE OR REPLACE PACKAGE  lbpks_lbdtfrqu_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdtfrqu_kernel.spc
  **
...
END lbpks_lbdtfrqu_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdtfrqu_kernel FOR lbpks_lbdtfrqu_kernel
/