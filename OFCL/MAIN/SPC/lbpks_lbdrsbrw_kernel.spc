CREATE OR REPLACE PACKAGE  lbpks_lbdrsbrw_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdrsbrw_kernel.spc
  **
...
END lbpks_lbdrsbrw_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdrsbrw_kernel FOR lbpks_lbdrsbrw_kernel
/