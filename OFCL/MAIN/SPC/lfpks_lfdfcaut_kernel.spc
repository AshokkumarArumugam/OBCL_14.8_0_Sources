CREATE OR REPLACE PACKAGE  lfpks_lfdfcaut_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lfpks_lfdfcaut_kernel.spc
  **
  ** Module     : The ICCF
  ** 
...
END lfpks_lfdfcaut_kernel;
/
CREATE OR REPLACE SYNONYM lfpkss_lfdfcaut_kernel FOR lfpks_lfdfcaut_Kernel
/