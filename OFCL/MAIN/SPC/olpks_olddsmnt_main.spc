CREATE OR REPLACE PACKAGE  olpks_olddsmnt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_olddsmnt_main.spc
  **
...
TYPE ty_olddsmnt IS RECORD (
     v_lbtms_disclosure     lbtm_disclosure%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_olddsmnt_main;
/
CREATE OR REPLACE SYNONYM olpkss_olddsmnt_main FOR olpks_olddsmnt_main
/