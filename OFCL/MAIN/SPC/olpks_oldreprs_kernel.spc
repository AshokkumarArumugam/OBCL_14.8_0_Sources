CREATE OR REPLACE PACKAGE olpks_oldreprs_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldreprs_kernel.spc
  **
...
END olpks_oldreprs_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldreprs_kernel FOR olpks_oldreprs_kernel
/