CREATE OR REPLACE PACKAGE  olpks_oldratlg_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldratlg_main.spc
  **
...
TYPE ty_oldratlg IS RECORD (
     v_lftb_rate_fixing_days_log     lftb_rate_fixing_days_log%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldratlg          IN OUT  olpks_oldratlg_Main.Ty_oldratlg,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_oldratlg          IN olpks_oldratlg_Main.Ty_oldratlg,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldratlg     IN  olpks_oldratlg_Main.Ty_oldratlg,
p_Wrk_oldratlg      IN OUT  olpks_oldratlg_Main.Ty_oldratlg,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldratlg     IN  olpks_oldratlg_Main.Ty_oldratlg,
p_Prev_oldratlg IN OUT  olpks_oldratlg_Main.Ty_oldratlg,
p_Wrk_oldratlg      IN OUT  olpks_oldratlg_Main.Ty_oldratlg,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldratlg     IN  olpks_oldratlg_Main.Ty_oldratlg,
p_Prev_oldratlg     IN  olpks_oldratlg_Main.Ty_oldratlg,
p_Wrk_oldratlg      IN OUT  olpks_oldratlg_Main.Ty_oldratlg,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldratlg IN  olpks_oldratlg_Main.Ty_oldratlg,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldratlg_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldratlg_main FOR olpks_oldratlg_main
/