create or replace PACKAGE  olpks_oldudful_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldudful_kernel.spc
  **
...
END olpks_oldudful_kernel;
/
CREATE OR REPLACE Synonym olpkss_oldudful_kernel FOR olpks_oldudful_kernel
/