CREATE OR REPLACE PACKAGE  olpks_oldtrntp_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldtrntp_main.spc
  **
...
TYPE ty_oldtrntp IS RECORD (
     v_oltms_trn_type     oltm_trn_type%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldtrntp_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldtrntp_main FOR olpks_oldtrntp_main
/