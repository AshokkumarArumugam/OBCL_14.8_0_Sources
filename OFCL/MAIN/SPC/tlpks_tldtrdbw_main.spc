CREATE OR REPLACE PACKAGE  tlpks_tldtrdbw_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldtrdbw_main.spc
  **
...
TYPE ty_tb_v_oltbs_lt_fee IS TABLE OF oltb_lt_fee%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_tltbs_contract_exception IS TABLE OF tltb_contract_exception%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_tldtrdbw IS RECORD (
     v_oltbs_lt_trade     oltb_lt_trade%ROWTYPE,
     v_oltbs_lt_fee    ty_tb_v_oltbs_lt_fee,
     v_oltbs_lt_in_log     oltb_lt_in_log%ROWTYPE,
     v_tltbs_contract_exception    ty_tb_tltbs_contract_exception,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_tldtrdbw          IN OUT  tlpks_tldtrdbw_Main.Ty_tldtrdbw,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_tldtrdbw          IN tlpks_tldtrdbw_Main.Ty_tldtrdbw,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_tldtrdbw     IN  tlpks_tldtrdbw_Main.Ty_tldtrdbw,
p_Wrk_tldtrdbw      IN OUT  tlpks_tldtrdbw_Main.Ty_tldtrdbw,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_tldtrdbw     IN  tlpks_tldtrdbw_Main.Ty_tldtrdbw,
p_Prev_tldtrdbw IN OUT  tlpks_tldtrdbw_Main.Ty_tldtrdbw,
p_Wrk_tldtrdbw      IN OUT  tlpks_tldtrdbw_Main.Ty_tldtrdbw,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_tldtrdbw     IN  tlpks_tldtrdbw_Main.Ty_tldtrdbw,
p_Prev_tldtrdbw     IN  tlpks_tldtrdbw_Main.Ty_tldtrdbw,
p_Wrk_tldtrdbw      IN OUT  tlpks_tldtrdbw_Main.Ty_tldtrdbw,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_tldtrdbw IN  tlpks_tldtrdbw_Main.Ty_tldtrdbw,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tldtrdbw_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tldtrdbw_main FOR tlpks_tldtrdbw_main
/