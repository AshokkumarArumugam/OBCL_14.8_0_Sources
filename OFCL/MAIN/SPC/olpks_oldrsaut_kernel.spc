CREATE OR REPLACE PACKAGE olpks_oldrsaut_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldrsaut_kernel.spc
  **
...
END olpks_oldrsaut_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldrsaut_kernel FOR olpks_oldrsaut_kernel
/