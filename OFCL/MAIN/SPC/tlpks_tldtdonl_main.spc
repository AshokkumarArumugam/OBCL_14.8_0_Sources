CREATE OR REPLACE PACKAGE  tlpks_tldtdonl_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldtdonl_main.spc
  **
...
TYPE ty_tb_v_tltbs_orig_buy_fee_log IS TABLE OF tltb_orig_buy_fee_log%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_comm_redn_log__rnd_det IS TABLE OF tltb_comm_redn_log%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_tldtdonl IS RECORD (
     v_oltbs_contract     oltb_contract%ROWTYPE,
     v_tltbs_contract_master     tltb_contract_master%ROWTYPE,
     v_oltbs_contract_event_log     oltb_contract_event_log%ROWTYPE,
     v_tltbs_orig_buy_fee_log    ty_tb_v_tltbs_orig_buy_fee_log,
     v_tltbs_comm_redn_log     tltb_comm_redn_log%ROWTYPE,
     v_comm_redn_log__rnd_det    ty_tb_v_comm_redn_log__rnd_det,
     v_tlvws_trade_summary     tlvw_trade_summary%ROWTYPE,
                 ...
                 ty_tlcswonl Tlpks_Tlcswonl_Main.ty_tlcswonl,
                 ty_tlcfmemo Tlpks_Tlcfmemo_Main.ty_tlcfmemo,
                 ty_tlcfincn Tlpks_Tlcfincn_Main.ty_tlcfincn,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_tldtdonl          IN OUT  tlpks_tldtdonl_Main.Ty_tldtdonl,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_tldtdonl          IN tlpks_tldtdonl_Main.Ty_tldtdonl,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_tldtdonl     IN  tlpks_tldtdonl_Main.Ty_tldtdonl,
p_Wrk_tldtdonl      IN OUT  tlpks_tldtdonl_Main.Ty_tldtdonl,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_tldtdonl     IN  tlpks_tldtdonl_Main.Ty_tldtdonl,
p_Prev_tldtdonl IN OUT  tlpks_tldtdonl_Main.Ty_tldtdonl,
p_Wrk_tldtdonl      IN OUT  tlpks_tldtdonl_Main.Ty_tldtdonl,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_tldtdonl     IN  tlpks_tldtdonl_Main.Ty_tldtdonl,
p_Prev_tldtdonl     IN  tlpks_tldtdonl_Main.Ty_tldtdonl,
p_Wrk_tldtdonl      IN OUT  tlpks_tldtdonl_Main.Ty_tldtdonl,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_tldtdonl IN  tlpks_tldtdonl_Main.Ty_tldtdonl,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tldtdonl_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tldtdonl_main FOR tlpks_tldtdonl_main
/