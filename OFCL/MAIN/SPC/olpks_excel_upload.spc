CREATE OR REPLACE PACKAGE olpks_excel_upload AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_excel_upload.spc
  **
...
--OBCL_14.4_PAYRECVUPLD CHANGES End
  ...
  FUNCTION Fn_Tranche_Fee_Schedules(p_Function_Id          IN VARCHAR2,
                                    ...
                                    p_Tranche_Fee_Schedule IN olpks_excel_upload.Ty_Oltbs_Contract_Schedules,
                                    p_Ty_Err_Log           OUT olpks_excel_upload.Ty_Error_Code,
  ...
  FUNCTION Fn_Tranche_Schedules(p_Function_Id         IN VARCHAR2,
                                ...
                                p_Tranche_Schedule_In IN olpks_excel_upload.Ty_Lbtbs_Tranche_Schedule_Input,
                                p_Ty_Err_Log          OUT olpks_excel_upload.Ty_Error_Code,
                                p_Err_Code            IN OUT VARCHAR2,
                                p_Err_Params          IN OUT VARCHAR2)
    RETURN BOOLEAN;
  /*FUNCTION fn_fac_fee_schedules(p_contract_ref_no IN oltbs_contract_schedules.contract_ref_no%TYPE,
                  p_version_no      IN oltbs_contract_schedules.version_no%TYPE,
                  p_event_seq_no    IN oltbs_contract_schedules.event_seq_no%TYPE,
                  p_tb_text_line    IN olpks_excel_upload.tb_text_line,
  p_tb_err_log      OUT olpks_excel_upload.ty_error_code,
  ...
  FUNCTION Fn_Fee_Ratio_Schedules(p_Function_Id       IN VARCHAR2,
                                  ...
                                  p_Participant_Ratio IN olpks_excel_upload.Ty_Lbtbs_Participant_Ratio,
                                  p_Component_Amount  IN olpks_excel_upload.Ty_Participant_Comp_Amount,
                                  p_Ty_Err_Log        OUT olpks_excel_upload.Ty_Error_Code,
                                  p_Err_Code          IN OUT VARCHAR2,
                                  p_Err_Params        IN OUT VARCHAR2)
    RETURN BOOLEAN;
  ...
  FUNCTION fn_validate_schedule_dates(p_con_shd_table IN olpks_excel_upload.tb_fac_fee_shd,
                                      p_error_code    IN OUT VARCHAR2,
                                      p_error_param   IN OUT VARCHAR2) RETURN BOOLEAN; */
  ...
  FUNCTION Fn_Facility_Fee_Schedules(p_Function_Id           IN VARCHAR2,
                                     ...
                                     p_Version_No            IN Oltbs_Contract_Schedules.Version_No%TYPE,
                                     p_Event_Seq_No          IN Oltbs_Contract_Schedules.Event_Seq_No%TYPE,
                                     p_Facility_Fee_Schedule IN olpks_excel_upload.Ty_Oltbs_Contract_Schedules,
                                     p_Ty_Err_Log            OUT olpks_excel_upload.Ty_Error_Code,
                                     p_Err_Code              IN OUT VARCHAR2,
                                     p_Err_Params            IN OUT VARCHAR2)
    RETURN BOOLEAN;
  ...
  FUNCTION Fn_Upload_Principal_Schedule(p_Function_Id     IN VARCHAR2,
                                        p_Source          IN VARCHAR2,
                                        p_Reference_No    IN OLTBS_SCHEDULE_UPLOAD.Reference_No%TYPE,
                                        p_Processing_Date IN DATE,
                                        p_Branch_Code     IN VARCHAR2,
                                        p_Err_Table       IN OUT olpks_excel_upload.Ty_Error_Code,
                                        p_Error_Code      IN OUT VARCHAR2,
                                        p_Error_Param     IN OUT VARCHAR2)
    RETURN BOOLEAN;
...
--    OBCL_14.4_PAYRECVUPLD CHANGES Start
  FUNCTION Fn_Upload_Pay_Receivable(p_Function_Id     IN VARCHAR2,
                                    p_Source          IN VARCHAR2,
                                    p_Reference_No    IN OLTBS_PAY_RECV_UPLOAD.Reference_No%TYPE,
                                    p_Processing_Date IN DATE,
                                    p_Err_Table       IN OUT olpks_excel_upload.Ty_Error_Code,
                                    p_Error_Code      IN OUT VARCHAR2,
                                    p_Error_Param     IN OUT VARCHAR2)
...
--    OBCL_14.4_PAYRECVUPLD CHANGES End
  /*FUNCTION fn_upload_customer(  p_reference_no    IN sttms_cust_closure_upload.reference_no%TYPE,
                  p_processing_date IN DATE,
                  p_branch_code     IN VARCHAR2,
                  p_err_table     IN OUT olpks_excel_upload.tb_error,
                  p_error_code      IN OUT VARCHAR2,
                  p_error_param     IN OUT VARCHAR2) RETURN BOOLEAN;
...
END olpks_excel_upload;
/
CREATE OR REPLACE Synonym olpkss_excel_upload FOR olpks_excel_upload
/