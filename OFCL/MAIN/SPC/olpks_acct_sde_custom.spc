CREATE OR REPLACE PACKAGE olpks_acct_sde_custom IS
  ...
  **
  **************************************************************************************************
  **  PACKAGE Name      : olpks_acct_sde_custom
  **  File Name         : olpks_acct_sde_custom.SPC
  **  Module            : OL
  ...
  *************************************************************************************************/
  ...
  FUNCTION fn_post_get_total_schodue(pcontractrefno IN oltb_contract.contract_ref_no%TYPE,
                                           ...
                                           p_err_cd       IN OUT ertbs_msgs.err_code%TYPE)
    RETURN BOOLEAN;
END olpks_acct_sde_custom;
/
create or replace synonym olpkss_acct_sde_custom for olpks_acct_sde_custom
/