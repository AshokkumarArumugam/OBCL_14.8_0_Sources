CREATE OR REPLACE PACKAGE  lbpks_lbcprctr_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbcprctr_main.spc
  **
...
TYPE ty_tb_v_participant_transfer IS TABLE OF lbtb_participant_transfer%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_lbtbs_consol_transfer IS TABLE OF lbtb_consol_transfer%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbcprctr IS RECORD (
     v_participant_transfer    ty_tb_v_participant_transfer,
     v_oltbs_contract__processed     oltb_contract%ROWTYPE,
     v_lbtbs_consol_transfer    ty_tb_v_lbtbs_consol_transfer,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbcprctr          IN OUT  lbpks_lbcprctr_Main.Ty_lbcprctr,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Main_Function    IN  VARCHAR2,
p_lbcprctr       IN    lbpks_lbcprctr_Main.ty_lbcprctr,
...
p_Main_Function    IN  VARCHAR2,
p_lbcprctr     IN  lbpks_lbcprctr_Main.Ty_lbcprctr,
p_Prev_lbcprctr IN OUT  lbpks_lbcprctr_Main.Ty_lbcprctr,
p_Wrk_lbcprctr IN OUT  lbpks_lbcprctr_Main.Ty_lbcprctr,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbcprctr     IN  lbpks_lbcprctr_Main.Ty_lbcprctr,
p_Prev_lbcprctr     IN  lbpks_lbcprctr_Main.Ty_lbcprctr,
p_Wrk_lbcprctr      IN OUT  lbpks_lbcprctr_Main.Ty_lbcprctr,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbcprctr IN  lbpks_lbcprctr_Main.Ty_lbcprctr,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbcprctr_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbcprctr_main FOR lbpks_lbcprctr_main
/