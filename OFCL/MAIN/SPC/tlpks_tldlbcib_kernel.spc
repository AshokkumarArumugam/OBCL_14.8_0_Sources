CREATE OR REPLACE PACKAGE  tlpks_tldlbcib_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldlbcib_kernel.spc
  **
...
END tlpks_tldlbcib_kernel;
/
CREATE OR REPLACE SYNONYM tlpkss_tldlbcib_kernel FOR tlpks_tldlbcib_Kernel
/