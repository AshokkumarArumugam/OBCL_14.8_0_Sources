CREATE OR REPLACE PACKAGE  lbpks_lbcparat_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbcparat_main.spc
  **
...
TYPE ty_tb_v_contract_participant IS TABLE OF lbtb_contract_participant%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb__lbtbs_participant_ratio IS TABLE OF lbtb_participant_ratio%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_part_settle_curr_det IS TABLE OF lbtb_part_settle_curr_det%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_oltbs_contract_entity IS TABLE OF oltb_contract_entity%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_participant__multi1 IS TABLE OF lbtb_contract_participant%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_articipant_ratio__multi1 IS TABLE OF lbtb_participant_ratio%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_contract_part_ba_dtls IS TABLE OF lbtb_contract_part_ba_dtls%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbcparat IS RECORD (
     v_oltbs_contract__parat     oltb_contract%ROWTYPE,
     ...
     v_oltbs_contract_entity    ty_tb_v_oltbs_contract_entity,
     v_participant__multi1    ty_tb_v_participant__multi1,
     v_participant_ratio__multi1    ty_tb_articipant_ratio__multi1,
     v_contract_part_ba_dtls    ty_tb_v_contract_part_ba_dtls,
     v_oltbs_contract__ba     oltb_contract%ROWTYPE,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbcparat          IN OUT  lbpks_lbcparat_Main.Ty_lbcparat,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Main_Function    IN  VARCHAR2,
p_lbcparat       IN    lbpks_lbcparat_Main.ty_lbcparat,
...
p_Main_Function    IN  VARCHAR2,
p_lbcparat     IN  lbpks_lbcparat_Main.Ty_lbcparat,
p_Prev_lbcparat IN OUT  lbpks_lbcparat_Main.Ty_lbcparat,
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbcparat     IN  lbpks_lbcparat_Main.Ty_lbcparat,
p_Prev_lbcparat     IN  lbpks_lbcparat_Main.Ty_lbcparat,
p_Wrk_lbcparat      IN OUT  lbpks_lbcparat_Main.Ty_lbcparat,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbcparat_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbcparat_main FOR lbpks_lbcparat_main
/