CREATE OR REPLACE PACKAGE  tlpks_tldmtsau_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldmtsau_kernel.spc
  **
...
END tlpks_tldmtsau_kernel;
/
CREATE OR REPLACE SYNONYM tlpkss_tldmtsau_kernel FOR tlpks_tldmtsau_Kernel
/