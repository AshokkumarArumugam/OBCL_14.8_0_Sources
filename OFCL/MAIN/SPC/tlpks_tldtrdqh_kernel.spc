create or replace PACKAGE  tlpks_tldtrdqh_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldtrdqh_kernel.spc
  **
...
END tlpks_tldtrdqh_kernel;
/
CREATE OR REPLACE SYNONYM tlpkss_tldtrdqh_kernel FOR tlpks_tldtrdqh_kernel
/