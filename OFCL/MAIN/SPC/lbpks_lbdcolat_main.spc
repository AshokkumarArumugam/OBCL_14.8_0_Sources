CREATE OR REPLACE PACKAGE  lbpks_lbdcolat_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdcolat_main.spc
  **
...
TYPE ty_lbdcolat IS RECORD (
     v_tranche_coll_effdate     lbtm_tranche_coll_effdate%ROWTYPE,
...
FUNCTION Fn_Get_Key_Information (p_Source    IN  VARCHAR2, 
                        ...
                        p_Function_id       IN     VARCHAR2,
                        p_Action_Code       IN     VARCHAR2,
p_lbdcolat       IN  OUT lbpks_lbdcolat_Main.Ty_lbdcolat,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdcolat_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdcolat_main FOR lbpks_lbdcolat_main
/