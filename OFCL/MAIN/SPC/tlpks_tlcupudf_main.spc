CREATE OR REPLACE PACKAGE  tlpks_tlcupudf_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tlcupudf_main.spc
  **
...
TYPE ty_tb_v_userdef_fields__det IS TABLE OF tltb_upload_userdef_fields%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_tlcupudf IS RECORD (
     v_tltbs_upload_master__mast     tltb_upload_master%ROWTYPE,
     v_userdef_fields__det    ty_tb_v_userdef_fields__det,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_tlcupudf          IN OUT  tlpks_tlcupudf_Main.Ty_tlcupudf,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Main_Function    IN  VARCHAR2,
p_tlcupudf       IN    tlpks_tlcupudf_Main.ty_tlcupudf,
...
p_Main_Function    IN  VARCHAR2,
p_tlcupudf     IN  tlpks_tlcupudf_Main.Ty_tlcupudf,
p_Prev_tlcupudf IN OUT  tlpks_tlcupudf_Main.Ty_tlcupudf,
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_tlcupudf     IN  tlpks_tlcupudf_Main.Ty_tlcupudf,
p_Prev_tlcupudf     IN  tlpks_tlcupudf_Main.Ty_tlcupudf,
p_Wrk_tlcupudf      IN OUT  tlpks_tlcupudf_Main.Ty_tlcupudf,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_tlcupudf IN  tlpks_tlcupudf_Main.Ty_tlcupudf,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tlcupudf_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tlcupudf_main FOR tlpks_tlcupudf_main
/