CREATE OR REPLACE PACKAGE olpks_udf_upload_custom AS
  /*-----------------------------------------------------------------------------------------------------
    **
    ** File Name  : olpks_udf_upload_custom.spc
    **
...
END olpks_udf_upload_custom;
/
CREATE or REPLACE synonym olpkss_udf_upload_custom for olpks_udf_upload_custom
/