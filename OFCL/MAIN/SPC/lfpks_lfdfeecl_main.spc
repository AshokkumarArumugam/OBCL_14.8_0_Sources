CREATE OR REPLACE PACKAGE  lfpks_lfdfeecl_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lfpks_lfdfeecl_main.spc
  **
  ** Module     : The ICCF
  ** 
...
TYPE ty_lfdfeecl IS RECORD (
     v_oltms_class     oltm_class%ROWTYPE,
     v_lftms_fee_class     lftm_fee_class%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lfpks_lfdfeecl_main;
/
CREATE OR REPLACE SYNONYM lfpkss_lfdfeecl_main FOR lfpks_lfdfeecl_main
/