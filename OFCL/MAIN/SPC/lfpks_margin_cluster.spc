CREATE OR REPLACE PACKAGE lfpks_margin_cluster AS
/*-----------------------------------------------------------------------------------
**
** File Name	: lfpks_margin_cluster.SPC
**
...
END lfpks_margin_cluster;
/
CREATE or replace SYNONYM lfpkss_margin_cluster FOR lfpks_margin_cluster
/