CREATE OR REPLACE PACKAGE  tlpks_tldtdonl_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldtdonl_kernel.spc
  **
...
END tlpks_tldtdonl_kernel;
/
CREATE OR REPLACE SYNONYM tlpkss_tldtdonl_kernel FOR tlpks_tldtdonl_kernel
/