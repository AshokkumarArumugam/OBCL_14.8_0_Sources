CREATE OR REPLACE PACKAGE  olpks_oldcdays_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldcdays_main.spc
  **
...
TYPE ty_oldcdays IS RECORD (
     v_oltms_brn_ccy_msg_days     oltm_brn_ccy_msg_days%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldcdays_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldcdays_main FOR olpks_oldcdays_main
/