CREATE OR REPLACE PACKAGE  olpks_oldpnwau_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldpnwau_main.spc
  **
...
TYPE ty_oldpnwau IS RECORD (
     v_contract_event_log__sp     oltb_contract_event_log%ROWTYPE,
     v_oltbs_contract     oltb_contract%ROWTYPE,
     v_contract_penalty_waiver     oltb_contract_penalty_waiver%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldpnwau          IN OUT  olpks_oldpnwau_Main.Ty_oldpnwau,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldpnwau     IN  olpks_oldpnwau_Main.Ty_oldpnwau,
p_Prev_oldpnwau IN OUT  olpks_oldpnwau_Main.Ty_oldpnwau,
p_Wrk_oldpnwau      IN OUT  olpks_oldpnwau_Main.Ty_oldpnwau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldpnwau     IN  olpks_oldpnwau_Main.Ty_oldpnwau,
p_Prev_oldpnwau     IN  olpks_oldpnwau_Main.Ty_oldpnwau,
p_Wrk_oldpnwau      IN OUT  olpks_oldpnwau_Main.Ty_oldpnwau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldpnwau IN  olpks_oldpnwau_Main.Ty_oldpnwau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldpnwau_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldpnwau_main FOR olpks_oldpnwau_main
/