CREATE OR REPLACE PACKAGE  tlpks_tlctrent_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tlctrent_main.spc
  **
  ** Module     : TL
  ** 
...
TYPE ty_tb_v_tltb_borrower_entities IS TABLE OF tltb_borrower_entities%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_tlctrent IS RECORD (
     v_tltb_contract_master__ent     tltb_contract_master%ROWTYPE,
     v_tltb_borrower_entities    ty_tb_v_tltb_borrower_entities,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_tlctrent          IN OUT  tlpks_tlctrent_Main.Ty_tlctrent,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Main_Function    IN  VARCHAR2,
p_tlctrent       IN    tlpks_tlctrent_Main.ty_tlctrent,
...
p_Main_Function    IN  VARCHAR2,
p_tlctrent     IN  tlpks_tlctrent_Main.Ty_tlctrent,
p_Prev_tlctrent IN OUT  tlpks_tlctrent_Main.Ty_tlctrent,
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_tlctrent     IN  tlpks_tlctrent_Main.Ty_tlctrent,
p_Prev_tlctrent     IN  tlpks_tlctrent_Main.Ty_tlctrent,
p_Wrk_tlctrent      IN OUT  tlpks_tlctrent_Main.Ty_tlctrent,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_tlctrent IN  tlpks_tlctrent_Main.Ty_tlctrent,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tlctrent_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tlctrent_main FOR tlpks_tlctrent_main
/