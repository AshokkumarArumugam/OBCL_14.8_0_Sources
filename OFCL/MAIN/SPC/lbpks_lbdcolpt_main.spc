CREATE OR REPLACE PACKAGE  lbpks_lbdcolpt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdcolpt_main.spc
  **
...
TYPE ty_tb_v_lbtbs_coll_participant IS TABLE OF lbtb_coll_participant%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbdcolpt IS RECORD (
     v_oltbs_contract     oltb_contract%ROWTYPE,
     v_lbtbs_coll_participant    ty_tb_v_lbtbs_coll_participant,
     v_oltbs_contract_event_log     oltb_contract_event_log%ROWTYPE,
     v_lbvw_coll_participant     lbvw_coll_participant%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdcolpt          IN OUT  lbpks_lbdcolpt_Main.Ty_lbdcolpt,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_lbdcolpt          IN lbpks_lbdcolpt_Main.Ty_lbdcolpt,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdcolpt     IN  lbpks_lbdcolpt_Main.Ty_lbdcolpt,
p_Wrk_lbdcolpt      IN OUT  lbpks_lbdcolpt_Main.Ty_lbdcolpt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdcolpt     IN  lbpks_lbdcolpt_Main.Ty_lbdcolpt,
p_Prev_lbdcolpt IN OUT  lbpks_lbdcolpt_Main.Ty_lbdcolpt,
p_Wrk_lbdcolpt      IN OUT  lbpks_lbdcolpt_Main.Ty_lbdcolpt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbdcolpt     IN  lbpks_lbdcolpt_Main.Ty_lbdcolpt,
p_Prev_lbdcolpt     IN  lbpks_lbdcolpt_Main.Ty_lbdcolpt,
p_Wrk_lbdcolpt      IN OUT  lbpks_lbdcolpt_Main.Ty_lbdcolpt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbdcolpt IN  lbpks_lbdcolpt_Main.Ty_lbdcolpt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdcolpt_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdcolpt_main FOR lbpks_lbdcolpt_main
/