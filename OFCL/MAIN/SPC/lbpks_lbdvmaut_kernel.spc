CREATE OR REPLACE PACKAGE  lbpks_lbdvmaut_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdvmaut_kernel.spc
  **
...
END lbpks_lbdvmaut_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdvmaut_kernel FOR lbpks_lbdvmaut_kernel
/