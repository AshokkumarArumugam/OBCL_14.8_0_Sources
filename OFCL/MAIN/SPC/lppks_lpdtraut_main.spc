CREATE OR REPLACE PACKAGE  lppks_lpdtraut_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lppks_lpdtraut_main.spc
  **
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lpdtraut          IN OUT  lppks_lpdtraut_Main.Ty_lpdtraut,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lpdtraut     IN  lppks_lpdtraut_Main.Ty_lpdtraut,
p_Prev_lpdtraut IN OUT  lppks_lpdtraut_Main.Ty_lpdtraut,
p_Wrk_lpdtraut      IN OUT  lppks_lpdtraut_Main.Ty_lpdtraut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Wrk_lpdtraut IN  lppks_lpdtraut_Main.Ty_lpdtraut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lppks_lpdtraut_main;
/
CREATE OR REPLACE SYNONYM lppkss_lpdtraut_main FOR lppks_lpdtraut_main
/