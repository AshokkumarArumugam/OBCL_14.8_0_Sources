CREATE OR REPLACE PACKAGE  olpks_oldtraut_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldtraut_main.spc
  **
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldtraut          IN OUT  olpks_oldtraut_Main.Ty_oldtraut,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldtraut     IN  olpks_oldtraut_Main.Ty_oldtraut,
p_Prev_oldtraut IN OUT  olpks_oldtraut_Main.Ty_oldtraut,
p_Wrk_oldtraut      IN OUT  olpks_oldtraut_Main.Ty_oldtraut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldtraut     IN  olpks_oldtraut_Main.Ty_oldtraut,
p_Prev_oldtraut     IN  olpks_oldtraut_Main.Ty_oldtraut,
p_Wrk_oldtraut      IN OUT  olpks_oldtraut_Main.Ty_oldtraut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldtraut IN  olpks_oldtraut_Main.Ty_oldtraut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldtraut_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldtraut_main FOR olpks_oldtraut_main
/