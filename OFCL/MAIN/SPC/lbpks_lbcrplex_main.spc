CREATE OR REPLACE PACKAGE  lbpks_lbcrplex_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbcrplex_main.spc
  **
...
TYPE ty_lbcrplex IS RECORD (
     v_partial_roll_exrate_fix     lbtb_partial_roll_exrate_fix%ROWTYPE,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbcrplex          IN OUT  lbpks_lbcrplex_Main.Ty_lbcrplex,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbcrplex     IN  lbpks_lbcrplex_Main.Ty_lbcrplex,
p_Prev_lbcrplex     IN  lbpks_lbcrplex_Main.Ty_lbcrplex,
p_Wrk_lbcrplex      IN OUT  lbpks_lbcrplex_Main.Ty_lbcrplex,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbcrplex IN  lbpks_lbcrplex_Main.Ty_lbcrplex,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbcrplex_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbcrplex_main FOR lbpks_lbcrplex_main
/