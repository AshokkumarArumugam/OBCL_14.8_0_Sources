CREATE OR REPLACE PACKAGE  lbpks_lbdtarmt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdtarmt_main.spc
  **
...
TYPE ty_tb_v_tax_remittance_detail IS TABLE OF txtb_tax_remittance_detail%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbdtarmt IS RECORD (
     v_tax_remittance_master     txtb_tax_remittance_master%ROWTYPE,
     v_tax_remittance_detail    ty_tb_v_tax_remittance_detail,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdtarmt          IN OUT  lbpks_lbdtarmt_Main.Ty_lbdtarmt,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_lbdtarmt          IN lbpks_lbdtarmt_Main.Ty_lbdtarmt,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdtarmt     IN  lbpks_lbdtarmt_Main.Ty_lbdtarmt,
p_Wrk_lbdtarmt      IN OUT  lbpks_lbdtarmt_Main.Ty_lbdtarmt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdtarmt     IN  lbpks_lbdtarmt_Main.Ty_lbdtarmt,
p_Prev_lbdtarmt IN OUT  lbpks_lbdtarmt_Main.Ty_lbdtarmt,
p_Wrk_lbdtarmt      IN OUT  lbpks_lbdtarmt_Main.Ty_lbdtarmt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbdtarmt     IN  lbpks_lbdtarmt_Main.Ty_lbdtarmt,
p_Prev_lbdtarmt     IN  lbpks_lbdtarmt_Main.Ty_lbdtarmt,
p_Wrk_lbdtarmt      IN OUT  lbpks_lbdtarmt_Main.Ty_lbdtarmt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbdtarmt IN  lbpks_lbdtarmt_Main.Ty_lbdtarmt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdtarmt_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdtarmt_main FOR lbpks_lbdtarmt_main
/