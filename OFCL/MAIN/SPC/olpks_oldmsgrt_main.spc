CREATE OR REPLACE PACKAGE  olpks_oldmsgrt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldmsgrt_main.spc
  **
...
TYPE ty_oldmsgrt IS RECORD (
     v_sytbs_smtb_msgs_rights     sytb_smtb_msgs_rights%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldmsgrt_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldmsgrt_main FOR olpks_oldmsgrt_main
/