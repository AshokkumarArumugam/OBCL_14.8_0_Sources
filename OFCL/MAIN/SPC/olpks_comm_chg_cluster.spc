CREATE OR REPLACE PACKAGE olpks_comm_chg_cluster AS
/*----------------------------------------------------------------------------------------------------
**
** File Name	: olpks_comm_chg_cluster.SPC
**
...
END olpks_comm_chg_cluster;
/


CREATE or replace SYNONYM olpkss_comm_chg_cluster FOR olpks_comm_chg_cluster
/