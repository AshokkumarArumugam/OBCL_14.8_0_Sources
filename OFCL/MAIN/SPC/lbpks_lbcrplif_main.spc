CREATE OR REPLACE PACKAGE  lbpks_lbcrplif_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbcrplif_main.spc
  **
...
TYPE ty_lbcrplif IS RECORD (
     v_partial_roll_intrate_fix     lbtb_partial_roll_intrate_fix%ROWTYPE,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbcrplif          IN OUT  lbpks_lbcrplif_Main.Ty_lbcrplif,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbcrplif     IN  lbpks_lbcrplif_Main.Ty_lbcrplif,
p_Prev_lbcrplif     IN  lbpks_lbcrplif_Main.Ty_lbcrplif,
p_Wrk_lbcrplif      IN OUT  lbpks_lbcrplif_Main.Ty_lbcrplif,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbcrplif IN  lbpks_lbcrplif_Main.Ty_lbcrplif,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbcrplif_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbcrplif_main FOR lbpks_lbcrplif_main
/