CREATE OR REPLACE PACKAGE  lbpks_lbdrsaut_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdrsaut_kernel.spc
  **
  ...
  ** India
  ...
  Date               : 12-Dec-2022
  Change Description : Bug#34880545
  Search String      : Bug#34880545
  -------------------------------------------------------------------------------------------------------
  */
  
 g_reprice_flg VARCHAr2(1 CHAR):= 'N';--Bug#34880545
...
p_lbdrsaut     IN  OUT lbpks_lbdrsaut_Main.Ty_lbdrsaut,
...
END lbpks_lbdrsaut_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdrsaut_kernel FOR lbpks_lbdrsaut_kernel
/