CREATE OR REPLACE PACKAGE  lfpks_lfcfesch_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lfpks_lfcfesch_main.spc
  **
  ** Module     : The ICCF
  ** 
...
TYPE ty_tb_ontract_schedules__multi IS TABLE OF oltb_contract_schedules%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_lbvws_schedule_summary IS TABLE OF lbvw_schedule_summary%ROWTYPE INDEX BY BINARY_INTEGER;
...
TYPE ty_tb_ftbs_contract_fee__fesch IS TABLE OF lftb_contract_fee%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb__fas91_fee_master__fesch IS TABLE OF lftb_fas91_fee_master%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_paybydt_schedule_summary IS TABLE OF lbvw_paybydt_schedule_summary%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lfcfesch IS RECORD (
     v_contract_schedules__fesch     oltb_contract_schedules%ROWTYPE,
     v_contract_schedules__multi    ty_tb_ontract_schedules__multi,
     v_lbvws_schedule_summary    ty_tb_v_lbvws_schedule_summary,
     v_oltbs_amount_due    ty_tb_v_oltbs_amount_due,
     v_olvws_amount_settled    ty_tb_v_olvws_amount_settled,
     v_syndication_master__fesch     lbtb_syndication_master%ROWTYPE,
     v_lftbs_contract_fee__fesch    ty_tb_ftbs_contract_fee__fesch,
     v_fas91_fee_master__fesch    ty_tb__fas91_fee_master__fesch,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lfcfesch          IN OUT  lfpks_lfcfesch_Main.Ty_lfcfesch,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Main_Function    IN  VARCHAR2,
p_lfcfesch     IN  lfpks_lfcfesch_Main.Ty_lfcfesch,
p_Prev_lfcfesch IN OUT  lfpks_lfcfesch_Main.Ty_lfcfesch,
...
p_Wrk_lfcfesch IN  lfpks_lfcfesch_Main.Ty_lfcfesch,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lfpks_lfcfesch_main;
/
CREATE OR REPLACE SYNONYM lfpkss_lfcfesch_main FOR lfpks_lfcfesch_main
/