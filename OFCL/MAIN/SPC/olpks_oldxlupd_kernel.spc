CREATE OR REPLACE PACKAGE  olpks_oldxlupd_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldxlupd_kernel.spc
  **
...
END olpks_oldxlupd_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldxlupd_kernel FOR olpks_oldxlupd_kernel
/