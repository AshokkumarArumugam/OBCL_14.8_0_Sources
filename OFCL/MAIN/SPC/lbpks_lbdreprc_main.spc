CREATE OR REPLACE PACKAGE  lbpks_lbdreprc_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdreprc_main.spc
  **
...
p_Wrk_lbdreprc IN  lbpks_lbdreprc_Main.Ty_lbdreprc,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdreprc_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdreprc_main FOR lbpks_lbdreprc_main
/