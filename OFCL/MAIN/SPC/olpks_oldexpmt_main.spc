CREATE OR REPLACE PACKAGE  olpks_oldexpmt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldexpmt_main.spc
  **
...
TYPE ty_oldexpmt IS RECORD (
     v_oltbs_extpmt_res_master     oltb_extpmt_res_master%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldexpmt_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldexpmt_main FOR olpks_oldexpmt_main
/