CREATE OR REPLACE PACKAGE  olpks_oldxlupd_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldxlupd_main.spc
  **
...
TYPE ty_tb__oltbs_upload_adjustment IS TABLE OF oltb_upload_adjustment%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_oldxlupd IS RECORD (
     v_oltbs_upload_xldtls     oltb_upload_xldtls%ROWTYPE,
     v_oltbs_upload_adjustment    ty_tb__oltbs_upload_adjustment,
     v_upload_adj_exception     oltb_upload_adj_exception%ROWTYPE,
                 ty_olceronl Olpks_Olceronl_Main.ty_olceronl,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldxlupd          IN OUT  olpks_oldxlupd_Main.Ty_oldxlupd,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_oldxlupd          IN olpks_oldxlupd_Main.Ty_oldxlupd,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldxlupd     IN  olpks_oldxlupd_Main.Ty_oldxlupd,
p_Wrk_oldxlupd      IN OUT  olpks_oldxlupd_Main.Ty_oldxlupd,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldxlupd     IN  olpks_oldxlupd_Main.Ty_oldxlupd,
p_Prev_oldxlupd IN OUT  olpks_oldxlupd_Main.Ty_oldxlupd,
p_Wrk_oldxlupd      IN OUT  olpks_oldxlupd_Main.Ty_oldxlupd,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldxlupd     IN  olpks_oldxlupd_Main.Ty_oldxlupd,
p_Prev_oldxlupd     IN  olpks_oldxlupd_Main.Ty_oldxlupd,
p_Wrk_oldxlupd      IN OUT  olpks_oldxlupd_Main.Ty_oldxlupd,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldxlupd IN  olpks_oldxlupd_Main.Ty_oldxlupd,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldxlupd_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldxlupd_main FOR olpks_oldxlupd_main
/