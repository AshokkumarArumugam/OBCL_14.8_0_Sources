CREATE OR REPLACE PACKAGE  olpks_oldintdt_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldintdt_kernel.spc
  **
...
END olpks_oldintdt_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldintdt_kernel FOR olpks_oldintdt_Kernel
/