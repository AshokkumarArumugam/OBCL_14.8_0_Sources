CREATE OR REPLACE PACKAGE  tlpks_tldorgqu_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldorgqu_kernel.spc
  **
...
END tlpks_tldorgqu_kernel;
/
CREATE OR REPLACE SYNONYM tlpkss_tldorgqu_kernel FOR tlpks_tldorgqu_kernel
/