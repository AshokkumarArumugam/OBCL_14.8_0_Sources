CREATE OR REPLACE PACKAGE  olpks_olctrent_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_olctrent_main.spc
  **
...
TYPE ty_tb__oltbs_borrower_entities IS TABLE OF oltb_borrower_entities%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_olctrent IS RECORD (
     v_oltbs_contract_master     oltb_contract_master%ROWTYPE,
     v_oltbs_borrower_entities    ty_tb__oltbs_borrower_entities,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_olctrent          IN OUT  olpks_olctrent_Main.Ty_olctrent,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Main_Function    IN  VARCHAR2,
p_olctrent       IN    olpks_olctrent_Main.ty_olctrent,
...
p_Main_Function    IN  VARCHAR2,
p_olctrent     IN  olpks_olctrent_Main.Ty_olctrent,
p_Prev_olctrent IN OUT  olpks_olctrent_Main.Ty_olctrent,
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_olctrent     IN  olpks_olctrent_Main.Ty_olctrent,
p_Prev_olctrent     IN  olpks_olctrent_Main.Ty_olctrent,
p_Wrk_olctrent      IN OUT  olpks_olctrent_Main.Ty_olctrent,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_olctrent IN  olpks_olctrent_Main.Ty_olctrent,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_olctrent_main;
/
CREATE OR REPLACE SYNONYM olpkss_olctrent_main FOR olpks_olctrent_main
/