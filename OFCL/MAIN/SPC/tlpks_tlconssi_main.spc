CREATE OR REPLACE PACKAGE  tlpks_tlconssi_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tlconssi_main.spc
  **
...
TYPE ty_tb_contract_curr_det__agent IS TABLE OF tltb_contract_curr_det%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_curr_det__counterparty IS TABLE OF tltb_contract_curr_det%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_tlconssi IS RECORD (
     v_oltbs_contract__ssi     oltb_contract%ROWTYPE,
     v_tltbs_contract_master     tltb_contract_master%ROWTYPE,
     v_contract_curr_det__agent    ty_tb_contract_curr_det__agent,
     v_curr_det__counterparty    ty_tb_v_curr_det__counterparty,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_tlconssi          IN OUT  tlpks_tlconssi_Main.Ty_tlconssi,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Main_Function    IN  VARCHAR2,
p_tlconssi     IN  tlpks_tlconssi_Main.Ty_tlconssi,
p_Prev_tlconssi IN OUT  tlpks_tlconssi_Main.Ty_tlconssi,
...
p_Wrk_tlconssi IN  tlpks_tlconssi_Main.Ty_tlconssi,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tlconssi_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tlconssi_main FOR tlpks_tlconssi_main
/