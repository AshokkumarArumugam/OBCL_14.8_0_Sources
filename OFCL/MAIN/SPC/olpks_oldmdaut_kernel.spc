CREATE OR REPLACE PACKAGE  olpks_oldmdaut_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldmdaut_kernel.spc
  **
...
END olpks_oldmdaut_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldmdaut_kernel FOR olpks_oldmdaut_Kernel
/