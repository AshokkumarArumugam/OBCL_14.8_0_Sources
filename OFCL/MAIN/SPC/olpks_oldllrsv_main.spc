CREATE OR REPLACE PACKAGE  olpks_oldllrsv_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldllrsv_main.spc
  **
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldllrsv          IN OUT  olpks_oldllrsv_Main.Ty_oldllrsv,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldllrsv     IN  olpks_oldllrsv_Main.Ty_oldllrsv,
p_Prev_oldllrsv IN OUT  olpks_oldllrsv_Main.Ty_oldllrsv,
p_Wrk_oldllrsv      IN OUT  olpks_oldllrsv_Main.Ty_oldllrsv,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Wrk_oldllrsv IN  olpks_oldllrsv_Main.Ty_oldllrsv,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldllrsv_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldllrsv_main FOR olpks_oldllrsv_main
/