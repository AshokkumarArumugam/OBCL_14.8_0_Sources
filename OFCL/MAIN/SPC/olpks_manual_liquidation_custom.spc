create or replace package olpks_manual_liquidation_custom is
  /*----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_manual_liquidation_custom.spc
  **
  ** Module   : OL
  **
...
end olpks_manual_liquidation_custom;
/
CREATE OR REPLACE SYNONYM olpkss_manual_liquidation_custom FOR olpks_manual_liquidation_custom
/