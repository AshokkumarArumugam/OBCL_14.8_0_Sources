CREATE OR REPLACE PACKAGE olpks_olcvwmsg_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_olcvwmsg_kernel.spc
  **
  ** Module     : Messaging
  **
...
END olpks_olcvwmsg_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_olcvwmsg_kernel for olpks_olcvwmsg_kernel
/