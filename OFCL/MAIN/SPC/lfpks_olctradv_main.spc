CREATE OR REPLACE PACKAGE  lfpks_olctradv_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lfpks_olctradv_main.spc
  **
  ** Module     : The ICCF
  ** 
...
TYPE ty_tb_ntract_event_advice__adv IS TABLE OF oltb_contract_event_advice%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_olctradv IS RECORD (
     v_oltbs_contract__adv     oltb_contract%ROWTYPE,
     v_ontract_event_advice__adv    ty_tb_ntract_event_advice__adv,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_olctradv          IN OUT  lfpks_olctradv_Main.Ty_olctradv,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Main_Function    IN  VARCHAR2,
p_olctradv       IN    lfpks_olctradv_Main.ty_olctradv,
...
p_Main_Function    IN  VARCHAR2,
p_olctradv     IN  lfpks_olctradv_Main.Ty_olctradv,
p_Prev_olctradv IN OUT  lfpks_olctradv_Main.Ty_olctradv,
p_Wrk_olctradv IN OUT  lfpks_olctradv_Main.Ty_olctradv,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_olctradv     IN  lfpks_olctradv_Main.Ty_olctradv,
p_Prev_olctradv     IN  lfpks_olctradv_Main.Ty_olctradv,
p_Wrk_olctradv      IN OUT  lfpks_olctradv_Main.Ty_olctradv,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_olctradv IN  lfpks_olctradv_Main.Ty_olctradv,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lfpks_olctradv_main;
/
CREATE OR REPLACE SYNONYM lfpkss_olctradv_main FOR lfpks_olctradv_main
/