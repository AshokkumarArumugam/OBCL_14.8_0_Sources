CREATE OR REPLACE PACKAGE olpks_amortise_cluster AS
/*----------------------------------------------------------------------------------------------------
**
** File Name	: olpks_amortise_cluster.SPC
**
...
END olpks_amortise_cluster;
/


CREATE or replace SYNONYM olpkss_amortise_cluster FOR olpks_amortise_cluster
/