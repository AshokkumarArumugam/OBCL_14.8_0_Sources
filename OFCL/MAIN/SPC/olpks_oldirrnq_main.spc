CREATE OR REPLACE PACKAGE  olpks_oldirrnq_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldirrnq_main.spc
  **
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldirrnq          IN OUT  olpks_oldirrnq_Main.Ty_oldirrnq,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldirrnq     IN  olpks_oldirrnq_Main.Ty_oldirrnq,
p_Prev_oldirrnq IN OUT  olpks_oldirrnq_Main.Ty_oldirrnq,
p_Wrk_oldirrnq      IN OUT  olpks_oldirrnq_Main.Ty_oldirrnq,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Wrk_oldirrnq IN  olpks_oldirrnq_Main.Ty_oldirrnq,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldirrnq_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldirrnq_main FOR olpks_oldirrnq_main
/