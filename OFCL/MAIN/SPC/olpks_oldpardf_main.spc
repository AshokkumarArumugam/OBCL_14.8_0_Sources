CREATE OR REPLACE PACKAGE  olpks_oldpardf_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldpardf_main.spc
  **
...
TYPE ty_oldpardf IS RECORD (
     v_oltms_party_type_defn     oltm_party_type_defn%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldpardf_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldpardf_main FOR olpks_oldpardf_main
/