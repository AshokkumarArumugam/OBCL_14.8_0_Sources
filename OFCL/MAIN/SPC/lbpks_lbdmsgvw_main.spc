CREATE OR REPLACE PACKAGE  lbpks_lbdmsgvw_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdmsgvw_main.spc
  **
...
TYPE ty_tb_v_olvws_part_dly_msg_out IS TABLE OF olvw_part_dly_msg_out%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbdmsgvw IS RECORD (
     v_oltbs_contract_event_log     oltb_contract_event_log%ROWTYPE,
     v_oltbs_dly_msg_out    ty_tb_v_oltbs_dly_msg_out,
     v_olvws_part_dly_msg_out    ty_tb_v_olvws_part_dly_msg_out,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdmsgvw          IN OUT  lbpks_lbdmsgvw_Main.Ty_lbdmsgvw,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_lbdmsgvw          IN lbpks_lbdmsgvw_Main.Ty_lbdmsgvw,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdmsgvw     IN  lbpks_lbdmsgvw_Main.Ty_lbdmsgvw,
p_Wrk_lbdmsgvw      IN OUT  lbpks_lbdmsgvw_Main.Ty_lbdmsgvw,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdmsgvw     IN  lbpks_lbdmsgvw_Main.Ty_lbdmsgvw,
p_Prev_lbdmsgvw IN OUT  lbpks_lbdmsgvw_Main.Ty_lbdmsgvw,
p_Wrk_lbdmsgvw      IN OUT  lbpks_lbdmsgvw_Main.Ty_lbdmsgvw,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbdmsgvw     IN  lbpks_lbdmsgvw_Main.Ty_lbdmsgvw,
p_Prev_lbdmsgvw     IN  lbpks_lbdmsgvw_Main.Ty_lbdmsgvw,
p_Wrk_lbdmsgvw      IN OUT  lbpks_lbdmsgvw_Main.Ty_lbdmsgvw,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbdmsgvw IN  lbpks_lbdmsgvw_Main.Ty_lbdmsgvw,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdmsgvw_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdmsgvw_main FOR lbpks_lbdmsgvw_main
/