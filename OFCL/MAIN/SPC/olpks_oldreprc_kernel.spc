CREATE OR REPLACE PACKAGE olpks_oldreprc_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldreprc_kernel.spc
  **
  ...
  */
  ...
  FUNCTION Fn_Post_Query(p_Source           IN VARCHAR2,
                         ...
                         p_Err_Code         IN OUT VARCHAR2,
                         p_Err_Params       IN OUT VARCHAR2) RETURN BOOLEAN;
END olpks_oldreprc_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldreprc_kernel FOR olpks_oldreprc_kernel
/