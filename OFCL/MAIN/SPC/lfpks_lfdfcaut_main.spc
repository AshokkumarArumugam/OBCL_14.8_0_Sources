CREATE OR REPLACE PACKAGE  lfpks_lfdfcaut_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lfpks_lfdfcaut_main.spc
  **
  ** Module     : The ICCF
  ** 
...
TYPE ty_tb_v_contract_fee__lwcfaut IS TABLE OF lftw_contract_fee%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lfdfcaut IS RECORD (
     v_oltbs_contract__olcaut     oltb_contract%ROWTYPE,
     v_ntract_event_log__olelaut     oltb_contract_event_log%ROWTYPE,
     v_contract_fee__lwcfaut    ty_tb_v_contract_fee__lwcfaut,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lfdfcaut          IN OUT  lfpks_lfdfcaut_Main.Ty_lfdfcaut,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_lfdfcaut          IN lfpks_lfdfcaut_Main.Ty_lfdfcaut,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lfdfcaut     IN  lfpks_lfdfcaut_Main.Ty_lfdfcaut,
p_Wrk_lfdfcaut      IN OUT  lfpks_lfdfcaut_Main.Ty_lfdfcaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lfdfcaut     IN  lfpks_lfdfcaut_Main.Ty_lfdfcaut,
p_Prev_lfdfcaut IN OUT  lfpks_lfdfcaut_Main.Ty_lfdfcaut,
p_Wrk_lfdfcaut      IN OUT  lfpks_lfdfcaut_Main.Ty_lfdfcaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lfdfcaut     IN  lfpks_lfdfcaut_Main.Ty_lfdfcaut,
p_Prev_lfdfcaut     IN  lfpks_lfdfcaut_Main.Ty_lfdfcaut,
p_Wrk_lfdfcaut      IN OUT  lfpks_lfdfcaut_Main.Ty_lfdfcaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lfdfcaut IN  lfpks_lfdfcaut_Main.Ty_lfdfcaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lfpks_lfdfcaut_main;
/
CREATE OR REPLACE SYNONYM lfpkss_lfdfcaut_main FOR lfpks_lfdfcaut_main
/