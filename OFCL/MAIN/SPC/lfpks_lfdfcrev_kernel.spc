CREATE OR REPLACE PACKAGE lfpks_lfdfcrev_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lfpks_lfdfcrev_kernel.spc
  **
  ** Module     : The ICCF
  **
...
FUNCTION Fn_Backup(  p_Contract_Ref_No IN OUT VARCHAR2,
                     p_Err_Code   IN OUT varchar2,
                     p_Err_Params  IN OUT varchar2) 
RETURN BOOLEAN; 
