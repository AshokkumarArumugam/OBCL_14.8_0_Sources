CREATE OR REPLACE PACKAGE Olpks_Oldffmat_Kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldffmat_kernel.spc
  **
...
END Olpks_Oldffmat_Kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldffmat_kernel FOR olpks_oldffmat_Kernel
/