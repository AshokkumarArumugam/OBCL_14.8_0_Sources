CREATE OR REPLACE PACKAGE  olpks_oldpsupl_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldpsupl_kernel.spc
  **
...
END olpks_oldpsupl_kernel;
/
CREATE OR REPLACE Synonym olpkss_oldpsupl_kernel FOR olpks_oldpsupl_kernel
/