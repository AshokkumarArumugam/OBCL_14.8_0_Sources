CREATE OR REPLACE PACKAGE  tlpks_tldcfdet_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldcfdet_kernel.spc
  **
...
END tlpks_tldcfdet_kernel;
/
CREATE OR REPLACE SYNONYM tlpkss_tldcfdet_kernel FOR tlpks_tldcfdet_Kernel
/