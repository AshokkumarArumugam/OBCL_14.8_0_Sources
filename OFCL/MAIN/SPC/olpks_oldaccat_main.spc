CREATE OR REPLACE PACKAGE  olpks_oldaccat_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldaccat_main.spc
  **
...
TYPE ty_oldaccat IS RECORD (
     v_oltms_acc_category     oltm_acc_category%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldaccat_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldaccat_main FOR olpks_oldaccat_main
/