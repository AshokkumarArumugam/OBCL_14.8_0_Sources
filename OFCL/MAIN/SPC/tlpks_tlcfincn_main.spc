CREATE OR REPLACE PACKAGE  tlpks_tlcfincn_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tlcfincn_main.spc
  **
...
TYPE ty_tb_ltms_trade_fincentre_dtl IS TABLE OF tltm_trade_fincentre_dtl%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_tlcfincn IS RECORD (
     v_upload_master__fincntr     tltb_upload_master%ROWTYPE,
     v_tltms_trade_fincentre_dtl    ty_tb_ltms_trade_fincentre_dtl,
...
p_Wrk_tlcfincn IN  tlpks_tlcfincn_Main.Ty_tlcfincn,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tlcfincn_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tlcfincn_main FOR tlpks_tlcfincn_main
/