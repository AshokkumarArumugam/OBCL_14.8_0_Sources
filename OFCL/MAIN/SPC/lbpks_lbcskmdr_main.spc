CREATE OR REPLACE PACKAGE  lbpks_lbcskmdr_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbcskmdr_main.spc
  **
...
TYPE ty_lbcskmdr IS RECORD (
     v_oltbs_contract__skim     oltb_contract%ROWTYPE,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbcskmdr          IN OUT  lbpks_lbcskmdr_Main.Ty_lbcskmdr,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Main_Function    IN  VARCHAR2,
p_lbcskmdr       IN    lbpks_lbcskmdr_Main.ty_lbcskmdr,
...
p_Main_Function    IN  VARCHAR2,
p_lbcskmdr     IN  lbpks_lbcskmdr_Main.Ty_lbcskmdr,
p_Prev_lbcskmdr IN OUT  lbpks_lbcskmdr_Main.Ty_lbcskmdr,
p_Wrk_lbcskmdr IN OUT  lbpks_lbcskmdr_Main.Ty_lbcskmdr,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbcskmdr     IN  lbpks_lbcskmdr_Main.Ty_lbcskmdr,
p_Prev_lbcskmdr     IN  lbpks_lbcskmdr_Main.Ty_lbcskmdr,
p_Wrk_lbcskmdr      IN OUT  lbpks_lbcskmdr_Main.Ty_lbcskmdr,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbcskmdr IN  lbpks_lbcskmdr_Main.Ty_lbcskmdr,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbcskmdr_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbcskmdr_main FOR lbpks_lbcskmdr_main
/