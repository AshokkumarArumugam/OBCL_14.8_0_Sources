CREATE OR REPLACE PACKAGE  lbpks_lbdpruat_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdpruat_kernel.spc
  **
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdpruat_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdpruat_kernel FOR lbpks_lbdpruat_Kernel
/