CREATE OR REPLACE PACKAGE lbpks_lbconccy_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbconccy_kernel.spc
  **
...
END lbpks_lbconccy_kernel;
/
create or replace synonym lbpkss_lbconccy_kernel for lbpks_lbconccy_kernel
/