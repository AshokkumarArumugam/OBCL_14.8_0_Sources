CREATE OR REPLACE PACKAGE  lbpks_lbdexrfx_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdexrfx_kernel.spc
  **
...
END lbpks_lbdexrfx_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdexrfx_kernel FOR lbpks_lbdexrfx_kernel
/