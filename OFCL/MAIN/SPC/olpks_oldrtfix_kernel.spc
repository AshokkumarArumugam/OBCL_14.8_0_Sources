CREATE OR REPLACE PACKAGE olpks_oldrtfix_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldrtfix_kernel.spc
  **
...
g_prm_esn            oltbs_contract_event_log.Event_Seq_No%type;
g_prm_old_esn        oltbs_contract_event_log.Event_Seq_No%type;
g_prm_mat_date       oltbs_contract_master.maturity_date%Type;
g_prm_value_date     oltbs_contract_master.value_date%Type;
