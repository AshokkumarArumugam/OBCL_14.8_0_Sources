CREATE OR REPLACE PACKAGE olpks_olduplod_fun_cluster AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_olduplod_fun_cluster.spc
  **
...
END olpks_olduplod_fun_cluster;
/
create or replace synonym olpkss_olduplod_fun_cluster for olpks_olduplod_fun_cluster
/