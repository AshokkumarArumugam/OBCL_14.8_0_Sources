CREATE OR REPLACE PACKAGE  lbpks_lbdexrau_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdexrau_kernel.spc
  **
...
END lbpks_lbdexrau_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdexrau_kernel FOR lbpks_lbdexrau_kernel
/