CREATE OR REPLACE PACKAGE  lbpks_lbdddaut_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdddaut_kernel.spc
  **
...
END lbpks_lbdddaut_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdddaut_kernel FOR lbpks_lbdddaut_kernel
/