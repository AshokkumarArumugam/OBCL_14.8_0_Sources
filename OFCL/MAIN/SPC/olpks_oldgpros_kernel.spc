CREATE OR REPLACE PACKAGE olpks_oldgpros_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldgpros_kernel.spc
  **
  ** Module     : Messaging
  **
...
END olpks_oldgpros_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldgpros_kernel FOR olpks_oldgpros_kernel
/