CREATE OR REPLACE PACKAGE  lbpks_lbdptcni_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdptcni_main.spc
  **
...
TYPE ty_tb_tp_part_ld_contract_info IS TABLE OF lbsvw_stp_part_ld_contract_info%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_oltbs_amount_due IS TABLE OF oltb_amount_due%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbdptcni IS RECORD (
     v_oltbs_contract_master     oltb_contract_master%ROWTYPE,
     v_stp_part_ld_contract_info    ty_tb_tp_part_ld_contract_info,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdptcni          IN OUT  lbpks_lbdptcni_Main.Ty_lbdptcni,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_lbdptcni          IN lbpks_lbdptcni_Main.Ty_lbdptcni,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdptcni     IN  lbpks_lbdptcni_Main.Ty_lbdptcni,
p_Wrk_lbdptcni      IN OUT  lbpks_lbdptcni_Main.Ty_lbdptcni,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdptcni     IN  lbpks_lbdptcni_Main.Ty_lbdptcni,
p_Prev_lbdptcni IN OUT  lbpks_lbdptcni_Main.Ty_lbdptcni,
p_Wrk_lbdptcni      IN OUT  lbpks_lbdptcni_Main.Ty_lbdptcni,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbdptcni     IN  lbpks_lbdptcni_Main.Ty_lbdptcni,
p_Prev_lbdptcni     IN  lbpks_lbdptcni_Main.Ty_lbdptcni,
p_Wrk_lbdptcni      IN OUT  lbpks_lbdptcni_Main.Ty_lbdptcni,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbdptcni IN  lbpks_lbdptcni_Main.Ty_lbdptcni,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdptcni_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdptcni_main FOR lbpks_lbdptcni_main
/