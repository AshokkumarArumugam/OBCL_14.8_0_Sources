CREATE OR REPLACE PACKAGE  olpks_oldstscd_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldstscd_main.spc
  **
...
TYPE ty_oldstscd IS RECORD (
     v_oltms_contract_statuses     oltm_contract_statuses%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldstscd_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldstscd_main FOR olpks_oldstscd_main
/