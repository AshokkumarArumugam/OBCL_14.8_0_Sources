CREATE OR REPLACE PACKAGE Lbpks_Lbcsprol_Utils_cluster AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_Lbcsprol_utils_cluster.spc
  **
...
END Lbpks_Lbcsprol_Utils_cluster;
/
CREATE OR REPLACE Synonym Lbpkss_Lbcsprol_Utils_cluster FOR Lbpks_Lbcsprol_Utils_cluster
/