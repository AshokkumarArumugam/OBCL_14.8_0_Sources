CREATE OR REPLACE PACKAGE  tlpks_tldpodau_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldpodau_kernel.spc
  **
...
END tlpks_tldpodau_kernel;
/
CREATE OR REPLACE SYNONYM tlpkss_tldpodau_kernel FOR tlpks_tldpodau_kernel
/