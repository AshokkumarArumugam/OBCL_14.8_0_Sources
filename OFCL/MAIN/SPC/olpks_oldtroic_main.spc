CREATE OR REPLACE PACKAGE  olpks_oldtroic_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldtroic_main.spc
  **
...
p_Child_oldtroic     IN  olpks_oldtroic_Main.Ty_oldtroic,
...
p_Child_oldtroic     IN  OUT olpks_oldtroic_Main.Ty_oldtroic);
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldtroic          IN OUT  olpks_oldtroic_Main.Ty_oldtroic,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_oldtroic          IN olpks_oldtroic_Main.Ty_oldtroic,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldtroic     IN  olpks_oldtroic_Main.Ty_oldtroic,
p_Wrk_oldtroic      IN OUT  olpks_oldtroic_Main.Ty_oldtroic,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldtroic     IN  olpks_oldtroic_Main.Ty_oldtroic,
p_Prev_oldtroic IN OUT  olpks_oldtroic_Main.Ty_oldtroic,
p_Wrk_oldtroic      IN OUT  olpks_oldtroic_Main.Ty_oldtroic,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldtroic     IN  olpks_oldtroic_Main.Ty_oldtroic,
p_Prev_oldtroic     IN  olpks_oldtroic_Main.Ty_oldtroic,
p_Wrk_oldtroic      IN OUT  olpks_oldtroic_Main.Ty_oldtroic,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldtroic IN  olpks_oldtroic_Main.Ty_oldtroic,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldtroic_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldtroic_main FOR olpks_oldtroic_main
/