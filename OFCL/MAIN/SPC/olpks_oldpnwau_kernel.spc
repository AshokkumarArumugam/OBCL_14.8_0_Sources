CREATE OR REPLACE PACKAGE  olpks_oldpnwau_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldpnwau_kernel.spc
  **
...
END olpks_oldpnwau_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldpnwau_kernel FOR olpks_oldpnwau_kernel
/