CREATE OR REPLACE PACKAGE tlpks_tlcswonl_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tlcswonl_kernel.spc
  **
...
END tlpks_tlcswonl_kernel;
/
CREATE OR REPLACE SYNONYM tlpkss_tlcswonl_kernel FOR tlpks_tlcswonl_kernel
/