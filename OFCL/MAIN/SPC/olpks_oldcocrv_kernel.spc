CREATE OR REPLACE PACKAGE  olpks_oldcocrv_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldcocrv_kernel.spc
  **
...
END olpks_oldcocrv_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldcocrv_kernel FOR olpks_oldcocrv_kernel
/