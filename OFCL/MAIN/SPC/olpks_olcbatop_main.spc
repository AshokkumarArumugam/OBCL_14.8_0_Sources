CREATE OR REPLACE PACKAGE  olpks_olcbatop_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_olcbatop_main.spc
  **
...
TYPE ty_olcbatop IS RECORD (
     v_olvws_batch_master     olvw_batch_master%ROWTYPE,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_olcbatop          IN OUT  olpks_olcbatop_Main.Ty_olcbatop,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Main_Function    IN  VARCHAR2,
p_olcbatop       IN    olpks_olcbatop_Main.ty_olcbatop,
...
p_Main_Function    IN  VARCHAR2,
p_olcbatop     IN  olpks_olcbatop_Main.Ty_olcbatop,
p_Prev_olcbatop IN OUT  olpks_olcbatop_Main.Ty_olcbatop,
p_Wrk_olcbatop IN OUT  olpks_olcbatop_Main.Ty_olcbatop,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_olcbatop     IN  olpks_olcbatop_Main.Ty_olcbatop,
p_Prev_olcbatop     IN  olpks_olcbatop_Main.Ty_olcbatop,
p_Wrk_olcbatop      IN OUT  olpks_olcbatop_Main.Ty_olcbatop,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_olcbatop IN  olpks_olcbatop_Main.Ty_olcbatop,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_olcbatop_main;
/
CREATE OR REPLACE SYNONYM olpkss_olcbatop_main FOR olpks_olcbatop_main
/