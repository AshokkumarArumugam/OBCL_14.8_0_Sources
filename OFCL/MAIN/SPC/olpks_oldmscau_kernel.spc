CREATE OR REPLACE PACKAGE  olpks_oldmscau_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldmscau_kernel.spc
  **
...
END olpks_oldmscau_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldmscau_kernel FOR olpks_oldmscau_kernel
/