CREATE OR REPLACE PACKAGE  olpks_oldmgmnt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldmgmnt_main.spc
  **
  ** Module     : Messaging
  ** 
...
TYPE ty_oldmgmnt IS RECORD (
     v_oltm_msg_type     oltm_msg_type%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldmgmnt_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldmgmnt_main FOR olpks_oldmgmnt_main
/