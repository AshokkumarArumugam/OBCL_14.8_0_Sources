CREATE OR REPLACE PACKAGE olpks_olcffmsg_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_olcffmsg_kernel.spc
  **
...
END olpks_olcffmsg_kernel;
/
CREATE OR REPLACE SYNONYM OLPKSS_OLCFFMSG_KERNEL FOR OLPKS_OLCFFMSG_KERNEL
/