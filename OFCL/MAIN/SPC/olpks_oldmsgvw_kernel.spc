CREATE OR REPLACE PACKAGE  olpks_oldmsgvw_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldmsgvw_kernel.spc
  **
...
END olpks_oldmsgvw_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldmsgvw_kernel FOR olpks_oldmsgvw_kernel
/