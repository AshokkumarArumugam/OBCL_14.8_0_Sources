CREATE OR REPLACE PACKAGE  lbpks_lbdmkliq_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdmkliq_main.spc
  **
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdmkliq          IN OUT  lbpks_lbdmkliq_Main.Ty_lbdmkliq,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdmkliq     IN  lbpks_lbdmkliq_Main.Ty_lbdmkliq,
p_Prev_lbdmkliq IN OUT  lbpks_lbdmkliq_Main.Ty_lbdmkliq,
p_Wrk_lbdmkliq      IN OUT  lbpks_lbdmkliq_Main.Ty_lbdmkliq,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbdmkliq     IN  lbpks_lbdmkliq_Main.Ty_lbdmkliq,
p_Prev_lbdmkliq     IN  lbpks_lbdmkliq_Main.Ty_lbdmkliq,
p_Wrk_lbdmkliq      IN OUT  lbpks_lbdmkliq_Main.Ty_lbdmkliq,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbdmkliq IN  lbpks_lbdmkliq_Main.Ty_lbdmkliq,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdmkliq_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdmkliq_main FOR lbpks_lbdmkliq_main
/