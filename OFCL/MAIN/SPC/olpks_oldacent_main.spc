CREATE OR REPLACE PACKAGE  olpks_oldacent_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldacent_main.spc
  **
  ** Module     : Core
  ** 
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldacent          IN OUT  olpks_oldacent_Main.Ty_oldacent,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_oldacent          IN olpks_oldacent_Main.Ty_oldacent,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldacent     IN  olpks_oldacent_Main.Ty_oldacent,
p_Wrk_oldacent      IN OUT  olpks_oldacent_Main.Ty_oldacent,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldacent     IN  olpks_oldacent_Main.Ty_oldacent,
p_Prev_oldacent IN OUT  olpks_oldacent_Main.Ty_oldacent,
p_Wrk_oldacent      IN OUT  olpks_oldacent_Main.Ty_oldacent,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldacent     IN  olpks_oldacent_Main.Ty_oldacent,
p_Prev_oldacent     IN  olpks_oldacent_Main.Ty_oldacent,
p_Wrk_oldacent      IN OUT  olpks_oldacent_Main.Ty_oldacent,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldacent IN  olpks_oldacent_Main.Ty_oldacent,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldacent_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldacent_main FOR olpks_oldacent_main
/