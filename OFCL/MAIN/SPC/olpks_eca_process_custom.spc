CREATE OR REPLACE PACKAGE olpks_eca_process_custom AS
  /*----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_eca_process_custom.SPC
  **
  ** Module    : OL
  **
...
END olpks_eca_process_custom;
/
CREATE OR REPLACE Synonym olpkss_eca_process_custom FOR olpks_eca_process_custom
/