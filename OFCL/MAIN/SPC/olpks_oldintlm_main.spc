CREATE OR REPLACE PACKAGE  olpks_oldintlm_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldintlm_main.spc
  **
...
TYPE ty_tb__product_currency_limits IS TABLE OF lftm_product_currency_limits%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_oldintlm IS RECORD (
     v_lftms_prod_comp_master     lftm_prod_comp_master%ROWTYPE,
     v_product_currency_limits    ty_tb__product_currency_limits,
...
FUNCTION Fn_Get_Key_Information (p_Source    IN  VARCHAR2, 
                        ...
                        p_Function_id       IN     VARCHAR2,
                        p_Action_Code       IN     VARCHAR2,
p_oldintlm       IN  OUT olpks_oldintlm_Main.Ty_oldintlm,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldintlm_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldintlm_main FOR olpks_oldintlm_main
/