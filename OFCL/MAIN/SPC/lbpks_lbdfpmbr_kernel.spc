CREATE OR REPLACE PACKAGE  lbpks_lbdfpmbr_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdfpmbr_kernel.spc
  **
...
END lbpks_lbdfpmbr_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdfpmbr_kernel FOR lbpks_lbdfpmbr_kernel
/