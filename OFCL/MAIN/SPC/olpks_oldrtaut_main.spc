CREATE OR REPLACE PACKAGE  olpks_oldrtaut_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldrtaut_main.spc
  **
  ** Module     : OL
  ** 
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldrtaut          IN OUT  olpks_oldrtaut_Main.Ty_oldrtaut,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_oldrtaut          IN olpks_oldrtaut_Main.Ty_oldrtaut,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldrtaut     IN  olpks_oldrtaut_Main.Ty_oldrtaut,
p_Wrk_oldrtaut      IN OUT  olpks_oldrtaut_Main.Ty_oldrtaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldrtaut     IN  olpks_oldrtaut_Main.Ty_oldrtaut,
p_Prev_oldrtaut IN OUT  olpks_oldrtaut_Main.Ty_oldrtaut,
p_Wrk_oldrtaut      IN OUT  olpks_oldrtaut_Main.Ty_oldrtaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldrtaut     IN  olpks_oldrtaut_Main.Ty_oldrtaut,
p_Prev_oldrtaut     IN  olpks_oldrtaut_Main.Ty_oldrtaut,
p_Wrk_oldrtaut      IN OUT  olpks_oldrtaut_Main.Ty_oldrtaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldrtaut IN  olpks_oldrtaut_Main.Ty_oldrtaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldrtaut_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldrtaut_main FOR olpks_oldrtaut_main
/