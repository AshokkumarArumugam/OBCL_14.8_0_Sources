CREATE OR REPLACE PACKAGE  olpks_oldvmaut_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldvmaut_main.spc
  **
  ** Module     : OL
  ** 
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldvmaut          IN OUT  olpks_oldvmaut_Main.Ty_oldvmaut,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldvmaut     IN  olpks_oldvmaut_Main.Ty_oldvmaut,
p_Prev_oldvmaut IN OUT  olpks_oldvmaut_Main.Ty_oldvmaut,
p_Wrk_oldvmaut      IN OUT  olpks_oldvmaut_Main.Ty_oldvmaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Wrk_oldvmaut IN  olpks_oldvmaut_Main.Ty_oldvmaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldvmaut_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldvmaut_main FOR olpks_oldvmaut_main
/