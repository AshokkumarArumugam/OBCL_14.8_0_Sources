CREATE OR REPLACE PACKAGE  lbpks_lbdataut_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdataut_main.spc
  **
...
TYPE ty_lbdataut IS RECORD (
     v_oltbs_contract__payau     oltb_contract%ROWTYPE,
     v_contract_event_log__payau     oltb_contract_event_log%ROWTYPE,
     v_oltbs_addl_text     oltb_addl_text%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdataut          IN OUT  lbpks_lbdataut_Main.Ty_lbdataut,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_lbdataut          IN lbpks_lbdataut_Main.Ty_lbdataut,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdataut     IN  lbpks_lbdataut_Main.Ty_lbdataut,
p_Wrk_lbdataut      IN OUT  lbpks_lbdataut_Main.Ty_lbdataut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdataut     IN  lbpks_lbdataut_Main.Ty_lbdataut,
p_Prev_lbdataut IN OUT  lbpks_lbdataut_Main.Ty_lbdataut,
p_Wrk_lbdataut      IN OUT  lbpks_lbdataut_Main.Ty_lbdataut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbdataut     IN  lbpks_lbdataut_Main.Ty_lbdataut,
p_Prev_lbdataut     IN  lbpks_lbdataut_Main.Ty_lbdataut,
p_Wrk_lbdataut      IN OUT  lbpks_lbdataut_Main.Ty_lbdataut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbdataut IN  lbpks_lbdataut_Main.Ty_lbdataut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdataut_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdataut_main FOR lbpks_lbdataut_main
/