CREATE OR REPLACE PACKAGE olpks_accounting_cluster AS
  /*----------------------------------------------------------------------------------------------------
  **
  ** File Name    : olpks_accounting_cluster.spc
  **
  ** Module       : OL                        **
  **
...
END olpks_accounting_cluster;
/
CREATE OR REPLACE synonym olpkss_accounting_cluster for olpks_accounting_cluster
/