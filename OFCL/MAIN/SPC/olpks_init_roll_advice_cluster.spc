CREATE OR REPLACE PACKAGE olpks_init_roll_advice_cluster AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_init_roll_advice_cluster.spc
  **
...
END olpks_init_roll_advice_cluster;
/
CREATE OR REPLACE SYNONYM olpkss_init_roll_advice_cluster FOR olpks_init_roll_advice_cluster
/