CREATE OR REPLACE PACKAGE  olpks_oldbrprm_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldbrprm_main.spc
  **
...
TYPE ty_oldbrprm IS RECORD (
     v_oltms_branch_parameters     oltm_branch_parameters%ROWTYPE,
...
FUNCTION Fn_Get_Key_Information (p_Source    IN  VARCHAR2, 
                        ...
                        p_Function_id       IN     VARCHAR2,
                        p_Action_Code       IN     VARCHAR2,
p_oldbrprm       IN  OUT olpks_oldbrprm_Main.Ty_oldbrprm,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldbrprm_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldbrprm_main FOR olpks_oldbrprm_main
/