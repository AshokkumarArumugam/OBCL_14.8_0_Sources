CREATE OR REPLACE PACKAGE  lfpks_lfdrlavl_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lfpks_lfdrlavl_main.spc
  **
  ** Module     : The ICCF
  ** 
...
TYPE ty_lfdrlavl IS RECORD (
     v_lftbs_iccf_rlavl     lftb_iccf_rlavl%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lfpks_lfdrlavl_main;
/
CREATE OR REPLACE SYNONYM lfpkss_lfdrlavl_main FOR lfpks_lfdrlavl_main
/