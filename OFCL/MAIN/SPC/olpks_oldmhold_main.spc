CREATE OR REPLACE PACKAGE  olpks_oldmhold_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldmhold_main.spc
  **
...
TYPE ty_oldmhold IS RECORD (
     v_oltbs_msg_hold     oltb_msg_hold%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldmhold_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldmhold_main FOR olpks_oldmhold_main
/