CREATE OR REPLACE PACKAGE  tlpks_tlcswupl_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tlcswupl_kernel.spc
  **
...
END tlpks_tlcswupl_kernel;
/
CREATE OR REPLACE SYNONYM tlpkss_tlcswupl_kernel FOR tlpks_tlcswupl_kernel
/