CREATE OR REPLACE PACKAGE  lppks_lpdspmnt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lppks_lpdspmnt_main.spc
  **
...
TYPE ty_lpdspmnt IS RECORD (
     v_lbtm_self_participant     lbtm_self_participant%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lppks_lpdspmnt_main;
/
CREATE OR REPLACE SYNONYM lppkss_lpdspmnt_main FOR lppks_lpdspmnt_main
/