CREATE OR REPLACE PACKAGE  olpks_oldreasn_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldreasn_main.spc
  **
  ** Module     : OL
  ** 
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldreasn          IN OUT  olpks_oldreasn_Main.Ty_oldreasn,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_oldreasn          IN olpks_oldreasn_Main.Ty_oldreasn,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldreasn     IN  olpks_oldreasn_Main.Ty_oldreasn,
p_Wrk_oldreasn      IN OUT  olpks_oldreasn_Main.Ty_oldreasn,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldreasn     IN  olpks_oldreasn_Main.Ty_oldreasn,
p_Prev_oldreasn IN OUT  olpks_oldreasn_Main.Ty_oldreasn,
p_Wrk_oldreasn      IN OUT  olpks_oldreasn_Main.Ty_oldreasn,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldreasn     IN  olpks_oldreasn_Main.Ty_oldreasn,
p_Prev_oldreasn     IN  olpks_oldreasn_Main.Ty_oldreasn,
p_Wrk_oldreasn      IN OUT  olpks_oldreasn_Main.Ty_oldreasn,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldreasn IN  olpks_oldreasn_Main.Ty_oldreasn,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldreasn_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldreasn_main FOR olpks_oldreasn_main
/