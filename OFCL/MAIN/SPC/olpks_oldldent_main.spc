CREATE OR REPLACE PACKAGE  olpks_oldldent_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldldent_main.spc
  **
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldldent          IN OUT  olpks_oldldent_Main.Ty_oldldent,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Wrk_oldldent IN  olpks_oldldent_Main.Ty_oldldent,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldldent_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldldent_main FOR olpks_oldldent_main
/