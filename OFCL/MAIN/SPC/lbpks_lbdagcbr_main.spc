CREATE OR REPLACE PACKAGE  lbpks_lbdagcbr_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdagcbr_main.spc
  **
...
TYPE ty_tb__tltb_contract_exception IS TABLE OF tltb_contract_exception%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbdagcbr IS RECORD (
     v_agency_confirm_browser     lbtb_agency_confirm_browser%ROWTYPE,
     v_tltb_contract_exception    ty_tb__tltb_contract_exception,
...
p_Wrk_lbdagcbr IN  lbpks_lbdagcbr_Main.Ty_lbdagcbr,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdagcbr_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdagcbr_main FOR lbpks_lbdagcbr_main
/