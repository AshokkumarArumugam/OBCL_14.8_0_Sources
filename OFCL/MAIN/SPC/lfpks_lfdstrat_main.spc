CREATE OR REPLACE PACKAGE  lfpks_lfdstrat_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lfpks_lfdstrat_main.spc
  **
  ** Module     : The ICCF
  ** 
...
TYPE ty_lfdstrat IS RECORD (
     v_lftms_standard_rate_code     lftm_standard_rate_code%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lfpks_lfdstrat_main;
/
CREATE OR REPLACE SYNONYM lfpkss_lfdstrat_main FOR lfpks_lfdstrat_main
/