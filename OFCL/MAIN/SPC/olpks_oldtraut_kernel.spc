CREATE OR REPLACE PACKAGE olpks_oldtraut_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldtraut_kernel.spc
  **
...
END olpks_oldtraut_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldtraut_kernel FOR olpks_oldtraut_kernel
/