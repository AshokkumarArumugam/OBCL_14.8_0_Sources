CREATE OR REPLACE PACKAGE olpks_olrenqry_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_olrenqry_kernel.spc
  **
 ...
 pm_current_user smtb_user.user_id%TYPE;
  ...
  PRM_PROJDATE     DATE;
  PRM_REFNUM       VARCHAR2(255);
 PRM_COUNTERPARTY VARCHAR2(255);
  PRM_DCN          VARCHAR2(255);
  ...
  FUNCTION Fn_Post_Check_Mandatory(p_Source           IN VARCHAR2,
                                   ...
                                   p_olrenqry         IN olpks_olrenqry_main.ty_olrenqry,
                                   p_Err_Code         IN OUT VARCHAR2,
                                   p_Err_Params       IN OUT VARCHAR2)
    RETURN BOOLEAN;
  ...
  FUNCTION Fn_Pre_Default_And_Validate(p_source           IN VARCHAR2,
                                       ...
                                       p_Child_Function   IN VARCHAR2,
                                       p_olrenqry         IN olpks_olrenqry_main.ty_olrenqry,
                                       p_wrk_olrenqry     IN OUT olpks_olrenqry_main.ty_olrenqry,
                                       p_Err_Code         IN OUT VARCHAR2,
                                       p_Err_Params       IN OUT VARCHAR2)
    RETURN BOOLEAN;
