CREATE OR REPLACE PACKAGE  tlpks_tlcfmemo_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tlcfmemo_main.spc
  **
...
TYPE ty_tb__tltbs_fmem_price_detail IS TABLE OF tltb_fmem_price_detail%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_fmem_interest_detail IS TABLE OF tltb_fmem_interest_detail%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_tltbs_fmem_fee IS TABLE OF tltb_fmem_fee%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_tltbs_fmem_ccy_details IS TABLE OF tltb_fmem_ccy_details%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_part_transfer_lor_dtls IS TABLE OF lbtb_part_transfer_lor_dtls%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_tlcfmemo IS RECORD (
     v_tltbs_fmem_master     tltb_fmem_master%ROWTYPE,
     v_tltbs_fmem_price_detail    ty_tb__tltbs_fmem_price_detail,
     v_fmem_interest_detail    ty_tb_v_fmem_interest_detail,
     v_tltbs_fmem_fee    ty_tb_v_tltbs_fmem_fee,
     v_tltbs_fmem_ccy_details    ty_tb_v_tltbs_fmem_ccy_details,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_tlcfmemo          IN OUT  tlpks_tlcfmemo_Main.Ty_tlcfmemo,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Main_Function    IN  VARCHAR2,
p_tlcfmemo     IN  tlpks_tlcfmemo_Main.Ty_tlcfmemo,
p_Prev_tlcfmemo IN OUT  tlpks_tlcfmemo_Main.Ty_tlcfmemo,
...
p_Wrk_tlcfmemo IN  tlpks_tlcfmemo_Main.Ty_tlcfmemo,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tlcfmemo_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tlcfmemo_main FOR tlpks_tlcfmemo_main
/