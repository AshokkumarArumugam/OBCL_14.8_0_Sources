CREATE OR REPLACE PACKAGE  olpks_oldffmsg_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldffmsg_kernel.spc
  **
...
END olpks_oldffmsg_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldffmsg_kernel FOR olpks_oldffmsg_kernel
/