CREATE OR REPLACE PACKAGE  lbpks_lbcasgvl_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbcasgvl_main.spc
  **
...
TYPE ty_tb_v_lbtbs_assgn_val_banks IS TABLE OF lbtb_assgn_val_banks%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_btbs_assgn_val_banks__as IS TABLE OF lbtb_assgn_val_banks%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_assgn_val_other_tranches IS TABLE OF lbtb_assgn_val_other_tranches%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_val_other_tranches__as IS TABLE OF lbtb_assgn_val_other_tranches%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbcasgvl IS RECORD (
     v_assignment_validation     lbtb_assignment_validation%ROWTYPE,
     v_lbtbs_assgn_val_banks    ty_tb_v_lbtbs_assgn_val_banks,
     v_lbtbs_assgn_val_banks__as    ty_tb_btbs_assgn_val_banks__as,
     v_assgn_val_other_tranches    ty_tb_assgn_val_other_tranches,
     v_val_other_tranches__as    ty_tb_v_val_other_tranches__as,
...
p_Wrk_lbcasgvl IN  lbpks_lbcasgvl_Main.Ty_lbcasgvl,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbcasgvl_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbcasgvl_main FOR lbpks_lbcasgvl_main
/