CREATE OR REPLACE PACKAGE  lbpks_lbrinicm_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbrinicm_kernel.spc
  **
...
p_lbrinicm     IN  OUT lbpks_lbrinicm_Main.Ty_lbrinicm,
...
p_lbrinicm IN   lbpks_lbrinicm_Main.ty_lbrinicm,
p_Err_Code       IN  OUT VARCHAR2,
p_Err_Params     IN  OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Child_Function    IN  VARCHAR2,
p_lbrinicm IN   lbpks_lbrinicm_Main.Ty_lbrinicm,
p_Wrk_lbrinicm IN OUT  lbpks_lbrinicm_Main.Ty_lbrinicm,
p_Err_Code       IN  OUT VARCHAR2,
p_Err_Params     IN  OUT VARCHAR2)
RETURN BOOLEAN;
...
END lbpks_lbrinicm_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbrinicm_kernel FOR lbpks_lbrinicm_kernel
/