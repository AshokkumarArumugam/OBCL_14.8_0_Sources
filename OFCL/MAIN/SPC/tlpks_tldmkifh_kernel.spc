create or replace PACKAGE  tlpks_tldmkifh_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldmkifh_kernel.spc
  **
...
END tlpks_tldmkifh_kernel;
/
CREATE OR REPLACE SYNONYM tlpkss_tldmkifh_kernel FOR tlpks_tldmkifh_kernel
/