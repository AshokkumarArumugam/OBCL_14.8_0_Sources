CREATE OR REPLACE PACKAGE  olpks_oldprlau_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldprlau_kernel.spc
  **
...
END olpks_oldprlau_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldprlau_kernel FOR olpks_oldprlau_kernel
/