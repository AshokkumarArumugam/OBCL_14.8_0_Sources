CREATE OR REPLACE PACKAGE  fcpks_fcdtraut_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : fcpks_fcdtraut_main.spc
  **
...
TYPE ty_fcdtraut IS RECORD (
     ...
     v_contract_event_log__faut     oltb_contract_event_log%ROWTYPE,
     v_lbtb_syndication_master     lbtb_syndication_master%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_fcdtraut          IN OUT  fcpks_fcdtraut_Main.Ty_fcdtraut,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_fcdtraut     IN  fcpks_fcdtraut_Main.Ty_fcdtraut,
p_Prev_fcdtraut IN OUT  fcpks_fcdtraut_Main.Ty_fcdtraut,
p_Wrk_fcdtraut      IN OUT  fcpks_fcdtraut_Main.Ty_fcdtraut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Wrk_fcdtraut IN  fcpks_fcdtraut_Main.Ty_fcdtraut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END fcpks_fcdtraut_main;
/
CREATE OR REPLACE SYNONYM fcpkss_fcdtraut_main FOR fcpks_fcdtraut_main
/