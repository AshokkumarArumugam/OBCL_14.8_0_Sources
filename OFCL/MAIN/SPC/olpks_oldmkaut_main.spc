CREATE OR REPLACE PACKAGE  olpks_oldmkaut_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldmkaut_main.spc
  **
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldmkaut          IN OUT  olpks_oldmkaut_Main.Ty_oldmkaut,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldmkaut     IN  olpks_oldmkaut_Main.Ty_oldmkaut,
p_Prev_oldmkaut IN OUT  olpks_oldmkaut_Main.Ty_oldmkaut,
p_Wrk_oldmkaut      IN OUT  olpks_oldmkaut_Main.Ty_oldmkaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldmkaut     IN  olpks_oldmkaut_Main.Ty_oldmkaut,
p_Prev_oldmkaut     IN  olpks_oldmkaut_Main.Ty_oldmkaut,
p_Wrk_oldmkaut      IN OUT  olpks_oldmkaut_Main.Ty_oldmkaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldmkaut IN  olpks_oldmkaut_Main.Ty_oldmkaut,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldmkaut_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldmkaut_main FOR olpks_oldmkaut_main
/