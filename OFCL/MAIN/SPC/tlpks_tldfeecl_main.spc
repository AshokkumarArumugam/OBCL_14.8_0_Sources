CREATE OR REPLACE PACKAGE  tlpks_tldfeecl_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldfeecl_main.spc
  **
...
TYPE ty_tldfeecl IS RECORD (
     v_oltms_class     oltm_class%ROWTYPE,
     v_tltms_fee_class     tltm_fee_class%ROWTYPE,
...
FUNCTION Fn_Get_Key_Information (p_Source    IN  VARCHAR2, 
                        ...
                        p_Function_id       IN     VARCHAR2,
                        p_Action_Code       IN     VARCHAR2,
p_tldfeecl       IN  OUT tlpks_tldfeecl_Main.Ty_tldfeecl,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tldfeecl_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tldfeecl_main FOR tlpks_tldfeecl_main
/