CREATE OR REPLACE PACKAGE  olpks_oldprgrt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldprgrt_main.spc
  **
...
TYPE ty_oldprgrt IS RECORD (
     v_oltms_product_group     oltm_product_group%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldprgrt_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldprgrt_main FOR olpks_oldprgrt_main
/