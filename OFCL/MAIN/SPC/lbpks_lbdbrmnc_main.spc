CREATE OR REPLACE PACKAGE  lbpks_lbdbrmnc_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdbrmnc_main.spc
  **
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdbrmnc          IN OUT  lbpks_lbdbrmnc_Main.Ty_lbdbrmnc,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Wrk_lbdbrmnc IN  lbpks_lbdbrmnc_Main.Ty_lbdbrmnc,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdbrmnc_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdbrmnc_main FOR lbpks_lbdbrmnc_main
/