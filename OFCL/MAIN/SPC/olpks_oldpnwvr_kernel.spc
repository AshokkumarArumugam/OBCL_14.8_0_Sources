CREATE OR REPLACE PACKAGE  olpks_oldpnwvr_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldpnwvr_kernel.spc
  **
...
END olpks_oldpnwvr_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldpnwvr_kernel FOR olpks_oldpnwvr_kernel
/