CREATE OR REPLACE PACKAGE  lfpks_lfcschmn_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lfpks_lfcschmn_main.spc
  **
  ** Module     : The ICCF
  ** 
...
TYPE ty_lfcschmn IS RECORD (
     v_oltbs_contract__ls     oltb_contract%ROWTYPE,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lfcschmn          IN OUT  lfpks_lfcschmn_Main.Ty_lfcschmn,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Main_Function    IN  VARCHAR2,
p_lfcschmn       IN    lfpks_lfcschmn_Main.ty_lfcschmn,
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lfcschmn     IN  lfpks_lfcschmn_Main.Ty_lfcschmn,
p_Prev_lfcschmn     IN  lfpks_lfcschmn_Main.Ty_lfcschmn,
p_Wrk_lfcschmn      IN OUT  lfpks_lfcschmn_Main.Ty_lfcschmn,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lfcschmn IN  lfpks_lfcschmn_Main.Ty_lfcschmn,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lfpks_lfcschmn_main;
/
CREATE OR REPLACE SYNONYM lfpkss_lfcschmn_main FOR lfpks_lfcschmn_main
/