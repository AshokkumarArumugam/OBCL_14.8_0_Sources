CREATE OR REPLACE PACKAGE  lbpks_lbdtxrfc_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdtxrfc_main.spc
  **
...
TYPE ty_tb_v_investor_refund_detail IS TABLE OF txtb_investor_refund_detail%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_investor_refund_comp IS TABLE OF txtb_investor_refund_comp%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_xtbs_investor_refund_sch IS TABLE OF txtb_investor_refund_sch%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbdtxrfc IS RECORD (
     v_investor_refund_master     txtb_investor_refund_master%ROWTYPE,
     v_investor_refund_detail    ty_tb_v_investor_refund_detail,
     v_investor_refund_comp    ty_tb_v_investor_refund_comp,
     v_txtbs_investor_refund_sch    ty_tb_xtbs_investor_refund_sch,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdtxrfc          IN OUT  lbpks_lbdtxrfc_Main.Ty_lbdtxrfc,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Wrk_lbdtxrfc IN  lbpks_lbdtxrfc_Main.Ty_lbdtxrfc,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdtxrfc_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdtxrfc_main FOR lbpks_lbdtxrfc_main
/