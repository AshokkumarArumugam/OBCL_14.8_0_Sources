CREATE OR REPLACE PACKAGE  olpks_oldgjobs_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldgjobs_main.spc
  **
...
TYPE ty_oldgjobs IS RECORD (
     v_oltb_dly_msg_out     oltb_dly_msg_out%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldgjobs          IN OUT  olpks_oldgjobs_Main.Ty_oldgjobs,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_oldgjobs          IN olpks_oldgjobs_Main.Ty_oldgjobs,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldgjobs     IN  olpks_oldgjobs_Main.Ty_oldgjobs,
p_Wrk_oldgjobs      IN OUT  olpks_oldgjobs_Main.Ty_oldgjobs,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldgjobs     IN  olpks_oldgjobs_Main.Ty_oldgjobs,
p_Prev_oldgjobs IN OUT  olpks_oldgjobs_Main.Ty_oldgjobs,
p_Wrk_oldgjobs      IN OUT  olpks_oldgjobs_Main.Ty_oldgjobs,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldgjobs     IN  olpks_oldgjobs_Main.Ty_oldgjobs,
p_Prev_oldgjobs     IN  olpks_oldgjobs_Main.Ty_oldgjobs,
p_Wrk_oldgjobs      IN OUT  olpks_oldgjobs_Main.Ty_oldgjobs,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldgjobs IN  olpks_oldgjobs_Main.Ty_oldgjobs,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldgjobs_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldgjobs_main FOR olpks_oldgjobs_main
/