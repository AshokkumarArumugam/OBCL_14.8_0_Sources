CREATE OR REPLACE PACKAGE  tlpks_tldcumnt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldcumnt_main.spc
  **
...
TYPE ty_tldcumnt IS RECORD (
     v_tltm_cusip_rating     tltm_cusip_rating%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tldcumnt_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tldcumnt_main FOR tlpks_tldcumnt_main
/