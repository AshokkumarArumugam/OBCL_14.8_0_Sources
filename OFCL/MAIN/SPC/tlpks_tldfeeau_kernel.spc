CREATE OR REPLACE PACKAGE tlpks_tldfeeau_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldfeeau_kernel.spc
  **
...
END tlpks_tldfeeau_kernel;
/
CREATE OR REPLACE SYNONYM tlpkss_tldfeeau_kernel FOR tlpks_tldfeeau_kernel
/