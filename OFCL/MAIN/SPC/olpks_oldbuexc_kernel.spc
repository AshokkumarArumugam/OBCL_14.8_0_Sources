CREATE OR REPLACE PACKAGE  olpks_oldbuexc_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldbuexc_kernel.spc
  **
...
END olpks_oldbuexc_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldbuexc_kernel FOR olpks_oldbuexc_Kernel
/