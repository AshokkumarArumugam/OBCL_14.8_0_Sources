CREATE OR REPLACE PACKAGE  olpks_olcprmnt_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_olcprmnt_kernel.spc
  **
...
END olpks_olcprmnt_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_olcprmnt_kernel FOR olpks_olcprmnt_kernel
/