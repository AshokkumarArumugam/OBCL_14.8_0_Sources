CREATE OR REPLACE PACKAGE  tlpks_tldagcon_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldagcon_main.spc
  **
...
TYPE ty_tb_v_agency_confirm_detail IS TABLE OF tltb_agency_confirm_detail%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_tldagcon IS RECORD (
     v_agency_confirm_master     tltb_agency_confirm_master%ROWTYPE,
     v_agency_confirm_detail    ty_tb_v_agency_confirm_detail,
...
FUNCTION Fn_Get_Key_Information (p_Source    IN  VARCHAR2, 
                        ...
                        p_Function_id       IN     VARCHAR2,
                        p_Action_Code       IN     VARCHAR2,
p_tldagcon       IN  OUT tlpks_tldagcon_Main.Ty_tldagcon,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tldagcon_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tldagcon_main FOR tlpks_tldagcon_main
/