CREATE OR REPLACE PACKAGE  lbpks_lbdskmam_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdskmam_main.spc
  **
...
TYPE ty_tb_v_contract_skim_master IS TABLE OF lbtb_contract_skim_master%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_contract_skim_details IS TABLE OF lbtb_contract_skim_details%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_ntract_skim_details__his IS TABLE OF lbtb_contract_skim_details%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_ontract_skim_details__lt IS TABLE OF lbtb_contract_skim_details%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbdskmam IS RECORD (
     v_oltbs_contract     oltb_contract%ROWTYPE,
     v_contract_skim_master    ty_tb_v_contract_skim_master,
     v_contract_skim_details    ty_tb_v_contract_skim_details,
     v_ontract_skim_details__his    ty_tb_ntract_skim_details__his,
     v_contract_skim_details__lt    ty_tb_ontract_skim_details__lt,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdskmam          IN OUT  lbpks_lbdskmam_Main.Ty_lbdskmam,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Wrk_lbdskmam IN  lbpks_lbdskmam_Main.Ty_lbdskmam,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdskmam_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdskmam_main FOR lbpks_lbdskmam_main
/