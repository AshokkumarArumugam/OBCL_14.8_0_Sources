CREATE OR REPLACE PACKAGE  lbpks_lbdolovd_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdolovd_main.spc
  **
...
TYPE ty_tb_v_lbtms_coll_ovd IS TABLE OF lbtm_coll_ovd%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_lbdolovd IS RECORD (
     v_oltbs_contract_master     oltb_contract_master%ROWTYPE,
     v_lbtms_coll_ovd    ty_tb_v_lbtms_coll_ovd,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbdolovd          IN OUT  lbpks_lbdolovd_Main.Ty_lbdolovd,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_lbdolovd          IN lbpks_lbdolovd_Main.Ty_lbdolovd,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdolovd     IN  lbpks_lbdolovd_Main.Ty_lbdolovd,
p_Wrk_lbdolovd      IN OUT  lbpks_lbdolovd_Main.Ty_lbdolovd,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_lbdolovd     IN  lbpks_lbdolovd_Main.Ty_lbdolovd,
p_Prev_lbdolovd IN OUT  lbpks_lbdolovd_Main.Ty_lbdolovd,
p_Wrk_lbdolovd      IN OUT  lbpks_lbdolovd_Main.Ty_lbdolovd,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbdolovd     IN  lbpks_lbdolovd_Main.Ty_lbdolovd,
p_Prev_lbdolovd     IN  lbpks_lbdolovd_Main.Ty_lbdolovd,
p_Wrk_lbdolovd      IN OUT  lbpks_lbdolovd_Main.Ty_lbdolovd,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbdolovd IN  lbpks_lbdolovd_Main.Ty_lbdolovd,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdolovd_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdolovd_main FOR lbpks_lbdolovd_main
/