CREATE OR REPLACE PACKAGE  lbpks_lbdfeamd_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdfeamd_kernel.spc
  **
  ...
  ** India
  ...
  Change Description :  
    ...
    Changed On         : 6-Oct-2022
    Change Description : Fix for Fee schedule Amendment 
    Search String      : Bug#34651367
  -------------------------------------------------------------------------------------------------------
  */
  
G_FEAMD_UNLOCK		VARCHAR2(1) := 'N'; --Bug#34651367
...
END lbpks_lbdfeamd_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdfeamd_kernel FOR lbpks_lbdfeamd_kernel
/