CREATE OR REPLACE PACKAGE  tlpks_tlcmemup_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tlcmemup_main.spc
  **
...
TYPE ty_tb_tltbs_fmem_upload_detail IS TABLE OF tltb_fmem_upload_detail%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_fmem_upload_int_detail IS TABLE OF tltb_fmem_upload_int_detail%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_btbs_upld_udf_field_vals IS TABLE OF lbtb_upld_udf_field_vals%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_tlcmemup IS RECORD (
     v_tltbs_fmem_upload_master     tltb_fmem_upload_master%ROWTYPE,
     v_tltbs_fmem_upload_detail    ty_tb_tltbs_fmem_upload_detail,
     v_fmem_upload_int_detail    ty_tb_v_fmem_upload_int_detail,
     v_fmem_upload_master__v     tltb_fmem_upload_master%ROWTYPE,
     v_lbtbs_upld_udf_field_vals    ty_tb_btbs_upld_udf_field_vals,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_tlcmemup          IN OUT  tlpks_tlcmemup_Main.Ty_tlcmemup,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Wrk_tlcmemup IN  tlpks_tlcmemup_Main.Ty_tlcmemup,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tlcmemup_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tlcmemup_main FOR tlpks_tlcmemup_main
/