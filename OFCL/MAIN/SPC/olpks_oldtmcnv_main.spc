CREATE OR REPLACE PACKAGE  olpks_oldtmcnv_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldtmcnv_main.spc
  **
...
TYPE ty_oldtmcnv IS RECORD (
     v_olvws_revolving_convert     olvw_revolving_convert%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldtmcnv          IN OUT  olpks_oldtmcnv_Main.Ty_oldtmcnv,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldtmcnv     IN  olpks_oldtmcnv_Main.Ty_oldtmcnv,
p_Prev_oldtmcnv IN OUT  olpks_oldtmcnv_Main.Ty_oldtmcnv,
p_Wrk_oldtmcnv      IN OUT  olpks_oldtmcnv_Main.Ty_oldtmcnv,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldtmcnv     IN  olpks_oldtmcnv_Main.Ty_oldtmcnv,
p_Prev_oldtmcnv     IN  olpks_oldtmcnv_Main.Ty_oldtmcnv,
p_Wrk_oldtmcnv      IN OUT  olpks_oldtmcnv_Main.Ty_oldtmcnv,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldtmcnv IN  olpks_oldtmcnv_Main.Ty_oldtmcnv,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldtmcnv_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldtmcnv_main FOR olpks_oldtmcnv_main
/