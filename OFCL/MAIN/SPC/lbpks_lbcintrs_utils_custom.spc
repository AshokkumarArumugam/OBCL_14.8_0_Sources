CREATE OR REPLACE PACKAGE Lbpks_Lbcintrs_Utils_Custom AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbcintrs_utils_custom.spc
  **
  ** Module     : The ICCF
  **
...
END Lbpks_Lbcintrs_Utils_Custom;
/
CREATE OR REPLACE Synonym Lbpkss_Lbcintrs_Utils_Custom FOR Lbpks_Lbcintrs_Utils_Custom
/