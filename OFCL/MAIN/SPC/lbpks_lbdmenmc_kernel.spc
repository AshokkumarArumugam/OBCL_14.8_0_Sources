CREATE OR REPLACE PACKAGE  lbpks_lbdmenmc_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdmenmc_kernel.spc
  **
...
END lbpks_lbdmenmc_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdmenmc_kernel FOR lbpks_lbdmenmc_kernel
/