CREATE OR REPLACE PACKAGE  olpks_oldpsupl_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldpsupl_main.spc
  **
...
TYPE ty_tb_v_oltbs_schedule_upload IS TABLE OF oltb_schedule_upload%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_ltbs_upload_exception_cs IS TABLE OF oltb_upload_exception_cs%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_oldpsupl IS RECORD (
     v_schedule_upload_master     oltb_schedule_upload_master%ROWTYPE,
     v_oltbs_schedule_upload    ty_tb_v_oltbs_schedule_upload,
     v_hedule_upload_master__exp     oltb_schedule_upload_master%ROWTYPE,
     v_schedule_upload_summary     olvw_schedule_upload_summary%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldpsupl          IN OUT  olpks_oldpsupl_Main.Ty_oldpsupl,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldpsupl     IN  olpks_oldpsupl_Main.Ty_oldpsupl,
p_Prev_oldpsupl     IN  olpks_oldpsupl_Main.Ty_oldpsupl,
p_Wrk_oldpsupl      IN OUT  olpks_oldpsupl_Main.Ty_oldpsupl,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldpsupl IN  olpks_oldpsupl_Main.Ty_oldpsupl,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldpsupl_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldpsupl_main FOR olpks_oldpsupl_main
/