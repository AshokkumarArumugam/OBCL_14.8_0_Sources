CREATE OR REPLACE PACKAGE  olpks_oldmsgvw_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldmsgvw_main.spc
  **
...
TYPE ty_tb_v_olvws_dly_msg_out IS TABLE OF olvw_dly_msg_out%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_oldmsgvw IS RECORD (
     v_oltbs_contract     oltb_contract%ROWTYPE,
     v_oltbs_dly_msg_out    ty_tb_v_oltbs_dly_msg_out,
     v_olvws_dly_msg_out    ty_tb_v_olvws_dly_msg_out,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldmsgvw          IN OUT  olpks_oldmsgvw_Main.Ty_oldmsgvw,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_oldmsgvw          IN olpks_oldmsgvw_Main.Ty_oldmsgvw,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldmsgvw     IN  olpks_oldmsgvw_Main.Ty_oldmsgvw,
p_Wrk_oldmsgvw      IN OUT  olpks_oldmsgvw_Main.Ty_oldmsgvw,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldmsgvw     IN  olpks_oldmsgvw_Main.Ty_oldmsgvw,
p_Prev_oldmsgvw IN OUT  olpks_oldmsgvw_Main.Ty_oldmsgvw,
p_Wrk_oldmsgvw      IN OUT  olpks_oldmsgvw_Main.Ty_oldmsgvw,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldmsgvw     IN  olpks_oldmsgvw_Main.Ty_oldmsgvw,
p_Prev_oldmsgvw     IN  olpks_oldmsgvw_Main.Ty_oldmsgvw,
p_Wrk_oldmsgvw      IN OUT  olpks_oldmsgvw_Main.Ty_oldmsgvw,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldmsgvw IN  olpks_oldmsgvw_Main.Ty_oldmsgvw,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldmsgvw_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldmsgvw_main FOR olpks_oldmsgvw_main
/