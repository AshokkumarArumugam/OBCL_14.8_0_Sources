CREATE OR REPLACE PACKAGE  olpks_oldmsprv_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldmsprv_kernel.spc
  **
...
END olpks_oldmsprv_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldmsprv_kernel FOR olpks_oldmsprv_Kernel
/