CREATE OR REPLACE PACKAGE lfpks_charge_custom AS
/*----------------------------------------------------------------------------------------------------
**
** File Name	: lfpks_charge_custom.SPC
**
...
END lfpks_charge_custom;
/


CREATE or replace SYNONYM lfpkss_charge_custom FOR lfpks_charge_custom
/