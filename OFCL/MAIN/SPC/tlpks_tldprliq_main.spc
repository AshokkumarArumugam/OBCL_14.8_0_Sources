CREATE OR REPLACE PACKAGE  tlpks_tldprliq_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldprliq_main.spc
  **
  ** Module     : TL
  ** 
...
TYPE ty_tb_v_fmem_lor_int_params__a IS TABLE OF tltb_fmem_lor_int_params%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_tltbs_lor_ssi_details IS TABLE OF tltb_lor_ssi_details%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_tldprliq IS RECORD (
     v_tltbs_fmem_lor_int_params     tltb_fmem_lor_int_params%ROWTYPE,
     v_fmem_lor_int_params__a    ty_tb_v_fmem_lor_int_params__a,
     v_tltbs_lor_ssi_details    ty_tb_v_tltbs_lor_ssi_details,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_tldprliq          IN OUT  tlpks_tldprliq_Main.Ty_tldprliq,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Wrk_tldprliq IN  tlpks_tldprliq_Main.Ty_tldprliq,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tldprliq_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tldprliq_main FOR tlpks_tldprliq_main
/