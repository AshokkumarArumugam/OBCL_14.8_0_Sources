CREATE OR REPLACE PACKAGE  tlpks_tldtrfee_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldtrfee_main.spc
  **
...
TYPE ty_tb_ltbs_contract_fee_master IS TABLE OF tltb_contract_fee_master%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_tltbs_contract_fee IS TABLE OF tltb_contract_fee%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_tldtrfee IS RECORD (
     v_oltbs_contract__fee     oltb_contract%ROWTYPE,
     v_tltbs_contract_master     tltb_contract_master%ROWTYPE,
     v_tltbs_contract_fee_master    ty_tb_ltbs_contract_fee_master,
     v_tltbs_contract_fee    ty_tb_v_tltbs_contract_fee,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_tldtrfee          IN OUT  tlpks_tldtrfee_Main.Ty_tldtrfee,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_tldtrfee     IN  tlpks_tldtrfee_Main.Ty_tldtrfee,
p_Prev_tldtrfee IN OUT  tlpks_tldtrfee_Main.Ty_tldtrfee,
p_Wrk_tldtrfee      IN OUT  tlpks_tldtrfee_Main.Ty_tldtrfee,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Wrk_tldtrfee IN  tlpks_tldtrfee_Main.Ty_tldtrfee,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tldtrfee_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tldtrfee_main FOR tlpks_tldtrfee_main
/