CREATE OR REPLACE PACKAGE  olpks_oldprefn_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldprefn_main.spc
  **
  ** Module     : OL
  ** 
...
TYPE ty_oldprefn IS RECORD (
     v_oltms_branch_preference     oltm_branch_preference%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldprefn_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldprefn_main FOR olpks_oldprefn_main
/