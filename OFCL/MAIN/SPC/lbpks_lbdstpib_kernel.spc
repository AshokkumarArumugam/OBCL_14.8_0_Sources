CREATE OR REPLACE PACKAGE  lbpks_lbdstpib_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdstpib_kernel.spc
  **
...
END lbpks_lbdstpib_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdstpib_kernel FOR lbpks_lbdstpib_kernel
/