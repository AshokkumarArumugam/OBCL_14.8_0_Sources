CREATE OR REPLACE PACKAGE olpks_oldrlovr_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldrlovr_kernel.spc
  **
...
g_oldrlovr olpks_oldrlovr_Main.Ty_oldrlovr;
...
END olpks_oldrlovr_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldrlovr_kernel FOR olpks_oldrlovr_kernel
/