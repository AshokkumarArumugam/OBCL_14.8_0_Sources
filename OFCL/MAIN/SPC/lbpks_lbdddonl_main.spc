CREATE OR REPLACE PACKAGE  lbpks_lbdddonl_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdddonl_main.spc
  **
...
p_Wrk_lbdddonl IN  lbpks_lbdddonl_Main.Ty_lbdddonl,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbdddonl_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdddonl_main FOR lbpks_lbdddonl_main
/