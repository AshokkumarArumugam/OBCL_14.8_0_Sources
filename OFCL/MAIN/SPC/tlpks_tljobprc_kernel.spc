CREATE OR REPLACE PACKAGE  tlpks_tljobprc_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tljobprc_kernel.spc
  **
...
END tlpks_tljobprc_kernel;
/
CREATE OR REPLACE SYNONYM tlpkss_tljobprc_kernel FOR tlpks_tljobprc_kernel
/