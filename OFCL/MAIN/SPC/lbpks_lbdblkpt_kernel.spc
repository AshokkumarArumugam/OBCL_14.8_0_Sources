CREATE OR REPLACE PACKAGE lbpks_lbdblkpt_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbdblkpt_kernel.spc
  **
  ...
  ** India
  ...
  Change Description : OBCL_14.5_LS_Bulk_Payment_Service
...
END lbpks_lbdblkpt_kernel;
/
CREATE OR REPLACE SYNONYM lbpkss_lbdblkpt_kernel FOR lbpks_lbdblkpt_kernel
/