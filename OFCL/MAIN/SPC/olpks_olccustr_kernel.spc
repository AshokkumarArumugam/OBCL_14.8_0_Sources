CREATE OR REPLACE PACKAGE  olpks_olccustr_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_olccustr_kernel.spc
  **
  ** Module     : Core
  ** 
...
END olpks_olccustr_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_olccustr_kernel FOR olpks_olccustr_kernel
/