CREATE OR REPLACE PACKAGE  olpks_oldirrnq_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldirrnq_kernel.spc
  **
...
END olpks_oldirrnq_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_oldirrnq_kernel FOR olpks_oldirrnq_kernel
/