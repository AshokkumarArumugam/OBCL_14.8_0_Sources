CREATE OR REPLACE PACKAGE  tlpks_tldposdt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldposdt_main.spc
  **
...
TYPE ty_tldposdt IS RECORD (
     v_tltbs_position_contract     tltb_position_contract%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_tldposdt          IN OUT  tlpks_tldposdt_Main.Ty_tldposdt,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_tldposdt          IN tlpks_tldposdt_Main.Ty_tldposdt,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_tldposdt     IN  tlpks_tldposdt_Main.Ty_tldposdt,
p_Wrk_tldposdt      IN OUT  tlpks_tldposdt_Main.Ty_tldposdt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_tldposdt     IN  tlpks_tldposdt_Main.Ty_tldposdt,
p_Prev_tldposdt IN OUT  tlpks_tldposdt_Main.Ty_tldposdt,
p_Wrk_tldposdt      IN OUT  tlpks_tldposdt_Main.Ty_tldposdt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_tldposdt     IN  tlpks_tldposdt_Main.Ty_tldposdt,
p_Prev_tldposdt     IN  tlpks_tldposdt_Main.Ty_tldposdt,
p_Wrk_tldposdt      IN OUT  tlpks_tldposdt_Main.Ty_tldposdt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_tldposdt IN  tlpks_tldposdt_Main.Ty_tldposdt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tldposdt_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tldposdt_main FOR tlpks_tldposdt_main
/