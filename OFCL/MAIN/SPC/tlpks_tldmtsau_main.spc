CREATE OR REPLACE PACKAGE  tlpks_tldmtsau_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : tlpks_tldmtsau_main.spc
  **
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_tldmtsau          IN OUT  tlpks_tldmtsau_Main.Ty_tldmtsau,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Exchange_Pattern   IN  VARCHAR2,
p_tldmtsau          IN tlpks_tldmtsau_Main.Ty_tldmtsau,
p_Err_Code        IN OUT VARCHAR2,
p_Err_Params      IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Product_Default         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_tldmtsau     IN  tlpks_tldmtsau_Main.Ty_tldmtsau,
p_Wrk_tldmtsau      IN OUT  tlpks_tldmtsau_Main.Ty_tldmtsau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_tldmtsau     IN  tlpks_tldmtsau_Main.Ty_tldmtsau,
p_Prev_tldmtsau IN OUT  tlpks_tldmtsau_Main.Ty_tldmtsau,
p_Wrk_tldmtsau      IN OUT  tlpks_tldmtsau_Main.Ty_tldmtsau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_tldmtsau     IN  tlpks_tldmtsau_Main.Ty_tldmtsau,
p_Prev_tldmtsau     IN  tlpks_tldmtsau_Main.Ty_tldmtsau,
p_Wrk_tldmtsau      IN OUT  tlpks_tldmtsau_Main.Ty_tldmtsau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_tldmtsau IN  tlpks_tldmtsau_Main.Ty_tldmtsau,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END tlpks_tldmtsau_main;
/
CREATE OR REPLACE SYNONYM tlpkss_tldmtsau_main FOR tlpks_tldmtsau_main
/