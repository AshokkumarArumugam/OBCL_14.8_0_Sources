CREATE OR REPLACE PACKAGE  olpks_oldjrnol_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldjrnol_main.spc
  **
...
TYPE ty_oldjrnol IS RECORD (
     v_oltbs_jrnl_log_de     oltb_jrnl_log_de%ROWTYPE,
     v_oltbs_batch_master     oltb_batch_master%ROWTYPE,
     v_cstb_ui_columns     cstb_ui_columns%ROWTYPE,
                 ty_olcbatop Olpks_Olcbatop_Main.ty_olcbatop,
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldjrnol     IN  olpks_oldjrnol_Main.Ty_oldjrnol,
p_Prev_oldjrnol     IN  olpks_oldjrnol_Main.Ty_oldjrnol,
p_Wrk_oldjrnol      IN OUT  olpks_oldjrnol_Main.Ty_oldjrnol,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldjrnol IN  olpks_oldjrnol_Main.Ty_oldjrnol,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldjrnol_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldjrnol_main FOR olpks_oldjrnol_main
/