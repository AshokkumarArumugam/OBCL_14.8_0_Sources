CREATE OR REPLACE PACKAGE  olpks_olcacadd_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_olcacadd_kernel.spc
  **
  ** Module     : Core
  ** 
...
END olpks_olcacadd_kernel;
/
CREATE OR REPLACE SYNONYM olpkss_olcacadd_kernel FOR olpks_olcacadd_kernel
/