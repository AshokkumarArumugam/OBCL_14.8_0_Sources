CREATE OR REPLACE PACKAGE  olpks_oldudevt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldudevt_main.spc
  **
  ** Module     : OL
  ** 
...
TYPE ty_oldudevt IS RECORD (
     ...
     v_olvws_audit     olvw_audit%ROWTYPE,
     v_olvws_event_summary     olvw_event_summary%ROWTYPE,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldudevt          IN OUT  olpks_oldudevt_Main.Ty_oldudevt,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldudevt     IN  olpks_oldudevt_Main.Ty_oldudevt,
p_Prev_oldudevt IN OUT  olpks_oldudevt_Main.Ty_oldudevt,
p_Wrk_oldudevt      IN OUT  olpks_oldudevt_Main.Ty_oldudevt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Wrk_oldudevt IN  olpks_oldudevt_Main.Ty_oldudevt,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldudevt_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldudevt_main FOR olpks_oldudevt_main
/