CREATE OR REPLACE PACKAGE  olpks_oldpnwrv_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldpnwrv_main.spc
  **
...
TYPE ty_tb__contract_penalty_waiver IS TABLE OF oltb_contract_penalty_waiver%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_oldpnwrv IS RECORD (
     v_oltbs_contract__sprv     oltb_contract%ROWTYPE,
     v_contract_penalty_waiver    ty_tb__contract_penalty_waiver,
...
FUNCTION Fn_Main       (p_Source            IN     VARCHAR2,
                        ...
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_oldpnwrv          IN OUT  olpks_oldpnwrv_Main.Ty_oldpnwrv,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Subsys_Pickup         (p_Source            IN VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_oldpnwrv     IN  olpks_oldpnwrv_Main.Ty_oldpnwrv,
p_Prev_oldpnwrv IN OUT  olpks_oldpnwrv_Main.Ty_oldpnwrv,
p_Wrk_oldpnwrv      IN OUT  olpks_oldpnwrv_Main.Ty_oldpnwrv,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_oldpnwrv     IN  olpks_oldpnwrv_Main.Ty_oldpnwrv,
p_Prev_oldpnwrv     IN  olpks_oldpnwrv_Main.Ty_oldpnwrv,
p_Wrk_oldpnwrv      IN OUT  olpks_oldpnwrv_Main.Ty_oldpnwrv,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_oldpnwrv IN  olpks_oldpnwrv_Main.Ty_oldpnwrv,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END olpks_oldpnwrv_main;
/
CREATE OR REPLACE SYNONYM olpkss_oldpnwrv_main FOR olpks_oldpnwrv_main
/