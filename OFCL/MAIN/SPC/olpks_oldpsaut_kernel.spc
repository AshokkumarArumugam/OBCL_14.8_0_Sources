CREATE OR REPLACE PACKAGE  olpks_oldpsaut_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldpsaut_kernel.spc
  **
...
END olpks_oldpsaut_kernel;
/
CREATE OR REPLACE Synonym olpkss_oldpsaut_kernel FOR olpks_oldpsaut_kernel
/