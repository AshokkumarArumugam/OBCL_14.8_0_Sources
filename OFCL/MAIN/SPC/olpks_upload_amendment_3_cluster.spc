CREATE OR REPLACE PACKAGE olpks_upload_amendment_3_cluster AS
/*----------------------------------------------------------------------------------------------------
**
** File Name	: olpks_upload_amendment_3_cluster.SPC
**
...
END olpks_upload_amendment_3_cluster;
/

CREATE or replace SYNONYM olpkss_upload_amendment_3_cluster FOR olpks_upload_amendment_3_cluster
/