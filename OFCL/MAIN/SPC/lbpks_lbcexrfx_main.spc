CREATE OR REPLACE PACKAGE  lbpks_lbcexrfx_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lbpks_lbcexrfx_main.spc
  **
...
TYPE ty_lbcexrfx IS RECORD (
     v_oltbs_contract__exch     oltb_contract%ROWTYPE,
...
p_Main_Function    IN  VARCHAR2,
                        p_Multi_Trip_Id     IN  VARCHAR2,
                        p_Request_No        IN     VARCHAR2,
                        p_lbcexrfx          IN OUT  lbpks_lbcexrfx_Main.Ty_lbcexrfx,
                        p_Status            IN OUT VARCHAR2 ,
                        p_Err_Code          IN OUT VARCHAR2,
                        p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
FUNCTION Fn_Build_Ts_List (p_Source    IN     VARCHAR2,
                        ...
                        p_Action_Code       IN     VARCHAR2,
p_Main_Function    IN  VARCHAR2,
p_lbcexrfx       IN    lbpks_lbcexrfx_Main.ty_lbcexrfx,
...
p_Main_Function    IN  VARCHAR2,
p_lbcexrfx     IN  lbpks_lbcexrfx_Main.Ty_lbcexrfx,
p_Prev_lbcexrfx IN OUT  lbpks_lbcexrfx_Main.Ty_lbcexrfx,
p_Wrk_lbcexrfx IN OUT  lbpks_lbcexrfx_Main.Ty_lbcexrfx,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Multi_Trip_Id    IN  VARCHAR2,
p_lbcexrfx     IN  lbpks_lbcexrfx_Main.Ty_lbcexrfx,
p_Prev_lbcexrfx     IN  lbpks_lbcexrfx_Main.Ty_lbcexrfx,
p_Wrk_lbcexrfx      IN OUT  lbpks_lbcexrfx_Main.Ty_lbcexrfx,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN ;
...
p_Wrk_lbcexrfx IN  lbpks_lbcexrfx_Main.Ty_lbcexrfx,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END lbpks_lbcexrfx_main;
/
CREATE OR REPLACE SYNONYM lbpkss_lbcexrfx_main FOR lbpks_lbcexrfx_main
/