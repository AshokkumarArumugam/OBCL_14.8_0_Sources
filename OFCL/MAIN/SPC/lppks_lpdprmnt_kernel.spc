CREATE OR REPLACE PACKAGE lppks_lpdprmnt_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : lppks_lpdprmnt_kernel.spc
  **
...
G_PRODUCT_TYPE  CHAR(1); --OBCL_14.5_SUPP_#33614564 CHANGES 
