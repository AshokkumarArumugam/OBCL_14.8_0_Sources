CREATE OR REPLACE PACKAGE  olpks_oldataut_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : olpks_oldataut_kernel.spc
  **
...
END olpks_oldataut_kernel;
/
CREATE OR REPLACE Synonym olpkss_oldataut_kernel FOR olpks_oldataut_kernel
/