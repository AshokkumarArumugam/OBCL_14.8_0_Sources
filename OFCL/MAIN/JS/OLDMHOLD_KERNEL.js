...
function fnPostNew_KERNEL(){
	...
	document.getElementById("BLK_MSG_HOLD__HOLDDATETIME").value = mainWin.AppDate;	//Bug#31400838
fireHTMLEvent(document.getElementById("BLK_MSG_HOLD__HOLDDATETIME"),"onpropertychange");
