...
function fnPostLoad_CVS_AUTH_KERNEL(screenArgs) {
  ...
  if(!fnProcessAuthOnLoad(screenArgs))
     ...
     fnEnableElement(document.getElementById("BLK_OLTBS_CONTRACT_REFUND_SUMMARY__TOTALREFUND"));
     fnEnableElement(document.getElementById("BLK_OLTBS_CONTRACT_REFUND_SUMMARY__REFUNDVALUEDATE"));
     gAction = 'NEW';
...
function fnPostExecuteQuery_KERNEL() {
    ...
    fnEnableElement(document.getElementById("BLK_OLTBS_CONTRACT_REFUND_SUMMARY__REMARKS"));
    document.getElementById("BLK_OLTBS_CONTRACT_REFUND_SUMMARY__REMARKS").readOnly = true;
    fnEnableElement(document.getElementById("BLK_OLTBS_CONTRACT_OVD__REMARKS"));
    document.getElementById("BLK_OLTBS_CONTRACT_OVD__REMARKS").readOnly = true;
	return true; 
}