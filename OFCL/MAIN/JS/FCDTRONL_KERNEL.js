...
**  Reason             : 
  Changed By         : Anusha k
  Changed On         : 26-Aug-2019
  Search String      : OBCL_14.1_SUPP_SMTB_#30120918
  
  Changed By         : Ashokkumar Arumugam
  Changed On         : 27-Feb-2020
  Search String      : OBCL_14.4_TAX_Changes#30956242
  
  Changed By         : Prakash Ravi
  Changed On         : 08-Apr-2020
...
**	Reason             : To invoke the contract screen from 360 Corporate customer view Screen
  ...
  Change Reason      : Explode Schedule Changes(Forward Porting) 
  
  Changed By         : Pallavi R
  Changed On         : 07-Oct-2021
  Search String      : OBCL_14.5_SMTB_#33418646 Changes
  Change Reason      : Schedule button is getting enabled after Adding the row only
  ...
  Changed On         : 09-SEP-2022
  Search String      : BUG#34559742
  Change Reason      : Added code checking the Borrower call form visited or not before settlement call form. 

  Changed By         : Chandra Achuta
  Changed On         : 25-JAN-2023
  Search String      : BUG#35015366
  Change Reason      : Added code for initialise the subsystem status while doing copy.
  
**Changed By         : Rashmi B V
**Date               : 10-Jun-2024
**Change Description : a. Changing the subsystem stat of Fee Call Form to U as post Resume repickup was  happening eventhough no dependent fields were changed 
					   b. Changing the subsystem stat of MIS to U as post Resume MIS data were getting deleted. 
**Search String      : Bug#ADD_36686743_1 

**Changed By         : Rashmi B V
**Date               : 27-Jul-2024
**Change Description : Changing the subsystem stat of MIS to S 
**Search String      : Bug#36871192 
****************************************************************************************************************************/
...
var gDisablePaidButton= false;
var gDisableBrowseButton = true;
//Schedule Upload Changes Starts
...
//Schedule Upload Changes Ends
//OBCL_14.1_SMTB_#31478827 Changes Ends
function fnPreAuthorize_KERNEL(){
    authFunction = 'FCDTRAUT';
    authUixml = 'FCDTRAUT';
    authScreenName = 'CVS_FAC_AUTH';
    gAction = 'EXECUTEQUERY';
    ArrFuncOrigin['FCDTRAUT'] = "KERNEL";
    ArrPrntFunc['FCDTRAUT'] = "";
    ArrPrntOrigin['FCDTRAUT'] = "";
    return true;
}
...
function fnPostExecuteQuery_KERNEL() { 
	...
	fnEnableElement(document.getElementById("BLK_OLTBS_CONTRACT__BTN_EXP_SCH"));//OBCL_14.1_SMTB_#31478827 Changes
	gDisablerdfschButton = true;	
	gDisablePaidButton = true;
	return true; 
}
function fn_PartSum(){
	screenArgs = new Array();
	screenArgs['Product_Type'] = 'F';
	screenArgs['FCCREF'] = document.getElementById("BLK_OLTBS_CONTRACT__CONTREFNO").value;
	screenArgs['FUNCTION_ID'] 	= 'LPSCOMNT';
...
function fnPreLaunchForm_CVS_DIARY_KERNEL(screenArgs ){
	//screenArgs = new Array();
	//screenArgs['Product_Type'] = 'F';
	screenArgs['FCCREF'] = document.getElementById("BLK_OLTBS_CONTRACT__CONTREFNO").value;
	parent.screenArgs =screenArgs;
...
//OBCL_14.1_SUPP_SMTB_#30120918 starts

function fnPostUnlock_KERNEL() {
	if (document.getElementById("BLK_OLTBS_CONTRACT__ONCEAUTH").value == 'Y')
	{
   	/*document.getElementById("BLK_LBTBS_SYNDICATION_MASTER__SUBSYSSTAT").value= 'LBCCONBW:U;LBCPARAT:U;LFCFEECF:S;LFCFESCH:S;OLCONDET:S;OLCTRMIS:S;OLCTRUDF:S;LBCPRTAX:S;LBCONPTY:S;CSSDRYET:S;LSCONPTY:U';*/
	//document.getElementById("BLK_LBTBS_SYNDICATION_MASTER__SUBSYSSTAT").value= 'LBCCONBW:U;LBCPARAT:U;LFCFEECF:S;LFCFESCH:D;OLCONDET:U;OLCTRMIS:S;OLCTRUDF:S;LBCPRTAX:S;LBCONPTY:S;CSSDRYET:S;LSCONPTY:U';
	//document.getElementById("BLK_LBTBS_SYNDICATION_MASTER__SUBSYSSTAT").value= 'LBCCONBW:U;LBCPARAT:U;LFCFEECF:D;LFCFESCH:D;OLCONDET:U;OLCTRMIS:S;OLCTRUDF:S;LBCPRTAX:S;LBCONPTY:S;CSSDRYET:S;LSCONPTY:U;TXCTRTAX:D'; /* OBCL_14.4_TAX_Changes#30956242 */
	  document.getElementById("BLK_LBTBS_SYNDICATION_MASTER__SUBSYSSTAT").value= 'LBCCONBW:U;LBCPARAT:U;LFCFEECF:D;LFCFESCH:D;OLCONDET:U;OLCTRMIS:S;OLCTRUDF:S;LBCPRTAX:S;LBCONPTY:S;CSSDRYET:S;LSCONPTY:U;TXCTRTAX:D;LBCAGDET:U;' /* BUG#32264871 */
	 //OBCL_14.1_SMTB_#31478827 Changes Starts 
	gDisableschblock = true;
	gDisablePaidButton = true; 
	gDisablerdfschButton =false;
	fnEnableElement(document.getElementById("BLK_OLTBS_CONTRACT__BTN_SCH_REDEFINE"));
	//OBCL_14.1_SMTB_#31478827 Changes Ends 
	}
	else {
		gDisablerdfschButton = true;//OBCL_14.1_SMTB_#31478827 Changes	
	}
	
	//BUG#30920049 Changes start
	if (document.getElementById("BLK_OLTBS_CONTRACT__ONCEAUTH").value == 'N' && document.getElementById("BLK_OLTBS_CONTRACT_EVENT_LOG__TXNSTAT").value == 'H')
	{
	//document.getElementById("BLK_LBTBS_SYNDICATION_MASTER__SUBSYSSTAT").value= 'LBCCONBW:U;LBCPARAT:U;LFCFEECF:D;LFCFESCH:D;OLCONDET:U;OLCTRMIS:S;OLCTRUDF:S;LBCPRTAX:S;LBCONPTY:S;CSSDRYET:S;LSCONPTY:U';// OBCL_14.1_SUPP_SMTB_#30562635 
	  //document.getElementById("BLK_LBTBS_SYNDICATION_MASTER__SUBSYSSTAT").value= 'LBCCONBW:U;LBCPARAT:U;LFCFEECF:D;LFCFESCH:D;OLCONDET:U;OLCTRMIS:S;OLCTRUDF:S;LBCPRTAX:S;LBCONPTY:S;CSSDRYET:S;LSCONPTY:U;LBCAGDET:U'; /* BUG#32264871 *///Bug#ADD_36686743_1 Commented
	  //document.getElementById("BLK_LBTBS_SYNDICATION_MASTER__SUBSYSSTAT").value= 'LBCCONBW:U;LBCPARAT:U;LFCFEECF:U;LFCFESCH:D;OLCONDET:U;OLCTRMIS:U;OLCTRUDF:S;LBCPRTAX:S;LBCONPTY:S;CSSDRYET:S;LSCONPTY:U;LBCAGDET:U'; /* BUG#32264871 *///Bug#ADD_36686743_1 Added
	  document.getElementById("BLK_LBTBS_SYNDICATION_MASTER__SUBSYSSTAT").value= 'LBCCONBW:U;LBCPARAT:U;LFCFEECF:U;LFCFESCH:D;OLCONDET:U;OLCTRMIS:S;OLCTRUDF:S;LBCPRTAX:S;LBCONPTY:S;CSSDRYET:S;LSCONPTY:U;LBCAGDET:U'; //Bug#36871192
	}
  	//BUG#30920049 Changes ends
...
//OBCL_14.1_SUPP_SMTB_#30120918 ends
/* OBCL_14.4_TAX_Changes#30956242 :: Starts */
function fnPostCopy_KERNEL(){
	fnPopulateSubSystemValues(document.getElementById("BLK_LBTBS_SYNDICATION_MASTER__SUBSYSSTAT").value);   //BUG#35015366  Code Added
	var l_statusStr = document.getElementById('BLK_LBTBS_SYNDICATION_MASTER__SUBSYSSTAT').value;
	var stat = extractSubSysStat(l_statusStr, 'TXCTRTAX');	
	if (stat != 'D'){
		setSubSystemAsChanged('TXCTRTAX');
	}
	return true;
}
/* OBCL_14.4_TAX_Changes#30956242 :: Ends */
//OBCL_14.1_SMTB_#31478827 Changes 
function fnRedfine(){
	if (document.getElementById("BLK_OLTBS_CONTRACT__ONCEAUTH").value == 'Y'){	
		g_prev_gAction = gAction;
		...
		gAction = g_prev_gAction;
		fnEnableMEBlock("BLK_CONT_SCH",true);	
		fnDisableElement(document.getElementById("BLK_OLTBS_CONTRACT__BTN_SCH_REDEFINE"));
		fnEnableElement(document.getElementById("BLK_OLTBS_CONTRACT__BTN_SCH_PAID"));   
		gDisableschblock = false;
		gDisablePaidButton = false;
		gDisablerdfschButton =true;
	} 
	return true; 
}
function fnExpSch() {
	...
	fnSubScreenMain('FCDTRONL', 'FCDTRONL', 'CVS_FEE_PAY_SCH', false); 
	return true; 
} 
function fnSchPaid() {
	fnSubScreenMain('FCDTRONL','FCDTRONL','CVS_SCH_PAID', false); 
	return true; 
}
function fnInTab_TAB_FEE_SCH_KERNEL() {
	debugger;
	if (gEnableButton)	{
		fnEnableElement(document.getElementById("BLK_OLTBS_CONTRACT__BTN_EXP_SCH"));
	}

	if (gDisablerdfschButton){
		fnDisableElement(document.getElementById("BLK_OLTBS_CONTRACT__BTN_SCH_REDEFINE"));
	}
	if (gDisablePaidButton) {
		fnDisableElement(document.getElementById("BLK_OLTBS_CONTRACT__BTN_SCH_PAID")); 
	}
	if (gDisableschblock)    { 
     fnEnableMEBlock("BLK_CONT_SCH",false);
	}
	//OBCL_14.5_SMTB_#33418646 Changes Starts 
    ...
    if (((gAction == 'NEW') || (gAction == 'MODIFY')) && gDisableBrowseButton) {
        if (onceAuth != 'Y')  {
            fnEnableUploadBtnElement(document.getElementById("BLK_OLTBS_CONTRACT__BTN_SCHUPLD"));
        }
        else {
            fnDisableUploadBtnElement(document.getElementById("BLK_OLTBS_CONTRACT__BTN_SCHUPLD"));
        }
    }
    else {
        fnDisableUploadBtnElement(document.getElementById("BLK_OLTBS_CONTRACT__BTN_SCHUPLD"));
    }
	//OBCL_14.5_SMTB_#33418646 Changes Ends
	return true;
}
...
/*function fnPostFocus_KERNEL() {
    var onceAuth = document.getElementById("BLK_OLTBS_CONTRACT__ONCEAUTH").value;
    if (((gAction == 'NEW') || (gAction == 'MODIFY')) && gDisableBrowseButton) {
        if ((selectNodes(dbDataDOM, "//BLK_CONT_SCH").length > 0) && (onceAuth == 'N') ) {
            fnEnableUploadBtnElement(document.getElementById("BLK_OLTBS_CONTRACT__BTN_SCHUPLD"));
        }
        else {
            fnDisableUploadBtnElement(document.getElementById("BLK_OLTBS_CONTRACT__BTN_SCHUPLD"));
...
function fnSchedulesUploadValidation(rows) {
    for (var i = 0;i < 2;i++) {
        ...
        if (cells.length > 1) {
            ...
            if (i == 1) {
                if ((cells[0].toUpperCase() != 'Component'.toUpperCase()) || (cells[1].toUpperCase() != 'Start Date'.toUpperCase())|| (cells[2].toUpperCase() != 'End Date'.toUpperCase()) || (cells[3].toUpperCase() != 'Number of Schedules'.toUpperCase()) || (cells[4].toUpperCase() != 'Frequency'.toUpperCase()) || (cells[5].toUpperCase() != 'Unit'.toUpperCase()) || (cells[6].toUpperCase() != 'Amount'.toUpperCase())) {
                    fnResetUpload();//reset upload parameters
                    errCode = 'LB-UPD-013';//alert("Please upload a valid CSV file.");
                    return false;
                }
                ...
                for (var j = 0;j < cells.length - 1;j++) {
                    ...
                    if (cells[j] != "" && cells[j] != '~END~') {
                        ...
                        if (currObject == undefined) {
							...
							if (currObject.getAttribute("name")=="ENDDT") {
								l = j;
								j = j - 1;
								continue;
                            }
...
function fnBackEndCall() {
    ...
    if (dbDataDOM.documentElement.nodeName != dataSrcLocationArray[0]) {
        ...
        var removeNode = selectNodes(orgDom, getXPathQuery("BLK_OLTBS_CONTRACT"));
...
function fnSchedulesUpload(e) {
    ...
    blockId = "BLK_CONT_SCH";//block id to upload the CSV file
    fileUploadBtn = document.getElementById("BLK_OLTBS_CONTRACT__BTN_SCHUPLD");
    if (gAction == 'NEW' || gAction == 'MODIFY' || gAction == 'SUBSYSPKP_NEW' || gAction == 'SUBSYSPKP_MODIFY') {
