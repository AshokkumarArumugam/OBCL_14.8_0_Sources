...
if(!fnProcessAuthOnLoad(screenArgs))
        return false;
	   fnEnableElement(document.getElementById("BLK_CONTRACTDETAILS__BTN_AUTH"));
	   gAction = 'AUTH';
	   return true;
}
...
function fnPostExecuteQuery_KERNEL() {
	   ...
	   var s = document.getElementById("BLK_CONTRACTDETAILS__CONTREFNO").value;
      return true;
}
...
function Fn_Auth(){
	...
	fnDisableElement(document.getElementById("BLK_CONTRACTDETAILS__BTN_AUTH"));        
			disableForm();
		}	
        return true;
    }
