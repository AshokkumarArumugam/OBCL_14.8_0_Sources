...
function fnPayRcvUpld(e) {
    ...
    blockId = "BLK_OLTBS_PAY_RECV_UPLOAD";//block id to upload the CSV file
    fileUploadBtn = document.getElementById("BLK_OLTBS_PAY_RECV_UPL_MASTER__BTN_FILE_UPD");
        ...
        if (regex.test(fileUploadBtn.value.toLowerCase())) {
            if (typeof (FileReader) != undefined) {
                ...
                reader.onload = function (e) {
					...
					document.getElementById("BLK_OLTBS_PAY_RECV_UPL_MASTER__FILE_NAME").value=fileUploadBtn.value.split('\\').pop();
...
{
  if (document.getElementById("BLK_OLTBS_PAY_RECV_UPL_MASTER_AU__AUTH_STAT").value == "A")
{
DisableToolbar_buttons("Authorize");
DisableToolbar_buttons("Delete");
}
  if (document.getElementById("BLK_OLTBS_PAY_RECV_UPL_MASTER_AU__AUTH_STAT").value == "U")
{
...
function fnPostFocus_KERNEL() {
  /*  var componentFlag = true;
    ...
    if (((gAction == 'NEW') || (gAction == 'MODIFY')) && gDisableBrowseButton) {
        fnEnableUploadBtnElement(document.getElementById("BLK_OLTBS_PAY_RECV_UPL_MASTER__BTN_FILE_UPD")); 
    }
    else {
        fnDisableUploadBtnElement(document.getElementById("BLK_OLTBS_PAY_RECV_UPL_MASTER__BTN_FILE_UPD"));
    }
    return true;
}
