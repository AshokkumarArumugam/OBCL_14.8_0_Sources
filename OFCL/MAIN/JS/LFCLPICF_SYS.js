...
msgxml += '      <FN PARENT="BLK_PRODUCT_MAIN" RELATION_TYPE="N" TYPE="BLK_PRODUCT_ICCF">AMORTIZATIONCONSTCOMPONENT~SPECIALRATETYPE~PRODUCT~COMPONENT~COMPONENTDESCRIPTION~EVENT~BASISAMOUNTTYPE~RATETYPE~SPECIALPENALTY~CHGDURINGAMEND~RATECODEUSAGE~RULE~BORROWLENDIND~RATECALCTYPE~REFINANCEREQD~STOPAPPLICATION~COMPONENTNO~MARGINAPPLICATION~MARGINBASIS~COMPONENTSRNO~PROPAGATIONREQD~SHOWNINCONTRACTMAINSCR~ONCEAUTH~BASISAMTCATEGORY~PENALTYSTARTDATEBASIS~ACCRUALREQD~RESETTENOR~RATEREVNMETHOD~INTCOMPUTATION~HOLCOMPOUND~DEFAULTWAIVER~LIQUIDITYPREMCOMP~LIQUIDITYPREMTYPE~AUTORATECODE~FIXEDRATETYPE~REAPPLYINTONPREPAIDAMT~REAPPLYINTONOUTSTAMT~NOINTONPREMATUREWITHDRWL~FIXEDRATECODE~RATECODE~PREPAYMENTPENALTYRATECODE~DISCACCRAPP~BILLINGNOTICEREQD~BILLINGNOTICEDAYS~RETAINMAINCOMPPROP~CONSIDERFORLIQ~BASISAMT~PRODDESC~EVENTFORASSOCDESC~BASISAMTTAGDESC~DISBASISAMTCATDESC~RULEDESC~AUTORATECODEDESC~RATECODEDESC~PREPAYMENTPENALTYRATECDDESC~FIXEDRATECODEDESC~CLASSDESC~NEGINTRATEALL~ORIGCOMP~NEGATIVECLASSCODE~SKIMPAYRECEIVE~SKIMCOMPONENT~MAXSKIMINSTANCEALWD~RATEFIXINGREQD</FN>'; 
msgxml += '    </FLD>'; 
...
var queryFields = new Array();    //Values should be set inside LFCLPICF.js, in "BlockName__FieldName" format
var pkFields    = new Array();    //Values should be set inside LFCLPICF.js, in "BlockName__FieldName" format
...
var modifyAmendArr = {"BLK_PRODUCT_ICCF":["ACCRUALREQD","AMORTIZATIONCONSTCOMPONENT","AUTORATECODE","BASISAMOUNTTYPE","BASISAMT","BASISAMTCATEGORY","BILLINGNOTICEDAYS","BILLINGNOTICEREQD","BORROWLENDIND","CHGDURINGAMEND","COMPONENTNO","COMPONENTSRNO","CONSIDERFORLIQ","DEFAULTWAIVER","DISCACCRAPP","EVENT","FIXEDRATECODE","FIXEDRATETYPE","HOLCOMPOUND","INTCOMPUTATION","LIQUIDITYPREMCOMP","LIQUIDITYPREMTYPE","MARGINAPPLICATION","MARGINBASIS","NOINTONPREMATUREWITHDRWL","PENALTYSTARTDATEBASIS","PREPAYMENTPENALTYRATECODE","PROPAGATIONREQD","RATECALCTYPE","RATECODE","RATECODEUSAGE","RATEREVNMETHOD","RATETYPE","REAPPLYINTONOUTSTAMT","REAPPLYINTONPREPAIDAMT","REFINANCEREQD","RESETTENOR","RETAINMAINCOMPPROP","RULE","SHOWNINCONTRACTMAINSCR","SKIMCOMPONENT","SKIMPAYRECEIVE","SPECIALPENALTY","SPECIALRATETYPE","STOPAPPLICATION"]};
...
ArrFuncOrigin["LFCLPICF"]="KERNEL";
ArrPrntFunc["LFCLPICF"]="";
ArrPrntOrigin["LFCLPICF"]="";
ArrRoutingType["LFCLPICF"]="X";


 // Code for Loading Cluster/Custom js File Starts
ArrClusterModified["LFCLPICF"]="N";
ArrCustomModified["LFCLPICF"]="N";
