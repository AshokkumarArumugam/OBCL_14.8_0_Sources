...
//----------------------------------------------------------------------------------------------------------------------
var fieldNameArray = {"BLK_HEADER":"MODULE~CONTRACT_REF_NO~MAKER_ID~MAKER_DT_STAMP~CHECKER_ID~CHECKER_DT_STAMP~EVENT_SEQ_NO~EVENT_DATE~EVENT_CODE~CONTRACT_STATUS~AUTH_STATUS~INTRATE~TXT_VALUEDATE~TXT_MATURITYDATE~TXT_CCY~TXT_AMOUNT~CONTRACT_REF_NO1~TXT_REFRATE~VISITED_UI~VISITED_MESSAGE~REKEY_TXTCCY~REKEY_TXTAMOUNT~REKEY_TXTVALDT~REKEY_TXTMATDT~REKEY_INTRT","BLK_OLTBS_CONTRACT_CHANGE_LOG":"CONTRACT_REF_NO~EVENT_SEQ_NO~CHANGE_SEQ_NO~DATE_CHANGED~FIELD_CHANGED~FIELD_DESCRIPTION~OLD_VALUE~OLD_DISPLAY_VALUE~NEW_VALUE~NEW_DISPLAY_VALUE","BLK_CONTRACT_OVD":"CONTRACT_REF_NO~EVENT_SEQ_NO~OVD_SEQ_NO~MODULE~ERR_CODE~PARAMETERS~ONLINE_AUTH_ID~REMARKS~AUTH_BY~AUTH_DT_STAMP~TXT_STATUS~OVD_STATUS~CONFIRMED~OVD_TYPE~OVDSTATDESC~TXTOVD"};

var multipleEntryPageSize = {"BLK_OLTBS_CONTRACT_CHANGE_LOG" :"15" ,"BLK_CONTRACT_OVD" :"15" };

var multipleEntrySVBlocks = "";

var tabMEBlks = {"CVS_DRAWDOWN_AUTH__TAB_MAIN":"BLK_OLTBS_CONTRACT_CHANGE_LOG~BLK_CONTRACT_OVD"};

var msgxml=""; 
msgxml += '    <FLD>'; 
msgxml += '      <FN PARENT="" RELATION_TYPE="1" TYPE="BLK_HEADER">MODULE~CONTRACT_REF_NO~MAKER_ID~MAKER_DT_STAMP~CHECKER_ID~CHECKER_DT_STAMP~EVENT_SEQ_NO~EVENT_DATE~EVENT_CODE~CONTRACT_STATUS~AUTH_STATUS~INTRATE~TXT_VALUEDATE~TXT_MATURITYDATE~TXT_CCY~TXT_AMOUNT~CONTRACT_REF_NO1~TXT_REFRATE~VISITED_UI~VISITED_MESSAGE~REKEY_TXTCCY~REKEY_TXTAMOUNT~REKEY_TXTVALDT~REKEY_TXTMATDT~REKEY_INTRT</FN>'; 
...
var strScreenName = "CVS_DRAWDOWN_AUTH";
var qryReqd = "Y";
var txnBranchFld = "" ;
var originSystem = "";
//----------------------------------------------------------------------------------------------------------------------
...
var queryFields = new Array();    //Values should be set inside LBDDDAUT.js, in "BlockName__FieldName" format
var pkFields    = new Array();    //Values should be set inside LBDDDAUT.js, in "BlockName__FieldName" format
...
ArrFuncOrigin["LBDDDAUT"]="KERNEL";
ArrPrntFunc["LBDDDAUT"]="";
ArrPrntOrigin["LBDDDAUT"]="";
ArrRoutingType["LBDDDAUT"]="X";


 // Code for Loading Cluster/Custom js File Starts
ArrClusterModified["LBDDDAUT"]="N";
ArrCustomModified["LBDDDAUT"]="N";
...
var scrArgSource = {"OLCSTINF":"BLK_HEADER__CONTRACT_REF_NO1","LBDMSGVW":"BLK_HEADER__CONTRACT_REF_NO1~"};
var scrArgVals = {"OLCSTINF":"","LBDMSGVW":"~EXECUTE_QUERY"};
var scrArgDest = {};
