...
//----------------------------------------------------------------------------------------------------------------------
var fieldNameArray = {"BLK_CITY_HOLIDAY_MASTER":"FIN_CENTRE~YEAR~WEEKLYHOLIDAYS~UNEXPHOL~MAKER~MAKERSTAMP~CHECKER~CHECKERSTAMP~MODNO~TXNSTAT~AUTHSTAT~ONCEAUTH","BLK_CITY_HOLIDAY":"FIN_CENTRE~YEAR~MONTH~HOLIDAYLIST"};

var multipleEntryPageSize = {"BLK_CITY_HOLIDAY" :"15" };

var multipleEntrySVBlocks = "";

var tabMEBlks = {"CVS_MAIN__TAB_MAIN":"BLK_CITY_HOLIDAY"};

var msgxml=""; 
msgxml += '    <FLD>'; 
msgxml += '      <FN PARENT="" RELATION_TYPE="1" TYPE="BLK_CITY_HOLIDAY_MASTER">FIN_CENTRE~YEAR~WEEKLYHOLIDAYS~UNEXPHOL~MAKER~MAKERSTAMP~CHECKER~CHECKERSTAMP~MODNO~TXNSTAT~AUTHSTAT~ONCEAUTH</FN>'; 
msgxml += '      <FN PARENT="BLK_CITY_HOLIDAY_MASTER" RELATION_TYPE="N" TYPE="BLK_CITY_HOLIDAY">FIN_CENTRE~YEAR~MONTH~HOLIDAYLIST</FN>'; 
msgxml += '    </FLD>'; 
...
var msgxml_sum=""; 
msgxml_sum += '    <FLD>'; 
msgxml_sum += '      <FN PARENT="" RELATION_TYPE="1" TYPE="BLK_CITY_HOLIDAY_MASTER">AUTHSTAT~TXNSTAT~FIN_CENTRE~YEAR</FN>'; 
msgxml_sum += '    </FLD>'; 

var detailFuncId = "OLDFCHOL";
var defaultWhereClause = "";
var defaultOrderByClause ="";
var multiBrnWhereClause ="";
var g_SummaryType ="S";
var g_SummaryBtnCount =0;
var g_SummaryBlock ="BLK_CITY_HOLIDAY_MASTER";
//----------------------------------------------------------------------------------------------------------------------
//***** CODE FOR DATABINDING *****
//----------------------------------------------------------------------------------------------------------------------
 var relationArray = {"BLK_CITY_HOLIDAY_MASTER" : "","BLK_CITY_HOLIDAY" : "BLK_CITY_HOLIDAY_MASTER~N"}; 

 var dataSrcLocationArray = new Array("BLK_CITY_HOLIDAY_MASTER","BLK_CITY_HOLIDAY"); 
...
//***** CODE FOR LOVs *****
//----------------------------------------------------------------------------------------------------------------------
var lovInfoFlds = {"BLK_CITY_HOLIDAY_MASTER__FIN_CENTRE__LOV_FC":["BLK_CITY_HOLIDAY_MASTER__FIN_CENTRE~BLK_CITY_HOLIDAY_MASTER__TXT_FIN_CENTRE_DESC~","","N~N",""]};
...
//----------------------------------------------------------------------------------------------------------------------
var multipleEntryIDs = new Array("BLK_CITY_HOLIDAY");
...
//***** SCRIPT FOR ATTACHED CALLFORMS *****
 ...
 var CallFormArray= new Array("CSCFNUDF~BLK_CITY_HOLIDAY_MASTER"); 
...
ArrFuncOrigin["OLDFCHOL"]="KERNEL";
ArrPrntFunc["OLDFCHOL"]="";
ArrPrntOrigin["OLDFCHOL"]="";
ArrRoutingType["OLDFCHOL"]="X";


 // Code for Loading Cluster/Custom js File Starts
ArrClusterModified["OLDFCHOL"]="N";
ArrCustomModified["OLDFCHOL"]="N";
