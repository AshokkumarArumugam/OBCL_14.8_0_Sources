...
//----------------------------------------------------------------------------------------------------------------------
var fieldNameArray = {"BLK_PARTICIPANT":"CONTRACTREFNO~TXT_USER_REFNO~CUSTOMERNO~BRANCHCODE~TXT_CUSTOMER_NAME~TXT_PRODUCT~TXT_PRODUCT_DESC~TXT_PRODUCT_TYPE~TXT_PRODUCT_TYPE_DESC~TXT_PURPOSE_SYNDICATION~TXT_FACILITY_NAME~TXT_TOTAL_RATE","BLK_PART_MARGIN_COMPONENT":"BRANCHCODE~CONTRACTREFNO~CUSTOMERNO~COMPONENT~CURRENCY~SLABTIER~AMTORPERCENT~TXT_USER_REF_NO~TXT_CUSTOMER_NAME~TXT_FACILITY_REF_NO~TXT_COMPONENT_DESCRIPTION~TXT_BOOK_DATE~TXT_VALUE_DATE","BLK_PART_MARGIN_CCY":"CCY~BRANCHCODE~CUSTOMERNO~CONTRACTREFNO~COMPONENT~TXT_CCY_DESC","BLK_PART_MARGIN_EFFDATE":"BRANCHCODE~CUSTOMERNO~COMPONENT~CONTRACTREFNO~CCY~LASTCHAGETIMESTAMP~RECALCREQD~EFFECTIVEDATE","BLK_PART_MARGIN_RATE":"MARGIN~COMPONENT~EFFECTIVEDATE~CUSTOMERNO~CCY~MARGINRATE~FROMBASISAMT~CONTRACTREFNO~TOBASISAMT~BRANCHCODE~SEQ_NO~MARGINRECORDSTATUS","BLK_PARTICIPANT_MARGIN_RATE":"CONTRACTREFNO~BRANCHCODE~CUSTOMERNO~COMPONENT~EFFECTIVEDATE~SEQNO~MARGINRECORDSTATUS~CCY~MARGIN~PARTICIPANT~FROMBASISAMT~MARGINRATE~TOBASISAMT~TXT_PARTICIPANT_NAME~TXT_ASSET_RATIO"};
...
var msgxml=""; 
msgxml += '    <FLD>'; 
msgxml += '      <FN PARENT="" RELATION_TYPE="1" TYPE="BLK_PARTICIPANT">CONTRACTREFNO~TXT_USER_REFNO~CUSTOMERNO~BRANCHCODE~TXT_CUSTOMER_NAME~TXT_PRODUCT~TXT_PRODUCT_DESC~TXT_PRODUCT_TYPE~TXT_PRODUCT_TYPE_DESC~TXT_PURPOSE_SYNDICATION~TXT_FACILITY_NAME~TXT_TOTAL_RATE</FN>'; 
...
msgxml += '      <FN PARENT="BLK_PART_MARGIN_EFFDATE" RELATION_TYPE="N" TYPE="BLK_PART_MARGIN_RATE">MARGIN~COMPONENT~EFFECTIVEDATE~CUSTOMERNO~CCY~MARGINRATE~FROMBASISAMT~CONTRACTREFNO~TOBASISAMT~BRANCHCODE~SEQ_NO~MARGINRECORDSTATUS</FN>'; 
...
var queryFields = new Array();    //Values should be set inside LPCRCMNT.js, in "BlockName__FieldName" format
var pkFields    = new Array();    //Values should be set inside LPCRCMNT.js, in "BlockName__FieldName" format
queryFields[0] = "BLK_PARTICIPANT__BRANCHCODE";
pkFields[0] = "BLK_PARTICIPANT__BRANCHCODE";
queryFields[1] = "BLK_PARTICIPANT__CONTRACTREFNO";
pkFields[1] = "BLK_PARTICIPANT__CONTRACTREFNO";
queryFields[2] = "BLK_PARTICIPANT__CUSTOMERNO";
pkFields[2] = "BLK_PARTICIPANT__CUSTOMERNO";
//----------------------------------------------------------------------------------------------------------------------
//***** CODE FOR AMENDABLE/SUBSYSTEM Fields *****
//----------------------------------------------------------------------------------------------------------------------
//***** Fields Amendable while Modification *****
var modifyAmendArr = {"BLK_PARTICIPANT_MARGIN_RATE":["MARGINRATE"],"BLK_PART_MARGIN_CCY":["CCY","TXT_CCY_DESC"],"BLK_PART_MARGIN_EFFDATE":["EFFECTIVEDATEI"],"BLK_PART_MARGIN_RATE":["FROMBASISAMT","MARGINRATE","TOBASISAMT"]};
...
ArrFuncOrigin["LPCRCMNT"]="KERNEL";
ArrPrntFunc["LPCRCMNT"]="";
ArrPrntOrigin["LPCRCMNT"]="";
ArrRoutingType["LPCRCMNT"]="X";


 // Code for Loading Cluster/Custom js File Starts
ArrClusterModified["LPCRCMNT"]="N";
ArrCustomModified["LPCRCMNT"]="N";
...
//----------------------------------------------------------------------------------------------------------------------
var scrArgName = {"CVS_PARTICIPANT":"PRODUCT~PRODUCTDESC~PRODTYPE~PRDTYPEDESC~CONTRACTREFNO~USERREFNO~CUSTOMERNO~CUSTOMERNAME~FACILITYNAME~PURPOSESYND~BRANCHCODE"};
var scrArgSource = {};
var scrArgVals = {"CVS_PARTICIPANT":"~~~~~~~~~~"};
var scrArgDest = {"CVS_PARTICIPANT":"BLK_PARTICIPANT__TXT_PRODUCT~BLK_PARTICIPANT__TXT_PRODUCT_DESC~BLK_PARTICIPANT__TXT_PRODUCT_TYPE~BLK_PARTICIPANT__TXT_PRODUCT_TYPE_DESC~BLK_PARTICIPANT__CONTRACTREFNO~BLK_PARTICIPANT__TXT_USER_REFNO~BLK_PARTICIPANT__CUSTOMERNO~BLK_PARTICIPANT__TXT_CUSTOMER_NAME~BLK_PARTICIPANT__TXT_FACILITY_NAME~BLK_PARTICIPANT__TXT_PURPOSE_SYNDICATION~BLK_PARTICIPANT__BRANCHCODE"};
