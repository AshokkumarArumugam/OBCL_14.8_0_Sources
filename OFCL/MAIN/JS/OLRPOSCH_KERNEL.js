...
{
	document.getElementById("BLK_REPORT__PM_APPLICATION_DATE").value = mainWin.AppDate;
	fireHTMLEvent(document.getElementById("BLK_REPORT__PM_APPLICATION_DATE"),"onpropertychange");
