...
var queryFields = new Array();    //Values should be set inside OLDFFLMT.js, in "BlockName__FieldName" format
var pkFields    = new Array();    //Values should be set inside OLDFFLMT.js, in "BlockName__FieldName" format
...
ArrFuncOrigin["OLDFFLMT"]="KERNEL";
ArrPrntFunc["OLDFFLMT"]="";
ArrPrntOrigin["OLDFFLMT"]="";
ArrRoutingType["OLDFFLMT"]="X";


 // Code for Loading Cluster/Custom js File Starts
ArrClusterModified["OLDFFLMT"]="N";
ArrCustomModified["OLDFFLMT"]="N";
