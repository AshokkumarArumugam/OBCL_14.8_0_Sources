...
//----------------------------------------------------------------------------------------------------------------------
var fieldNameArray = {"BLK_HEADER":"MODULE~CONTRACTREFNO~MAKERID~MAKERDTSTAMP~CHECKERID~CHECKERDTSTAMP~EVENTSEQNO~EVENTDATE~EVENTCODE~CONTRACTSTATUS~AUTHSTATUS~TXTREFRATE~LSTINTRTSIGN~INTRT~TXTCCY~TXTAMOUNT~TXTVALDT~TXTMATDT~VISITED_UI~CONTRACTREFNO1~TXTCOUNTERPARTY","BLK_OLTBS_CONTRACT_CHANGE_LOG":"CONTRACTREFNO~EVENTSEQNO~CHANGESEQNO~DATECHANGED~FIELDCHANGED~FIELDDESCRIPTION~OLDVALUE~OLDDISPLAYVALUE~NEWVALUE~NEWDISPLAYVALUE","BLK_CONTRACT_OVD":"CONTRACTREFNO~EVENTSEQNO~OVDSEQNO~MODULE~ERRCODE~PARAMETERS~ONLINEAUTHID~REMARKS~AUTHBY~AUTHDTSTAMP~TXTSTATUS~OVDSTATUS~CONFIRMED~OVDTYPE~OVDSTATDESC~TXTOVD"};
...
var msgxml=""; 
msgxml += '    <FLD>'; 
msgxml += '      <FN PARENT="" RELATION_TYPE="1" TYPE="BLK_HEADER">MODULE~CONTRACTREFNO~MAKERID~MAKERDTSTAMP~CHECKERID~CHECKERDTSTAMP~EVENTSEQNO~EVENTDATE~EVENTCODE~CONTRACTSTATUS~AUTHSTATUS~TXTREFRATE~LSTINTRTSIGN~INTRT~TXTCCY~TXTAMOUNT~TXTVALDT~TXTMATDT~VISITED_UI~CONTRACTREFNO1~TXTCOUNTERPARTY</FN>'; 
...
var queryFields = new Array();    //Values should be set inside LPDTRAUT.js, in "BlockName__FieldName" format
var pkFields    = new Array();    //Values should be set inside LPDTRAUT.js, in "BlockName__FieldName" format
...
ArrRoutingType["LPDTRAUT"]="X";


 // Code for Loading Cluster/Custom js File Starts
ArrClusterModified["LPDTRAUT"]="N";
ArrCustomModified["LPDTRAUT"]="N";
