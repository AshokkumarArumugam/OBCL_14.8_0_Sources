...
//----------------------------------------------------------------------------------------------------------------------
var fieldNameArray = {"BLK_AUTH_REKEY":"MATDT~VALDT~CONTRACTCCY~AMT~CCY~CPY~ESN~VRSNO~CONTREFNO~CONTREFNUM~INPUTBY~EVNTSQNO~EVTDT~EVTCD~MSGGENREQD~INTRATEAMT~TXTCOUNTERPARTY","BLK_CONTRACT_CHANGE_LOG":"CONREFNO~ESN~CHGSN~DTCHANGED~FLDCHANGED~FLDDESC~OLDVAL~OLDDISPVAL~NEWVAL~NEWDISPVAL","BLK_CONTRACT_OVD":"CONREFENO~EVNTSEQENO~OVDSEQNO~MOD~ERRCODE~ONLAUTHID~REMARK~AUTHBY~AUTHDTSTAMP~TXTSTAT~OVDSTAT~CONFIRMED~OVDREMARKS"};
...
var msgxml=""; 
msgxml += '    <FLD>'; 
msgxml += '      <FN PARENT="" RELATION_TYPE="1" TYPE="BLK_AUTH_REKEY">MATDT~VALDT~CONTRACTCCY~AMT~CCY~CPY~ESN~VRSNO~CONTREFNO~CONTREFNUM~INPUTBY~EVNTSQNO~EVTDT~EVTCD~MSGGENREQD~INTRATEAMT~TXTCOUNTERPARTY</FN>'; 
...
var queryFields = new Array();    //Values should be set inside LBDVMAUT.js, in "BlockName__FieldName" format
var pkFields    = new Array();    //Values should be set inside LBDVMAUT.js, in "BlockName__FieldName" format
...
ArrRoutingType["LBDVMAUT"]="X";


 // Code for Loading Cluster/Custom js File Starts
ArrClusterModified["LBDVMAUT"]="N";
ArrCustomModified["LBDVMAUT"]="N";
