...
msgxml += '      <FN PARENT="BLK_OLVWS_PAYMENT_SUMMARY" RELATION_TYPE="N" TYPE="BLK_MSGVW">AUTHSTAT~DCN~ESN~MEDIA~MESSAGE~MSGSTATUS~MSGTYPE~NAME~RECEIVER~REFERENCENO~RUNNINGNO~SWFTMSGTYPE~TESTINGSTATUS</FN>'; 
...
//----------------------------------------------------------------------------------------------------------------------
 var relationArray = {"BLK_OLVWS_PAYMENT_SUMMARY" : "","BLK_OLVWS_PAYMENT_BREAKUP" : "BLK_OLVWS_PAYMENT_SUMMARY~N","BLK_AUDITTRIAL" : "BLK_OLVWS_PAYMENT_SUMMARY~1","BLK_SCH_DTLS" : "BLK_OLVWS_PAYMENT_SUMMARY~N","BLK_AMOUNT_SCH_DTLS" : "BLK_OLVWS_PAYMENT_SUMMARY~N","BLK_OLTBS_CONTRACT_CONTROL" : "BLK_OLVWS_PAYMENT_SUMMARY~1","BLK_MSGVW" : "BLK_OLVWS_PAYMENT_SUMMARY~N","BLK_TRAN" : "BLK_OLVWS_PAYMENT_SUMMARY~N","BLK_SCHBREAKUP_HDR" : "BLK_OLVWS_PAYMENT_SUMMARY~1","BLK_OLVWS_PAYMENT_REFUND" : "BLK_OLVWS_PAYMENT_SUMMARY~1"}; 

 var dataSrcLocationArray = new Array("BLK_OLVWS_PAYMENT_SUMMARY","BLK_OLVWS_PAYMENT_BREAKUP","BLK_AUDITTRIAL","BLK_SCH_DTLS","BLK_AMOUNT_SCH_DTLS","BLK_OLTBS_CONTRACT_CONTROL","BLK_MSGVW","BLK_TRAN","BLK_SCHBREAKUP_HDR","BLK_OLVWS_PAYMENT_REFUND"); 
...
var queryFields = new Array();    //Values should be set inside OLDPMNSI.js, in "BlockName__FieldName" format
var pkFields    = new Array();    //Values should be set inside OLDPMNSI.js, in "BlockName__FieldName" format
...
ArrFuncOrigin["OLDPMNSI"]="KERNEL";
ArrPrntFunc["OLDPMNSI"]="OLDPMNT";
ArrPrntOrigin["OLDPMNSI"]="KERNEL";
ArrRoutingType["OLDPMNSI"]="X";


 // Code for Loading Cluster/Custom js File Starts
ArrClusterModified["OLDPMNSI"]="N";
ArrCustomModified["OLDPMNSI"]="N";
...
//----------------------------------------------------------------------------------------------------------------------
var actStageArry = {"QUERY":"1","NEW":"2","MODIFY":"1","AUTHORIZE":"1","DELETE":"1","CLOSE":"1","REOPEN":"1","REVERSE":"1","ROLLOVER":"1","CONFIRM":"1","LIQUIDATE":"1","SUMMARYQUERY":"2"};
