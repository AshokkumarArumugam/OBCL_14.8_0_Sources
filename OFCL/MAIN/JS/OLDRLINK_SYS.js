...
//----------------------------------------------------------------------------------------------------------------------
var fieldNameArray = {"BLK_LBTM_STP_CONTRACT_RELINK":"LSREFNO~LLREFNO~LDREFNO~OLDLDREFNO~VALIDATEVALUEDTAVAILABILITY~DELINK_COMMITMENT~MAKER~MAKERSTAMP~CHECKER~CHECKERSTAMP~MODNO~TXNSTAT~AUTHSTAT~ONCEAUTH"};
...
var msgxml=""; 
msgxml += '    <FLD>'; 
msgxml += '      <FN PARENT="" RELATION_TYPE="1" TYPE="BLK_LBTM_STP_CONTRACT_RELINK">LSREFNO~LLREFNO~LDREFNO~OLDLDREFNO~VALIDATEVALUEDTAVAILABILITY~DELINK_COMMITMENT~MAKER~MAKERSTAMP~CHECKER~CHECKERSTAMP~MODNO~TXNSTAT~AUTHSTAT~ONCEAUTH</FN>'; 
msgxml += '    </FLD>'; 
...
var queryFields = new Array();    //Values should be set inside OLDRLINK.js, in "BlockName__FieldName" format
var pkFields    = new Array();    //Values should be set inside OLDRLINK.js, in "BlockName__FieldName" format
...
ArrFuncOrigin["OLDRLINK"]="KERNEL";
ArrPrntFunc["OLDRLINK"]="";
ArrPrntOrigin["OLDRLINK"]="";
ArrRoutingType["OLDRLINK"]="X";


 // Code for Loading Cluster/Custom js File Starts
ArrClusterModified["OLDRLINK"]="N";
ArrCustomModified["OLDRLINK"]="N";
