...
function fnPostLoad_CVS_AUTH_KERNEL(screenArgs) {
    ...
    if(!fnProcessAuthOnLoad(screenArgs))
        return false;
       document.getElementById("BLK_TLTBS_POSITION_DCF_STAT_CHANGE__BTN_AUTH").disabled = false;
...
function fnOnlineAuth() {
    ...
    gAction = 'AUTH';
       ...
       if (!fnOnlineAuthorize(subScreen)) {		
		...
		document.getElementById("BLK_TLTBS_POSITION_DCF_STAT_CHANGE__BTN_AUTH").disabled = true;
