...
{
	document.getElementById("BLK_REPORT__PRM_REPORTDATE").value = mainWin.AppDate;
	fireHTMLEvent(document.getElementById("BLK_REPORT__PRM_REPORTDATE"),"onpropertychange");
	return true; 
}
