...
**  Written by         : 
**  Date of creation   : 
**  File Name          : LDDPMAUT_KERNEL.js
**  Purpose            : 
**  Called From        : 
**  
**  CHANGE LOG
**  Last Modified By   : ArunaDeviRajendran
**  Last modified on   : 
**  Full Version       : 
**  Reason             : Changed the function id in CAPS
****************************************************************************************************************************/
...
function fnPostLoad_CVS_AUTH_KERNEL(screenArgs) {
    ...
    if(!fnProcessAuthOnLoad(screenArgs))
        return false;
       document.getElementById("BLK_CONTRACT__BTNAUTH").disabled = false;
        
	gAction = 'NEW';
	
	return true;
}
function FNADJUSTMENTAUTH() {
    var gprev = gAction;
    gAction = 'AUTH';
