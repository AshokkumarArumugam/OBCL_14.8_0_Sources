...
**Date               : 14-MAY-2021
**Change Description : Commented the mainWin.AppDate assignment  for VALDTI & LIMITDTI 
...
{	
	...
	fireHTMLEvent(document.getElementById("BLK_OLTBS_CONTRACT_PAY__VALDT"),"onpropertychange");//OBCL_14.3_SUPPORT_BUG#31400838  CHANGES
	// document.getElementById("BLK_OLTBS_CONTRACT_PAY__VALDT").value = mainWin.AppDate; //Bug#31400838 
	...
	fireHTMLEvent(document.getElementById("BLK_OLTBS_CONTRACT_PAY__LIMITDT"),"onpropertychange");//OBCL_14.3_SUPPORT_BUG#31400838  CHANGES
	//document.getElementById("BLK_OLTBS_CONTRACT_PAY__LIMITDT").value = mainWin.AppDate;	// Bug#31400838 
