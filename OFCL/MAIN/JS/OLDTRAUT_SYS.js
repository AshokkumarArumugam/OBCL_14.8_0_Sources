...
//----------------------------------------------------------------------------------------------------------------------
var fieldNameArray = {"BLK_HEADER":"MODULE~CONTRACTREFNO~MAKERID~MAKERDTSTAMP~CHECKERID~CHECKERDTSTAMP~EVENTSEQNO~EVENTDATE~EVENTCODE~CONTRACTSTATUS~AUTHSTATUS~TXTREFRATE~LSTINTRTSIGN~INTRT~TXTCCY~TXTAMOUNT~TXTVALDT~TXTMATDT~VISITED_UI~CONTRACTREFNO1~TXTCOUNTERPARTY~REKEY_TXTCCY~REKEY_TXTAMOUNT~REKEY_TXTVALDT~REKEY_TXTMATDT~REKEY_TXTCOUNTERPARTY~REKEY_INTRT","BLK_OLTBS_CONTRACT_CHANGE_LOG":"CONTRACTREFNO~EVENTSEQNO~CHANGESEQNO~DATECHANGED~FIELDCHANGED~FIELDDESCRIPTION~OLDVALUE~OLDDISPLAYVALUE~NEWVALUE~NEWDISPLAYVALUE","BLK_CONTRACT_OVD":"CONTRACTREFNO~EVENTSEQNO~OVDSEQNO~MODULE~ERRCODE~PARAMETERS~ONLINEAUTHID~REMARKS~AUTHBY~AUTHDTSTAMP~TXTSTATUS~OVDSTATUS~CONFIRMED~OVDTYPE~OVDSTATDESC~TXTOVD"};
...
var msgxml=""; 
msgxml += '    <FLD>'; 
msgxml += '      <FN PARENT="" RELATION_TYPE="1" TYPE="BLK_HEADER">MODULE~CONTRACTREFNO~MAKERID~MAKERDTSTAMP~CHECKERID~CHECKERDTSTAMP~EVENTSEQNO~EVENTDATE~EVENTCODE~CONTRACTSTATUS~AUTHSTATUS~TXTREFRATE~LSTINTRTSIGN~INTRT~TXTCCY~TXTAMOUNT~TXTVALDT~TXTMATDT~VISITED_UI~CONTRACTREFNO1~TXTCOUNTERPARTY~REKEY_TXTCCY~REKEY_TXTAMOUNT~REKEY_TXTVALDT~REKEY_TXTMATDT~REKEY_TXTCOUNTERPARTY~REKEY_INTRT</FN>'; 
...
var queryFields = new Array();    //Values should be set inside OLDTRAUT.js, in "BlockName__FieldName" format
var pkFields    = new Array();    //Values should be set inside OLDTRAUT.js, in "BlockName__FieldName" format
...
ArrRoutingType["OLDTRAUT"]="X";


 // Code for Loading Cluster/Custom js File Starts
ArrClusterModified["OLDTRAUT"]="N";
ArrCustomModified["OLDTRAUT"]="N";
...
var scrArgSource = {"OLCSTINF":"BLK_HEADER__CONTRACTREFNO1"};
