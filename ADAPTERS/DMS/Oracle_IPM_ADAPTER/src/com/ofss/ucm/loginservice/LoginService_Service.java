 ...
 * 
 */
@WebServiceClient(name = "LoginService", targetNamespace = "http://imaging.oracle/", wsdlLocation = "/wsdls/LoginService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName LOGINSERVICE_QNAME = new QName("http://imaging.oracle/", "LoginService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("/wsdls/LoginService.wsdl");
    ...
    public LoginService getLoginServicePort() {
        return super.getPort(new QName("http://imaging.oracle/", "LoginServicePort"), LoginService.class);
    }
    ...
    public LoginService getLoginServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://imaging.oracle/", "LoginServicePort"), LoginService.class, features);
    }
